...
* URL: https://www.reddit.com/r/rational/comments/85k5np/d_monday_general_rationality_thread/
* Score: 19

* Created: 2018-03-19T15:07:02
...
>> **u/Marthinwurer** [+6]  (2 hours later)
>> 
...
>> **u/OnlyEvonix** [+1]  (26 days later)
>> 
>> Perhaps look in sociology or neurology terms?

> **u/Gigapode** [+15]  (6 hours later)
> 
> [man creates and uses gene therapy on himself](https://www.reddit.com/r/videos/comments/7x8x3q/dude_uses_homebrew_genetic_engineering_to_cure/)
> 
...
> **u/ben_oni** [+10]  (16 hours later)
> 
> Do we like physics? [Researchers have devised a method to determine if gravity is a quantum force.](https://www.quantamagazine.org/physicists-find-a-way-to-see-the-grin-of-quantum-gravity-20180306/) Whichever way the experiment turns out, it will be most interesting, since the Standard Model is silent on this issue. I'm on the fence here and can't decide which way I think the experiment will go. On the one hand, I thought gravity was just [geometry](https://en.wikipedia.org/wiki/General_relativity), that is, the stage upon which physics plays out. On the other hand, it's just a set of field equations, no different than the others. But if so, what sort of mathematics allows for superpositions of spacetime manifolds?
> 
...
> **u/NotRationalEnough** [+8]  (2 hours later)
> 
> > Found a new way to get your shit even-more together?
> 
...
>>>> **u/Boron_the_Moron** [+4]  (20 hours later)
>>>> 
...
>>>> **u/NotRationalEnough** [+1]  (a day later)
>>>> 
...
>>> **u/NotRationalEnough** [-2]  (a day later)
>>> 
...
>> **u/MagicWeasel** [+7]  *Cheela Astronaut* (20 hours later)
>> 
