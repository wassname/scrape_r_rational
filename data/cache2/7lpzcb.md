...
* Author: u/None *
* URL: https://www.reddit.com/r/rational/comments/7lpzcb/rationalist_wish_fulfilment/
* Score: 3

* Created: 2017-12-23T17:59:22
...
> **u/NotACauldronAgent** [+33]  *Probably* (an hour later)
> 
...
> **u/Makin-** [+28]  *homestuck ratfic, you can do it* (an hour later)
> 
> Try Arcane Emperor.
> 
...
>> **u/eaglejarl** [+22]  (4 hours later)
>> 
>> Yep. He phrased it better this time, though.

>>> **u/Anderkent** [+4]  (5 hours later)
>>> 
...
>>>>> **u/callmesalticidae** [+2]  *writes worldbuilding books* (23 hours later)
>>>>> 
...
>>>>>>> **u/callmesalticidae** [+17]  *writes worldbuilding books* (a day later)
>>>>>>> 
...
> **u/awesomeideas** [+9]  *Dai stiho, cousin.* (8 hours later)
> 
...
>> **u/MultipartiteMind** [+1]  (9 days later)
>> 
>> (At 6.1 now, compelled to express frustration about two particular recent matters--)
>> 
>> 1.  [](#s "Alan has not expressed any curiosity at all about the possibility of a real-life banproof capsule (even if it wouldn't save him from real-life planet destruction), despite that (a) he's been getting closer and closer to getting banned, (b) he's seen in person the horror of people kicked out of the game, and (c) he *needs* a reliable defence against banning if he ever wants to use Data Interaction as a hot-knife-through-butter balance-breaking OP ability.  Void's last hint is plausibly exactly for dealing with that sort of situation, but it's frustrating if it saves him from that predictable threat without any attempts on his part to prepare for it.  And speaking of preparations, it's all the more important that he get to the point where he can use Data Interaction as his main game-breaking ability, because--")
>> 
>> 2.  [](#s "He's lost Hypercognition.  More than the other supporting aspects which could potentially be fully or partially shored up by a replacement AI, Hypercognition has been his primary OP ability up until now, Hacking pending free Data Interaction use.  He has no capsule-state backups of Eve.  He has no backups of Eve before loading her into the capsule. He has no backups of the design documents he used to make Eve.  Even once he was made aware that Eve could die, online--and Hypercognition itself aside--he made no effort to make sure she could be restored or regrown, whether for her sake or out of self-interest.")
>> 
>> From both these things, I am left unable to comprehend his {thinking process}/{value system}.
>> 
>> As a largely-unrelated aside, [](#s "I thought he moved his physical body from Earth because the communications lag from long-distance communication was starting to show up in Hypercognition?  But isn't he also told that his body is empty, with himself wholly uploaded to and running in the Game, when he's logged in?  (So shouldn't the post-upload communication lag be exactly the same?)  ...and why is he told that in response to his comment about a brain scan of his last state?  Maybe you can't restore a wetware brain to its last scanned state, but if you're in a wholly-uploaded state then you certainly *can* be replaced with a saved copy no matter how thoroughly the previous copy was destroyed (in Cyperspace, say)").

> **u/SpiritLBC** [+3]  (17 hours later)
> 
...
>>> **u/Roxolan** [+2]  *Head of antimemetiWalmart senior assistant manager* (12 days later)
>>> 
>>> > Sad thing is that after the author got divorced no new novel came out.
>>> 
...
>> 
>> Is the MC [smart](http://yudkowsky.tumblr.com/writing)?

>>> **u/SpiritLBC** [+1]  (4 days later)
>>> 
...
>>> 
>>> Well, HPMOR was good. 
>>> These are fiction I started before HPMOR, so they may not be LW!rational or even  [smart](http://yudkowsky.tumblr.com/writing), so don't go in to expectant.    
>>> 
>>> * Dungeon Defense (ATN) 
>>> * Code Geass (Anm) 
>>> * Death Note (Mng) 
