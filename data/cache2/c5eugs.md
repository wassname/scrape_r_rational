...
* Author: u/None *
* URL: https://www.smbc-comics.com/comic/passive
* Score: 58

* Created: 2019-06-25T20:37:57
...
> **u/Neon_Powered** [+3]  (3 hours later)
> 
...
> **u/sambelulek** [+1]  *Ulquaan Ibasa Liquor Smuggler* (6 hours later)
> 
...
>> **u/sykomantis2099** [+7]  *Custom Flair* (16 hours later)
>> 
...
>>> &#x200B;
>>> 
>>> For a toy system analogy, imagine a very simple system that will not give up information unless a particular binary number is sent to it.  All it is doing is a simple while(1) get\_incoming; if incoming.code.valid() break;
>>> 
>>> &#x200B;
>>> 
...
>>>> **u/sykomantis2099** [+4]  *Custom Flair* (a day later)
>>>> 
>>>> [First](https://docs.google.com/spreadsheets/u/1/d/e/2PACX-1vRPiprOaC3HsCf5Tuum8bRfzYUiKLRqJmbOoC-32JorNdfyTiRRsR7Ea5eWtvsWzuxo8bjOxCG84dAg/pubhtml), don't underestimate the lengths an AI will go to in order to achieve its objective.
>>>> 
>>>> [Second](https://en.wikipedia.org/wiki/Row_hammer), your toy system is still subject to the laws of physics and whatever physical limitations are part of the medium it runs on, and thus it is ripe for having the flaws of its medium exploited.
>>>> 
>>>> [Third](https://twitter.com/browserdotsys/status/1130909264065716224), lack of creativity on your part in regards to bypassing physical systems does not constitute lack of creativity on the part of an AI.
>>>> 
>>>> [Fourth](https://www.the-scientist.com/features/proprioception-the-sense-within-32940), our brains are also physical systems, and as such, given the right stimulus, an agent can make them do, or think, whatever it wants.
>>>> 
>>>> [Finally](https://www.lesswrong.com/posts/c5GHf2kMGhA4Tsj4g/the-ai-in-a-box-boxes-you), there are many different methods of persuasion.
