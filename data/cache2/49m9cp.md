...
* URL: https://forums.spacebattles.com/threads/mixed-feelings-worm-oc.375923/
* Score: 18

* Created: 2016-03-09T03:47:58
...
>> 
>> [Vague spoiler](#s " It's on a sharp upwards curve. (For now at least. Leviathan is bound to show up eventually...)")
...
> **u/JoshuaBlaine** [+6]  *Princess of the Wasteland* (15 minutes later)
> 
...
>> **u/Teal_Thanatos** [+3]  (an hour later)
>> 
...
>>> **u/JoshuaBlaine** [+6]  *Princess of the Wasteland* (an hour later)
>>> 
...
>>>> **u/Teal_Thanatos** [+1]  (19 hours later)
>>>> 
>>>> Hated due to the emotions, caused by her taking it.
>>>> She just triggered and then continues in the behavior that resulted in the triggering.
>>>> I don't see this as realistic in the scope of the conditions that power is assigned by the shards. 
>>>> I do see it as realistic by our standards, or by the standards of an non powered person.
...
> **u/chaosmosis** [+2]  *and with strange aeons, even death may die* (3 days later)
> 
...
> **u/lawnmowerlatte** [+1]  (8 hours later)
> 
> Is it on FF or AO3? I can't stand reading fan fiction via forum posts.

>> **u/noggin-scratcher** [+7]  *I am a happy tree* (9 hours later)
>> 
>> I was briefly hopeful, but [this has a very different subject matter](https://www.fanfiction.net/s/3598975/2/Mixed-Feelings)

>>> **u/lawnmowerlatte** [+2]  (9 hours later)
>>> 
>>> Haha, very different indeed.

>> **u/Escapement** [+4]  *Ankh-Morpork City Watch* (15 hours later)
>> 
>> I don't know if you read .epub or other, similar formats. If you do, the Fanficfare program, available as a [plugin](http://www.mobileread.com/forums/showthread.php?t=259221) for [Calibre](http://calibre-ebook.com/) or [on it's own](https://fanficfare.appspot.com/) converts many websites' of fanfic into .epub - and it will work for spacebattles or sufficient velocity forums, if the threads have either an index post or are using threadmarks (this story uses threadmarks).

>>> **u/lawnmowerlatte** [+1]  (a day later)
>>> 
>>> Thanks! I didn't know about that.

> **u/__2BR02B__** [+1]  *Marxist-Lurianism* (2 days later)
> 
> Damn. On the one hand, it's excellently written and truly disturbing. 
> On the other hand, that makes it *very* hard to read, in light of the subject matter.
