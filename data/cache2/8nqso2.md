## [RST] Pokemon: The Origin of Species, Ch. 56 - At Sea

* Author: u/DaystarEld  *Pokémon Professor**
* URL: https://www.fanfiction.net/s/9794740/56/Pokemon-The-Origin-of-Species
* Score: 112

* Created: 2018-06-01T10:17:28

### Post:

[Link to content](https://www.fanfiction.net/s/9794740/56/Pokemon-The-Origin-of-Species)

### Comments:

> **u/GaiusCoffee** [+55]  (40 minutes later)
> 
> >Sir... this is a *boat*.
> 
> :D

>> **u/Cariyaga** [+23]  *Kyubey did nothing wrong* (an hour later)
>> 
>> Right? I could just *feel* the indignation.

>>> **u/xamueljones** [+14]  *My arch-enemy is entropy* (5 hours later)
>>> 
...
>> 
>> Red's [on a boat, don't you ever forget.](https://www.youtube.com/watch?v=avaSdC0QOUM)

> **u/nicholaslaux** [+46]  (3 hours later)
> 
> The true origin of species was the friends we made along the way.

>> **u/Ceres_Golden_Cross** [+4]  (a day later)
>> 
>> Sir, you get an upvote

> **u/Lemerney2** [+32]  (3 hours later)
> 
> Shipppppppp. I’m sorry. I can’t resist.

>> **u/DerSaidin** [+21]  (5 hours later)
>> 
>> Author shipped 'ship on a ship.

>>> **u/DCarrier** [+12]  (12 hours later)
>>> 
>>> The current biweekly challenge is shipping. Maybe he should post this chapter there.

>>> **u/chaos-engine** [+12]  (14 hours later)
>>> 
>>> "Sir, this is a ship"

> **u/Croktopus** [+27]  (an hour later)
> 
> Ah. So, puberty rears its ugly head.

>> **u/akaltyn** [+29]  (7 hours later)
>> 
...
>> **u/ManyCookies** [+7]  (14 hours later)
>> 
...
>>> **u/nicholaslaux** [+10]  (14 hours later)
>>> 
...
> **u/noimnotgreedy** [+21]  (5 hours later)
> 
...
> **u/CopperZirconium** [+16]  (14 hours later)
> 
> I loved the Game Freak reference. Pokemon games on both sides of the fourth wall!

>> **u/PDNeznor** [+4]  (a day later)
>> 
>> Also the pokemon amie and holocaster cameos! Looks like somebody just finished a replay of x/y.
>> Man, I hope Game Freak gets those AR helmets out soon so *somebody* gets a scouter level reference in.
...
>>> **u/ketura** [+20]  *Organizer* (17 hours later)
>>> 
...
>>> **u/The_Magus_199** [+8]  *Ankh-Morpork City Watch* (11 hours later)
>>> 
...
>>> **u/Silver_Swift** [+16]  (20 hours later)
>>> 
...
>> **u/tokol** [+3]  *The Greater Good* (3 days later)
>> 
...
>> **u/vallar57** [+4]  *Unseen University: Faculty of High-Energy Magic* (a day later)
>> 
>> They probably could tame them, the old-fasioned way.

> **u/Neverwant** [+12]  (3 hours later)
> 
...
> **u/Saffrin-chan** [+11]  (8 hours later)
> 
...
>>>>> **u/Pious_Mage** [+7]  (a day later)
>>>>> 
>>>>> Done :)

> **u/Silver_Swift** [+12]  (2 hours later)
> 
> Man, that was a lot less disastrous than I thought it would be, given how the last chapter ended.

>> **u/DaystarEld** [+31]  *Pokémon Professor* (9 hours later)
>> 
...
>>> **u/Silver_Swift** [+9]  (9 hours later)
>>> 
>>> Ah, you should have totally done that, that would have been brilliant :D

>> **u/The_Magus_199** [+7]  *Ankh-Morpork City Watch* (11 hours later)
>> 
...
> 
> I'm identifying myself so much with Red in this conversation. I don't want animals to suffer, but I don't care that much to stop eating. 
> ...wait, I am feeling a lot like Red in general. Does that make me guilty when I root for the reaf ship?
> 
...
> 
> What.
> Oh wait, other readers are waiting for plot to happen. Here it comes, I assume. Not that I'm not getting excited too
> 
> >pidgey nuggets
> 
...
>> **u/DaystarEld** [+9]  *Pokémon Professor* (a day later)
>> 
...
>>> **u/nipplelightpride** [+5]  (3 days later)
>>> 
>>> Of course they're all colors, they're the ones on the artist's Palette

>> **u/Sailor_Vulcan** [+2]  *Champion of Justice and Reason* (5 days later)
>> 
...
>>> **u/Ceres_Golden_Cross** [+1]  (5 days later)
>>> 
...
> **u/MaddoScientisto** [+10]  (2 hours later)
> 
...
>> **u/notsureiflying** [+7]  (6 hours later)
>> 
>> What's a lemon tag?

>>> **u/Aretii** [+27]  *Cultist of Cthugha* (7 hours later)
>>> 
>>> Oh boy.
>>> 
...
>>>>> **u/Aretii** [+4]  *Cultist of Cthugha* (5 days later)
>>>>> 
>>>>> Probably not.

>> **u/TheGreatTactician** [+3]  (10 hours later)
>> 
>> Bro they're actual kids. Come on man.

>>> **u/DaystarEld** [+10]  *Pokémon Professor* (12 hours later)
>>> 
...
>>>>> **u/DaystarEld** [+11]  *Pokémon Professor* (a day later)
>>>>> 
...
>>> **u/Aretii** [+7]  *Cultist of Cthugha* (10 hours later)
>>> 
>>> note to self: add /s next time.

> **u/DaystarEld** [+6]  *Pokémon Professor* (12 seconds later)
> 
> Typo thread! Much thanks in advance!

>> **u/Croktopus** [+8]  (38 minutes later)
>> 
>> >it would be a waste to never try and publish what he.
>> 
>> incomplete sentence? "finds" for last word?

>>> **u/DaystarEld** [+3]  *Pokémon Professor* (20 hours later)
>>> 
>>> Yep, meant to be finds :) Fixed now!

>> **u/ZeroProtagonist** [+4]  (3 hours later)
>> 
>> 1. 
>> "Interviews!" Leaf puts her notebook on the table **nd** starts to eat.
>> 
>> 2. 
>> "Are they ever in groups **just just** psychics, though?"

>>> **u/DaystarEld** [+3]  *Pokémon Professor* (20 hours later)
>>> 
>>> Fixed!

>>>> **u/ZeroProtagonist** [+2]  (6 days later)
>>>> 
...
>> **u/xibfeii** [+5]  (3 hours later)
>> 
>> Great story, as ever!
>> 
>> +++
>> 
>> [awhile](http://www.dictionary.com/e/word-fact-whats-the-difference-between-a-while-and-awhile/) -> a while
>> 
>> [presentor](https://trends.google.com/trends/explore?geo=US&q=presenter,presentor) -> presenter
>> 
...
>> **u/KnickersInAKnit** [+6]  (5 hours later)
>> 
...
>> **u/PDNeznor** [+2]  (16 hours later)
>> 
>> what looks a whole separate room / what looks like a whole separate room
>> steps to the front of stage. / steps to the front of the stage.
>> Imagine what the the analysis / Imagine what the analysis
>> 
...
> **u/PDNeznor** [+6]  (a day later)
> 
> "Eventually he checks his phone and sees that it’s near noon...so he should probably get up soon. Instead he browses on his phone for a bit..."
> It seems like even the protag's are not immune to the dreaded phone-by-the-bed-time-sink.
> 
> Also "'Oh, yeah. Is Silph going to be presenting something too?'
> 'No, this year we’re strictly on the hunt.' He smiles." Isn't ominous sounding at all (I bet Silph hired all those psychics and is about to go Team Rocket Executive Proton on this boat isn't he?)
...
> 
> I just realized that I've been reading this every month for three years! Thank you, Damon.
> I'd like to say every chapter is better than the last, but I have an inordinate fondness for the Mewtwo interlude.
...
>>> **u/nipplelightpride** [+3]  (3 days later)
>>> 
...
>> **u/DaystarEld** [+5]  *Pokémon Professor* (3 days later)
>> 
...
>>>> **u/DaystarEld** [+4]  *Pokémon Professor* (4 days later)
>>>> 
...
> **u/None** [+6]  (45 minutes later)
> 
> [deleted]

>> **u/Croktopus** [+16]  (an hour later)
>> 
...
>>> **u/Electric999999** [+9]  (8 hours later)
>>> 
...
>> **u/empocariam** [+11]  (12 hours later)
>> 
...
>>> **u/The_Magus_199** [+6]  *Ankh-Morpork City Watch* (17 hours later)
>>> 
>>> Pffffff
>>> 
...
> **u/noimnotgreedy** [+3]  (a day later)
> 
> By the way, since you mentioned "other projects".. [Alolan spinoff confirmed](http://i2.kym-cdn.com/photos/images/facebook/001/185/925/ae6.jpg_large)?
...
>>> **u/Ceres_Golden_Cross** [+4]  (2 days later)
>>> 
...
> **u/Walk_the_Max_Planck** [+2]  (4 days later)
> 
...
>> **u/crivtox** [+2]  *Closed Time Loop Enthusiast* (7 days later)
>> 
>> I also planing to write a rational pokemon fic .(well a pokemon mystery dungeon  quest inspired by this and mfd more specifically) and have been trying to justify some really gamey bits of canon, but I think I haven't though of trade evolution yet.
>> I think you should just ignore the trading part, and just think of it as an abstraction of more specific evolution mechanics.
>> Maybe metal coat for example  just represents the Pokemon eating a lot of metal , or maybe its an item that the Pokemon has to be in contact whith for along time .
>> Kadabra could need the psychic contact  of multiple psychic Pokemon and 
>>  trainers  or something like that .

>> **u/wadaboutit** [+2]  (12 days later)
>> 
...
> **u/I_Probably_Think** [+2]  (6 days later)
> 
...
>> **u/DaystarEld** [+4]  *Pokémon Professor* (6 days later)
>> 
