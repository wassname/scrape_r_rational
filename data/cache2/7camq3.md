## [D] Rationally Writing 38 - The Medium of Prose Fiction

* Author: u/DaystarEld  *Pokémon Professor**
* URL: http://daystareld.com/podcast/rationally-writing-38/
* Score: 12

* Created: 2017-11-11T20:02:07

### Post:

[Link to content](http://daystareld.com/podcast/rationally-writing-38/)

### Comments:

> **u/Kuiper** [+5]  (5 hours later)
> 
...
> 
> On the subject of Japanese prose fiction, visual novels (which originated in Japan but started crossing over to the west during the 00's) are an interesting case.  Visual novels usually take the form of software that run as an executable on a computer or game console, though there are some web-based visual novels.  One of the things that's interesting about visual novels is that the player progresses through them line-by-line, allowing the creator to provide a more directed experience, e.g. cues for music changes and sound effects or visual effects can be tied to specific lines in the story.  Awhile back I wrote a [blog post](http://www.route59games.com/how-visual-novel-writing-is-different/) about some of the more subtle ways that writing for visual novels differs from writing for other forms of prose.
> 
...
>>>> **u/Kuiper** [+2]  (16 hours later)
>>>> 
>>>> You could always go onto a recruitment board (I believe [Lemmasoft](https://lemmasoft.renai.us/forums/viewforum.php?f=58)  is still the most active/popular one) to try and find an artist who'd be willing to work with you. 
>>>> 
...
> **u/DaystarEld** [+3]  *Pokémon Professor* (15 seconds later)
> 
