## Sampling Bias (short story)

* Author: u/VanPeer  *The shard made me do it**
* URL: https://vanpeerblog.wordpress.com/sampling-bias/
* Score: 22

* Created: 2016-11-25T03:04:06

### Post:

[Link to content](https://vanpeerblog.wordpress.com/sampling-bias/)
...
>>>> **u/VanPeer** [+2]  *The shard made me do it* (a day later)
>>>> 
>>>> It is contrived, no doubt about that. The reason I thought I could pull it off was because the MC gets information from the future in the form a Seer's vision which sort of clues him to the Important Piece of Wisdom. If it still seems contrived, then the failure is mine.
>>>> Thanks for confirming some of my misgivings. I'll try to avoid this particular failure mode in the future.

> **u/Lugnut1206** [+3]  (13 hours later)
> 
...
>> 
>> Fixed, thanks !
>> This is embarrassing since I keep making this error despite my brother pointing this out once before.
