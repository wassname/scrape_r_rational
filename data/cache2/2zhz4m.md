...
* Author: u/Arandur *
* URL: https://i.imgur.com/WKaOyBV.jpg
* Score: 43

* Created: 2015-03-18T19:05:42
...
> **u/haeri** [+66]  (24 minutes later)
> 
> Fruits are *sentient*?!

>> **u/noggin-scratcher** [+44]  *I am a happy tree* (33 minutes later)
>> 
>> and hats aren't just sentient, but sufficiently sophisticated to be *seduced*.

>>> **u/haeri** [+11]  (an hour later)
>>> 
>>> That just put a very dark twist on the notion of eating one's hat...

>>>> **u/PeridexisErrant** [+27]  *put aside fear for courage, and death for life* (2 hours later)
>>>> 
>>>> Or a rather saucy twist.  *waggles eyebrows*

>>> **u/Sparkwitch** [+5]  (21 hours later)
>>> 
>>> On the internet, nobody knows you're a hat.

>> **u/literal-hitler** [+3]  (5 hours later)
>> 
>> First snakes, now fruits...

>> **u/Action_Bronzong** [+2]  (3 days later)
>> 
...
> **u/alexanderwales** [+58]  *Time flies like an arrow* (12 minutes later)
> 
...
>> **u/Action_Bronzong** [+5]  (3 days later)
>> 
>> >**Bullet attraction**
>> 
...
>>> **u/LordSwedish** [+4]  *Q Continuum* (16 hours later)
>>> 
...
>> **u/FountainsOfFluids** [+2]  (3 days later)
>> 
>> Bullet Attraction is also an ability of a character on Haven.

> **u/IWantUsToMerge** [+52]  (41 minutes later)
> 
...
>> **u/psychothumbs** [+4]  (18 hours later)
>> 
...
> **u/noggin-scratcher** [+28]  *I am a happy tree* (35 minutes later)
> 
...
>> **u/alexanderwales** [+11]  *Time flies like an arrow* (53 minutes later)
>> 
>> > **75% Levitation** suggests you would only need a little extra thrust to achieve "full" levitation, and even if you can't find yourself a 25% jetpack it might at least make you lighter on your feet, more agile, able to jump to great heights.
>> 
...
>>> **u/chaosmosis** [+9]  *and with strange aeons, even death may die* (an hour later)
>>> 
...
>>>>> **u/chaosmosis** [+6]  *and with strange aeons, even death may die* (an hour later)
>>>>> 
...
>>>>>>> **u/ulyssessword** [+3]  (8 hours later)
>>>>>>> 
...
>> **u/blazinghand** [+8]  *Chaos Undivided* (3 hours later)
>> 
...
>> **u/Richard_the_Saltine** [+2]  (20 hours later)
>> 
>> If you can activate it at will, you could activate the power for a second and just bend all the bullets around you.

> **u/MadScientist14159** [+6]  *WIP: Sodium Hypochlorite (Rational Bleach) Eventually. Maybe.* (2 hours later)
> 
> Okay, let's see...
> 
...
>> **u/noggin-scratcher** [+6]  *I am a happy tree* (5 hours later)
>> 
...
>> **u/condortheboss** [+5]  (9 hours later)
>> 
...
>>> **u/coredumperror** [+2]  (10 hours later)
>>> 
...
> **u/Igigigif** [+3]  *IT Foxgirl* (33 minutes later)
> 
...
> **u/Drazelic** [+3]  *Dai-Gurren Brigade* (an hour later)
> 
...
> **u/gibusyoursandviches** [+3]  (2 hours later)
> 
...
> **u/Newfur** [+3]  *Crazy like a fox. Literally.* (4 hours later)
> 
...
>> **u/Nevereatcars** [+8]  *The Greatest Is Behind* (an hour later)
>> 
...
> **u/Chronophilia** [+2]  *sci-fi ≠ futurology* (13 hours later)
> 
...
>> **u/chaosmosis** [+3]  *and with strange aeons, even death may die* (an hour later)
>> 
...
> **u/Richard_the_Saltine** [+1]  (20 hours later)
> 
...
> **u/None** [+1]  (a day later)
> 
> Super-slow mo: Jump off a plane. Activate slow-mo the instant before landing. If you act like you have tremendous inertia while slowed to outside forces, you could basically have conditional super-strength by swinging a hammer and activating slow-mo mid-swing. Combined with 75% levitation and a jetpack that provides more than 2.95 m/s acceleration per your body weight, which has already been brought up, this would allow you to perform orbital strikes by yourself. Assuming the one-second super-strength comes with super-durability as well, you could even survive it if you timed it properly.
> Summoning a lamp that intersects another object might result in the annihilation of both, meaning a four-kilogram lamp materialized in a sphere of osmium would result in an antimatter-equivalent explosion with force equal to ((volume of lamp*density of osmium)+4 kg)*c^2.
> Bug revival - does this include fossils? Because, back in the day, there were some pretty badass bugs.
> Also, desaturation = urban camo.
