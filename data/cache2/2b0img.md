...
* Author: u/KOTORman  *Galactic Empire**
* URL: https://www.reddit.com/r/rational/comments/2b0img/star_wars_rational_take/
* Score: 19

* Created: 2014-07-18T02:48:47
...
>> **u/Escapement** [+12]  *Ankh-Morpork City Watch* (13 hours later)
>> 
...
>>>> **u/traverseda** [+9]  *With dread but cautious optimism* (a day later)
>>>> 
...
>>>> 
>>>> That said, I find reading stories that focus on technical details at the expense of story/plot or characters tedious at best. Technical details can facilitate story quite often and easily, e.g. see [Sanderson's First Law](http://brandonsanderson.com/sandersons-first-law/), but it often, often isn't. Hard science fiction has a distressing propensity to become [things like this](http://notes.greaterthanorequalto.net/post/3963193805/note-ive-been-wanting-to-link-to-this-for-a)

>>> **u/Kodix** [+1]  (13 hours later)
>>> 
...
>>>> **u/trifith** [+6]  *Man plans, god laughs. Like the ant and the grasshopper.* (17 hours later)
>>>> 
...
>> **u/omgimpwned** [+6]  *Sunshine Regiment* (12 hours later)
>> 
...
>> **u/KOTORman** [+6]  *Galactic Empire* (a day later)
>> 
...
>> **u/Abpraestigio** [+3]  (10 hours later)
>> 
>> All of my YES
...
>> **u/KOTORman** [+7]  *Galactic Empire* (a day later)
>> 
...
>>>> **u/KOTORman** [+2]  *Galactic Empire* (2 days later)
>>>> 
...
>>>>>> **u/KOTORman** [+1]  *Galactic Empire* (2 days later)
>>>>>> 
...
>>>> **u/traverseda** [+7]  *With dread but cautious optimism* (a day later)
>>>> 
>>>> Agreed. A simple
>>>> 
...
> **u/omgimpwned** [+5]  *Sunshine Regiment* (13 hours later)
> 
...
> 
> For sources on SW, go with [Wookiepedia](http://starwars.wikia.com/wiki/Main_Page) for general lore stuff and [stardestroyer.net](http://stardestroyer.net/) for weapons numbers and calculations, along with a lot of other similar, really useful stuff. While they apply WSOD liberally, they've spent a *lot* of time thinking about SW over there.
> 
> I hope some of this will help. Cheers! :P

>> **u/DeliaEris** [+6]  *Fully General Idealist* (15 hours later)
>> 
...
>>> **u/omgimpwned** [+3]  *Sunshine Regiment* (15 hours later)
>>> 
...
>>> **u/trifith** [+4]  *Man plans, god laughs. Like the ant and the grasshopper.* (16 hours later)
>>> 
...
>>>>> **u/trifith** [+2]  *Man plans, god laughs. Like the ant and the grasshopper.* (a day later)
>>>>> 
...
>> **u/KOTORman** [+2]  *Galactic Empire* (a day later)
>> 
...
> **u/Abpraestigio** [+2]  (2 hours later)
> 
...
> 
> Hmm... I wonder how feasible it would be to harvest electricity by putting a bunch of children on a midichlorian drip and teaching them to hate (force-)lightning rods... 
> Eh, screw feasible, I'd do it for the amusement value alone.
> Come to the Stormfront Holiday resort! Powered 100% by carefully cultivated hordes of insane orphan Siths!

>> **u/omgimpwned** [+2]  *Sunshine Regiment* (12 hours later)
>> 
...
>> **u/qznc** [+1]  *Chaos Legion* (3 days later)
>> 
...
> **u/whywhisperwhy** [+1]  (11 hours later)
> 
...
> **u/EndlessStrategy** [+1]  (21 hours later)
> 
...
>> **u/KOTORman** [+1]  *Galactic Empire* (a day later)
>> 
>> Of course, it limits my audience within r/rational but not to the hardcore EU-loving community I'm also focusing on. ;) Any munchkin shenanigans will be as much to do with the character knowing pretty much every detail of the EU, coming from Earth after all, than being rational.
>> 
...
>>>> **u/KOTORman** [+0]  *Galactic Empire* (2 days later)
>>>> 
...
> **u/colourlessgreen** [+0]  (11 hours later)
> 
