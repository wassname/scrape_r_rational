...
* URL: https://www.reddit.com/r/rational/comments/d46b9i/d_saturday_munchkinry_thread/
* Score: 13

* Created: 2019-09-14T15:04:27
...
> **u/Reverend_Giggles** [+4]  (12 hours later)
> 
...
>>> **u/Reverend_Giggles** [+3]  (a day later)
>>> 
...
>>> **u/Reverend_Giggles** [+1]  (20 hours later)
>>> 
...
>>>>> **u/Reverend_Giggles** [+2]  (23 hours later)
>>>>> 
...
>>>>>>> **u/Reverend_Giggles** [+1]  (23 hours later)
>>>>>>> 
...
>>>>>>>>>>> --------------
>>>>>>>>>>> 
>>>>>>>>>>> Result: Animal A learns to bypass its memory issues by [making notes on its own skin](http://spacespy.thecomicseries.com/comics/189/)
...
>>>>>>> **u/Reverend_Giggles** [+2]  (a day later)
>>>>>>> 
...
>>>>>>>>> **u/Reverend_Giggles** [+1]  (a day later)
>>>>>>>>> 
>>>>>>>>> Wait, they did? Must’ve missed that.
>>>>>>>>> Anyway, since even I’m losing track here, here’s a quick rundown.
>>>>>>>>> 
...
>>>>>>>>> **u/CCC_037** [+2]  (a day later)
>>>>>>>>> 
>>>>>>>>> The thing is, what you're doing here is generating near-instant [evolutionary computation](https://en.wikipedia.org/wiki/Evolutionary_computation) - that is to say, it's quite possible to get very similar results in only slightly slower time-scales with properly designed software and suitably beefy hardware. If it were *that* simple to use this power to create a cure, then you'd be able to define a similar methodology as a computer program and evolve *that* into a cure - taking maybe in the order of weeks instead of in the order of minutes (and depending on the beefiness of your hardware that might be even further reduced).
>>>>>>>>> 
