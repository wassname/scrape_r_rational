...
* Author: u/Nulono  *Reverse-Oneboxer: Only takes the transparent box**
* URL: https://www.reddit.com/r/rational/comments/65fpwy/is_it_possible_for_a_character_to_be/
* Score: 29

* Created: 2017-04-14T22:36:38
...
> **u/GaBeRockKing** [+35]  *Horizon Breach: http://archiveofourown.org/works/6785857**
> 
...
>> **u/Nulono** [+14]  *Reverse-Oneboxer: Only takes the transparent box**
>> 
...
> One literary example which is sort of in the same ballpark is Terry Pratchett's [Leonard da Quirm](https://wiki.lspace.org/mediawiki/Leonard_of_Quirm); the sort of person who doesn't bother to check if they're about to walk off a cliff because they'd probably be able to figure out a solution to falling - or gravity - before they hit the bottom.
> 

> **u/Tinfoil_Haberdashery** [+9] *
> 
...
>  * highly intelligent character with certain psychological inhibitions — e.g. an intelligent character with [learned helplessness.](https://en.wikipedia.org/wiki/Learned_helplessness) 
>  * highly intelligent character with severely limited worldview — The protagonist of *[The Girl with All the Gifts](https://www.goodreads.com/series/202735-the-girl-with-all-the-gifts)* is like this at the beginning of the story (then it slowly slides into being an [InformedAttribute\).](http://tvtropes.org/pmwiki/pmwiki.php/Main/InformedAttribute) She was described as being very intelligent, but all the information about the outside world she could get was the unbalanced and measly bits and pieces received from her teachers, so she didn’t have much ground to work on. 
...
>> 
>> Or [Infinite Fun Space](https://mlthesis.wordpress.com/2015/01/09/26/)
>> 
