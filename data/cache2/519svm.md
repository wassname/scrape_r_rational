...
* URL: https://www.reddit.com/r/rational/comments/519svm/d_monday_general_rationality_thread/
* Score: 19

* Created: 2016-09-05T15:04:23
...
>> **u/space_fountain** [+12]  (12 hours later)
>> 
...
>>>> **u/waylandertheslayer** [+6]  (9 hours later)
>>>> 
...
>>>>> **u/captainNematode** [+1]  (7 days later)
>>>>> 
...
>>> **u/DataPacRat** [+5]  *Amateur Immortalist* (7 hours later)
>>> 
...
>>> 
>>> Put another way, I'm aiming to be a person of the same approximate realm as a [Heinleinian protagonist](https://en.wikipedia.org/wiki/Competent_man). (Without the negative implications.)
>>> 
...
>>>>> 
>>>>> And now, I'm off to start my "what can I start work on improving /today/" by reading a book or two on harmonicas, picking something from [here](https://www.harptabs.com/songlist.php?DisplayBy=view) as an initial tune to work towards not being obviously terrible at playing, and figuring out where I can go to make awful noises on one without bothering anyone. :)
...
>>>>>>>> 
>>>>>>>> You should get yourself a 3D graphics programming framework and [this book](http://codingthematrix.com/).  Or just get the book, and learn linear algebra.
