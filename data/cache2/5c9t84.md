...
* URL: https://www.reddit.com/r/rational/comments/5c9t84/too_much_rationality_too_much_intelligence_a_bad/
* Score: 24

* Created: 2016-11-10T19:33:16
...
> **u/SimonSim211** [+22]  (20 minutes later)
> 
...
>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (23 minutes later)
>> 
>> > While intelligence might limit some characters, I think it opens up so much more space realistically
>> 
...
> **u/DaystarEld** [+40]  *Pokémon Professor* (28 minutes later)
> 
...
>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (42 minutes later)
>> 
>> > And you seem to be assuming that intelligent characters have equally ridiculous power levels, where the fight has to be over in an "instant." I don't see how that follows: the tools someone has at their disposal and the intelligence to use those powers has to be balanced by the writer to make the story entertaining: if they can't do that, it's their failure as a writer, not the result of having intelligent characters.
>> 
...
>>> **u/CouteauBleu** [+17]  *We are the Empire.* (an hour later)
>>> 
...
>>>> **u/OrzBrain** [-1]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (2 hours later)
>>>> 
...
>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (2 hours later)
>> 
>> > You can totally have two superheroes monologuing at each other in rational fiction, but they do it because they're both trying to win the fight and trying to improve their public image at the same time. Or they're actually trying to convince each other and spare themselves the fight.
>> > 
>> > 
...
>>>> **u/OrzBrain** [-3]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (3 hours later)
>>>> 
...
>>>>>>>> 
>>>>>>>> Was accidentally repeating LupoCani's mistaken reference to [this post](http://yudkowsky.tumblr.com/writing/level2intelligent) which explains Vinge's Law: if you know exactly what a very smart agent would do, you must be at least as smart.

>>>>>> **u/OrzBrain** [-1]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (4 hours later)
>>>>>> 
...
>>>>>>>> **u/LiteralHeadCannon** [+4]  (9 hours later)
>>>>>>>> 
...
>>>>> **u/LupoCani** [+10]  (5 hours later)
>>>>> 
>>>>> Intelligence ≠ superintelligence. Intelligence isn't a switch the Author flicks, immediately bestowing godly AI-level thought processes on all characters. In fact, no AI-level character has ever been written, what with [Vince's law](http://yudkowsky.tumblr.com/writing/level2intelligent) and all.
>>>>> 
...
>>>>>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (5 hours later)
>>>>>> 
...
>>>> **u/OrzBrain** [+1]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (5 days later)
>>>> 
...
> **u/EliezerYudkowsky** [+13]  *Godric Gryffindor* (11 hours later)
> 
...
>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (20 hours later)
>> 
>> > Suppose the average level of intelligence in the world was what we'd consider to be IQ 140. The writers, naturally, would tend to be a bit smarter than that. Is it impossible for them to write organically good literature? Do they need to write stories about people as dumb as the characters in our world in order to be able to write stories? Or does the intelligence everywhere in the fiction just organically go up with nobody thinking much of it?
>> 
...
> **u/nonoforreal** [+7]  (21 hours later)
> 
...
> **u/UnlikelyToBeEaten** [+6]  (49 minutes later)
> 
...
>>> **u/UnlikelyToBeEaten** [+2]  (2 hours later)
>>> 
...
>>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (3 hours later)
>>> 
>>> > Don't really agree that that is his motivation at all. Just that he's happy to enjoy the life even if it means that ending 
>>> 
...
> **u/TK17Studios** [+3]  *Author of r!Animorphs: The Reckoning* (3 hours later)
> 
...
>> **u/OrzBrain** [+2]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (4 hours later)
>> 
>> > You started this thought with r!Animorphs. I'm curious if the rest of the thought applies directly to r!Animorphs (i.e. whether you think it's bad/boring/less entertaining/more predictable fiction as a result), or whether your thoughts meandered further and it isn't a direct commentary. If you don't mind sharing, that is.
>> 
...
> **u/That2009WeirdEmoKid** [+4]  (44 minutes later)
> 
...
>>> **u/That2009WeirdEmoKid** [+4]  (3 hours later)
>>> 
...
>>>> **u/hillaryrapedobrien** [+1]  (4 hours later)
>>>> 
...
> **u/TennisMaster2** [+3]  (47 minutes later)
> 
...
> **u/rineSample** [+3]  (19 minutes later)
> 
> Thoughts on HPMOR?

>> **u/OrzBrain** [+5]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (29 minutes later)
>> 
>> > Thoughts on HPMOR?
>> 
...
>>>>> **u/TBestIG** [+4]  *Every second of quibbling is another dead baby* (5 hours later)
>>>>> 
...
> **u/hillaryrapedobrien** [+2]  (2 hours later)
> 
...
>>> **u/hillaryrapedobrien** [+9]  (3 hours later)
>>> 
...
>>>>>>>> **u/OrzBrain** [+0]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (a day later)
>>>>>>>> 
...
>>>>> **u/hillaryrapedobrien** [+3]  (3 hours later)
>>>>> 
...
>>>>>>> **u/hillaryrapedobrien** [+3]  (4 hours later)
>>>>>>> 
...
>>>>>>>>>> **u/OrzBrain** [+1]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (5 hours later)
>>>>>>>>>> 
...
>>>>>>>>>>> **u/hillaryrapedobrien** [+1]  (6 hours later)
>>>>>>>>>>> 
