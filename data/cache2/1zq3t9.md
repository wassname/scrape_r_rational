...
> **u/p_prometheus** [+8]  *These are not sins of omission but signs of preoccupation.* (10 hours later)
> 
...
>>> **u/loonyphoenix** [+1]  (24 days later)
>>> 
...
>>> **u/p_prometheus** [+1]  *These are not sins of omission but signs of preoccupation.* (a day later)
>>> 
...
>>> 
>>> I never got that impression. The whole thing was a mistake. There never was a necessity for genocide. The aliens were never going to attack us.
>>> They thought there was a cold equation to deal with when there was none. Just think about the money this ridiculous enterprise had cost them. In the movie they say 50 billion dollars. So they spent 50 billion dollars for nothing. It's a total waste. At the top of it they mass murdered a sentient race. How exactly did that story managed to convey the idea that you should crush anything that threatens you?
>>> ***
>>> What's wrong with Atlas Shrugged is that it is just bad philosophy and even worse writing.

>>>> **u/rictic** [+2]  (3 days later)
>>>> 
...
> **u/TastyBrainMeats** [+2]  (2 hours later)
> 
> This really knocked it out of the park. Saving the link so I can read it again once I've mentally digested it a bit.

> **u/trifith** [+5]  *Man plans, god laughs. Like the ant and the grasshopper.* (54 minutes later)
> 
...
>>> **u/p_prometheus** [+4]  *These are not sins of omission but signs of preoccupation.* (an hour later)
>>> 
...
>>>>> **u/p_prometheus** [+2]  *These are not sins of omission but signs of preoccupation.* (6 hours later)
>>>>> 
...
>>>>>>>>> **u/trifith** [+2]  *Man plans, god laughs. Like the ant and the grasshopper.* (3 hours later)
>>>>>>>>> 
...
>>>>>>>>>>>>> **u/trifith** [+1]  *Man plans, god laughs. Like the ant and the grasshopper.* (4 hours later)
>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>> >My what now? 
>>>>>>>>>>>>>> 
>>>>>>>>>>>>>> [You really didn't notice when she popped out of the ether?](https://www.youtube.com/watch?v=xA9dFZJtQWc)  Well then, MAZAL TOV, because you're a father!
...
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> [You have me confused with something else.](http://www.youtube.com/watch?v=hdsL_yOj4SU) I must say, all these different realities can get confusing sometimes.
...
>>>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>>>> Oh, the body is not. [The mind/sprit/soul/whatever](http://www.startrek.com/legacy_media/images/200307/q01/320x240.jpg) the old man used on the other hand...
...
>>>>>>>>>>> **u/trifith** [+1]  *Man plans, god laughs. Like the ant and the grasshopper.* (3 hours later)
>>>>>>>>>>> 
>>>>>>>>>>> >Sure, unless those resources were unfairly distributed in the first place, right? This of course brings the discussion into a wider one of what "fair distribution of resources" looks like, but the point is it's far less simple than equating taxes with theft: if I make millions of dollars a year in large part because of an existing infrastructure that turned my unique skills and hard work into profit, then I owe quite a lot to that infrastructure: far more than someone who merely makes a few hundred thousand, who in turn owes far more than someone who makes a few tens of thousands.
>>>>>>>>>>> 
...
>>>>>>>>>>>>>>> **u/trifith** [+1]  *Man plans, god laughs. Like the ant and the grasshopper.* (7 hours later)
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> > I'm sorry, but there's really no evidence for your beliefs here. It's as ideologically blind as communists who think that everything would just be honkey-dory if a centralized organization controlled EVERYTHING.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Evidence, huh? 
...
>>>>>>>>>>>>>>> Infrastructure:
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Roads: [The First New Hampshire Turnpike](http://northernnewenglandvillages.com/wp-content/uploads/2010/11/NH-Road-Marker-First-New-Hampshire-Turnpike.jpg) built by private corporations. Now part of NH route 4
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Dams: [Hells Canyon Dam](http://en.wikipedia.org/wiki/Hells_Canyon_Dam) the worlds largest privately built dam.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Charity: 
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> There are innumerable private charitable organizations, I'll not list them here.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Police: [Google search results](https://www.google.com/search?client=ubuntu&channel=fs&q=private+security+companies&ie=utf-8&oe=utf-8) for private security companies. Looks like quite a few to chose from.
>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>> > Good for you. Most people won't. Most people don't. You think they suddenly will if the government steps out of it? History doesn't support your belief, nor do studies of areas with less public charity. This is another idealized fantasy of libertarians: once again, relying on the goodness of mankind, while criticizing communists for making the same fallacy.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> On average [Americans give about 5% *$135.8 billion*](http://philanthropy.com/article/Interactive-How-America-Gives/133709/) of their household income to charity, after paying an [average of 17% *federal, 2009*](http://www.taxpolicycenter.org/taxfacts/displayafact.cfm?Docid=456) in taxes. I'd be willing to bet the charity rate increases when people are not taxed, and thus have more disposable income.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> > Alternatively, study other systems and governments that are far more agile and adapt to different circumstances. The idea that "America hasnt' done it yet, therefor it can't be done" is pretty amusing to people who live in other countries that have already found a better balance of socialism and capitalism :)
>>>>>>>>>>>>>>> 
