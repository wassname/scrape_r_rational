...
* URL: https://www.reddit.com/r/rational/comments/4riwlf/d_wednesday_worldbuilding_thread/
* Score: 13

* Created: 2016-07-06T15:04:55
...
>>>> 
>>>> -- [Margaret Mead](https://en.wikiquote.org/wiki/Margaret_Mead) (disputed)
...
>> **u/Aabcehmu112358** [+5]  *Utter Fallacy* (2 hours later)
>> 
...
>>> **u/Chronophilia** [+4]  *sci-fi ≠ futurology* (6 hours later)
>>> 
...
>>> **u/buckykat** [+2]  (11 hours later)
>>> 
>>> This is how one category of powers works in The Fall of Doc Future.

>> **u/Sailor_Vulcan** [+2]  *Champion of Justice and Reason* (20 hours later)
>> 
>> Strong Female Protagonist is an amazing work of rational literature, and does not fall into that trap. [Spoiler](#s "the protagonist ditches the mask and becomes a firefighter very early on, before the story even begins.")

>> **u/RolandsVaria** [+1]  (9 hours later)
>> 
...
>> 
>> Superheros fighting crime is harder.  There are [real-life superheroes](https://en.wikipedia.org/wiki/Real-life_superhero), so clearly it's a thing that some people are motivated to do.  The vast majority would more likely go into law-enforcement, fire/rescue, the military, or some other community-service-oriented career.
>> 
...
>> 
>> Again, you can [read the book](http://patreon.com/davidstorrs) to see if I succeeded, but I would contend that it's very possible to write a rational superhero story.
...
> **u/space_fountain** [+5]  (an hour later)
> 
...
>> **u/Chronophilia** [+7]  *sci-fi ≠ futurology* (7 hours later)
>> 
