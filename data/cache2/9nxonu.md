...
* URL: http://daystareld.com/podcast/rationally-writing-45/
* Score: 23

* Created: 2018-10-13T22:03:06

### Post:

[Link to content](http://daystareld.com/podcast/rationally-writing-45/)

### Comments:

> **u/DaystarEld** [+7]  *Pokémon Professor**
> 
> Hey everyone! Today we're joined by professional game writer Kuiper to discuss writing as a skill, or rather a set of skills, and the ways people can improve them. He's probably less well known around here than previous guests, unless you've been following [Re:Dragonize](https://www.royalroad.com/fiction/17234/re-dragonize/chapter/202344/chapter-1-welcome-to-the-afterlife), which is off to a promising start.
> Enjoy!
> **Timestamps**
...
>> 
>> This subreddit [has a Discord](https://discord.gg/5sutD3W), which has #looking_for_group, where you *might* be able to find some people to play with. I'm the admin there, so can help set up a channel or whatever you'd want.
>> I [also have my own Discord](https://discord.gg/PMeRkNF), and would be fine setting up a channel for you there if you want to find players or play a game. 
