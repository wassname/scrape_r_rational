...
> **u/BekenBoundaryDispute** [+6]  (12 hours later)
> 
...
>> **u/Transfuturist** [+1]  *Carthago delenda est.* (4 months later)
>> 
...
> **u/traverseda** [+3]  *With dread but cautious optimism* (13 hours later)
> 
...
> 
> It sounds interesting, but right from the first page, you see that Ulf is very stupid (or should that be gullible?) and to me, most of the interesting parts is how he learns/plays with the technology. The art doesn't get any better than the first page and I feel that the plot only gets really interesting around page #100. [Before that is ](#s "a nuclear war.")

>> **u/dokh** [+5]  *that which can be destroyed by the truth should be* (17 hours later)
>> 
...
> **u/superliminaldude** [+1]  (7 hours later)
> 
