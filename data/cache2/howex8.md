## I'm not sure how rational this fanfic is, but it does explain many inconsistencies in Star Trek: Voyager.

* Author: u/copenhagen_bram *
* URL: https://www.fanfiction.net/s/9648913/1/Detox
* Score: 13

* Created: 2020-07-10T20:21:55
...
> **u/ArgentStonecutter** [+11]  *Emergency Mustelid Hologram* (12 hours later)
> 
...
>> **u/Slinkinator** [+1]  (14 hours later)
>> 
...
>>>>> 
>>>>> [https://nicic.gov/criminal-how-lockup-quotas-and-low-crime-taxes-guarantee-profits-private-prison-corporations](https://nicic.gov/criminal-how-lockup-quotas-and-low-crime-taxes-guarantee-profits-private-prison-corporations)
...
>>>> 
>>>> An analogy would be how Microsoft never could have tested/predicted how Windows 95 would have run on CPUs 10x-100x faster than existed at the time; but then those CPUs *did* exist (only a few years later!), [and made Windows crash](https://www.zdnet.com/article/amd-discloses-k6-win95-glitch/).
>>>> 
...
>>>>> **u/ArgentStonecutter** [+3]  *Emergency Mustelid Hologram* (3 days later)
>>>>> 
>>>>> Unrelated comment:
>>>>> 
...
>>>>> 
>>>>> I got the impression from _Encounter at Farpoint_ that the Enterprise holodeck was one of the first installations of the technology. It seemed new technology to basically everyone present, so it was not yet commonly known about in the federation as a whole, and it was designed for that installation.
>>>>> 
...
> **u/Amargosamountain** [+5]  (6 hours later)
> 
...
> **u/Trustworth** [+3]  (15 hours later)
> 
> This seems like it would have been a fun idea for a oneshot, but by a few chapters in the joke wore kind of thin.

> **u/Kimundi** [+1]  (2 days later)
> 
> This has originally been a Quest on SpaceBattle Forums [here](https://forums.spacebattles.com/threads/star-trek-voyager-detox.265703/).
> 
> If you find the main fic funny, its worth checking out the omakes by other posters in that thread. [I particulary liked the explanation of why Voyager never seemed to run out of Shuttles and other "limited" hardware...](https://forums.spacebattles.com/threads/star-trek-voyager-detox.265703/page-27#post-11599346)
