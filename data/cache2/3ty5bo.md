...
* URL: https://www.reddit.com/r/rational/comments/3ty5bo/d_monday_general_rationality_thread/
* Score: 13

* Created: 2015-11-23T15:05:15
...
>>> 
>>> What do you need broken down there? I read through [the study](http://online.liebertpub.com/doi/pdf/10.1089/rej.2014.1636), but it seems fairly straightforward. They had trained and untrained worms split into ten groups (two of which were redundant) and both vitrification and slow freezing seemed to have little effect on the results of the test (i.e. the worms that were trained responded the same whether they were exposed to cryoprotectant or not, and whether slow-freezing or vitrification was used).
>>> 
...
>>>>> 3. Open up the SafeSpeed pack the worms are in with a scissors ([this thing](http://safepreservation.com/en/safespeed-device/))
...
>>>>>>>> **u/ArgentStonecutter** [+0]  *Emergency Mustelid Hologram* (3 days later)
>>>>>>>> 
>>>>>>>> > We know some emotions come from the Force; people with a strong Force connection often find their emotions spiralling out of control, in a kind of self-sustaining cycle of Force and emotion.
>>>>>>>> 
...
>>>>>>>>>>> **u/Transfuturist** [+2]  *Carthago delenda est.* (4 days later)
>>>>>>>>>>> 
...
>>>> 
>>>> really? everything i've seen points to them being pretty much all sophonts. admittedly, i haven't read much EU at all, but going by the categorization on [wookiepedia](http://starwars.wikia.com/wiki/Droid) the only droids that could really be useful without sentience are class fives.
...
>>>>>> 
>>>>>> that obi-wan quote is just him being a racist old coot. the [restrictions](http://starwars.wikia.com/wiki/Life_preservation_programming) you mention are basically asimov's laws.
>>>>>> 
...
> **u/ToaKraka** [+9]  *https://i.imgur.com/OQGHleQ.png* (59 minutes later)
> 
...
>>>> **u/Escapement** [+5]  *Ankh-Morpork City Watch* (12 hours later)
>>>> 
...
>> **u/TaoGaming** [+10]  *No Flair Detected!* (4 hours later)
>> 
...
>> **u/wendigo_days** [+4]  (12 hours later)
>> 
...
>> **u/Sailor_Vulcan** [+3]  *Champion of Justice and Reason* (23 hours later)
>> 
...
>>> **u/wendigo_days** [+1]  (14 hours later)
>>> 
...
>> **u/notmy2ndopinion** [+2]  *Concent of Saunt Edhar* (3 hours later)
>> 
