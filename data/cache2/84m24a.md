...
* URL: https://www.reddit.com/r/rational/comments/84m24a/anyone_else_loves_greg_egan_what_do_you_think_is/
* Score: 64

* Created: 2018-03-15T12:26:56
...
> **u/ArgentStonecutter** [+22]  *Emergency Mustelid Hologram* (44 minutes later)
> 
...
>>>> **u/SimoneNonvelodico** [+6]  *Dai-Gurren Brigade* (2 hours later)
>>>> 
...
>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (3 hours later)
>>>>>> 
...
>> **u/5erif** [+1]  (7 hours later)
>> 
>> > as ancient as Konishi polis itself.
>> (from Orphanogenesis)
>> 
>> I threw 'Konishi' into Google Translate and got nothing, then I added '-wa' because I thought I had heard that as a Japanese greeting. But no, apparently 'konishiwa' translates to ['wrinkle on child'](https://translate.google.com/#auto/en/konishiwa). So that was mildly interesting.

>>> **u/ArgentStonecutter** [+1]  *Emergency Mustelid Hologram* (7 hours later)
>>> 
>>> I always assumed it was a variant on something in Russian.

>>>> **u/5erif** [+3]  (8 hours later)
>>>> 
...
>> **u/VanPeer** [+2]  *The shard made me do it* (12 hours later)
>> 
...
>>>>> 
>>>>> I don't think the commentary itself feels out of place, but I agree it's not exactly *subtle*, and I guess one might find that aspect annoying. I didn't have a problem with it, except for what I consider to be a bit of a plot contrivance at the end of The Eternal Flame, namely [spoilers](#s " that when they are researching division, they only get one recording from arborines, and it breaks down - and then coincidentally not only that randomly ripped recording was the perfect one to induce monoparous splitting in arborines, it actually works the same in the protagonists' race as well! That I felt was stretching it a bit, especially considering that at that point the remaining arborines are also killed by the fanatics who oppose the research and yet apparently they still manage to perfect it, so basically they're at a stage where they're suddenly allowed to research on people").
...
> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (12 days later)
> 
