...
* URL: http://daystareld.com/podcast/rationally-writing-56/
* Score: 29

* Created: 2020-09-10T03:03:11
...
> **u/DaystarEld** [+10]  *Pokémon Professor* (3 minutes later)
> 
...
> **u/alexanderwales** [+7]  *Time flies like an arrow* (2 days later)
> 
...
> **u/AStartlingStatement** [+7]  (6 minutes later)
> 
...
>>>>>> **u/alexanderwales** [+7]  *Time flies like an arrow* (5 days later)
>>>>>> 
...
>>>>>>> **u/scholcombe** [+1]  (1 year, 11 months later)
>>>>>>> 
>>>>>>> I think a lot of American media depicts a default culture that, rather than being “white”, merely depicts American cultural values. America itself is a melting pot culture, basically we take what we like or works well from other cultures and incorporate them into our own, much like the English language itself. Using the Star Trek example, I think a lot of the bridge crew act stereotypically American, rather than stereotypically white, though, given the culture of the 1960’s, I can see how the two could easily be conflated. But even then, certain characters evinced traits associated with their individual traditional cultures. Uhura, for example, was shown several times to speak fluent swahili, she demonstrated multiple cultural hallmarks of her heritage without seeming comment from the other crew, and the audience was meant to just accept it. Sulu was another one, his accent was deliberately evocative of a Japanese native speaker using a long-standing fluency in English. Dr McCoy even pulled off one of the rare positive portrayals of a fundamentalist conservative southern United States citizen.
>>>>>>> 
>>>>>>> There is an obvious bias, given that the show was in fact written by white American men, but I think they at least tried to be more representative with their portrayals.
