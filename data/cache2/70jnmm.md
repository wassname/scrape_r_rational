...
* URL: https://www.reddit.com/r/rational/comments/70jnmm/d_uses_for_an_infinitely_fast_computer/
* Score: 31

* Created: 2017-09-16T21:53:35
...
>> **u/ShiranaiWakaranai** [+10]  (8 hours later)
>> 
...
>>> **u/Oh_Hi_Mark_** [+5]  (12 hours later)
>>> 
...
>>> **u/traverseda** [+3]  *With dread but cautious optimism* (16 hours later)
>>> 
>>> 0,1,and infinity are the only numbers that don't need to be justified. So, 1 or infinity?

>>> **u/crivtox** [+2]  *Closed Time Loop Enthusiast* (11 hours later)
>>> 
...
>>> **u/Dent7777** [+1]  *House Atreides* (8 days later)
>>> 
...
>> **u/everything-narrative** [+5]  *Coral, Abide with Rubicon!* (13 hours later)
>> 
...
> **u/eternal-potato** [+14]  *he who vegetates* (39 minutes later)
> 
> > All code is specified in a minimal combinator calculus, because it's the only thing you could embed into the exotic quantum state that is the computation medium.
> 
...
>> **u/everything-narrative** [+5]  *Coral, Abide with Rubicon!* (an hour later)
>> 
...
>>> **u/eternal-potato** [+11]  *he who vegetates* (an hour later)
>>> 
>>> You realize that Infiniputer is a Turing Halting Oracle, right?

>>>> **u/everything-narrative** [+4]  *Coral, Abide with Rubicon!* (13 hours later)
>>>> 
...
>>>>>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (a day later)
>>>>>> 
...
>>>>>>>>> 
>>>>>>>>> [Aha-ish](http://www.inf.ed.ac.uk/teaching/courses/inf2a/slides/2011_inf2a_L29_slides.pdf).  If you have an output buffer of 2^10 32-bit words, then you only have 2^15 possible output configurations.  You can run your Infiniputer for a brute-force search of those configurations, provided that *on the character's end of things*, the correctness and usefulness of the computation's result is [efficiently checkable](https://en.wikipedia.org/wiki/NP_(complexity\)), or he has an efficiently checkable *proof* that the stopping criterion for the brute-force search is correct.
...
> **u/Predictablicious** [+16]  *Only Mark Annuncio Saves* (3 hours later)
> 
...
>>> **u/Predictablicious** [+2]  *Only Mark Annuncio Saves* (a day later)
>>> 
...
>>> **u/NoYouTryAnother** [+2]  (6 days later)
>>> 
...
>>>> **u/Predictablicious** [+1]  *Only Mark Annuncio Saves* (7 days later)
>>>> 
>>>> Yeah, Scott Aaronson writes great explanations

>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (19 hours later)
>> 
>> Good idea w/ the BB function!
>> 
>> Also good idea w/ entropy hacking!

> **u/ThatDarnSJDoubleW** [+12]  (16 hours later)
> 
...
>> **u/everything-narrative** [+3]  *Coral, Abide with Rubicon!* (18 hours later)
>> 
>> Snrk.

> **u/ShiranaiWakaranai** [+11]  (8 hours later)
> 
...
>> **u/Tar_alcaran** [+6]  (10 hours later)
>> 
...
>>>> **u/Tar_alcaran** [+1]  (12 hours later)
>>>> 
...
>>>>> 
>>>>> Also maybe your simulation of how the materials behave could be wrong in some way and it could end up not working in real life , or not working outside certain specific conditions.
...
>> **u/PM_ME_OS_DESIGN** [+4]  (18 hours later)
>> 
>> > 
>> > 
>> > For example, you could ask your computer to design an extremely fuel-efficient or inexpensive rocket, brute-forcing all possible construction materials/methods/designs, with limitations on maximum size and construction time to make it practical to build.
...
>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (18 hours later)
>> 
...
>> **u/monkyyy0** [+8]  (5 hours later)
>> 
>> Wouldn't it just over fit the data and give gibberish?

>>> **u/EliezerYudkowsky** [+4]  *Godric Gryffindor* (9 hours later)
>>> 
>>> Solomonoff induction does not overfit.  (Ever.)

>>>> **u/696e6372656469626c65** [+7]  *I think, therefore I am pretentious.* (18 hours later)
>>>> 
...
>>>>>> **u/696e6372656469626c65** [+1]  *I think, therefore I am pretentious.* (23 hours later)
>>>>>> 
...
>>>>>>> 
>>>>>>> In the case of EY's example... a model that generates the Wikipedia articles in a way that can extrapolate to the future would need to generate the laws of physics, the initial conditions they started from, and all the quantum randomness since the beginning of time (or otherwise specify the Everett Branch), in addition to the location of Earth, and a schema for reducing that down into Wikipedia articles.  Comparatively, it might be simpler for the program to have Wikipedia articles directly coded into it via [magic numbers](https://en.wikipedia.org/wiki/Magic_number_(programming\))...  Solomonoff induction cares about the bits in the program, not how intuitively elegant you think it is.

>>>> **u/scruiser** [+3]  *CYOA* (23 hours later)
>>>> 
...
>> **u/PM_ME_OS_DESIGN** [+9]  (19 hours later)
>> 
>> > (Don't actually try this, you'll die.)
>> 
...
>>>>>>>>>>>>>>>>>>> **u/ben_oni** [+1]  (5 days later)
>>>>>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>>>>>> Oh really. Pray tell. [What do other people mean?](https://en.wikipedia.org/wiki/Simulation)
...
>> **u/Daneels_Soul** [+7]  (8 hours later)
>> 
...
>>> **u/EliezerYudkowsky** [+10]  *Godric Gryffindor* (9 hours later)
>>> 
>>> It basically gets you a phone line to a UFAI, yes.

>>>> **u/everything-narrative** [+11]  *Coral, Abide with Rubicon!* (14 hours later)
>>>> 
...
>>>> **u/Daneels_Soul** [+1]  (10 hours later)
>>>> 
...
>>>> **u/noahpocalypse** [+3]  (2 days later)
>>>> 
>>>> Portal 2 reference.
...
>>>> **u/scruiser** [+1]  *CYOA* (23 hours later)
>>>> 
...
>>>>> **u/EliezerYudkowsky** [+7]  *Godric Gryffindor* (2 days later)
>>>>> 
...
>>>>> **u/scruiser** [+3]  *CYOA* (6 days later)
>>>>> 
...
>> **u/FeepingCreature** [+6]  *GCV Literally The Entire Culture* (14 hours later)
>> 
...
>>> **u/DCarrier** [+4]  (21 hours later)
>>> 
>>> Here is a video of [Conway's game of life modelling itself](https://www.youtube.com/watch?v=xP5-iIeKXE8). In fact, any Turing machine can emulate any other Turing machine, which can emulate itself.
>>> 
...
>>>> 
>>>> In other words, the 'indeterminism' arises when _you_ become part of the otherwise isolated QM system you call an experimental setup, by virtue of some electron and photon interactions or some such, if I were to guess. Modeling several septillions of hadrons and associated force carriers is understandably a bit more difficult than a few photons.
>>>> 
...
>> **u/crivtox** [+7]  *Closed Time Loop Enthusiast* (12 hours later)
>> 
...
>> **u/nonoforreal** [+2]  (20 hours later)
>> 
...
>>> **u/AmeteurOpinions** [+3]  *Finally, everyone was working together.* (21 hours later)
>>> 
...
>> **u/crivtox** [+1]  *Closed Time Loop Enthusiast* (15 hours later)
>> 
>> What if it fails to solve FAI and a UFAI sends its seed  instead?
>>  Also Eliezer already proposed something  similar.
...
>>>>> **u/FeepingCreature** [+3]  *GCV Literally The Entire Culture* (16 hours later)
>>>>> 
...
>>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (5 days later)
>>> 
>>> Go watch 3Blue1Brown 's video about bitcoin to see why this is infeasible.

>>>> **u/crivtox** [+1]  *Closed Time Loop Enthusiast* (6 days later)
>>>> 
>>>> I haven't watched it yet , but you already told me that in response of other coment.
>>>> If you want I can change all my comments to say why that would be infeasible.But now I don't have time to do that, maybe tomorrow.
...
> **u/Frommerman** [+2]  (20 minutes later)
> 
...
>> **u/everything-narrative** [+11]  *Coral, Abide with Rubicon!* (26 minutes later)
>> 
...
>>> **u/crivtox** [+6]  *Closed Time Loop Enthusiast* (2 hours later)
>>> 
...
>>>>> 
>>>>> Well you can be really paranoid about it , send the information from multiple Internet connections and trying to do everything possible to avoid the cia getting to you.( I don't know exactly what things you can do to avoid intelligence agencies but I'm sure someone else here knows more about how to be paranoid on the internet and things you can do to avoid people finding you).
>>>>> Also you can use the launch codes to bluff so they won't want to touch you because one of your ( nonexistent)colleagues whith the same machine  (this is a crazy idea and will probably cause a lot of chaos , so it's better to only use it is really necessary , or maybe just  don't use it).
>>>>> Another less crazy way to protect yourself is becoming an public figure trough a pseudonym , making  cia seem evil if they try to take your machine , and ensuring a public uproar if it happens.
...
>>>> **u/everything-narrative** [+6]  *Coral, Abide with Rubicon!* (an hour later)
>>>> 
...
> **u/aeschenkarnos** [+1]  (5 hours later)
> 
...
>> **u/PM_ME_OS_DESIGN** [+2]  (19 hours later)
>> 
...
> **u/TheAtomicOption** [+1]  (6 hours later)
> 
> >What are you going to do with your infinitely fast computer?
> 
...
> **u/ShiranaiWakaranai** [+1]  (7 hours later)
> 
> Do you have to steal someone's bitcoins? Just use your infinitely fast computer to mine the bitcoins yourself.

>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (14 hours later)
>> 
>> Go watch 3Blue1Brown's video on Bitcoin.

>>> **u/crivtox** [+1]  *Closed Time Loop Enthusiast* (14 hours later)
>>> 
>>> So there is some problem which using the computer to mine  a lot of bitcoins?
>>> I will wach that video latter  I admit I don't  know how bitcoin works and maybe a lot of my comments  are wrong  because of that.

>>>> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (18 hours later)
>>>> 
>>>> Mining bitcoin is in essence being complicit in the infrastructure of the blockchain. It's a _reward_ for devoting computational work to the continued subsistence of bitcoin, not a _goal_. Cracking a digital signature is much easier.

> **u/crivtox** [+1]  *Closed Time Loop Enthusiast* (12 hours later)
> 
...
>> **u/everything-narrative** [+2]  *Coral, Abide with Rubicon!* (14 hours later)
>> 
>> The latter.
...
> 
> Create an identity as a group of people or maybe  a  millionaire who prefers to remain anonimous.
> Maybe once I have  enough money buy a  supercomputer so if people traces all back to me it won't be suspicious , It would seem that Im   just  an eccentric internet entrepreneur that got rich   and invested in a lot of computers to mine criptocurrency and whaterver other things I can find to get money on the net.
> I should get a really good internet connection.
> 
> Also I should spend a lot of electricity so people wont notice I'm not using my supercomputer at all , maybe even use the supercomputer an send everithing to the internet trought it.
> Then I can start anonymously donating my computing power to different  distributed computer projets to benefit science and medicine , but avoiding making people suspicious by using too munch on any particular thing  (If i can do that anonymously better , i don't want people realising my total computing power is unreasonably big if they start adding all the things I'm doing at the same time). 
> 
