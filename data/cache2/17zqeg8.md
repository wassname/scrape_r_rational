...
* URL: https://www.reddit.com/r/rational/comments/17zqeg8/d_monday_request_and_recommendation_thread/
* Score: 23

* Created: 2023-11-20T15:00:15
...
> **u/bestgreatestsuper** [+20]  (2 hours later)
> 
...
>>> **u/vorpal_potato** [+20]  (a day later)
>>> 
...
>>>> **u/bestgreatestsuper** [+6]  (7 hours later)
>>>> 
...
>>> **u/RegnarFle** [+2]  (3 hours later)
>>> 
>>> Another short parody:
>>> 
>>> [Wait, What?](https://archiveofourown.org/works/1115311) (Harry Potter)

>>>> **u/thomas_m_k** [+1]  (a day later)
>>>> 
>>>> Hmm, I don't really understand the significance of Harry having a twin brother. Is it just so that >!Dumbledore and Lily have a reason to talk about sending Harry to the Dursley's while she's alive?!<

>>>>> **u/RegnarFle** [+3]  (a day later)
>>>>> 
>>>>> Probably, or else they're parodying all the "Harry has a twin self-insert" stories.

>> **u/SpeakKindly** [+6]  (2 days later)
>> 
...
> **u/bestgreatestsuper** [+16]  (12 hours later)
> 
...
>> **u/bestgreatestsuper** [+12]  (a day later)
>> 
...
> **u/WilyCoyotee** [+12]  (11 hours later)
> 
...
>> **u/ReproachfulWombat** [+17]  (19 hours later)
>> 
...
>>>>> **u/netstack_** [+1]  (5 days later)
>>>>> 
>>>>> Wait, does final fantasy justify it?
>>>>> 
>>>>> Seeing swords facing up against guns is one thing, but seeing *bows* on level footing with guns never made a lot of sense. I’m thinking from an FFXIV perspective, though, where class balance was clearly the priority.

>>>>>> **u/TheColourOfHeartache** [+3]  (5 days later)
>>>>>> 
>>>>>> I don't think FF ever explains why bows and guns are balanced

>>>>>>> **u/sephirothrr** [+3]  (6 days later)
>>>>>>> 
>>>>>>> it's the ~~violence~~ magic inherent in the system
...
>>>> **u/lucidobservor** [+10]  (2 days later)
>>>> 
...
>> **u/DomesticatedDungeon** [+9]  (16 hours later)
>> 
...
>>> **u/serge_cell** [+3]  (19 hours later)
>>> 
>>> Which would you recommend (not a stub)?

>>>> **u/ansible** [+14]  *The Culture* (a day later)
>>>> 
...
>> **u/chiruochiba** [+6]  (12 hours later)
>> 
...
>> 
>> https://www.royalroad.com/fiction/60452/lockdown-expansion-apocalypse-litrpg
>> 
>> Lock down expansion has a similar feel to Scourged Earth, but is not as good yet.

> **u/hoja_nasredin** [+8]  *Dai-Gurren Brigade* (31 minutes later)
> 
> Anything similar to the practical guide to evil? Especially similar to early chapters.

>> **u/jaghataikhan** [+3]  *Primarch of the White Scars* (6 days later)
>> 
>> grandiose soft deserve future unused bag deer slimy teeny aspiring
>> 
>>  *This post was mass deleted and anonymized with [Redact](https://redact.dev)*

> **u/Cosmogyre** [+9]  (13 hours later)
> 
...
>>> >I noticed a thing with manga recently where the translations I'm reading just seem really choppy. Like, sorta incoherent. Maybe I'm noticing it more, or maybe translation quality varies considerably.
>>> 
>>> Yes, translation quality does vary considerably, especially the 'official' English translation. For instance, I've found that Tapas has extremely good official translations. On the other end of the spectrum, the official translations on Webtoons are so terrible that I end up reading the manga on a scanlation site instead.
...
>>> **u/VettedBot** [-5]  (3 days later)
>>> 
>>> Hi, I’m Vetted AI Bot! I researched the **Tonmom Laptop Stand for Desk Adjustable Laptop Riser ABS Silicone Foldable Portable Laptop Holder Ventilated Cooling Notebook Stand for 10 15 6 Laptops Tablet Black** and I thought you might find the following analysis helpful.
>>> 
>>> **Users liked:**
>>> * Stand provides comfortable typing angle (backed by 3 comments)
>>> * Stand is sturdy and stable (backed by 4 comments)
>>> * Stand is portable and compact (backed by 3 comments)
>>> 
>>> **Users disliked:**
>>> * Product may arrive damaged (backed by 1 comment)
>>> * Laptop may slip off stand (backed by 1 comment)
>>> * Stand requires flat, stable surface and weight to stay in place (backed by 1 comment)
>>> 
...
>> **u/-main** [+1]  (15 days later)
>> 
>> For fanfic/most webfic (including RR), urls go to fanficfare in calibre, then the downloaded epubs go to my kindle. Fanficfare is great, in the specific sense of being battle-tested for decades against the messiness of the web and the laser-precise desires of obsessive fanfic horders. Highly configurable, actually works. 
>> 
>> For anime, `nyaa.se`, open the magnet links in deluge on my desktop or laptop, dump it all on the local fileserver for watching at desktop or on the projector/home cinema setup. Yes it can take some fiddling around with fansub groups and video formats and reencoders/muxers, but I value actually having files for things. Warning: dubious-at-best legality, willingness to deal with technical jargon and weeby subcultures helps. 
>> 
>> Webcomics, tends to be my android tablet these days. Don't really have a good reading setup, especially not for the korean-style infinite scroll ones.

> **u/Krakenarrior** [+5]  *Absurdist disguised as a Rationalist* (4 hours later)
> 
...
>> **u/bestgreatestsuper** [+9]  (8 hours later)
>> 
...
>> **u/LovelandHywel** [+6]  (5 hours later)
>> 
...
>>>>>> 
>>>>>> Entirely possible. I've never watched the video version before.

>> **u/Cosmogyre** [+5]  (12 hours later)
>> 
...
>> 
>> My GM swears by youtuber/dnd personality Matt Coville, and it looks like he has narrative advice videos.

> **u/ManHasJam** [+1]  (5 days later)
> 
> Good sci-fi with audio options. Recently enjoyed Bobiverse and Foundation series.
