...
>>> **u/itisike** [+7]  *Dragon Army* (2 hours later)
>>> 
>>> He misread Harry multiple times, and said so in Parseltounge iirc.

>>>> **u/nevinera** [+2]  (15 hours later)
>>>> 
...
> **u/ishaan123** [+3]  *Sidebar Contestant* (3 hours later)
> 
...
>>> **u/None** [+2]  (a day later)
>>> 
>>> Well, prophecies are supposed to be _true_, if that counts as a rule requiring people to be alive if prophecies say they are supposed to do something they haven't done yet.

>>> **u/Uncaffeinated** [+1]  (a day later)
>>> 
>>> I don't think so.

>> **u/Farmerbob1** [+0]  *Level 1 author* (2 days later)
>> 
...
>>> **u/ishaan123** [+1]  *Sidebar Contestant* (2 days later)
>>> 
>>> Haha "Valdemort"? T)
>>> 
...
> **u/kaukamieli** [+2]  (8 minutes later)
> 
