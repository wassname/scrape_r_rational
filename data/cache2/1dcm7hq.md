...
* URL: https://www.reddit.com/r/rational/comments/1dcm7hq/d_monday_request_and_recommendation_thread/
* Score: 26

* Created: 2024-06-10T14:00:15
...
> **u/Do_Not_Go_In_There** [+19]  (an hour later)
> 
...
> 
> I'm currently reading [*The Winter of Widows*](https://forums.spacebattles.com/threads/the-winter-of-widows-si.1140307/) which is great. It's got a female SI-OC MC set right after the Dance. It's really good, the writing is great and the characters are interesting. The MC does get more than a bit lucky by being surrounded by ridiculously smart and competent people, but that's not really a huge deal IMO.
> 
> I just picked up [*When Heroes Die*](https://forums.spacebattles.com/threads/when-heroes-die.1163547/), which is a Worm x A Practical Guide to Evil fic. It follows Taylor Post-GM after Contessa dumps her in Calernia a few years before canon. I've only read a few chapters so far, but the writing is good and the author does a good job with the characters.

>> **u/LaziIy** [+9]  (a day later)
>> 
>> There's a comment from a [couple years ago that I saved ](https://www.reddit.com/r/rational/comments/oe7yxu/d_monday_request_and_recommendation_thread/h46to1z/). This has a decent spread and some comments that link to other lists of things that have been recommended here before.

>>> **u/Do_Not_Go_In_There** [+27]  (a day later)
>>> 
...
>> **u/DomesticatedDungeon** [+2]  (4 days later)
>> 
>> You may find [*Gospel of the Lost Gods*](https://forums.spacebattles.com/threads/gospel-of-the-lost-gods-asoiaf-worm.760033/threadmarks) by ManMag interesting, although it's not rational.

>> **u/Naitra** [+2]  (5 days later)
>> 
>> [For House and Dominion](https://suptg.thisisnotatrueending.com/archive.html?tags=Dominion%20Quest) is probably one of the best space kingdom building novels I've read, with really interesting twists, competent political maneuvering as well as realistic space combat. 
>> 
...
>>> **u/fassina2** [+6]  *Progressive Overload* (5 days later)
>>> 
>>> Sounds really interesting, anyone has an epub for this ?

> **u/Raileyx** [+16]  (2 hours later)
> 
> does anyone here still read [Delve](https://www.royalroad.com/fiction/25225/delve)? I remember seeing the weekly threads on here and enjoyed reading those, mostly because people kept losing their minds over how slowly the story progressed week after week. Very entertaining.
> 
> So how is the story now?

>> **u/ReproachfulWombat** [+10]  (3 hours later)
>> 
>> I do. 
>> 
...
>>>> **u/ReproachfulWombat** [+10]  (4 hours later)
>>>> 
>>>>     ^-('-')-^
>>>> 
...
>>>>> **u/Raileyx** [+3]  (4 hours later)
>>>>> 
>>>>> ok fuck it WE GO AGAIN
>>>>> 
>>>>> thanks man!

>>>>> **u/N0_B1g_De4l** [+3]  (4 hours later)
>>>>> 
>>>>> Is there somewhere you suggest picking back up to skip over the endless "soul" stuff? What you describe sounds interesting, but I'm just not willing to slog through that.

>>>>>> **u/ReproachfulWombat** [+4]  (4 hours later)
>>>>>> 
...
> **u/Dragongeek** [+9]  *Path to Victory* (5 hours later)
> 
...
>> **u/GlimmervoidG** [+21]  (6 hours later)
>> 
...
>>> **u/Dragongeek** [+18]  *Path to Victory* (11 hours later)
>>> 
...
> **u/PEAKEDINHIGHSCHO0L** [+5]  (a day later)
> 
...
>> **u/Missing_Minus** [+3]  *Please copy my brain* (5 days later)
>> 
>> [The Calculator (DC)](https://forums.sufficientvelocity.com/threads/the-calculator-dc-multiverse-si-as-canon-character-season-1-complete.39138/) is one of the usually recced ones, though I forgot how much it has of applying usual rational thought.  
>> 
>> I'm hopeful for [A Certain Road of Good Intentions](https://forums.spacebattles.com/threads/a-certain-road-of-good-intentions.1167672/) which is an SI into the Railgun universe as Accelerator. Seems to be going for a utilitarian main character slowly deciding whether to use their large power to improve things, quite likely forcibly. Unfortunately only started a week ago, so only a couple chapters. Definitely not with 'survive' as the main goal.    
>> 
...
>> **u/DrMaridelMolotov** [+6]  (a day later)
>> 
...
>>> **u/PresN** [+8]  (6 days later)
>>> 
>>> I only read the start of _The Outsider's Resolve_, but it starts off... pretty bad. You know that feeling in fanfic where the author is just a _little too good_ at writing a helpless loser main character? Yeah... our protagonist here is a supposed adult with essentially no knowledge of canon SI'd into a 10-year-old academy student. They proceed to... act in every way (emotionally, physically, mentally) like a 10-year-old who has the physical skills of a five-year-old _Naruto_ character. They don't know anything relevant, and put forth no real effort to learn. They miraculously get a tutor, and mere paragraphs after explaining that failing to graduate the academy within a year will result in them being a homeless orphan in the gutter, are shocked at the idea that they should get up at 5AM to train.
>>> 
...
>>> **u/masterax2000** [+3]  *Chaos Legion* (5 days later)
>>> 
...
>>> **u/NTaya** [+7]  *Tzeentch* (6 days later)
>>> 
...
>>>>> 
>>>>> Hmm. I'll get back, then. For a little bit. Maybe. But I'm sad to hear that the aforementioned problems only get worse.

>>>>>> **u/CaramilkThief** [+4]  (7 days later)
>>>>>> 
>>>>>> I've read up to 254, and I'll say that yeah if you want anticipation you're not gonna get it in Ar'k, or at least not much of it. There are plot hooks and foreshadowing, but they are so vague and finely spread out that they just get lost in the background noise until they're revisited and recontextualized in a much later chapter. You said that there are no events that are set up dozens of chapters in advance, and that's true, they're set up like 100 chapters in advance lol, and so get lost. IIRC there are some worldbuilding points raised in the 110-130 range that only got fully revealed after chapter 230. So there isn't a drip feed of tension and intrigue to set up the worldbuilding detail and events, they just get frontloaded whenever the time is right. 
>>>>>> 
>>>>>> I'm not sure if the author has mentioned it, but the story *is* sort of intentionally anti-anticipation, at least for plot points and lore. The goal was always to show how exactly the world became the way it is, and then how it is fixed over time. That it will be fixed is never in question. The story is ultimately one about optimism and benevolence and love, and even though it sometimes gets dark and has twists, the themes never change. There is no "surprise" I guess, in the strict sense.

> **u/gazemaize** [+10]  (an hour later)
> 
...
>>>> **u/bildramer** [+1]  (4 days later)
>>>> 
>>>> brazenautomaton's on tumblr, and one more I don't remember.

>>>>> **u/Tibn** [+1]  (4 days later)
>>>>> 
>>>>> Ah, I thought you were saying that you were previously recommended better stories about exploiting toon physics.

>> **u/Makin-** [+4]  *homestuck ratfic, you can do it* (5 hours later)
>> 
>> Fully seconding this.

> **u/BRKdoppo** [+2]  (4 days later)
> 
...
>>>> **u/JaxThePyro** [+5]  (4 days later)
>>>> 
>>>> It’s still up on the wayback machine if you want to take a look.

>>>>> **u/BRKdoppo** [+1]  (6 days later)
>>>>> 
>>>>> I’ll check it out, thank you

> **u/PekoraShine** [+5]  (2 days later)
> 
...
>> **u/SvalbardCaretaker** [+8]  *Mouse Army* (2 days later)
>> 
...
>> **u/DomesticatedDungeon** [+4]  (4 days later)
>> 
>> Seconding [*Doc Future*](https://tvtropes.org/pmwiki/pmwiki.php/Sandbox/DocFuture).
>> 
>> Also: 
>> 
>> `•` [*No Hero*](https://tvtropes.org/pmwiki/pmwiki.php/ComicBook/NoHero) by Warren Ellis (gore / body horror warnings);
>> 
>> `~`[*Legion*](https://tvtropes.org/pmwiki/pmwiki.php/Literature/TheManyLivesOfStephenLeeds) by Brandon Sanderson — rational enough, but not sure if it fits in the superhero genre. I'd say prot's "Thinker" rating would be sufficiently high;
>> 
>> `•` [*Shadows of the Limelight*](https://tvtropes.org/pmwiki/pmwiki.php/Literature/ShadowsOfTheLimelight) by Alexander Wales — has at least one >!deus ex machina solution!<, but otherwise rational.
>> 
>> `•` [*Watchmen*](https://tvtropes.org/pmwiki/pmwiki.php/ComicBook/Watchmen) by Alan Moore. The live adaptations of this have their problematic moments, but overall are worth watching too;
>> 
>> `~` [*Legion*](https://tvtropes.org/pmwiki/pmwiki.php/Series/Legion2017) by Noah Hawley — not rational, but has some really good scenes and moments. Later seasons deteriorate, but still contain a few really good scenes here and there.
>> 
>> -
>> 
>> From the fanfics (mostly Worm):
>> 
>> `•` [*Fun-house Mirror*](https://forums.spacebattles.com/threads/fun-house-mirror.963049/threadmarks) by WafflesAndCoffee;
>> 
>> `•` [OPM] [*One Compile Man*](https://archiveofourown.org/works/22394524) by PermutationGroupS7;
>> 
>> `•` *Si Vis Pacem* by EverythingNarrative;
>> 
>> `•` [*Bad Name, A*](https://forums.spacebattles.com/threads/a-bad-name-worm-oc-the-gamer.500626/threadmarks) by Potato Nose [LitRPG];
>> 
>> `•` [DC] [*Lex Luthor - Triumphant*](https://archiveofourown.org/works/43979322/chapters/114051268) by The_Dark_Watcher  — reader discretion advised; verisim, bad-ending type of story;
>> 
>> `~` [*Back and Forth*](https://forums.spacebattles.com/threads/back-and-forth-oc.1055118/threadmarks) by TryingItOut — teleporter MC. Not rational, but good fight scenes;
>> 
>> `~` [*Swallowtail*](https://forums.spacebattles.com/threads/swallowtail-worm-au.970396/threadmarks) by NotDis — not rational, uniqueness value;
>> 
>> `~` [*Camera Shy*](https://forums.spacebattles.com/threads/camera-shy-worm-alt-power.685357/threadmarks) by TheGreatGimmick — not rational, uniqueness value;
>> 
>> `~` [*Wiki Warrior*](https://forums.sufficientvelocity.com/threads/wiki-warrior.64766/threadmarks) by LMeire — not rational, but fun premise and great, evolving setting;
>> 
>> `~` [*Nemesis*](https://forums.spacebattles.com/threads/nemesis-worm-au.747148/threadmarks) by BeaconHill — not rational, fun premise, a more light-hearted setting.
>> 
>> -
>> 
