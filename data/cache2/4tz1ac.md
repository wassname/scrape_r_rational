...
* URL: https://www.reddit.com/r/rational/comments/4tz1ac/rtff_hermione_granger_and_the_perfectly/
* Score: 38

* Created: 2016-07-21T20:25:49
...
>> **u/RobinDrew** [+7]  *Ravenclaw - (Author: HGPRE)* (6 hours later)
>> 
...
>> **u/turbinicarpus** [+4]  (15 hours later)
>> 
...
>>>> **u/turbinicarpus** [+5]  (17 hours later)
>>>> 
...
>>>>>>>>> 
>>>>>>>>> HP fanfic is usually pretty easy going. I imagine I can read it quite a bit faster than pretty much anything else. 
>>>>>>>>> There's a lot of dialog markers and such, and I don't have to create much in the way of new mental imagery. To be honest it's almost a skim read and I certainly couldn't give a detailed plot outline.
...
>>>>>> **u/turbinicarpus** [+1]  (a day later)
>>>>>> 
>>>>>> Nifty! Thanks!

>>> **u/torac** [+1]  (a day later)
>>> 
>>> Not "Hermione does science", but somewhat related: [D.S.S. Requirement](https://archiveofourown.org/works/3412346/chapters/7472102) by esama. Some muggleborns ask the Room of Requirement for a spaceship. It complies, but everything is shut down and all labels are written in ancient runes. I think there were some sciencey bits about finding out *where* the space-ship is located and using the technology gained to find out what makes dragon hide so magic resistant.
>>> 
...
> **u/RobinDrew** [+3]  *Ravenclaw - (Author: HGPRE)* (9 minutes later)
> 
...
>>> **u/RobinDrew** [+2]  *Ravenclaw - (Author: HGPRE)* (19 hours later)
>>> 
>>> Thanks, fixed!

>> **u/nikic** [+2]  (2 days later)
>> 
>> The journal is called just "Physical Review D" (without the "Letters").

>>> **u/RobinDrew** [+1]  *Ravenclaw - (Author: HGPRE)* (3 days later)
>>> 
>>> Argh, thanks!  I specifically checked this, and somehow the Letters part snuck in.  Probably [*Timescape*](https://www.amazon.com/Timescape-Gregory-Benford/dp/0553297090)'s fault.

> **u/daydev** [+4]  (11 hours later)
> 
...
>> **u/Noumero** [+7]  *Self-Appointed Court Statistician* (15 hours later)
>> 
>> WMG ahead, beware.
>> 
...
>>> **u/turbinicarpus** [+2]  (15 hours later)
>>> 
...
>>>> **u/RobinDrew** [+2]  *Ravenclaw - (Author: HGPRE)* (4 days later)
>>>> 
...
>>>> **u/RobinDrew** [+6]  *Ravenclaw - (Author: HGPRE)* (19 hours later)
>>>> 
...
>>>>> **u/autourbanbot** [+1]  (4 days later)
>>>>> 
>>>>> *Here's the Urban Dictionary definition of* [***WMG***](http://www.urbandictionary.com/define.php?term=wmg) : 
>>>>> 
>>>>> ---
>>>>> 
...
>>>>> ---
>>>>> 
>>>>> _Person 1:Hey,did you see Counter Clockwise Strike: Lighting? It was funny!_
>>>>> 
>>>>> _Person 2:No,it got copyright for the audio._
>>>>> 
>>>>> _Person 1: WTF?! They are using their own voices and they got copyright? Fuck off WMG!_
>>>>> 
>>>>> _Person 3:If you want to boycott them look at the first defintion and follow their link to the real name of them._
>>>>> 
>>>>> ---
>>>>> 
>>>>> [^(about)](http://www.reddit.com/r/autourbanbot/wiki/index) ^| [^(flag for glitch)](http://www.reddit.com/message/compose?to=/r/autourbanbot&subject=bot%20glitch&message=%0Acontext:https://www.reddit.com/r/rational/comments/4tz1ac/rtff_hermione_granger_and_the_perfectly/d5ra7r5) ^| ^(**Summon**: urbanbot, what is something?)

>>>>> **u/None** [+1]  (4 days later)
>>>>> 
>>>>> Yeah, I did check Urban Dictionary first, but I'm pretty sure it wasn't that.

> **u/tbroch** [+3]  (2 days later)
> 
> Is this any good? I've been seeing it upvoted pretty consistently.

>> **u/Chevron** [+2]  *there is no antimemetics division* (5 days later)
>> 
>> I just finished catching up after being introduced to it by this post and think it's fantastic, so there's an opinion.

> **u/PlacidPlatypus** [+3]  (a day later)
> 
