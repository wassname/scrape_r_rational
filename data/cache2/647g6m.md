...
* URL: https://www.reddit.com/r/rational/comments/647g6m/d_saturday_munchkinry_thread/
* Score: 9

* Created: 2017-04-08T15:03:55
...
> **u/Nulono** [+6]  *Reverse-Oneboxer: Only takes the transparent box* (7 hours later)
> 
...
>>> **u/Gurkenglas** [+7]  (10 hours later)
>>> 
>>> Exchange of disease might be a problem.

>>>> **u/reaper7876** [+10]  (11 hours later)
>>>> 
...
>>>> **u/NotACauldronAgent** [+1]  *Probably* (10 hours later)
>>>> 
...
>>>>> **u/Nulono** [+2]  *Reverse-Oneboxer: Only takes the transparent box* (12 hours later)
>>>>> 
...
>>> **u/Nulono** [+2]  *Reverse-Oneboxer: Only takes the transparent box* (15 hours later)
>>> 
...
>>>> **u/Nulono** [+2]  *Reverse-Oneboxer: Only takes the transparent box* (2 days later)
>>>> 
...
>> **u/jaspercb** [+3]  *Gravitas Free Zone* (a day later)
>> 
...
>> **u/iamzeph** [+3]  (7 hours later)
>> 
>> Laser vision?

> **u/PM_ME_EXOTIC_FROGS** [+1]  (4 hours later)
> 
> Munchkin the [Death Note](http://deathnote.wikia.com/wiki/Rules_of_the_Death_Note).

>> **u/puesyomero** [+6]  *The Culture* (6 hours later)
>> 
...
>> 
>> Shameless plug, but [I am writing a Wormfic with this as its premise](https://forums.sufficientvelocity.com/threads/mortality.36749/).
>> 
>> Updates sundays.
...
>> 
>> I don't know the exact math involved but I t you can send information to the past using death notes to communicate FTL, I'm not sure how exactly you have to set up things to do that( and I would really appreciate if someone more knowledgeable about  relativity  explained the details of how to make time machines once you have faster than light travel).
>> For maximizing information sent a future civilization could create a creature that can transmit a lot of information effectively in ways easy to manipulate for the death note, and can be easily revived , that way you can maximize the information sent while minimizing the usage of the death note( I haven't seen the show in a long time but I think the number of pages was limited).
>> 
...
>> **u/GaBeRockKing** [+0]  *Horizon Breach: http://archiveofourown.org/works/6785857* (7 hours later)
>> 
...
>>>>>>> **u/696e6372656469626c65** [+1]  *I think, therefore I am pretentious.* (16 hours later)
>>>>>>> 
...
>>>>>>>>> **u/696e6372656469626c65** [+2]  *I think, therefore I am pretentious.* (16 hours later)
>>>>>>>>> 
