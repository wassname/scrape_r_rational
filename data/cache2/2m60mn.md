...
* Author: u/Maxeonyx *
* URL: https://www.fanfiction.net/s/10636246/22/Following-the-Phoenix
* Score: 9

* Created: 2014-11-13T09:06:47
...
> **u/MadScientist14159** [+10]  *WIP: Sodium Hypochlorite (Rational Bleach) Eventually. Maybe.* (6 minutes later)
> 
...
> **u/JackStargazer** [+14]  *Primordial Apologist* (8 hours later)
> 
...
>>> 
>>> [Link](http://fas.org/spp/military/docops/operate/ds/images.htm)
>>> 
>>> I assume these are only the ones near Kuwait.
>>> 
>>> Here by the way [Link](http://fas.org/irp/imint/kh-11.htm) are examples of photos taken by a KH-11 satellite. You will notice they are all greyscale.
>>> 
...
>>> 
>>> [This](http://www.au.af.mil/au/awc/awcgate/grayspc/dstorm/dstorm.htm) suggests satellites were better ( and I trust this source more), but still not below 5M resolution on the best state of the art types (Meteor Prioida advertises 5 meter resolution, but that is a Russian bird) They will have had advanced imaging satellites at the time as well, with better imaging than the KH-11's. It is specifically mentioned that there is a tradeoff between resolution and area covered.
>>> 
...
>>> 1. The teachers escaping from the school were idiotic enough to use the same type of ward - **which they knew had been compromised** - again at the new location.
>>> 3. Some of those teachers had already survived a decade of guirella fighting between wizards who were actively trying to murder them, and yet they did not post proper guards, did not react first while the muggles spent minutes fucking around at the edge of the wards, did not have prepared safehouses when they knew Voldemort was back. 
>>> In short, they were all holding enormous idiot balls.
>>> 
...
>>>>> **u/JackStargazer** [+0]  *Primordial Apologist* (2 days later)
>>>>> 
...
>>> **u/JackStargazer** [+0]  *Primordial Apologist* (a day later)
>>> 
...
> **u/MoralRelativity** [+5]  (11 hours later)
> 
...
> **u/PeridexisErrant** [+4]  *put aside fear for courage, and death for life* (an hour later)
> 
> Oh dear.
> 
> This is... not good.
