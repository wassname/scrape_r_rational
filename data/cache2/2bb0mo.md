...
* Author: u/MugaSofer *
* URL: https://www.reddit.com/r/rational/comments/2bb0mo/ideas_for_rationalanimorphs/
* Score: 24

* Created: 2014-07-21T16:15:43
...
> **u/ketura** [+13]  *Organizer* (11 hours later)
> 
...
>> **u/ketura** [+9]  *Organizer* (11 hours later)
>> 
...
> **u/alexanderwales** [+12]  *Time flies like an arrow* (32 minutes later)
> 
...
>>>>> **u/EndlessStrategy** [+1]  (2 days later)
>>>>> 
>>>>> If memory serves,
>>>>> after the Yeerks obtained morphing technology, which could have let them all take on a permanent non-parasitic, non-Kandrona dependent form, they didn't just give up the war.
>>>>> 
...
>> **u/noggin-scratcher** [+4]  *I am a happy tree* (an hour later)
>> 
...
>>>>>> 
>>>>>> Or you could always make a more limited version of morph tech that _only_ a allows a person to morph into themselves (and maybe doesn't have telepathy)  Give that to everyone, and everyone has regeneration.  Might even make them immortal depending on how it handles aging.

>>>>>>> **u/Zephyr1011** [+2]  *Potentially Unfriendly Aspiring Divinity* (4 days later)
>>>>>>> 
...
>>> **u/ketura** [+5]  *Organizer* (12 hours later)
>>> 
...
>> **u/someonewrongonthenet** [+3]  (9 hours later)
>> 
...
>>> **u/ketura** [+3]  *Organizer* (12 hours later)
>>> 
...
>>>> **u/someonewrongonthenet** [+1]  (a day later)
>>>> 
...
> **u/Timewinders** [+3]  (15 minutes later)
> 
...
>>>> **u/buckykat** [+2]  (4 days later)
>>>> 
>>>> [Spoiler](#s "The central conceit of the show is 'spiral energy' which is generated by humanoids trying to progress. It gives the strength to go beyond the impossible and kick reason to the curb. Anti-spirals, as the name suggests, consider this an existential risk and try to stop it by annihilating humanoid species that seem uppity. The final battle is between mechsuits made of galaxies and willpower.")

>>>>> **u/Zephyr1011** [+1]  *Potentially Unfriendly Aspiring Divinity* (4 days later)
>>>>> 
>>>>> Well, you have convinced me to watch it at some point this summer

> **u/themiragechild** [+2]  (an hour later)
> 
...
> **u/EndlessStrategy** [+2]  (16 hours later)
> 
...
>>> **u/EndlessStrategy** [+2]  (20 hours later)
>>> 
...
>>> **u/EndlessStrategy** [+2]  (2 days later)
>>> 
...
> **u/chaosmosis** [+2]  *and with strange aeons, even death may die* (14 days later)
> 
...
> **u/Zephyr1011** [+1]  *Potentially Unfriendly Aspiring Divinity* (4 days later)
> 
> From the [Animorphs Wiki](http://animorphs.wikia.com/wiki/Morphing):
> 
