...
* Author: u/deltashad *
* URL: https://www.reddit.com/r/rational/comments/820552/d_interplay_between_magic_system_and_scientific/
* Score: 21

* Created: 2018-03-04T20:05:51
...
> **u/SoylentRox** [+17]  (7 minutes later)
> 
...
> **u/ABZB** [+5]  *Count of Real Numbers* (an hour later)
> 
...
>>> 
>>> >Because magic in it based on really advanced science and therefore susceptible to scientific inquiry, and each parahuman has unique power.
>>>   Except it's not even Magic, it's super-advanced science that is understandable and follows specific laws, putting it in your First category if anything else.
>>> 
>>> >I am aware of that, but nowhere in my classification I made any assumptions on how and when magic emerged.
>>> 
...
>>> 
>>> >I don't see how that relevant at all - can you elaborate on what you mean by it?
>>>   I meant to say **wouldn't** not **would**.  IE:  If the "Magic" in the system arrived in prehistoric times, most technology would never be developed, except that granted by the magic itself (ie: Tinker powers).
...
> **u/everything-narrative** [+1]  *Coral, Abide with Rubicon!* (7 days later)
> 
> I have a magic system wherein the potency of magic is directly proportional to scientific knowledge. Anything is possible, but only if you have an understanding of _how it works._

> **u/xDarkSadye** [+1]  (21 days later)
> 
> Bit late to the party, but have you read Ra by Sam Hughes?
> 
> It tells the story of how magic was discovered in 1970 and has been incorporated into the world. In this case, it sits firmly in the first category, except for the fact that it has only been discovered in 1970, and that there is no evidence of its existence before 1970. The how and why of this are explained in the story and are a major spoiler. [MAJOR spoiler. If you're ever going to read the story, don't read this](#s " It's a virtually omniscient and omnipotent supercomputer called Ra in the center of of sun. It is used to do virtually anything you can ask of it (e.g. 'create a car' and it creates the perfect car for you, having taking that image right from your brain). It has gone rogue. Only a few people survived and they decided to reset the world back to 1970 and 'create' magic the way they see it to prevent humans from ever discovering the truth and waking Ra. It escapes me why the deception was necessary but it is well explained in the story. The magic rules and words are arbitrary and not based on anything physical.") It seems to fit fairly well into the first category, but when the story advances it becomes more and more arbitrary and might even end in the fourth category.
