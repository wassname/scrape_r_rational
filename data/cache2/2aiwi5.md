## The Two Year Emperor, Chapter 50 - Diplomacy Considered Dangerous

* Author: u/eaglejarl *
* URL: https://www.fanfiction.net/s/9669819/50/The-Two-Year-Emperor
* Score: 11

* Created: 2014-07-12T18:09:50
...
> **u/Prezombie** [+2]  (33 minutes later)
> 
...
>> **u/Evilness42** [+1]  *And even myth is long forgotten...* (an hour later)
>> 
>> [Possibility](#s "He could probably just commit suicide and respawn at his phylactery if negotiations turn sour. Also, wasn't it implied that the Flobovians also got people from other RPGverses? They could be lying, though.")
>> 
>> [Edit:] (#s "My second point is proven(enough to count without the author saying no) in Chapter 2: 'You must be from a dimension with an incompatible mystic framework. One of those point based ones, maybe?'")
...
>> **u/eaglejarl** [+1]  (6 hours later)
>> 
>> [Quote from your 'Ch. 50' entry:](#s "Isn't this an unnecessary risk on Afi's part?")
>> 
>> Sure seems that way, doesn't it? ;)

>>> **u/Prezombie** [+1]  (6 hours later)
>>> 
>>> [Ch. 50](#s "Oh gods living and dead, please say that spell engines can't run 'Polymorph any object, pebble into the human(?) lich Afi")
>>> 
>>> [Edit, second thoughts](#s "still hoping that's not possible, considering the implied rule of people being unique and non-duplicatable at the soul level, but then my new guess would be some kind of projection or directly controlled golem. If PAO is allowed to create "A human lich with skill levels x, y, and z", that would be nearly as broken as template abuse.")

>>>> **u/eaglejarl** [+1]  (12 hours later)
>>>> 
>>>> Rest assured, PAO cannot do that.  Which doesnt' mean that the truth is comforting.

> **u/Evilness42** [+1]  *And even myth is long forgotten...* (58 minutes later)
> 
> [Question](#s "Would Jake be affected by the diplomacy power, considering that he comes from another world?")
...
>> **u/ulyssessword** [+1]  (an hour later)
>> 
>> I don't think so.  He breaks enough rules that he should be affected as if by earth-physics.

>>> **u/Evilness42** [+2]  *And even myth is long forgotten...* (2 hours later)
>>> 
...
>>> 
>>> Wait, I just thought of a second point. Does he count as a PC or NPC? [Explanation](#s "I don't play D&D, but I think it said that that skill does stuff to NPCs at the bottom, not PCs. Is it supposed to apply to both or something? If he's a PC and that's true, he should be fine. I think.")
>>> 
...
>>>>> **u/Evilness42** [+1]  *And even myth is long forgotten...* (3 hours later)
>>>>> 
>>>>> In that case: [What might happen in Ch. 51](#s "Afi is going to die. Very quickly-or at least be taken out of action unless he is capable of overpowering everyone in the room.") Anyways, thanks for answering my question.

>>>>>> **u/PeridexisErrant** [+1]  *put aside fear for courage, and death for life* (19 hours later)
>>>>>> 
...
> 
> [Monster](#S "Afi is a very monstrous being. I can see why he's the top lich. And my diplomacy build, it doesn't take much out of they combat potential of a lich. He's likely still very monstrous in other ways.")
