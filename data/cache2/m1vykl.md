...
* Author: u/Yeongua *
* URL: https://www.reddit.com/r/rational/comments/m1vykl/lf_specific_time_travel_stories/
* Score: 15

* Created: 2021-03-10T12:00:40
...
>> 
>> Could be just that.
>> Tnx for the link ,will check it
>> 
...
>> **u/Yeongua** [+1] *
>> 
>> BTW is there a way to download book from stories online? 
>> Maybe some on-line converter?
>> Fichub unfortunately doesn't support this site.
>> 

>>> **u/ahasuerus_isfdb** [+1] *
>>> 
>>> [FanFicFare](https://www.mobileread.com/forums/showthread.php?t=259221) supports a ton of Web sites, including storiesonline. It can be used as a standalone program or as a Calibre plugin.
>>> 
...
>> Looking for stories with a focus on 'software' part.
...
> **u/PortionoftheCure** [+1] *
> 
> Doesn't hit most of that criteria, and is a fantasy setting, and the updates started slowing down, and now it hasn't been updated in over a year, but [A Hero's War](https://www.fictionpress.com/s/3238329/1/A-Hero-s-War) is about an engineer MC thrown into a medieval fantasy land where he begins to uplift technology with steel production and standardizing measurements. But then magic is involved and he tries to objectify its rules and implement them into engineering as well. Big Bad is zombies who begin to counter eradication by somehow hive-minding.
