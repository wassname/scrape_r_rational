...
* URL: https://www.reddit.com/r/rational/comments/5ncmla/d_wednesday_worldbuilding_thread/
* Score: 10

* Created: 2017-01-11T15:04:24
...
>> **u/MonstrousBird** [+7]  (3 hours later)
>> 
...
>> 
>> depending on where precisely on the cliff you are a waterfall actually is rather difficult to get power from, check out the [angel falls](https://en.wikipedia.org/wiki/Angel_Falls) the falls turn to a heavy drizzle at the bottom. also similar stuff will render most liquid waste to drizzles if there is enough distance between the out pour and the unfortunate folk below. 
>> 
...
>>>>>> **u/space_fountain** [+2]  (5 hours later)
>>>>>> 
