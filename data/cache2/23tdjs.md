...
> **u/Threedoge** [+4]  *New Lunar Republic* (7 minutes later)
> 
...
>>> **u/Threedoge** [+2]  *New Lunar Republic* (a day later)
>>> 
>>> Heck most of Doctorow's work is worth reading. The only one I just couldn't get into was "Rapture of the Nerds".

>>>> **u/boomfarmer** [+1]  *Trying to be helpful* (8 days later)
>>>> 
>>>> Have you read Charles Stross' [*Accelerando*](http://www.antipope.org/charlie/blog-static/fiction/accelerando/accelerando-intro.html)? *Rapture of the Nerds* can be likened to the story of those left behind on Earth during the events of *Accelerando*. They aren't the same universe by far, but it's a useful comparison, and provides a link to a story in a similar universe but a different perspective.

>>>>> **u/Threedoge** [+2]  *New Lunar Republic* (8 days later)
>>>>> 
...
>>> **u/boomfarmer** [+2]  *Trying to be helpful* (8 days later)
>>> 
>>> [link to the author's site, where CC-licensed downloads are available](http://craphound.com/down/). 
>>> 
>>> Also by Charles Doctorow: [*Rapture of the Nerds*](http://craphound.com/rotn/), a collaboration with Charles Stross.
>>> 
>>> And if you're looking for another bit of transhuman scifi, try Stross' [*Accelerando*](http://www.antipope.org/charlie/blog-static/fiction/accelerando/accelerando-intro.html).
...
>>> **u/Threedoge** [+2]  *New Lunar Republic* (3 days later)
>>> 
...
>>>>> **u/Threedoge** [+1]  *New Lunar Republic* (8 days later)
>>>>> 
...
>>>>>> **u/PeridexisErrant** [+1]  *put aside fear for courage, and death for life* (9 days later)
>>>>>> 
...
> **u/PeridexisErrant** [+4]  *put aside fear for courage, and death for life* (3 days later)
> 
> In the unusual but excellent category, I have to reccomend *[To the Stars](https://www.fanfiction.net/s/7406866/1/To-the-Stars)*.  
> 
...
> **u/4791** [+4]  *should be taken out and shot for endorsing UFAI.* (15 hours later)
> 
...
>> **u/Threedoge** [+3]  *New Lunar Republic* (19 hours later)
>> 
...
>>> **u/4791** [+3]  *should be taken out and shot for endorsing UFAI.* (a day later)
>>> 
>>> I actually don't think it's that strange. I mean, the 'Superhappies' utopia in Three Worlds Collide is even more different and some people have still defended it. I have the feeling that if you seriously started implementing the [Coherent Extrapolated Volition](http://wiki.lesswrong.com/wiki/Coherent_Extrapolated_Volition) of humanity and let it reach its conclusion, FiO utopia would be child's play when compared to that - which is an argument against FiO utopia of course.
...
>>>> **u/boomfarmer** [+1]  *Trying to be helpful* (8 days later)
>>>> 
>>>> Have you read [*The Metamorphosis of Prime Intellect*](http://www.localroger.com/prime-intellect/)? It's utopia as implemented by an all-powerful Three Laws AI. Things get nonconsensual pretty fast.

>> **u/alexanderwales** [+3]  *Time flies like an arrow* (22 hours later)
>> 
>> It's been awhile since I've read it, but there's also the [](#s "genocide of all non-human intelligences throughout the galaxy"), right?

>>> **u/erwgv3g34** [+3]  (a day later)
>>> 
>>> Yes, with the exception of [FiO](#s " a few alien races which are similar enough to humans to count under CelestAI's hard-coded definition of what "human" means.")

>>> **u/None** [+1]  (a day later)
>>> 
>>> [FiO](#s "Depends on how you define 'human'. Celestia would likely make similar offers to alien species that have sufficiently humanlike minds and destroy mercilessly everything else.")

>>> **u/4791** [+1]  *should be taken out and shot for endorsing UFAI.* (a day later)
>>> 
>>> [FiO](#s " That's how I understood it, plus the elimination of all the non-human species on Earth. It's exactly why I put the clause "when it comes to a single individual's well-being and values." It would be sad and should be avoided, but it would be a minor thing when compared to all the Fun and would get forgotten after a while. The fact that people are currently okay with killing and torturing billions of animals means that it probably wouldn't bother people all that much.")
...
>>>> 
>>>> [I feel reminded of this wonderful Galactic Civilizations 2 Let's Play](http://www.computerandvideogames.com/198344/blog/galactic-civilizations-diary-final-entry/), for reasons that should quickly become obvious.
...
>>>>>> 
>>>>>> I was mainly thinking of the part where [TWC](#s "he starts out as a pacifist, and his solution to every problem in the last half of the game is blowing up suns.")
...
>>> **u/4791** [+1]  *should be taken out and shot for endorsing UFAI.* (2 days later)
>>> 
>>> Wonderful. I'll carry my flair with pride!

> **u/AmeteurOpinions** [+2]  *Finally, everyone was working together.* (an hour later)
> 
> [Unreal Estate](http://stefangagne.com/unrealestate/) is a pretty awesome world. The story itself is great (imagine if Terry Pratchett wrote a harem anime) but also rather irrational so I've never mentioned it here before.
