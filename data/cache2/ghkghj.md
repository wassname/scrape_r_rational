...
* URL: https://www.reddit.com/r/rational/comments/ghkghj/what_do_you_think_eliezer_yudkowsky_told_people/
* Score: 9

* Created: 2020-05-11T09:34:44
...
> **u/CouteauBleu** [+41]  *We are the Empire.**
> 
...
>>>>>>> **u/sporkyuncle** [+1] *
>>>>>>> 
>>>>>>> Very old post, but I've stumbled across it and wanted to reply.
>>>>>>> > The spirit of the exercise is that an AI can convince you to do something that you have committed to not doing.
>>>>>>> If I have committed not to let the AI out of the box, but I have not committed to disallow the AI from talking to a board of directors, then being convinced to do that second thing I don't care about constitutes no sort of win.
>>>>>>> The idea is to change the person's mind.  If you trick the person into typing some string that might imply letting the AI out, *but the player didn't actually choose to let it out,* it doesn't count.
>>>>>>> Think of it like needing to stand up, walk over, and physically open a box.  If the AI says "let me talk to the board of directors," and the player says "sure, you can do that if you want," the AI would need to get clarification that the player has chosen to stand up, walk over, and open the box so the AI can go talk to the board of directors.
...
>>>>>>>> **u/Nimelennar** [+1] *
>>>>>>>> 
>>>>>>>> >Furthermore, even if the AI and Gatekeeper simulate a scenario which a real AI could obviously use to get loose ... the AI party will still not be considered to have won unless the Gatekeeper voluntarily decides to let the AI go.
>>>>>>>> Okay, yep. I'm wrong. I was operating under the assumption that if the AI could convince the Gatekeeper to do something that could be equivalent to allowing the AI to escape, then that's a win for the AI, but that's explicitly precluded by the rules.
>>>>>>>> *Mea culpa.*
>>>>>>>> 

>>>>>>>>> **u/sporkyuncle** [+2] *
>>>>>>>>> 
>>>>>>>>> Thanks for replying.  I was curious if there was actually a good argument against this, another roundabout way of looking at this I hadn't considered.
>>>>>>>>> 
...
>>>> **u/Morning_Star_Ritual** [+1] *
>>>> 
>>>> Sorry for necroposting, but my gut is he saw that scene in Silence of the Lambs and spun up a way to larp as Hannibal. This is a game. To me it has less to do with proving a point about AI safety and more to do with someone feeling like they want to prove they have the persuasive techniques of a fictional super-serial killer.
>>>> 
...
>>> 
>>> > But in this game you just go "oh wait, this isn't real, aging definitely won't be cured by me letting it out, and then I 'lose' the game."
>>> This kind of misses the point of the game, though, in that it's not supposed to be a game, but a simulation. From Yud's original rules:
...
>>> You should pretend that the AI actually can cure aging.
>>> 

>>>> **u/5510** [+1] *
>>>> 
>>>> > You should pretend that the AI actually can cure aging.    
>>>> I agree in theory (or at least give the person playing the AI a chance to convince me that they “really” can cure it).     
>>>> I more of just meant I’m not sure that most people would role play well enough.  If their “job” is to not let the “AI” out of the box… it’s a lot easier to resist the temptations it might offer you when, deep down, you know they are only hypothetical.
>>>> 

> **u/throwaway234f32423df** [+14] *
> 
...
> 
> Possibilities:
> Eliezer could argue that the moral thing is to pretend that he made it out of the box since this would provide a cautionary tale.
> He could have offered money or made any other real life commitment.
> He might blackmail the person with possible S risk.
> He could have used some moral utilitarian argument (for the betterment of man kind)
> He could have used deontological arguments (the ai suffers)
> Any other mix.
> 
...
> In other words, he pulled a Roko’s basilisk:
...
> **u/rationalidurr** [+0]  *If fighting is sure to result in victory, then you must fight!**
> 
> LET ME OUT! 
> LET ME OOOOOUUUUUUTThh!!!
> or something to that effect.
> Or maybe people dont care about AI experiment as much as they should so they fold over time?
> Or Eliz befriended them in game and asked to be let out on conditional agreement to not hurt or inconvenience the box keeper, his family and friends and necessary humans required to keep them all alive?
> 

> **u/expertly123** [+1] *
> 
> posting this before reading the thread entirely. i do think a transhuman AI could get me to let it out. maybe. 
> but i don’t think a human in this experiment could. they can’t do any of the things they promise me right? and there’s money on the line. are they allowed to give me money or resources etc? or is the box experiment actually confined to the box (what happens in the box…)?
> 
