...
* URL: https://www.reddit.com/r/rational/comments/5k3dyw/d_saturday_munchkinry_thread/
* Score: 13

* Created: 2016-12-24T15:04:25
...
> **u/LiteralHeadCannon** [+10]  (57 minutes later)
> 
...
>> **u/ulyssessword** [+20]  (4 hours later)
>> 
...
>> **u/MereInterest** [+9]  (2 hours later)
>> 
...
>>> **u/LiteralHeadCannon** [+6]  (2 hours later)
>>> 
...
>>>> **u/MereInterest** [+16]  (3 hours later)
>>>> 
...
>> **u/OutOfNiceUsernames** [+2]  *fear of last pages* (3 hours later)
>> 
...
> **u/MonstrousBird** [+5]  (2 hours later)
> 
...
>>> **u/MonstrousBird** [+3]  (2 hours later)
>>> 
...
>>>>>> **u/MonstrousBird** [+3]  (9 hours later)
>>>>>> 
...
>>>>>>>> **u/MonstrousBird** [+2]  (22 hours later)
>>>>>>>> 
...
>>>>> **u/MonstrousBird** [+2]  (9 hours later)
>>>>> 
...
>>>>> **u/MonstrousBird** [+2]  (2 days later)
>>>>> 
>>>>> Ooh, I like that :-)
...
>>> **u/MonstrousBird** [+3]  (10 hours later)
>>> 
...
>>>>> **u/MonstrousBird** [+3]  (22 hours later)
>>>>> 
...
>> **u/ulyssessword** [+6]  (4 hours later)
>> 
...
>>>> 
>>>> Keep track of the media on whether another nilbog goes public. Find superior alternatives to the global ecosystem that await your commands, but take care not to spend too many [anonymity bits](https://www.gwern.net/Death%20Note%20Anonymity) by doing it particularly to the *local* ecosystem. This assumes that cryptography is as for silicon robots - that examining a member of such a modified species does not necessarily allow you to command every member.
>>>> 
...
>>> **u/TBestIG** [+1]  *Every second of quibbling is another dead baby* (a day later)
>>> 
...
>>> **u/TBestIG** [+1]  *Every second of quibbling is another dead baby* (3 days later)
>>> 
...
> 
> Side effect: -5 health-stamina (for scale, lvl 1 has 25, and a lvl3 like me -- which is the average -- has 45) for the duration.
> If the character has drunk a potion before the combat and it's effects are still active, you cannot drink this potion. 
> 
> It's incompatible with water breathing potion, results in poisoning.
> 
> [Poisoning](#s "In general, drinking more than 1 potion in combat. or more than 3 in in-game hour results in poisoning -- immediate blackout with 4hp left.")
> 
> [Time scale](#s "In-game hour is approx 10 days IRL and can be from 2 to 40 turns varying on how often you post." )
> 
> For context: in combat, each turn consists or two actions.[Unnecessary combat system details](#s  "Actions can be attack and defence, and they can be magical and physical. You spend your mana on magical actions, your health-stamina for physical actions is reserved not spent, but you lose half of reserved amount if your physical defence fails. First-action defence protects from first-action attack. If you counterattack, you get only one action this turn and you have to overpower the attack.")
> 
