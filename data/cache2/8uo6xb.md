...
* Author: u/Ih8Otakus *
* URL: https://www.reddit.com/r/rational/comments/8uo6xb/what_exactly_is_munchkinry_and_the_best_examples/
* Score: 23

* Created: 2018-06-28T22:53:21
...
> **u/TempAccountIgnorePls** [+54]  (43 minutes later)
> 
...
> 
> Examples of munchkinry? There are plenty in [Worm](https://parahumans.wordpress.com/).  
> 
...
>>>> 
>>>> Hmm, [this guy](http://unitedfederationofcharles.blogspot.com/2015/07/what-is-grimdark.html) defines it more broadly than that... anyway, Worm, [as I understand it,](#s " doesn't exactly have a *happy* ending, just a world-isn't-dead ending") which is an issue for me.

>>>>> **u/None** [+15]  (20 hours later)
>>>>> 
...
> **u/keeper52** [+12]  (an hour later)
> 
> A munchkin is someone who would take a bite out of their family member if it gave them a power-up.

> **u/Russelsteapot42** [+10]  (9 minutes later)
> 
> [This TVTropes article](https://tvtropes.org/pmwiki/pmwiki.php/Main/Munchkin) does a good job explaining what the term means. According to that article:
> 
...
>> **u/ArgentStonecutter** [+8]  *Emergency Mustelid Hologram* (56 minutes later)
>> 
>> "Munchkin" predates Usenet.

>>> **u/Russelsteapot42** [+1]  (57 minutes later)
>>> 
>>> Source?

>>>> **u/ArgentStonecutter** [+26]  *Emergency Mustelid Hologram* (59 minutes later)
>>>> 
...
>>>>> **u/Russelsteapot42** [+4]  (an hour later)
>>>>> 
...
>>>>>> **u/ArgentStonecutter** [+14]  *Emergency Mustelid Hologram* (an hour later)
>>>>>> 
...
>>>> 
>>>> According to [witionary](https://en.wiktionary.org/wiki/munchkin) it's originally coined in The Wonderful Wizard of Oz (written in 1900), it initially meant tiny person or child. I don't know how old the RPG related definition is.

> **u/CCC_037** [+10]  (8 hours later)
> 
> Munchkinry is taking maximal advantage of the rules as written, often in a way that was never intended by the writer.
> 
> Perhaps the most extreme example is [Pun-Pun](https://www.dandwiki.com/wiki/Pun-Pun_\(3.5e_Optimized_Character_Build\)), a kobold with a viper familiar who uses an unexpected combination of monster abilities to obtain arbitrarily high values for all his character stats and every other number on his character sheet.

> **u/ajuc** [+13]  (15 minutes later)
> 
...
> **u/RMcD94** [+6]  (5 hours later)
> 
> A lot is two words

> **u/DCarrier** [+3]  (an hour later)
> 
> The [Gamebreaking category](https://1d4chan.org/wiki/Category:Gamebreaking) on 1d4chan.org has a lot of good examples.

> **u/kaukamieli** [+2]  (9 hours later)
> 
...
>>> **u/ArgentStonecutter** [+9]  *Emergency Mustelid Hologram* (57 minutes later)
>>> 
>>> 1. Munchkin comes from "the Wizard of Oz".
>>> 2, 3. Depend on 1 therefore wrong.
