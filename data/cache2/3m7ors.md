...
* Author: u/MugaSofer *
* URL: https://www.reddit.com/r/rational/comments/3m7ors/bst_how_would_you_deal_with_gaining_a_tinkermad/
* Score: 14

* Created: 2015-09-24T16:02:59
...
>>> **u/ArgentStonecutter** [+10]  *Emergency Mustelid Hologram* (3 hours later)
>>> 
...
> **u/ulyssessword** [+8]  (an hour later)
> 
...
> **u/puesyomero** [+5]  *The Culture* (an hour later)
> 
...
> **u/Uncaffeinated** [+6]  (9 hours later)
> 
> Make a device that explains its own principle of operation.

>> **u/Sceptically** [+1]  (21 hours later)
>> 
>> Like in the [last panel](http://www.schlockmercenary.com/2010-08-29)?

>>> **u/Uncaffeinated** [+2]  (22 hours later)
>>> 
...
>>>>> 
>>>>> Oh dear, you had to bring up [Brainfuck](https://en.wikipedia.org/wiki/Brainfuck).
>>>>> 
...
>>>>>>> ಠ_ಠ
>>>>>>> 
>>>>>>> And here I thought Brainfuck was the worst....after a little research, I have concluded that Brainfuck is actually the BEST of all the more... *esotric* languages such as [Whitespace](https://en.wikipedia.org/wiki/Whitespace_%28programming_language%29), [Lolcode](https://en.wikipedia.org/wiki/LOLCODE), [INTERCAL](https://en.wikipedia.org/wiki/INTERCAL), [Befunge](https://en.wikipedia.org/wiki/Befunge), and [Malbolge](https://en.wikipedia.org/wiki/Malbolge).
>>>>>>> 
...
> **u/captainNematode** [+2]  (3 hours later)
> 
