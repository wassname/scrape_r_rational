...
* URL: https://www.reddit.com/r/rational/comments/vbcvey/d_monday_request_and_recommendation_thread/
* Score: 37

* Created: 2022-06-13T14:00:11
...
>>>>> **u/Kachajal** [+1] *
>>>>> 
>>>>> > I'm a sucker for stories where an AI is living in the main character's head
>>>>> &#x200B;
>>>>> You might enjoy [Symbiote](https://farmerbob1.wordpress.com/2013/11/13/chapter-1-a-meeting-of-the-minds/) then.  You probably know about it already, but hey.
>>>>> 
...
>>>> **u/jimmy77james** [+1] *
>>>> 
>>>> The odd turn the story takes does kind of make sense in the context of a fictional universe (which they are technically in, and a super intelligent agent might make such a discovery about their universe).
>>>> >! The rule could be seen as something that emerges in-universe due to an out-of-universe reader preference for stories that occur in universes where everyone can’t be wiped out. Universe spanning plot armour!<
>>>> 
...
>> **u/magictheblathering** [+6]  * The Gothamite 🦇 dot net **
>> 
...
>>>>>> **u/lillarty** [+0] *
>>>>>> 
>>>>>> You asserted that they're discriminated against before we (readers, or the public in general) get to make a choice, though. That's such a wild claim, because it means that this process is either a natural process or has been internationally automated, both of which are patently absurd. This is why I asked you these questions. But based on this reply, I guess you just misspoke before? 
>>>>>> I'm not being disingenuous at all, though. I'm phenomenally bad at identifying "whiteness" in an international context. If you're purely comparing between an Irish and a Nigerian person, obviously it's pretty easy. But in real life you're adding a thousand other factors into consideration and I find that these factors make the matter far more complex than American progressives present it as.
>>>>>> 

>>>>>>> **u/rantenki** [+5] *
>>>>>>> 
>>>>>>> >That's such a wild claim, because it means that this process is either a natural process or has been internationally automated
>>>>>>> It's not a wild claim at all. Institutional racism is a very well documented problem.
>>>>>>> I didn't misspeak/write, but I could have been more clear: processes used to promote stories are often biased towards white, CIS protagonists (and their authors, who are also generally white/CIS because they write characters they can identify with). That bias can be as simple as the demographics of the voters (affluent enough for good internet, the spare time and literacy necessary to read recreationally, familiarity with the tropes and culture of the fiction pages, etc). For that reason, stories with white/CIS protagonists get filtered to the top of the lists. The problem compounds, too. If it's harder to find stories with non-mainstream protagonists, then they're likely to not get votes/promotion from readers who are busy with the stories which \_are\_ at the top of the lists.
>>>>>>> These kinds of filter issues are also pretty well understood, whether it's in policing, facial recognition, or an algorithm to measure the popularity of some fiction. [https://towardsdatascience.com/algorithms-are-racist-now-what-53fc130bb203](https://towardsdatascience.com/algorithms-are-racist-now-what-53fc130bb203)
>>>>>>> Nobody had to intend for the filter to be racist, it's as simple as building a system to promote the most popular protagonists/stories/etc. (ie: not anything resembling a minority).
>>>>>>> 
