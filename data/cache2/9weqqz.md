...
* URL: https://www.reddit.com/r/rational/comments/9weqqz/d_monday_general_rationality_thread/
* Score: 13

* Created: 2018-11-12T15:05:47
...
>> 
>> Let's assume that your propeller setup is perfectly efficient and you are just hovering. Then Thrust = (P^2 \*4\*ρ\*A)^(1/3) ,where P is the power of your engine,  ρ is the density of air, and A is the cross section of your propellers. You can see the derivation of this formula [here.](https://en.wikipedia.org/wiki/Thrust#Thrust_to_power)
>> 
...
>> >why don't they use newtons for engines and electricity instead of watts.
>> 
>> According to [this website](https://www.traditionaloven.com/tutorials/power/convert-newton-metre-seconds-to-watts-w.html) I found by googling 'watts versus newtons', 
>> 
>> 1 Watt = 1 Newton metre per second. 
>> 
>> This suggest that they do different things. Here's [Wikipedia](https://en.wikipedia.org/wiki/Watt#Distinction_between_watts_and_watt-hours) on the subject:
>> 
>> >The terms [power](https://en.wikipedia.org/wiki/Power_(physics)) and [energy](https://en.wikipedia.org/wiki/Energy) are frequently confused. **Power is the rate at which energy is generated** or consumed and hence is measured in units (e.g. watts) that represent energy *per unit time*.
>> 
>> \[emphasis mine\]
>> 
>> >Does the acceleration really depend on speed? 
>> 
>> If a car can 'go from zero to 60 in 5 seconds' that's acceleration. Between physics/calculus you can tell how fast the car is going not only on the *fifth* second, but also in between 0 and 5 seconds. (And how [far](https://www.quora.com/A-car-starting-from-rest-accelerates-to-50-0-m-s-in-5-00-seconds-How-do-you-find-the-acceleration-and-the-distance-covered-by-the-car) it drove.)
