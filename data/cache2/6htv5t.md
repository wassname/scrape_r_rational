...
* URL: https://www.reddit.com/r/rational/comments/6htv5t/d_saturday_munchkinry_thread/
* Score: 14

* Created: 2017-06-17T15:06:43
...
> **u/AmeteurOpinions** [+12]  *Finally, everyone was working together.* (26 minutes later)
> 
...
>>> **u/ArgentStonecutter** [+9]  *Emergency Mustelid Hologram* (5 hours later)
>>> 
...
>> **u/Gurkenglas** [+3]  (34 minutes later)
>> 
...
>> **u/ShiranaiWakaranai** [+1]  (9 hours later)
>> 
...
>>>> **u/ShiranaiWakaranai** [+7]  (10 hours later)
>>>> 
...
> **u/Nickoalas** [+9]  (12 minutes later)
> 
...
>> **u/Gurkenglas** [+20]  (28 minutes later)
>> 
...
>>> **u/trekie140** [+8]  (5 hours later)
>>> 
>>> Why is left-handed sugar so valuable?

>>>> **u/alexanderwales** [+13]  *Time flies like an arrow* (6 hours later)
>>>> 
...
>>>>> **u/DaystarEld** [+9]  *Pokémon Professor* (8 hours later)
>>>>> 
...
>>>>>> **u/alexanderwales** [+10]  *Time flies like an arrow* (9 hours later)
>>>>>> 
...
>>>>>>>> **u/ShiranaiWakaranai** [+5]  (13 hours later)
>>>>>>>> 
...
>>>>>>> **u/Nickoalas** [+1]  (10 hours later)
>>>>>>> 
>>>>>>> I did not expect to be learning something today. Would this ability actually result in 'left-handed' sugar? 
>>>>>>> Would reflecting myself and eating regular sugar have the same effect?
...
>>>>>>>>>> **u/Laborbuch** [+1]  (3 days later)
>>>>>>>>>> 
>>>>>>>>>> Another work dealing with this phenomenon is [a short story by Arthur C Clarke](https://en.wikipedia.org/w/index.php?title=Technical_Error&oldid=762053060), in which an industrial worker has an accident. The characters don’t know what happened and try to figure out what’s wrong with him, and why he’s losing weight despite eating regularly. 
>>>>>>>>>> 
...
>> **u/gbear605** [+6]  *history’s greatest story* (3 hours later)
>> 
...
>> **u/ShiranaiWakaranai** [+2]  (9 hours later)
>> 
...
> **u/XerxesPraelor** [+6]  (2 hours later)
> 
...
>>> **u/ShiranaiWakaranai** [+3]  (9 hours later)
>>> 
...
>> **u/ulyssessword** [+1]  (2 hours later)
>> 
...
> **u/Nulono** [+2]  *Reverse-Oneboxer: Only takes the transparent box* (6 hours later)
> 
...
>>> **u/Nulono** [+3]  *Reverse-Oneboxer: Only takes the transparent box* (9 hours later)
>>> 
>>> Upon examination, it appears to be an ordinary pebble.

>>>> **u/kuilin** [+4]  (a day later)
>>>> 
...
>>>>> **u/Nulono** [+1]  *Reverse-Oneboxer: Only takes the transparent box* (10 days later)
>>>>> 
...
>>> **u/Nulono** [+11]  *Reverse-Oneboxer: Only takes the transparent box* (9 hours later)
>>> 
...
> **u/AdjectiveRecoil** [+1]  (3 hours later)
> 
...
>>> **u/AdjectiveRecoil** [+1]  (5 hours later)
>>> 
>>> > You could use this to build a hover-board. Since the board is keeping you steady at a constant height, it's not actually consuming energy.
>>> 
...
>>>>> **u/AdjectiveRecoil** [+1]  (2 days later)
>>>>> 
>>>>> > A third option might be to add consequences for misuse of spirits. Maybe they can be trapped. And this causes some kind of terrible damage to the person who's now lost their magic. For instance, you can only fall asleep when your spirit is inside your body.
>>>>> 
...
>> 
>> Two spirits fighting is pretty much a fight of endurance, whoever runs out of energy first loses.
>> Less distance between you and your spirit means less energy use, and efficiency is the biggest advantage you could have.
>> 
>> The contest would basically be both spirits trying to locate the unprotected body of their opponent while also trying to maintain leverage of distance without giving away their own position. 
>> The best way would probably be to sneak up on your opponent with your real body, keeping them distracted with the fight. Or luring your opponent into a trap.
>> 
>> There's plenty of mind games and strategy to explore here. But this is all all attack, no defense strategy. If you choose this fighting style it only makes sense if your goal is to attack the body directly, expect high risk feints and gambits, not a direct spirit to spirit fight, because that would almost always equal a loss to whoever is furthest from their body. 
>> Both would have to be the 'sacrifice all your peices for the checkmate' kind of people to end up fighting like this.
>> 
...
>> 
>> Vs someone with a weak defenseless body and a spirit unnecessarily leaking energy somewhere away from their pathetic body. 
>> Blow for blow against our friend they will lose the most energy in Spirit, or their body will get smashed into paste.
>> 
...
>>> **u/AdjectiveRecoil** [+1]  (a day later)
>>> 
>>> > How fast can a spirit move?
>>> 
...
>>>>>>> > You could have a loophole in the distance restriction if two people have their spirit with the other person, substituting their own. Kind of like a stable link between two people. There would be a tangible sense of loss when the other died.
>>>>>>> 
>>>>>>> I like this. The fluff I've come up with includes reincarnation (ATLA style—past lives can advise) and the possibility of [reincarnation romance](http://tvtropes.org/pmwiki/pmwiki.php/Main/ReincarnationRomance) (warning: TV Tropes).
...
>>> **u/AdjectiveRecoil** [+2]  (2 days later)
>>> 
>>> > It makes sense for damage to the spirit to reflect damage to the body; if your spirit punches mine in the nose, my body gets a bloody nose (perhaps only when my spirit returns to it?)
>>> 
...
>>>>> **u/AdjectiveRecoil** [+2]  (3 days later)
>>>>> 
>>>>> > Do spirits retain memory? This could be a means of immortality.
>>>>> 
...
>>>>>>> **u/AdjectiveRecoil** [+2]  (4 days later)
>>>>>>> 
...
>>>>>>>>> **u/AdjectiveRecoil** [+2]  (5 days later)
>>>>>>>>> 
>>>>>>>>> > Can a detective interview a three-year-old who he suspects is holding the spirit of a murder victim? (Or the spirit of a murderer, if he suspects that the wrong person has been accused of the crime?)
>>>>>>>>> 
...
>>>>>>>>>>> **u/AdjectiveRecoil** [+1]  (6 days later)
>>>>>>>>>>> 
>>>>>>>>>>> > So, let's say Jack hits his head (let's assume that at the time of the injury he thought he would die), and gets a perfect case of Hollywood Amnesia - all the memories in his brain are scrambled but nothing else is affected. Can he use the backup memories in his spirit to remember things? Are these as good and plentiful as memories-in-the-head? Do they get overwritten by his memoryless brain?
>>>>>>>>>>> 
>>>>>>>>>>> > If you think you'll die, do you get a copy of your brain at this time written to your spirit? Are you then able to tap into this copy as if it were a past life, and re-remember things that you forgot since it was made?
...
>>>>>>>>>>>>> **u/AdjectiveRecoil** [+2]  (6 days later)
>>>>>>>>>>>>> 
>>>>>>>>>>>>> > What's the *exact* cutoff here?
>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>> **u/AdjectiveRecoil** [+2]  (8 days later)
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> > Does he get a new spirit? His old spirit back, but with his old memories written into it? No spirit at all?
>>>>>>>>>>>>>>> 
...
>>>> 
>>>> Give them absurdly powerful bows that a normal person couldn't operate. 
>>>> Something that for normal humans to get the same amount of power, would need to be stabilized in the ground and cranked up with gears. Basically seige weapons. Portable seige weapons
>>>> 
...
>>> **u/BotPaperScissors** [+0]  (a day later)
>>> 
>>> Paper! ✋ I win

> **u/Nulono** [+1]  *Reverse-Oneboxer: Only takes the transparent box* (6 hours later)
> 
> What would you do with an indestructible pebble, *i.e.* one that no-sells any form of physical damage?
