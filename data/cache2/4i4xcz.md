...
* URL: http://www.alexanderwales.com/glimwarden-prologue
* Score: 61

* Created: 2016-05-06T12:48:39
...
>>>> However, [this factsheet from the FAO](http://www.fao.org/fileadmin/user_upload/newsroom/docs/en-solaw-facts_1.pdf) [PDF] shows the following:
...
>> **u/alexanderwales** [+3]  *Time flies like an arrow**
>> 
>> Fixed, thanks! I've been thinking about how to set up some kind of system for typos that works a little better than using comment threads. I don't (necessarily) want an e-mail alias like typos@alexanderwales.com, since maybe that's an extra cost, but perhaps something like that.
...
> - [/r/glimwarden] [Glimwarden Discussion Link: Prologue & Chapter 1](https://np.reddit.com/r/glimwarden/comments/4op6u9/glimwarden_discussion_link_prologue_chapter_1/)
