...
* Author: u/STRONKInTheRealWay *
* URL: https://www.reddit.com/r/rational/comments/g9a7lw/creating_a_philosopher_king/
* Score: 8

* Created: 2020-04-27T21:46:28
...
> **u/Nimelennar** [+24]  (49 minutes later)
> 
...
>>>>>>>>>>>>>> 
>>>>>>>>>>>>>> > Reversing the latter part of that, if you install proper accountability into an office, you don't need the people you appoint/elect to that office to be angels. You can trust the restrictions of the office, so you don't have to trust the person.
>>>>>>>>>>>>>> > Of course, if the mechanisms holding them accountable become corrupt, then you're right back in the same mess, but I think that applies to the incentive/disincentive motivation as well.
>>>>>>>>>>>>>> 
...
>>>>>>> 
>>>>>>> The current gold-standard IQ test, the [WAIS-IV](https://en.wikipedia.org/wiki/Wechsler_Adult_Intelligence_Scale#WAIS-IV), measures the following:
>>>>>>> 
...
>>>>>>>> >NO! Again, I haven't taken a formal IQ test, but I've heard them described, and I don't remember, a storytelling component. Or musical composition. Or artistic ability. Or... really, anything else that would showcase creativity.
>>>>>>>> 
>>>>>>>> While I'm not sure about the WAIS IV, plenty of other tests like the one I took [include word association components which are one type of creativity test.](https://en.wikipedia.org/wiki/Creativity#Personal_assessment) That being said because creativity is almost impossible to disentangled from intelligence in measurement (and because creativity tests don't correlate as strongly with each other as different intelligence tests do) I've become agnostic as to its exact relation to G.      
...
>>>>>>>> >What I'm saying is that you do not get what you don't select for (or, at least, not at a rate better than random chance). If you believe, as I do, that "intelligence" encompasses more than verbal comprehension, perceptual reasoning, working memory, and processing speed, then, if you select based on IQ (which measures those four things), you will not get someone who is more intelligent than average in any kinds of intelligence that are not included in one of those four things.
>>>>>>>> 
>>>>>>>> Goodhart's law isn't a universal law: it works as a heuristic under certain conditions and can't be applied the way you're trying to here. [The whole point of Goodhart's law is that when a metric is used as a target it creates incentives to game the metric, thus reducing the original efficacy of that metric.](https://en.wikipedia.org/wiki/Goodhart%27s_law) There's a number of reasons however why that doesn't apply to this situation though, foremost being that IQ tests can't be gamed to significantly increase one's adult scores short of cheating.
...
>>>>>>>>> 
>>>>>>>>> If you want to argue that the definition of "charisma" is so obvious as to not require an exact definition, the best definition for charisma I've seen is its sociological one, which describes ["a particular type of leader who uses values-based, symbolic, and emotion-laden leader signaling."](https://en.wikipedia.org/wiki/Charisma)  If you can convince me *that's* genetic, I'll be impressed.  Otherwise, find me a better, *objective* definition of what charisma is, and how we might recognize it in a person, absent a crowd to be inspired by the person.
>>>>>>>>> 
...
>>>>>>>>> 
>>>>>>>>> If I read your argument correctly, you're saying that Donald Trump isn't charismatic.  To quote [you from an earlier post](https://www.reddit.com/r/rational/comments/g9a7lw/creating_a_philosopher_king/fp08whd/?context=3):
>>>>>>>>> 
...
>>>>>>>>> 
>>>>>>>>> If your argument is that Trump is not charismatic, are you arguing that [he doesn't have a cult of personality](https://en.wikipedia.org/wiki/List_of_cults_of_personality#United_States), or are you withdrawing your argument that charisma is the most important trait in establishing one?
>>>>>>>>> 
...
>>>>>>>>> 
>>>>>>>>> [I think you're misusing that](https://www.geneticshumanagency.org/gha/robert-plomins-use-of-my-ideas-in-blueprint/).
>>>>>>>>> 
...
>>>>>>>>>> **u/vakusdrake** [+1]  (9 days later)
>>>>>>>>>> 
>>>>>>>>>> >What, exactly, about that standard is too high? I'm asking for something that you can give me an exact definition for, measure, and correlate with genetics (and I'm only asking for the third because your assertion is that it's a genetic quality).
>>>>>>>>>> 
>>>>>>>>>> Did you somehow miss the entire paragraph addressing that? Of your three demands only the last one makes sense. Expecting that charisma should be purely definable based on personality traits is assuming a model of charisma I reject from the outset. [Now you can measure charisma in plenty of different ways](https://www.psychologytoday.com/us/blog/cutting-edge-leadership/201103/measuring-personal-charisma-emotional-intelligence-and-savoir), but you can't escape the inability to feasibly measure charisma without social interaction. [This study](https://digest.bps.org.uk/2017/08/15/psychologists-have-developed-the-first-scientific-definition-and-test-of-everyday-charisma/) is notable in that it found charisma to be a factor not explainable by intelligence and OCEAN scores. There's also studies [linking leadership to various genes](https://www.independent.co.uk/news/science/born-to-rule-scientists-uncover-gene-that-may-help-create-natural-leaders-8452499.html), but a frustrating lack of genetic studies that used the aforementioned charisma psychometrics rather than just looking for genes more common among leaders.           
>>>>>>>>>> 
...
>>>>>>>>>> >My point is that you're placing pressure on IQ scores for genetic selection. There may be a correlation between IQ scores and other forms of intelligence beyond math and language, but that correlation is likely to collapse when you start using IQ as a target for genetic improvement.
>>>>>>>>>> 
>>>>>>>>>> This still misses why Goodhart's Law works. In the wikipedia article _all of the mechanisms actually described are based on people gaming the metric_. If you want to use Goodhart's Law totally differently than all the examples then you actually need to know what the mechanism would be. If people can't game IQ tests and IQ correlates to other areas of intelligence it doesn't directly test, then how _exactly_ would this correlation disappear as a consequence of selecting for IQ? 
>>>>>>>>>> 
>>>>>>>>>> As for your second reply, everything you talk about is common knowledge among those who work with IQ (the increase in average IQ over time is called the [Flynn Effect](https://en.wikipedia.org/wiki/Flynn_effect)). It seems as though you are objecting to IQ as it’s misused by laymen: The test is normalized to a bell curve because that makes it the best at distinguishing relative performance for most of the population (those in the bulge). Intelligence may not in absolute terms be distributed normally (like a lot of polygenic traits it’s probably a skewed bell curve), but trying to construct an absolute intelligence test is a fool's errand. 
>>>>>>>>>> 
>>>>>>>>>> The test doesn’t measure intelligence in absolute terms _and this isn’t a bad thing_, because the test still has impressive predictive power and works for the purposes scientists need it to.
...
>>>>>>>>>>> 
>>>>>>>>>>> > [Now you can measure charisma in plenty of different ways](https://www.psychologytoday.com/us/blog/cutting-edge-leadership/201103/measuring-personal-charisma-emotional-intelligence-and-savoir)
>>>>>>>>>>> 
...
> **u/darkflagrance** [+21]  (2 hours later)
> 
...
>>> **u/Xtraordinaire** [+7]  *Team Glimglam* (20 hours later)
>>> 
>>> So, AI overlord it is. Friendship is ~~Optimal~~ Mandatory.

>> **u/OnlyEvonix** [+3]  (4 hours later)
>> 
...
> **u/MultipartiteMind** [+7]  (11 hours later)
> 
> Two pence:  
> 
...
> **u/Xtraordinaire** [+4]  *Team Glimglam* (21 hours later)
> 
...
> **u/GeneralExtension** [+3]  (9 hours later)
> 
...
>> **u/DangerouslyUnstable** [+1]  (20 hours later)
>> 
...
>> **u/STRONKInTheRealWay** [+1]  (a day later)
>> 
...
>> **u/STRONKInTheRealWay** [+2]  (a day later)
>> 
...
> **u/BuccaneerRex** [+2]  (51 minutes later)
> 
> Sounds a little 'Dune' -esque. That's similar to the Bene Gesserit plans.

> **u/WoozySloth** [+1]  (14 hours later)
> 
> There's a programme somewhat like this in Fullmetal Alchemist, though with less altruistic goals.
> And Aldous Huxley has a caste like this in 'Brave New World'
> ...Perhaps I'm not providing the most morally upright examples of caste-systems/eugenics
