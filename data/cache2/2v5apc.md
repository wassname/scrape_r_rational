## [FF][RST] The Waves Arisen [Ch.14]

* Author: u/Wertifloke *
* URL: https://wertifloke.wordpress.com/2015/02/07/the-waves-arisen-chapter-14/
* Score: 23

* Created: 2015-02-08T01:02:56

### Post:

[Link to content](https://wertifloke.wordpress.com/2015/02/07/the-waves-arisen-chapter-14/)

### Comments:

> **u/Jace_MacLeod** [+20]  (50 minutes later)
> 
...
>> **u/JackStargazer** [+8]  *Primordial Apologist* (3 hours later)
>> 
>> I actually, physically facepalmed at this line.

>> **u/kaukamieli** [+8]  (6 hours later)
>> 
...
>>> **u/Adamantium9001** [+1]  *United Federation of Planets* (18 hours later)
>>> 
>>> > But hey, maybe Sasuke is right
>>> 
>>> No way. Just...no. I'm sure there will be more surprises, but this is definitely *not* one of them. [She ](#s "straight-up confesses to him, and he's *so sure* she's joking that he says *to her face* that there's no way he would ever *not* think she's joking.") So unless you're suggesting that she's *actually not* in love--which is an equally ludicrous claim at this point--she's absolutely *dying* inside right now.
>>> 
...
>>>>> **u/Adamantium9001** [+1]  *United Federation of Planets* (2 days later)
>>>>> 
...
> **u/696e6372656469626c65** [+11]  *I think, therefore I am pretentious.* (27 minutes later)
> 
> ...Well, they're pretty screwed.
> 
> EDIT: Also, Sasuke and Naruto talking about Hinata was *hilarious*.

>> **u/Ilverin** [+2]  (3 hours later)
>> 
...
> **u/scruiser** [+10]  *CYOA* (an hour later)
> 
...
>> **u/Jello_Raptor** [+4]  *The Last Tool User* (an hour later)
>> 
>> Why exactly was that dramatic irony?

>>> **u/scruiser** [+5]  *CYOA* (2 hours later)
>>> 
>>> They've completely screwed up assessing the motivations of various characters in a way that is known to the audience (the part of the audience that knows the canon. I think that meets the [definition](http://en.wikipedia.org/wiki/Irony#Dramatic_irony).
>>> 
...
>>>> 
>>>> ####&#009;
>>>> Section 6. [**Dramatic irony**](https://en.wikipedia.org/wiki/Irony#Dramatic_irony) of article  [**Irony**](https://en.wikipedia.org/wiki/Irony): [](#sfw) 
>>>> 
>>>> ---
>>>> 
>>>> >
>>>> 
>>>> >This type of irony is the device of giving the spectator an item of information that at least one of the characters in the narrative is unaware of (at least consciously), thus placing the spectator a step ahead of at least one of the characters. The [OED](https://en.wikipedia.org/wiki/OED) has:
>>>> 
>>>> >>
>>>> 
...
>>>> >
>>>> 
>>>> >* In *[City Lights](https://en.wikipedia.org/wiki/City_Lights)* the audience knows that [Charlie Chaplin](https://en.wikipedia.org/wiki/Charlie_Chaplin)'s character is not a millionaire, but the blind flower girl ([Virginia Cherrill](https://en.wikipedia.org/wiki/Virginia_Cherrill)) believes him to be rich. 
>>>> 
>>>> >* In *[North by Northwest](https://en.wikipedia.org/wiki/North_by_Northwest)*, the audience knows that Roger Thornhill ([Cary Grant](https://en.wikipedia.org/wiki/Cary_Grant)) is not Kaplan; Vandamm ([James Mason](https://en.wikipedia.org/wiki/James_Mason)) and his accomplices do not. The audience also knows that Kaplan is a fictitious agent invented by the CIA; Roger (initially) and Vandamm (throughout) do not. 
>>>> 
>>>> >* In *[Oedipus the King](https://en.wikipedia.org/wiki/Oedipus_the_King)*, the audience knows that Oedipus himself is the murderer that he is seeking; Oedipus, Creon and Jocasta do not. 
>>>> 
>>>> >* In *[Othello](https://en.wikipedia.org/wiki/Othello)*, the audience knows that Desdemona has been faithful to Othello, but Othello does not. The audience also knows that Iago is scheming to bring about Othello's downfall, a fact hidden from Othello, Desdemona, Cassio and Roderigo. 
>>>> 
>>>> >* In *[The Cask of Amontillado](https://en.wikipedia.org/wiki/The_Cask_of_Amontillado)*, the reader knows that Montresor is planning on murdering Fortunato, while Fortunato believes they are friends. 
>>>> 
>>>> >* In *[The Truman Show](https://en.wikipedia.org/wiki/The_Truman_Show)*, the viewer is aware that Truman is on a television show, but Truman himself only gradually learns this. 
>>>> 
>>>> >* In *[Romeo and Juliet](https://en.wikipedia.org/wiki/Romeo_and_Juliet)*, the audience knows that Juliet is already married to Romeo, but her family does not. Also, in the crypt, most of the other characters in the cast think Juliet is dead, but the audience knows she only took a sleeping potion. Romeo is also under the same misapprehension when he kills himself. 
>>>> 
>>>> >Tragic irony is a special category of dramatic irony. In tragic irony, the words and actions of the characters contradict the real situation, which the spectators fully realize. The [Oxford English Dictionary](https://en.wikipedia.org/wiki/Oxford_English_Dictionary) has:
>>>> 
>>>> >>
>>>> 
>>>> >the incongruity created when the (tragic) significance of a character's speech or actions is revealed to the audience but unknown to the character concerned, the literary device so used, orig. in Greek tragedy. 
>>>> 
>>>> >[Ancient Greek drama](https://en.wikipedia.org/wiki/Theatre_of_ancient_Greece) was especially characterized by tragic irony because the audiences were so familiar with the [legends](https://en.wikipedia.org/wiki/Legend) that most of the plays dramatized. [Sophocles](https://en.wikipedia.org/wiki/Sophocles)' *[Oedipus the King](https://en.wikipedia.org/wiki/Oedipus_the_King)* provides a classic example of tragic irony at its fullest. Colebrook writes:
>>>> 
>>>> >>
>>>> 
...
>>>> 
>>>> >Further, Oedipus vows to find the murderer and curses him for the plague that he has caused, not knowing that the murderer he has cursed and vowed to find is himself. Irony has some of its foundation in the onlooker's perception of [paradox](https://en.wikipedia.org/wiki/Paradox) that arises from insoluble problems. For example, in the [William Shakespeare](https://en.wikipedia.org/wiki/William_Shakespeare) play *Romeo and Juliet*, when Romeo finds Juliet in a drugged deathlike sleep, he assumes her to be dead and kills himself. Upon awakening to find her dead lover beside her, Juliet stabs herself with a dagger thus killing herself.
>>>> 
>>>> >
>>>> 
>>>> ---
>>>> 
>>>> ^Interesting: [^Irony ^Is ^a ^Dead ^Scene](https://en.wikipedia.org/wiki/Irony_Is_a_Dead_Scene) ^| [^Irony ^punctuation](https://en.wikipedia.org/wiki/Irony_punctuation) ^| [^Antidote ^for ^Irony](https://en.wikipedia.org/wiki/Antidote_for_Irony) ^| [^Post-irony](https://en.wikipedia.org/wiki/Post-irony) 
>>>> 
>>>> ^Parent ^commenter ^can [^toggle ^NSFW](/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+coenrqa) ^or[](#or) [^delete](/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+coenrqa)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)

> **u/JanusTheDoorman** [+6]  (9 minutes later)
> 
...
>> **u/Jello_Raptor** [+5]  *The Last Tool User* (an hour later)
>> 
...
>> 
>> Naruto is the dead-last in the academy, the complete screwup.  He fails his final exam, so he can't become a ninja.  [At that point, ](#s "Mizuki, one of the teachers at the academy comes to him and says "There's an extra-credit assignment which, if you can do it, will let you graduate.  Break into Hokage Tower, steal the Forbidden Scroll and bring it to me at midnight."  Turns out that Mizuki is a spy from another village; when Naruto steals the Scroll, Mizuki shows up intending to steal it and kill Naruto.  While waiting for Mizuki to show up, Naruto read the Scroll and learned one of the techniques on it:  the shadow clone.")  
>> 
>> I think everything else important is covered in the text.

>>> **u/Wertifloke** [+6]  (3 hours later)
>>> 
...
> **u/Anderkent** [+3]  (14 minutes later)
> 
> Holy fucking shit [!?](#s "no one died!?")
