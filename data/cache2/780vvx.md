...
* URL: https://youtu.be/QMNGEY8OZqo
* Score: 24

* Created: 2017-10-22T15:39:02
...
>>>>>> 
>>>>>> This actually reminds me of Unsong. [Spoilers](#s "You could create worlds with tons of different Todds so they aren't the same, but then the unhappy Todds will be very unhappy and desperately prefer to have been the same as the happy Todds, even though you the creator may see no point. It certainly matters a lot to them.")
>>>>>> 
>>>>>> > How old are you and what are you doing with your life? (Don't feel pressured to answer if you don't want to).
>>>>>> 
...
>>>>>>> 
>>>>>>> That's why you make lots of backups, and store them in a highly distributed [paxos cluster](https://en.wikipedia.org/wiki/Paxos_\(computer_science\)) with error correcting codes. It's still not perfect, but it increases your expected lifespan by a lot. Or just reside in pure virtuality, which is even better (for safety, at least). Eventually, something will go wrong and you will die anyway, but that was already expected, given heat death and such.
>>>>>>> 
...
>>>>>>>> 
>>>>>>>> > Your time loop thing could go terribly wrong if you forget to specify that your memories are erased each loop, for example.
>>>>>>>> > You won't regret it because your memories will be erased at each starting point.
>>>>>>>> 
...
>>> **u/LieGroupE8** [+1]  ** (10 days later)
>>> 
>>> Is that good or bad? 
>>> 
>>> Also, how are you? Are you OK?

> **u/18scsc** [+4]  (8 hours later)
> 
...
>> **u/ZeroNihilist** [+12]  (23 hours later)
>> 
...
>> **u/Silver_Swift** [+7]  (19 hours later)
>> 
...
>>>> **u/VirtueOrderDignity** [+1]  (2 days later)
>>>> 
