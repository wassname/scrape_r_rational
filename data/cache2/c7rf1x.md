...
* URL: https://www.fanfiction.net/s/9794740/70/Pokemon-The-Origin-of-Species
* Score: 110

* Created: 2019-07-01T11:28:54
...
> **u/XxChronOblivionxX** [+33]  (4 hours later)
> 
...
> **u/JanusTheDoorman** [+28]  (4 hours later)
> 
...
>> **u/Cariyaga** [+13]  *Kyubey did nothing wrong* (20 hours later)
>> 
...
>> **u/thrawnca** [+9]  *Carbon-based biped* (23 hours later)
>> 
>> > Sometimes you learn something that only maybe sortof helps a little bit!
>> 
>> \*cough\*MoL\*cough\*

> **u/RynnisOne** [+20]  (16 hours later)
> 
...
>> **u/DaystarEld** [+19]  *Pokémon Professor* (17 hours later)
>> 
...
>> **u/shankarsivarajan** [+11]  (a day later)
>> 
...
>>>> **u/shankarsivarajan** [+10]  (a day later)
>>>> 
...
>> **u/CharmingOracle** [+1]  (3 years later)
>> 
>> Following this logic of ghost types being tied to an emotion, I would imagine the ties between a few other ghost type Pokémon and their particular emotions would be the following:
>> 
>> * Hisuian Zoroark/Zorua - hatred/spite
>> * Mimikyu - Loneliness/shame/(envy? If going by it’s anime appearance)
>> * Sandygast line and banette- grudges
>> * Yamask - grief
>> * Spirittomb and Galarian Yamask - vengeance
>> * Froslass - regret
>> * Driftloon line - aimlessness? (This one’s admittedly a bit of a stretch)
>> * Basculegion - determination
>> * Alolan Marowak - brotherhood/comradery
>> * Aegislash line - duty
>> 
>> One other thing I want to mention is that the theory that ghost Pokémon are formed from a spirit that has imprinted by an object is actually backed up by in-game Pokédex entrees. For example honedge have a chance to form on the sword by the soul of one of the sword’s slain victims.
>> 
>> EDIT: I’m unsure if I would associate ghost types who feed on particular emotions with those emotions but here’s some if you’re curious:
>> 
>> * Misdreavus - fear
>> * Shuppet - negative emotions in general with a preference for vengeance

> **u/None** [+17]  (49 minutes later)
> 
> [deleted]

>> **u/zeekaran** [+14]  (7 hours later)
>> 
...
>>> **u/None** [+4]  (8 days later)
>>> 
>>> [deleted]

>>>> **u/DaystarEld** [+2]  *Pokémon Professor* (9 days later)
>>>> 
>>>> Hmm... maybe it just evolved? :P
>>>> 
>>>> Fixed now :)

> **u/zeekaran** [+12]  (4 hours later)
> 
> So in this universe, do Koffing and Weezing have the poison symbols and how is that explained?

>> **u/TheJungleDragon** [+38]  (4 hours later)
>> 
...
>>> **u/writersfuelcantmelt** [+14]  (6 hours later)
>>> 
...
>>> **u/DaystarEld** [+16]  *Pokémon Professor* (16 hours later)
>>> 
...
>>> **u/zeekaran** [+4]  (7 days later)
>>> 
>>> Do we know what happened to the Magneton?

>>>> **u/1337_w0n** [+5]  (7 days later)
>>>> 
...
> **u/LazarusRises** [+13]  (8 hours later)
> 
...
>> **u/Memes_Of_Production** [+22]  (4 hours later)
>> 
...
>> **u/zeekaran** [+17]  (7 hours later)
>> 
>> > once this is all complete
>> 
>> Ah, I see you are an optimist.

>>> **u/LazarusRises** [+18]  (18 hours later)
>>> 
...
> **u/ManyCookies** [+8]  (11 hours later)
> 
...
>> **u/DaystarEld** [+10]  *Pokémon Professor* (17 hours later)
>> 
>> >Psychics can passively read surface emotions, very strong psychics can read surface thoughts. This does or doesn't require some level of merge?
>> 
...
>>>> **u/DaystarEld** [+7]  *Pokémon Professor* (2 days later)
>>>> 
>>>> > Ah, so do Pokemon have trouble breaking human shields or are they just "powerful" enough to brute force it?
>>>> 
...
> **u/DaystarEld** [+7]  *Pokémon Professor* (2 minutes later)
> 
> Typo thread!
...
>>> **u/writersfuelcantmelt** [+5]  (6 hours later)
>>> 
...
>>>> **u/thrawnca** [+3]  *Carbon-based biped* (17 hours later)
>>>> 
...
>>>>> **u/writersfuelcantmelt** [+3]  (22 hours later)
>>>>> 
...
>> **u/KnickersInAKnit** [+3]  (3 hours later)
>> 
...
>> **u/tokol** [+3]  *The Greater Good* (6 hours later)
>> 
...
>> **u/Diamondstor2** [+2]  (57 minutes later)
>> 
...
>> **u/tokol** [+2]  *The Greater Good* (12 hours later)
>> 
...
>> **u/personalensing** [+2]  (a day later)
>> 
>> "his research in viridian forest" - Viridian Forest

> **u/ForMyWork** [+7]  (4 hours later)
> 
...
> **u/I_Probably_Think** [+5]  (10 hours later)
> 
...
> **u/Bolt_The_Doggo** [+4]  (3 days later)
> 
...
> **u/ClaireBear1123** [+9]  (7 hours later)
> 
...
>> **u/DaystarEld** [+22]  *Pokémon Professor* (8 hours later)
>> 
>> Come back in *checks notes* September? Probably September :)

> **u/empocariam** [+3]  (8 days later)
> 
...
> **u/CharmingOracle** [+1]  (3 years later)
> 
> Now that you mention rotom, what are the status of rotom-tronics or electronics specifically designed for a rotom to possess such as the rotomdex, phone, drone, etc in this universe? Would they still be more of in the conceptual or prototyping phase, similar to the various inventions showcased on the SS Anne? Or would they already be a thing and be widespread in places such Galar and would it have developed to the point where the rotom can communicate verbally through the device itself?

>> **u/DaystarEld** [+1]  *Pokémon Professor* (3 years later)
>> 
>> Still conceptual :) Personally I think the way rotom are treated in the games are very strange and inconsistent, so am unlikely to include those techs as "actual" ways to communicate with them given they're not human intelligence.
