...
* URL: https://www.reddit.com/r/rational/comments/czm3d1/d_wednesday_worldbuilding_and_writing_thread/
* Score: 7

* Created: 2019-09-04T15:05:58
...
> **u/junipersmith** [+5]  (4 hours later)
> 
> **NSFW** **(Seriously)**
> 
> ----
...
>> **u/junipersmith** [+6]  (4 hours later)
>> 
>> #Mages
>> 
...
>> * Depending on the variables, there will be less use for mines, if a mage can just make a knife or sword or horseshoe out of nothing. Probably not possible given the scales involved though. Probably not desirable to get rid of mines, from a worldbuilding perspective.
>> Mages can either be hoarders, not using their stored essence until it’s on something big, or they can be day-to-day or week-to-week, only keeping a limited stockpile for the jobs on hand. The former would make more sense with a patron, while the latter would make more sense in a capitalist economy.
...
>>>> **u/Aphrodite_Ascendant** [+2]  (a day later)
>>>> 
>>>> >Based on the description I would guess functional immortality. Which is really interesting from the societal perspective. It would imply that the female rulers would have centuries of experience whereas male rulers would get a century at max, thus I would predict that societies either would have female rulers in place due to the higher competence or would have strong norms against women being in power.
>>>> > 
>>>> > I feel that there is a strong incentive to have daughters as those can become functional immortal and have a much higher availability of mana. I feel that there is also a high chance that a society would emerge with men being seen as little more than cattle.
...
>>>> **u/Hakurei06** [+1]  (9 days later)
>>>> 
>>>> Not a hill i’m going to fight and die on, but if you’re going for variety, there does not seem to be many mechanisms to facilitate homoeroticism. 
>>>> though i suppose a strap-on with a cockring would count for sapphic variety. 
>>>> 
...
>> **u/JohnKeel** [+1]  (9 hours later)
>> 
>> If people in a strange place ever invite you to dinner to talk diplomacy with their secret society, be EXTRA CAREFUL about poisons. Just thought you might want to know.
...
> **u/red_adair** [+1]  *{{explosive-stub}}* (12 minutes later)
> 
...
>> **u/red_adair** [+1]  *{{explosive-stub}}* (16 minutes later)
>> 
>> My own personal favorite is the [Chiba Urban Monorail](https://en.wikipedia.org/wiki/Chiba_Urban_Monorail), based mostly on aesthetic and freedom of planning, but it's probably more expensive to implement than other forms of urban mass transit, and as a suspended elevated line has some risks that non-elevated non-suspended systems don't have.
