...
* URL: https://www.reddit.com/r/rational/comments/3v7dol/the_grim_calculus/
* Score: 7

* Created: 2015-12-02T22:38:28
...
> **u/Roxolan** [+20]  *Head of antimemetiWalmart senior assistant manager* (23 minutes later)
> 
...
>> **u/totorox92** [+8]  *Because I want to Know* (an hour later)
>> 
>> Thanks!
>> And yes, the numbers (which these are only a simple approximation of) are derived from magic which is at least 99.99% accurate.  I was just making sure I was treating the problem correctly.
...
> **u/blazinghand** [+13]  *Chaos Undivided* (55 minutes later)
> 
...
> **u/djscrub** [+8]  (31 minutes later)
> 
> Is the person making this calculation supposed to be well-versed in game theory? If so, this construction is quite rudimentary and probably won't be believable to knowledgeable readers. You might want to look into [Bayes' Theorem](https://en.wikipedia.org/wiki/Bayes%27_theorem).
> 
> For a less technical analysis, the [Hand theorem](https://en.wikipedia.org/wiki/Calculus_of_negligence) is a principle of law that is used to make this kind of determination.
> 
> Note also that many people don't see preventable deaths as having the same moral weight as murders. If this guy has a high chance to be Hitler and a low chance to be Norman Borlaug, even if the math checks out, a lot of people would still not consider it to be worth the risk. For an analysis of the way people treat preventable harm as less significant than deliberate harm (from the point of view that they are wrong to do so), I recommend Peter Singer's seminal essay ["Famine, Affluence, and Morality."](https://en.wikipedia.org/wiki/Famine,_Affluence,_and_Morality)

> **u/IomKg** [+3]  (a day later)
> 
> Personally i don't know if that ratio is that good actually..
> to compare, lets say someone offers you a bet, you roll a dice with 10 faces, if you roll higher 3 or higher you win.
> now you have the option, either you put 1000$ and do this once and get 2000$ or lose the 1000$ if you lose.
> alternatively you can do the same thing, but need to win 20 times in a row. if you win you get 1024001$, if you lose you get nothing.
> 
...
> 
> A character acting on this example of 'the grim calculus' would be hugely mistaken in my mind.  It's a classic [Chesteron's Fence Scenario](https://en.wikipedia.org/wiki/Wikipedia:Chesterton%27s_fence).  He's acting on what he knows for sure, while ignoring/giving no weight to the reasons the cultural norms exist in the first place.
...
> **u/loonyphoenix** [+2]  (11 hours later)
> 
