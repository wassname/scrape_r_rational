...
> [](#s "Not wholly satisfied with the ending, but it's not a total disaster. The first two arcs are probably better than the last, but I didn't read the last arc in one big go like the others, so maybe that didn't help.")
> 
