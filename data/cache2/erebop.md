...
* URL: https://www.reddit.com/r/rational/comments/erebop/d_monday_request_and_recommendation_thread/
* Score: 37

* Created: 2020-01-20T15:05:20
...
>>> **u/None** [+3] *
>>> 
>>> I'd at least read a summary of [The History of the Decline and Fall of the Roman Empire](https://en.wikipedia.org/wiki/The_History_of_the_Decline_and_Fall_of_the_Roman_Empire), an 18th-century work which has inspired a lot of our theory about societal decline, and also the Foundation series.
>>> 

> **u/TheFightingMasons** [+11] *
> 
...
>> **u/andor3333** [+8] *
>> 
>> If you like Worm there is [Gospel of the Lost Gods](https://forums.spacebattles.com/threads/gospel-of-the-lost-gods-asoiaf-worm.760033/) on spacebattles which is a Worm/Game of Thrones crossover. It is incomplete but updating with 120k words.
>> 
...
>> [Purple Days](https://forums.spacebattles.com/threads/purple-days-asoiaf-joffrey-timeloop-au.450894/) evolves into kingdom building later in order to fight the white walkers but it is one amongst multiple focus.
>> All still ongoing.
>> 
...
>>> **u/TheFightingMasons** [+4] *
>>> 
>>> [Tree of Aoens](https://www.royalroad.com/fiction/20568/tree-of-aeons-an-isekai-story) 
>>> [Tallrock](https://www.royalroad.com/fiction/18663/tallrock)
>>> 
...
>>> **u/None** [+2] *
>>> 
>>> The Wandering Inn still wanders a lot. Volume 6 has longer side arcs than any Volume so far and a lot less time with Erin. I can see how its frustrating and you might not like it now even if the plot points are starting to slowly draw together. 
>>> But the Wandering Inn is my favorite running serial BECAUSE it wanders so much. I think it makes the world feel alive and lived in. I love being sucked in to some random new or returning character twice a week and learning to care about their world and struggles.
>>> 
...
>> **u/ricree** [+11] *
>> 
>> I don't know if it quite counts or not, but have you read [Dungeon Keeper Ami](https://forums.sufficientvelocity.com/threads/dungeon-keeper-ami-sailor-moon-dungeon-keeper-story-only-thread.30066/)?
>> 
...
>> **u/ExiledQuixoticMage** [+11] *
>> 
>> [Superman: Red Son](https://en.wikipedia.org/wiki/Superman:_Red_Son) is a pretty good three issue "what-if" story where where Superman lands in the U.S.S.R instead.  All the usual faces show up but that one change causes some interesting ripples.
>> [Saga](https://en.wikipedia.org/wiki/Saga_\(comics\)), about a couple from opposite sides of a galactic war trying to raise their kid, is also supposed to be very good, but I haven't read it myself yet.
>> 
...
>>>>> I'm going to share my thoughts, so in case someone other than u/callmesalticidae reads this: there are going to be unmarked spoilers!
...
>>>>> I don't have a deep knowledge of DC lore, but I recognized all the main characters, and, more importantly, could compare them to their usual portrayals. I really liked the takes on most of them, and I especially enjoyed how Lois 
>>>>> not-Lane was written here. Also, Batman the ushanka terrorist is probably my favorite portrayal of the character aside from *LEGO Batman*.
...
>>>>>> Last but not least, I wrote a [review for Jonathan Hickman's *The Black Monday Murders*](https://wmbsaltworks.wordpress.com/2019/01/04/media-recommendation-the-black-monday-murders-by-jonathan-hickman/). The story is complete in the sense that the initial mystery was solved but there are lots of sequel hooks dangling, and unfortunately Hickman hasn't gone back to it recently. 
...
>> **u/chiruochiba** [+3] *
>> 
>> After you read *Sandman*, I recommend trying some of the other classic comic series in the Vertigo imprint. For instance, *[Hellblazer](https://en.wikipedia.org/wiki/Hellblazer)* was a trend setter for many ideas that later became popular in the urban fantasy genre.  The series had its ups and downs as it changed authors and artists, and in some ways it's a time capsule for the issues that were important in Britain at the time it published, but the high points are definitely worth the read. It's not particularly rational (but then neither is *Sandman*).
>> 
...
>> But I really do like [Habitat](https://www.goodreads.com/en/book/show/30896672-habitat)by Simon Roy. The "Euhumanists" hid from the Singularity inside a giant cylindrical habitat, cutting themselves off from the outside universe. Now it's five generations later, than conditions in the habitat are very bad indeed.
>> 
...
>> **u/aponty** [+1] *
>> 
>> The korean web novel Solo Leveling\* got a comic adaptation that you can read at [https://sololeveling.net/](https://sololeveling.net/) which is a bit of an ad-infested translation-pirate site, but still, cool comic.
>> (a better translation of the title might be I Alone Level Up)
>> there's also complete translations of the original web novel at [https://boxnovel.com/novel/i-alone-level-up/](https://boxnovel.com/novel/i-alone-level-up/) and also wuxia    idk which is better/less evil
>> 
...
>> [Tank](https://forums.spacebattles.com/threads/tank-worm-altpowertaylor-au-complete.700525/)
...
>> [Timelooping Tinker](https://forums.spacebattles.com/threads/timelooping-tinker-worm-fanfic-au.338287/)
...
>>>> **u/ahasuerus_isfdb** [+4] *
>>>> 
>>>> [According to the author of *Tank*](https://www.reddit.com/r/WormFanfic/comments/e16viy/my_compiled_thoughts_of_tank/f8o7ork/):
...
> Example: [Everybody Loves Large Chests](https://www.royalroad.com/fiction/8894/everybody-loves-large-chests)
> 

>> **u/MoneyLicense** [+7] *
>> 
>> The closest I've found have been [Super Minion](https://www.royalroad.com/fiction/21410/super-minion) and [The Iron Teeth](https://www.royalroad.com/fiction/4293/the-iron-teeth-a-goblins-tale)
>> 
...
>> **u/anenymouse** [+3] *
>> 
>> [A Bad Name](https://forums.spacebattles.com/threads/a-bad-name-worm-oc-the-gamer.500626/) sounds like what youre asking for.
>> 
