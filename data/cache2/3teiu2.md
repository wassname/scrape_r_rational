...
* URL: https://www.reddit.com/r/rational/comments/3teiu2/challenge_companion_cryonics/
* Score: 14

* Created: 2015-11-19T06:50:50
...
>>> 
>>> My story in this week's challenge somewhat deals with this theme. [](#s "A military attack prompts an evacuation of the cryonics facility, and it is left to run on full auto. The attack also leads to the entrances collapsing and the facility disconnecting from the main US power grid. Decades pass and power reserves run out eventually....." )

>> **u/Empiricist_or_not** [+3]  *Aspiring polite Hegemonizing swarm* (19 hours later)
>> 
>> Ouch! So do you or don't you have a policy?

>>> **u/alexanderwales** [+7]  *Time flies like an arrow* (23 hours later)
>>> 
...
>> **u/alexanderwales** [+9]  *Time flies like an arrow* (12 hours later)
>> 
...
>> **u/DataPacRat** [+5]  *Amateur Immortalist* (12 hours later)
>> 
...
>>>> **u/DataPacRat** [+3]  *Amateur Immortalist* (13 hours later)
>>>> 
...
>> **u/MultipartiteMind** [+3]  (15 hours later)
>> 
...
>>>>>>> > Plus I have a feeling that you won't be using a surrogate even though you value your wife's life more than anyone else which makes me doubt the clarity of your thought.
>>>>>>> 
>>>>>>> The CDC gives the [pregnancy related mortality ratio](http://www.cdc.gov/reproductivehealth/maternalinfanthealth/pmss.html) as 12.5 deaths per 100,000 live births for white women. (It's even less for women who are young and physically fit.) That means that childbirth carries a 0.0125% chance of death. The cost of surrogacy [is something like $100,000](http://www.circlesurrogacy.com/costs). If I'm unwilling to pay $100,000 for a 0.0125% reduction in the chance of death for my wife, that would mean that I value her life at less than $800 million, which I think is true (especially given that I demonstrably value my own life less than that).
>>>>>>> 
>>>>>>> > None the less the cost of a new life and all that entails has to slated against the parents desire to have a kid.
>>>>>>> 
>>>>>>> I don't know exactly what you're talking about here, but you haven't given me any numbers to work with either way. After insurance, the average cost of childbirth is [$3,400](http://www.nytimes.com/2013/07/01/health/american-way-of-birth-costliest-in-the-world.html?pagewanted=all).
...
>>>>>>>>> **u/alexanderwales** [+1]  *Time flies like an arrow* (8 days later)
>>>>>>>>> 
>>>>>>>>> From the article:
>>>>>>>>> 
