## The Lizard People Of Alpha Draconis 1 Decided To Build An Ansible (2017)

* Author: u/whosyourjay *
* URL: https://slatestarcodex.com/2017/08/09/the-lizard-people-of-alpha-draconis-1-decided-to-build-an-ansible/
* Score: 43

* Created: 2019-02-24T14:19:36
...
> **u/ArgentStonecutter** [+37]  *Emergency Mustelid Hologram* (an hour later)
> 
...
>>>>>> **u/Silver_Swift** [+4]  (3 days later)
>>>>>> 
>>>>>> Relativity is weird (or we are weird for not understanding relativity if you've been listening to [Eliezer](https://www.lesswrong.com/posts/7FSwbFpDsca7uXpQ2/quantum-explanations)). Let me try to repeat the explanation that made it somewhat make sense for me:
>>>>>> 
...
>>>>>> 
>>>>>> Note that this has nothing to do with measurement errors or anything like that, the events _actually_ happen in a different order depending on which direction you are moving in (check the wiki page on [relativity of simultaneity](https://en.wikipedia.org/wiki/Relativity_of_simultaneity) for more details). Yes, this is super counterintuitive and not at all how we usually think of time working, blame the ancestral enviroment for not including more near-lightspeed tigers for us to avoid. 
>>>>>> 
...
>>>>>>>>>> (relevant videos )
>>>>>>>>>> 
>>>>>>>>>> [https://www.youtube.com/watch?v=SrNVsfkGW-0](https://www.youtube.com/watch?v=SrNVsfkGW-0)  
>>>>>>>>>> [https://www.youtube.com/watch?v=LKjaBPVtvms&t=112s](https://www.youtube.com/watch?v=LKjaBPVtvms&t=112s)

>>>>>>>>>>> **u/Endovior** [+2]  (6 days later)
>>>>>>>>>>> 
...
>>>>>>>>>>>> 
>>>>>>>>>>>> A ok sorry. 
>>>>>>>>>>>> Special relativity by itself doesn't 
>>>>>>>>>>>> say anything about locality as far as I unsertand
>>>>>>>>>>>> And while this is getting out the limits of my knowdelenge of physics  I think we currently say that you can't have violations of locality because they cause violations of  causality and we asume you cant have those. 
...
>>>>>> 
>>>>>> If you send an instantaneous signal at 4pm  it arrives to me  at  3pm , and I send a response back wich arrives even sooner(since when it was 3 pm on my side for me your clock was at 2:30)
>>>>>> Efectively sending messages back in time. 
>>>>>> 
...
>>>>>>>> **u/PlaneOfInfiniteCats** [+2]  (5 days later)
>>>>>>>> 
...
>>>>>>>> 
>>>>>>>> EDIT: [here](http://www.physicsmatt.com/blog/2016/8/25/why-ftl-implies-time-travel)'s an article with spacetime diagrams that should clarify the issue, in case you want a detailed explanation.
>>>>>>>> 
>>>>>>>> A relevant quote:
>>>>>>>> 
...
>>>>>>>>>> **u/PlaneOfInfiniteCats** [+1]  (10 days later)
>>>>>>>>>> 
>>>>>>>>>> >Well, there's you're problem right there.  They will never see each other *at all*  as long as they continue at that speed.  One object going 99%  lightspeed in one direction while another goes 99% in an opposite  direction will result in their relative speed to each other being much  faster than the photons travelling between them.
>>>>>>>>>> 
>>>>>>>>>> Well, there's *your* problem right there. You don't just add speeds of two objects to get the speed with which they move away from each other, instead you use [velocity addition formula](https://en.wikipedia.org/wiki/Velocity-addition_formula#Special_relativity), that's one of the big parts of relativity.
>>>>>>>>>> 
...
>>>>>>>>>> 
>>>>>>>>>> 1. [Introduction to general relativity](https://en.wikipedia.org/wiki/Introduction_to_general_relativity)
>>>>>>>>>> 2. [Introduction to special relativity](https://opentextbc.ca/physicstestbook2/chapter/introduction-to-special-relativity/)
>>>>>>>>>> 
>>>>>>>>>> EDIT: added the missing % to 99.99% c

>>>>>>>>>>> **u/RynnisOne** [+1]  (11 days later)
>>>>>>>>>>> 
>>>>>>>>>>> > Relativity says that no matter how fast you move, you can never move away from other object at speed faster than c, even if you move at 99.99% c away from the starting point, and other object moves at 99.99% c away from the starting point in an opposite direction.
>>>>>>>>>>> 
...
>>>>>>>>>>>> **u/PlaneOfInfiniteCats** [+1]  (11 days later)
>>>>>>>>>>>> 
>>>>>>>>>>>> >Appearance or reality?  Assuming A and C are moving objects, and B is a central point, using your scenario, are the speeds of A and C now reduced to half their previous amount, or is their perceived observable speed of each other merely capped at below c?  Do A, B, and C all see each other moving away at the same speed?
>>>>>>>>>>>> 
>>>>>>>>>>>> One of the least intuitive parts of relativity is that [there is no privileged reference frame](https://en.wikipedia.org/wiki/Inertial_frame_of_reference#Special_relativity). 
>>>>>>>>>>>> 
...
>>>>>>>>>>>> 
>>>>>>>>>>>> Also, they experience [time dilation](https://en.wikipedia.org/wiki/Time_dilation) and [length contraction](https://en.wikipedia.org/wiki/Length_contraction).
>>>>>>>>>>>> 
>>>>>>>>>>>> > Subjective or objective?  Is each 'traveller' bending its own localized  spacetime to enable this perception, and if not, are the photons somehow  violating their own maximum limits? 
>>>>>>>>>>>> 
...
>>>>>>>> **u/crivtox** [+1]  *Closed Time Loop Enthusiast* (6 days later)
>>>>>>>> 
>>>>>>>> No, the events happen slower for the other person even taking into account that light takes time to travel.
>>>>>>>> If they turn back towards you  you can compare clocks and theirs will say less time has passed. 
>>>>>>>> And if you turn back  your clock will say less time has pased. 
>>>>>>>> 
