## Harry Potter and the Natural 20 Chapter 60

* Author: u/gamarad  *LessWrong (than usual)**
* URL: https://www.fanfiction.net/s/8096183/60/Harry-Potter-and-the-Natural-20
* Score: 31

* Created: 2014-08-30T02:41:19
...
>>>> 
>>>> No one.
>>>> Or, possibly a very lenient DM that doesn't really care if you do ridiculous stuff. In a real game of D&D, hiding behind a tower shield wouldn't even work once. [Rule Zero](http://1d4chan.org/wiki/Rule_Zero) of D&D is that the DM has veto power and can treat the rules as mere suggestions, and in those situations where someone tries to construct a [Commoner Railgun](http://1d4chan.org/wiki/Peasant_Railgun) or [create Pun-Pun](http://1d4chan.org/wiki/Pun-Pun), the DM just says "No".
>>>> 

>>>>> **u/Riddle-Tom_Riddle** [+7] *
>>>>> 
