...
* URL: http://youtu.be/nQHBAdShgYI
* Score: 31

* Created: 2016-03-07T16:05:05
...
> **u/Pluvialis** [+24]  *Second Age Sauron* (an hour later)
> 
...
>>> **u/Aabcehmu112358** [+2]  *Utter Fallacy* (9 hours later)
>>> 
...
>>>>>> **u/vakusdrake** [+1]  (8 days later)
>>>>>> 
>>>>>> I suppose the problem with a transporter is that there is a gap in consciousness if no gap actually existed it would be a sort of different thing. 
>>>>>> As for dying several times a second, because of the gaps in neurons, I used to think that might be the case, however because you have so many neurons i'm not really sure any aren't firing at a given time.

>> **u/raymestalez** [+1]  (an hour later)
>> 
>> Great explanation, I really liked it!

> **u/Aabcehmu112358** [+10]  *Utter Fallacy* (4 hours later)
> 
...
>> **u/SoundLogic2236** [+7]  (5 hours later)
>> 
...
>>> **u/Aabcehmu112358** [+0]  *Utter Fallacy* (9 hours later)
>>> 
...
> **u/ansible** [+8]  *The Culture* (7 hours later)
> 
...
> **u/Covane** [+1]  *Dragon Army* (3 days later)
> 
...
> 
> [Ender Spoilers](#s "In Xenocide, as Miro forms his new body in Outside, I wondered about the duplicate dilemma. The Enderverse canon has aiua as the soul, so in the narrative the question is already answered, but from a purely exploring-the-thought point I wondered. I figured as Miro could remember seeing the new body be created and then "transferring" to it, he was probably the original, as presumably a newly created Miro wouldn't remember seeing himself be created. Probably, anyway. And also since the aiua it's a non-question, but I figure "remembering seeing the other body be created" could prove it's not a duplicator.")
