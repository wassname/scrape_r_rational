...
* Author: u/FriendComputer11 *
* URL: https://www.reddit.com/r/rational/comments/k1esn9/have_any_of_you_gmed_a_rational_tabletop_rpg/
* Score: 14

* Created: 2020-11-26T12:57:50
...
> **u/Redditor76394** [+16]  (5 hours later)
> 
...
>> **u/elysian_field_day** [+3]  (12 hours later)
>> 
...
>> 
>> I used the Orator feat instead of Student of Philosophy, to use Linguistics in place of the three social skills. At level three, I had a Linguistics check of +17+1d6. [build](https://paizo.com/people/Trotts)
>> 
>> Edit: oh shoot, this is r/rational, not r/Pathfinder_RPG. This is unimportant, haha.

>>> **u/edwardkmett** [+1]  (7 days later)
>>> 
...
>>> 
>>> I realize you pulled Skill Focus off of Half-Elf, but a Human build would get a bonus feat in its place. Arguably that _could_ juggle things so that your base build was cheaper. 
>>> 
...
>>>> 
>>>> If you go the Human [Focused Study] route, then you can take SF: Linguistics at level 1 and take SF: Knowledge at 8 to qualify for [Student of War](https://aonprd.com/PrestigeClassesDisplay.aspx?ItemName=Student%20of%20War), which can add INT to armor class, *instead of* DEX.
>>>> 
>>>> Re: your edits.
>>>> You can get a free style feat without meeting the prerequisites, from either:  
...
>>>>>> 
>>>>>> I think that [Outslug Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Outslug%20Sprint) would be your best option, unless you can get Pounce.  
>>>>>> If you can, then use [Charging Stag](https://aonprd.com/FeatDisplay.aspx?ItemName=Charging%20Stag%20Style) Style to get more charge options.  
>>>>>> You could try [Street Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Street%20Style) but you’ll need a magic item to avoid opportunity attacks from the bull rush. Perhaps your GM will let you pick an urban animal with this style.
>>>>>> [Shapeshifter Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Shapeshifter%20Style) is quite versatile.  
>>>>>> [Jabbing Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Jabbing%20Style) could add a lot of damage, if it applies.
...
>>>>>>> 
>>>>>>> Charging Stag runs into the problem that I don't have _that_ amazing of a CMB so the add-ons don't help much, and if I'm charging I'm not full action attacking.
>>>>>>> 
...
>>>>>>>> **u/covert_operator100** [+1]  (7 days later)
>>>>>>>> 
>>>>>>>> Unfortunately, the 'bonus style feat without prerequisites' can only give you the first feat in the chain. [Kirin Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Kirin%20Style) is of type (Combat, Style) while [Kirin Path](https://aonprd.com/FeatDisplay.aspx?ItemName=Kirin%20Path) is just (Combat).
>>>>>>>> 
...
>>>>>>>> 
>>>>>>>> The Lunge reach with Outslug Sprint is nice, because you can start making full attacks from 20 ft away (10-ft step and 10-ft reach).
>>>>>>>> You'll have to drop the polearm at some point in every fight, if you want to make attacks with both claws.
...
>>>>>>>>>> 
>>>>>>>>>> [ctrl+F "diversion"](https://aonprd.com/FeatDisplay.aspx?ItemName=Equipment%20Trick), then get any ability that applies additional effects on successful feints.
>>>>>>>>>> 
>>>>>>>>>> Perhaps... [give your allies a no-dex attack too](https://www.aonprd.com/FeatDisplay.aspx?ItemName=Feint%20Partner)? [Or a chance to steal something](https://www.aonprd.com/FeatDisplay.aspx?ItemName=Team%20Pickpocketing)? [Fire damage](https://www.aonprd.com/FeatDisplay.aspx?ItemName=Blistering%20Feint)?
...
>>>>>>>>>>> 
>>>>>>>>>>> Cloak Tricks (Distracting Cloak) is good, but hard to bluff that hard in combat with a 6 CHA. Then again, I suppose I'd be better at it than our brawler, who this level just got forced to take [Snake Feint](https://www.d20pfsrd.com/classes/hybrid-classes/brawler/archetypes/paizo-brawler-archetypes/snakebite-striker/#Snake_Feint_Ex) with _2 CHA_.

>>>>>>>>>>>> **u/covert_operator100** [+1]  (8 days later)
>>>>>>>>>>>> 
...
>>>>>>>>>>>> 
>>>>>>>>>>>> Your friend could take [Manipulative Agility](https://www.aonprd.com/FeatDisplay.aspx?ItemName=Manipulative%20Agility), [Slayer's Feint](https://www.aonprd.com/FeatDisplay.aspx?ItemName=Slayer%27s%20Feint), or [Fox Style](https://aonprd.com/FeatDisplay.aspx?ItemName=Fox%20Style)

> **u/nicholaslaux** [+4]  (4 hours later)
> 
...
> **u/CopperZirconium** [+4]  (2 days later)
> 
...
>>> **u/CopperZirconium** [+1]  (7 days later)
>>> 
