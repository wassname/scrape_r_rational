...
* Author: u/rthomas2 *
* URL: http://flipside.keenspot.com
* Score: 6

* Created: 2014-03-31T02:44:05

### Post:

[Link to content](http://flipside.keenspot.com)

### Comments:

> **u/TimeLoopedPowerGamer** [+5]  *Utopian Smut Peddler* (5 days later)
> 
...
> 
> Worst of all, throughout the story she and other people are essentially batman: pulling solutions out of a metaphorical utility belt, or ninja-arguing their way out of situations using concepts being introduced for the first time. See my recent comment on the [Sanderson post](http://www.reddit.com/r/rational/comments/21xyoa/hfd_sandersons_first_law_on_the_rules_of_magic/cght80e) about why this doesn't work. All this is presented with a sort of high-school mentality, where the world bends in response to a single forthright individual's strongly held and logically consistent opinions.
> 
...
> 
> A lot of the author's philosophical points are perfectly valid, but it is presented through the lens of a sort of late-adolescent wish fulfillment. The main protagonist is quite clearly a [Manic Pixie Dream Girl](http://tvtropes.org/pmwiki/pmwiki.php/Main/ManicPixieDreamGirl) and a rather poorly excused [Mary Sue](http://tvtropes.org/pmwiki/pmwiki.php/Main/MarySue), to use the common fanfic term. Her flaws are enduring traits and both mental and physical problems are really strengths. The protagonist narrowly avoids being [Too Good For This Sinful Earth](http://tvtropes.org/pmwiki/pmwiki.php/Main/TooGoodForThisSinfulEarth) as the climax to a number of plot lines.
> 
