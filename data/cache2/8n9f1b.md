...
* URL: https://www.reddit.com/r/rational/comments/8n9f1b/recommendations_please/
* Score: 8

* Created: 2018-05-30T15:20:27
...
> **u/neondragonfire** [+8]  (16 hours later)
> 
...
>> **u/thrawnca** [+4]  *Carbon-based biped* (16 hours later)
>> 
>> Note that Time Braid is rather NSFW.

>> **u/user19911506** [+3]  (2 hours later)
>> 
>> Wasn't Edge if tomorrow based on it ?

>>> **u/Rouninscholar** [+4]  (3 hours later)
>>> 
>>> Yes, The book is obviously much better.

>>>> **u/Amonwilde** [+1]  (4 hours later)
>>>> 
>>>> That's the one. Couldn't remember the name.

>>> **u/Oaden** [+1]  (18 hours later)
>>> 
...
>>>> 
>>>> Also [Edge of Tomorrow/All you need is Kill spoilers](#s " by making it end well, with the aliens defeated and the two protagonists alive and together, instead of the horribly depressing ending of the novel and manga").

>>>> **u/butt-the-antagonist** [+1]  (4 days later)
>>>> 
>>>> John Cage _wasn't_ brave from the start in the book -- there was a similar (if somewhat abbreviated) character arc. That said, the movie did lose almost everything that made the book compelling
...
> 
> There's a whole series of fics connected to [Friendship is Optimal](https://www.fimfiction.net/story/62074/friendship-is-optimal). The premise is simple: tasked with creating an MLP-themed MMO, a game studio creates a superintelligent AI that takes over the world. Its goal is to satisfy human values through friendship, and ponies. Only a cursory knowledge of MLP canon is needed. There are some great spin-offs.
> 
> [Broken Symmetry](https://www.fimfiction.net/story/301077/broken-symmetry) is a great story on time travel. Hard RT, some RST. However, some knowledge on MLP is probably in order.
