...
* URL: https://www.reddit.com/r/rational/comments/4lpwvx/d_monday_general_rationality_thread/
* Score: 17

* Created: 2016-05-30T15:04:38
...
>>>> The don’t have to be, the in-group part was just an example. IIRC, all that had to happen was for them to define their target as “human” — and killing the target became instinctively impossible for them. Even thinking of it as human could trigger the death feedback, as was the case with the monk and the [snail creature.](http://vignette3.wikia.nocookie.net/shinsekaiyori/images/d/d9/Minoshiro.jpg)
>>>> >wouldn't it have been easier and more humane to just implement the same do-not-kill limitation in all humans
>>>> Doing that wasn’t possible, since that limitation\blocking technique (the death feedback) depended on subconscious [Cantus](http://shinsekaiyori.wikia.com/wiki/Cantus) (PK).
>>>> >What do you mean?
>>>> I meant that the inability for PK-wielders to overcome their killing block and kill human targets — or ones that closely resembled humans — was further supported by the way they went out of their way and used ridiculously convoluted solutions like genetic manipulations (for dealing with rat-people) and [tainted cats](http://vignette3.wikia.nocookie.net/shinsekaiyori/images/7/71/Black.png) (for dealing with hazardous).
>>>> 
...
>>>> 
>>>> Nah, the key difference here is that [Spoiler:](#s " Lelouche actually won before dying. If he'd lost the final battle, then yeah, the WWII comparison works. The point was to unite through conquest, not getting everyone against him. Becoming public enemy #1 was to circumvent the cycle of hatred that leads to perpetual war. He just so happened to reconcile his goals of a unified world and a peaceful one at the same time. ") Not that I actually think this would work in real life, it's just an anime after all, but I hope you get what I'm saying!
>>>> 
