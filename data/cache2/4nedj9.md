## QC's AI commentary on its mundane post-singularity comic: "Skynet is Bullshit"

* Author: u/notmy2ndopinion  *Concent of Saunt Edhar**
* URL: http://questionablecontent.net/view.php?comic=3239
* Score: 0

* Created: 2016-06-10T02:55:09

### Post:

[Link to content](http://questionablecontent.net/view.php?comic=3239)
...
> **u/Towerowl** [+6] *
> 
> Guys, I know Yudkowsky is obsessed over AI, but that doesn't mean we have to post every single thing remotly related to AI on this subreddit. 
> Btw, QQ ( the comic linked in this post ) is nowhere near anything rational, it's just an occasionally amusing comic where the author demonstrates his views on what is his vision of a healthy sex life. Also indie rock snobism.
> 
...
>> **u/tilkau** [+7] *
>> 
>> Why do people think p-zombies is a valid concept? One of its essential premises is [fundamentally magical thinking](https://scientiasalon.wordpress.com/2014/08/04/p-zombies-are-inconceivable-with-notes-on-the-idea-of-metaphysical-possibility/) -- 'because I can think of a world where X is the case, X must be possible'.
...
>>> 
>>> Calm down. It's a valid concept in the *Questionable Content* setting, because the author uses "conscious" to mean "thinks like a human". Which, really, is all it's ever meant. Most AIs in the story, from [sentient toasters](http://questionablecontent.net/view.php?comic=1999) to [space stations](http://www.questionablecontent.net/view.php?comic=2113) still act like people, so they need a word for "human or AI" (it's important for discussions of AI rights). And once they settled on "conscious", it makes sense to discuss the possibility that someone will build a type of mind that isn't based off humans.
>>> 
...
> Still, if you want to know if the comic actually contains godlike AIs that have hidden themselves from the world, t[his other comic is probably relevant.](http://www.questionablecontent.net/view.php?comic=2070)
> 
