...
* URL: http://addventure.bast-enterprises.de/266508.html
* Score: 19

* Created: 2015-12-19T22:24:24
...
>>> **u/OutOfNiceUsernames** [+1]  *fear of last pages* (22 hours later)
>>> 
...
>>> 
>>> The author could make this approach useless of course by his [word of god](http://tvtropes.org/pmwiki/pmwiki.php/Main/WordOfGod) (like how he made “torturing zombies” possible without Ami even doubting for a second whether it will work), but logically if Hearts were rigged to react to any exchange between a DM and a captive, all her civilians would’ve already been converted into her minions, since she’s been providing them with both services (housing) and products (food, clothing) for quite some time by now (and the fake currency will basically be representing the same goods and services).

>>>> **u/Empiricist_or_not** [+3]  *Aspiring polite Hegemonizing swarm* (4 days later)
>>>> 
>>>> Okay, apologies for the delay, I still can't find the primary source, but [Spoilers not sure if in war against death or the avatar island arc](#s "Camilla makes a deal with Mercury where she will heal or give aid for Mercury leaving alone prisoners she was going to leave alone, this is referenced in the TV tropes article under the "Deal with the Devil" trope, and implies social contracts, we don't know if implicit or explicit, not just actual payment of socially accepted tender make a bond")  . . . Note this should be somewhat penalized as it might be a secondary author until I or somebody finds the primary source (Help Me! Please!), but TVTropes does tend to be maintained by fanatics.

>> **u/linkhyrule5** [+2]  (3 days later)
>> 
...
>>> 
>>> Time’s not that much of an issue because she can teleport and [BodySurf](http://tvtropes.org/pmwiki/pmwiki.php/Main/BodySurf) at the speed of light. The only time she’d be needing would be for physically scanning the area through some deep-sea dweller’s eyes.

>>>> **u/linkhyrule5** [+1]  (3 days later)
>>>> 
