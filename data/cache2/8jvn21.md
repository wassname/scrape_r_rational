...
* URL: https://www.reddit.com/r/rational/comments/8jvn21/d_wednesday_worldbuilding_thread/
* Score: 13

* Created: 2018-05-16T15:07:05
...
> **u/InvisibleRegrets** [+3]  (3 hours later)
> 
...
>> 
>> How exactly is this world shaped? I'm imagining a pocket dimension shaped like a [3-sphere](https://en.wikipedia.org/wiki/3-sphere) with a sphere that splits it in half and the sun in the middle of one of the hemispheres. Or a better but much harder to explain way: split the 3-sphere into two toruses and have the sun move through one. That sort of gets you a day/night cycle, though it never goes fully dark. It might be better to use that for seasons if you don't mind not having nights. The topology of that is pretty confusing. I'll try to find something that can explain it better if you want.
>> 
