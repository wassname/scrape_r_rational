...
* Author: u/embrodski *
* URL: https://www.reddit.com/r/rational/comments/233nlt/general_characteristics_of_a_rational_fic/
* Score: 8

* Created: 2014-04-15T15:54:13
...
> **u/EliezerYudkowsky** [+14]  *Godric Gryffindor* (10 hours later)
> 
...
>>> **u/jaiwithani** [+6]  *Insufficient data for a meaningful answer* (a day later)
>>> 
...
> **u/Rhamni** [+8]  *Aspiring author* (18 hours later)
> 
...
>>>>>> **u/Transfuturist** [+1]  *Carthago delenda est.* (11 days later)
>>>>>> 
>>>>>> I already know that. I was asking eaturbrainz to elaborate on his rebuke.

>>>>>>> **u/Iconochasm** [+2]  (11 days later)
>>>>>>> 
...
>>>>>> **u/4791** [+1]  *should be taken out and shot for endorsing UFAI.* (3 days later)
>>>>>> 
...
>> **u/None** [+1]  (2 days later)
>> 
>> I still disagree.  This should not be a counter-culture.  We should not be shunning "the normals".  We are not Morpheus and they are not blue-pills.  Any delusions of status we may grow are just delusions (even though I would generally say status is a mutual delusion in the first place); we are *not* visionaries.  We are [five-year-old children](http://lesswrong.com/lw/2pv/intellectual_hipsters_and_metacontrarianism/), and proud of it ;-).

>>> **u/embrodski** [+3]  (2 days later)
>>> 
>>> From extensive speaking with "the normals" (oh god, there's no way this line won't come back to bite me in the ass out-of-context later), it doesn't matter that this *shouldn't* be counter-culture and that it *isn't* visionary. In theory, yeah, it's [just simplified humanism](http://yudkowsky.net/singularity/simplified/). But in practice it (sadly) is counter-culture, and only someone willing to be considered as such will spread these memes.

>>>> **u/None** [+5]  (2 days later)
>>>> 
>>>> Who cares about spreading memes?  Go and actually help someone.

>>>>> **u/jaiwithani** [+9]  *Insufficient data for a meaningful answer* (2 days later)
>>>>> 
