...
* URL: https://www.reddit.com/r/rational/comments/f9uja3/d_wednesday_worldbuilding_and_writing_thread/
* Score: 4

* Created: 2020-02-26T15:05:14
...
> **u/onemerrylilac** [+3]  (21 minutes later)
> 
...
>> **u/alexanderwales** [+7]  *Time flies like an arrow* (39 minutes later)
>> 
...
>>> **u/onemerrylilac** [+1]  (42 minutes later)
>>> 
>>> That's a nice one. Thanks for the response!

>> **u/Frommerman** [+2]  (5 days later)
>> 
...
>>> **u/onemerrylilac** [+1]  (5 days later)
>>> 
>>> Neat, I like it! Thanks for the response!

>> **u/Trew_McGuffin** [+1]  *Dao = Improve Yourself* (6 hours later)
>> 
...
>>> **u/onemerrylilac** [+1]  (2 days later)
>>> 
>>> That's a good one. Thanks for the input!

> **u/Veedrac** [+2]  (14 hours later)
> 
...
>> 
>> If you don't want to do a bunch of bespoke creatures, this might be one of those times when it makes sense to really quickly create a generator of some kind (I can give some code, but you'd have to make your own arrays), or if you're into the Next Big Thing, use something like GPT-2. [Talk to Transformer](https://talktotransformer.com/) gives the following when fed that list:
>> 
...
>>> **u/waylandertheslayer** [+1]  (5 hours later)
>>> 
...
>> **u/Papa-Walrus** [+2]  (5 hours later)
>> 
>> The SCP Foundation could have some good ideas. Take this question over to /r/SCP  and you might get a decent handful of responses. Most might be too far from normal for what you're looking for, but may be good inspiration.
>> Off the top of my head:
>> 
>> * [SCP-682](http://www.scp-wiki.net/scp-682) - A lizard/reptile-of-some-sort that is impossible to kill and adapts to how you try to kill it (a la Doomsday the DC villain, but the adaptations are more temporary)
>> * [SCP-408](http://www.scp-wiki.net/scp-408) - A flock of butterflies with a hivemind and super-camo

>>> **u/waylandertheslayer** [+1]  (8 hours later)
>>> 
...
>> **u/Trew_McGuffin** [+2]  *Dao = Improve Yourself* (6 hours later)
>> 
>> This YouTube channel is doing something like what you're asking for I think? [Here](https://m.youtube.com/channel/UC3HyvfrwscLKtE_NmOQfWGw) and they come with statblocks in the description
