...
> * (in-universe) [the Cantus sealing ritual](http://shinsekaiyori.wikia.com/wiki/Temple_of_Purity) from *Shin Sekai Yori* 
> * [belief magic,](http://tvtropes.org/pmwiki/pmwiki.php/Main/ClapYourHandsIfYouBelieve) [sympathetic magic, contagious magic,](https://www2.palomar.edu/anthro/religion/rel_5.htm) [emotion magic,](http://powerlisting.wikia.com/wiki/Emotion_Embodiment) etc
> * *Doctor Who* often features a genre that I’d call the opposite of [Cosmicism](https://en.wikipedia.org/wiki/Cosmicism) — humanity manages to survive one apocalyptic scenario after another, the main crew manages to overcome one incredibly powerful foe after another because the human race itself is the darling of the universe; and from the way the Doctor talks one would assume it has a plot armor that’s an actual in-universe phenomenon. [Though perhaps it’s only because one single — but incredibly powerful — entity is fond of humanity.](https://archiveofourown.org/works/471497/chapters/815855)
>  * similar themes are also present in many /r/HFY/ texts \ recommendations.  
> * [“brainwashing” techniques](https://www.google.com/search?q=thought+stopping+brainwashing+site:edu) (sorry for no specific links) used by religions, cults, other organised groups that are molded into a story-telling format
>  * scriptures and texts of many religions and cults,
>  * [Heavy-handed implementations](http://tvtropes.org/pmwiki/pmwiki.php/Main/BadWritingIndex) of [AnAesop](http://tvtropes.org/pmwiki/pmwiki.php/Main/AnAesop) (e.g. in folk tales), [Anvilicious](http://tvtropes.org/pmwiki/pmwiki.php/Main/Anvilicious) (e.g. in children's TV series, mainstream media, etc), [AuthorTract,](http://tvtropes.org/pmwiki/pmwiki.php/Main/AuthorTract) etc.
> 
...
> 
> I am not entirely sure what to do with your question. [Rationalization](https://en.wikipedia.org/wiki/Rationalization_(psychology)), as far as I know, is an inherently human thing, and no human is "incapable" of it. From context I presume you meant "inability to explain" instead? Those are not the same, and I'd even call them opposites in some sense.
...
> Oh, and doctor Strange was just a classic straw man of a "rational" person at the beginning of the movie. There was [even a post about it](https://www.reddit.com/r/rational/comments/5as909/spoilers_doctor_strange_is_the_antirational_movie/) here when movie came out.
> 
