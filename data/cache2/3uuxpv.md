...
* URL: https://www.reddit.com/r/rational/comments/3uuxpv/d_monday_general_rationality_thread/
* Score: 16

* Created: 2015-11-30T15:05:44
...
> 
> (The game I used for D&D was a variant on [latrunculi](https://en.wikipedia.org/wiki/Ludus_latrunculorum), which is sufficiently obscure that none of the players knew what it was, while also being close enough to traditional board game grammar that they wouldn't be completely lost. I've done this before with a different group using Nine Men's Morris, though I don't think that's usable now that the Assassin's Creed games have increased exposure to it.)

>> **u/TaoGaming** [+3]  *No Flair Detected!* (13 hours later)
>> 
>> FYI (You probably know this, but others may not) Zendo is derived from [Eleusis](
>> https://en.wikipedia.org/wiki/Eleusis_%28card_game%29)  by Robert Abbott. I think Abbott also designed a chess-like game where you don't know which of your pieces is which (but your opponent does) and you propose moves that are cancelled if illegal. So, that's similar to mastermind (known rules, hidden information) but as a two player chess game. 
>> 
...
>> > The larger problem is generating rules procedurally in such a way that the rules can be tested and figured out and still be entertaining, which would probably involve too much work.
>> 
>> I'm sure it's possible with the right constraints. For example, chess with new randomly generated pieces. There's quite a library of [fairy chess pieces](https://en.wikipedia.org/wiki/Fairy_chess_piece), with simple rules for generating more.
...
> **u/DataPacRat** [+6]  *Amateur Immortalist* (15 hours later)
> 
...
>>> **u/DataPacRat** [+3]  *Amateur Immortalist* (16 hours later)
>>> 
