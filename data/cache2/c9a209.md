...
* URL: https://www.reddit.com/r/rational/comments/c9a209/why_cant_ai_safety_be_solved_by_giving_ai_limited/
* Score: 25

* Created: 2019-07-05T01:13:45
...
>>> 
>>> I don't think that's how it's going to work. If the AI has human-level intelligence or above and humans tell it what they mean by "stopping", it will understand it very easily, but that doesn't mean it will actually want to stop (as the humans will define the word in their own minds), it will merely want to 'stop' (as the concept is encoded in its goal system). [The genie knows but doesn't care.](https://www.lesswrong.com/posts/NyFuuKQ8uCEDtd2du/the-genie-knows-but-doesn-t-care)
>>> 
>>> &#x200B;
>>> 
>>> >In principle, if an AI is gated into a box, "stopping" is simply "turn this switch off". There aren't many ways around it.
...
>> 
>> By training a neural network. ([Relevant XKCD](https://m.xkcd.com/2173/))
>> 
...
> **u/xachariah** [+41]  (24 minutes later)
> 
...
>> **u/BlackKnightG93M** [+11]  (11 hours later)
>> 
...
>> **u/lumenwrites** [-1]  (33 minutes later)
>> 
...
>>> **u/xachariah** [+10]  (37 minutes later)
>>> 
...
>>>> **u/lumenwrites** [+4]  (54 minutes later)
>>>> 
...
>> **u/lumenwrites** [+8]  (20 minutes later)
>> 
...
> **u/MisterCommonMarket** [+3]  (9 hours later)
> 
...
> **u/None** [+4]  (42 minutes later)
> 
> [deleted]

>> **u/varno2** [+3]  (an hour later)
>> 
>> don't you mean
>> 
...
>>> **u/TaltosDreamer** [+1]  (an hour later)
>>> 
...
>>> <=
>>> 
>>> < 170 will not stop if it reaches 171 by skipping 170
>>> <= 170 will stop if it reaches 171

>>>> **u/BSaito** [+3]  (an hour later)
>>>> 
...
>>>>> **u/TaltosDreamer** [+2]  (an hour later)
>>>>> 
...
>>> **u/OrzBrain** [+1]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (6 days later)
>>> 
...
> **u/exelsisxax** [+0]  (18 minutes later)
> 
...
>> **u/lumenwrites** [+1]  (25 minutes later)
>> 
...
>>> **u/exelsisxax** [+3]  (33 minutes later)
>>> 
...
>>>> **u/lumenwrites** [+2]  (39 minutes later)
>>>> 
