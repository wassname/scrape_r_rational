...
* Author: u/distrofijus *
* URL: https://www.reddit.com/r/motheroflearning/comments/80crs2/sovereign_gate_whowhy_redrobe_clues/
* Score: 32

* Created: 2018-02-26T13:36:44
...
> **u/Xtraordinaire** [+36]  *Team Glimglam* (8 hours later)
> 
...
>> **u/SpeculativeFiction** [+15]  (12 hours later)
>> 
...
>>> **u/Xtraordinaire** [+6]  *Team Glimglam* (20 hours later)
>>> 
...
>>>> **u/distrofijus** [+3]  (20 hours later)
>>>> 
...
>>>>>> **u/distrofijus** [+2]  (22 hours later)
>>>>>> 
...
>>>> **u/SpeculativeFiction** [+6]  (a day later)
>>>> 
>>>> > If the kids (humanity or whatnot) feels like they want to take on primordial for some time, gods are not interfering with that - it will be pulled back into prison with that anchor anyway after some period of time.
>>>> 
>>>> The priests in Cyoria[ told](https://www.fictionpress.com/s/2961893/26/Mother-of-Learning) Zorian that primordials, when released, do not eventually get unsummoned, because they're native to the plane. 
>>>> 
...
>> 
>> As for your other arguments, they can also be explained. We didn't see any other divine artifact in use yet besides orb. The suspected uses are: dagger - in soul kill episode and crown in temporary marker. There's also totally unproven theory about knowledge of using soul marker to achieve those purposes. 
>> The latter could be somewhat disproved by Zorians increasing soul awariness. He pretty much discovered all the purposes of switches and so far he didn't find any. All 5 switches related to those functions to be broken is very unlikely. 
>> 
...
>>>> **u/distrofijus** [+1]  (21 hours later)
>>>> 
...
>>>>>> **u/distrofijus** [+1]  (22 hours later)
>>>>>> 
...
>> **u/SpeculativeFiction** [+9]  (13 hours later)
>> 
...
>>>> 
>>>> except that the gate can copy souls
>>>> so magic that can give a simulcrum its own soul is not too far fetched and would solve the mystery of too much mana
>>>> 
>>>> i think a simulcrum villain would be the far better story than the never mentioned ex class mate. 
>>>> the class mate wouldn't care about the others coming out too (except if he wants to release the primordial), the simulcrum would want to be zach in reality and they would fight for it.
...
> 
> Pro-unification members are very influential and are 
>  high ranking members of various organizations (cults, royal family, mages). They are aware of the plot Ibasa is trying to pull and providing their own support to impede Big 3 states. 
> 
