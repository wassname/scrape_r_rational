...
* Author: u/sure_why_nott *
* URL: https://www.reddit.com/r/rational/comments/2fpwzd/bst_so_i_considered_writing_a_rational_one_piece/
* Score: 8

* Created: 2014-09-07T14:22:48
...
>>> 
>>> Super speed isn't that broken, at least in its conventional form as possessed by Quicksilver or others. However, the Flash has the Speed Force, which I think started out as the answer to how he can travel at Mach 10 and not burn up from the air compression or friction, and just got more out of hand from there. There's a panel where [the Flash](http://4thletter.net/2006/09/flash-fact-jla-89/) removes a half million people from a city in .00001 microseconds. There's his infamous ["Infinite Mass Punch"](http://i.imgur.com/AarVpKD.jpg) where he knocks a guy into orbit.
...
>>>> 
>>>> Not the Flash, or exactly rational but [this short](http://dailysciencefiction.com/science-fiction/superhero/nathaniel-matthews-lee/as-fast-as-you-can_1) here started off along the veins of this. Shame about the plot and the ending though.
>>>> 
...
>>>>> 
>>>>> The Flash can think, react, and move at (or just under) the speed of light. If the Flash threw a baseball, it would basically be [this XKCD what-if](https://what-if.xkcd.com/1/). His power suite extends a bit beyond just super speed as well. And sometimes he can go faster than the speed of light, or travel through time, though that's more dependent on the writer.
>>>>> 
...
>>>>>>>>> Molecule Man.
>>>>>>>>> The Celestials.
>>>>>>>>> The various incarnations of things (Death, etc).
>>>>>>>>> Mephisto.
>>>>>>>>> ...
...
>> 
>> For Naruto, there's [Lighting Up the Dark](https://www.fanfiction.net/s/9311012/1/Lighting-Up-the-Dark) and [In Fire Forged](https://www.fanfiction.net/s/10263221/1/In-Fire-Forged). ASOIAF fics suffer from the fact that GRRM and his publishers are *very* proactive about going after derivative works. Martin has come out and said that he detests the idea of fanfiction.
>> 
...
>> **u/sure_why_nott** [+5] *
>> 
>> Well if you like breaking rules, may I suggest [Time Braid](https://m.fanfiction.net/s/5193644/1/Time-Braid). It's not really rational but it's an enjoyable naruto munchkin read.
>> 
