...
* URL: https://www.reddit.com/r/rational/comments/6udiz8/challenge_companion_metafiction/
* Score: 8

* Created: 2017-08-17T22:19:56

### Post:

**tl;dr: This is the companion thread to the [biweekly challenge](https://www.reddit.com/r/rational/comments/6udfhy/biweekly_challenge_metafiction/), post recommendations, discussions, chit-chat, or ideas below.**
...
> **u/Grand_Strategy** [+5]  (11 hours later)
> 
...
> 
> Other cool example of metafiction in move is [Last Action Hero](http://www.imdb.com/title/tt0107362/) where Arnold Schwarzenegger plays character who travels from "move" to "real world". He then tries to act like he does in a movies and is shocked to discover things don't work that way. For instance he tries to take out bad guy by punching through closed window and dragging him out of a car and instead glass cuts his whole hand and he starts bleeding quite badly. 
> 
...
>> **u/_trailerbot_tester_** [+1]  (11 hours later)
>> 
>> Hello, I'm a bot! The movie you linked is called **[Last Action Hero](https://www.imdb.com/title/tt0107362)**,  here are some **[Trailers](https://www.youtube.com/results?search_query=Last+Action+Hero+Trailer )**

> **u/None** [+3]  (10 hours later)
> 
> Regarding your question, I think Stephen King's The Dark Tower might be an interesting example. [General discussion of the Dark Tower, no specific plot spoilers](#s " As that story progresses, the metafictional aspects escalate, to the point that I think it might well be called an example from the extreme end, even if the metafictional aspects aren't always the most important part of the plot. Up to a certain point, they are handled in a way that is, I think, emblematic of Fantasy as a whole: the metafictional aspects are most of all a part of the worldbuilding, a part of the deeper truth behind the myths and legends. As in many works of Fantasy, there comes a point when the myths and legends are leveraged to solve the core problem of the plot, and that is part of one of the more controversial and unsatisfying sections of the Dark Tower. I think metafiction often becomes unsatisfying at that very point, because abusing the fact that the story is a story feels like cheating, yet *ignoring* it is seldom what a rational character should do, and would render the metafictional aspects of the story irrelevant to the plot. It's a dilemma, and I can't think of a work that solves it in a fully satisfying way.")
> 
