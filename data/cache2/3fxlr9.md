## Somewhere over the Rainbow (arc 5/Gone with the Sun) [HSF][RST][FF][Mass Effect]

* Author: u/None *
* URL: 
* Score: 1

* Created: 2015-08-05T22:36:38
...
> 
> recapitulating the events of the Red Flash. The opening chapter of the story proper is:
...
> Mass Effect 3 came out some time back, following which I wrote a 'rationalist' novel exploring the aftermath - 
> 
> posted for the canonical year and a day. It explored consequences of ME3's 'red flash' from the point of view 
> 
> of certain characters.
> As it happens, the closing lines of the last arc had survivors heading for Andromeda. Imagine my shock when 
> 
> the recent E3 2015 trailer, "Mass Effect: Andromeda" was issued, showing an N7 in Andromeda, obviously not 
> 
> Shepard but still. Hence the excerpting of the final scene as a prologue.
> This latest post is Arc 5 of that story, dealing with exploration, restoring survivors, and coping with 
> 
