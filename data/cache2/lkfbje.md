...
* URL: https://www.reddit.com/r/rational/comments/lkfbje/d_monday_request_and_recommendation_thread/
* Score: 46

* Created: 2021-02-15T15:00:26
...
> **u/GaBeRockKing** [+15]  *Horizon Breach: http://archiveofourown.org/works/6785857* (10 hours later)
> 
> I'm going to recommend the manga [Child](https://mangadex.org/title/55476/child) .It's a manga about a nonverbal girl called Nao and her upbeat sister Yui. It's a manga about mental illness and coping strategies. And it's a story about the tragedies and successes of growing up.
> 
> ... and it manages to do all that in  the10 short chapters that have been translated.
> 
> The translation is a bit rough since the translator is using DeepL, but they're quite obviously taking what care they can to make sure their translations are accurate and readable. Also, art aside, this isn't a 'furry' manga, per se-- it's a [Lackadaisy Cats](https://www.lackadaisycats.com/) situation where, despite the art, all the characters are obviously human.
> 
> edit: and while I'm recommending furry manga anyways, I'll also recommend [Slayer Volte](https://mangadex.org/title/35838/slayer-volte). Moral ambiguity, interesting worldbuilding, and cute characters getting horribly traumatized. Exactly my cup of tea.

> **u/Freevoulous** [+12]  (20 hours later)
> 
...
>>>>> **u/vorpal_potato** [+3]  (5 days later)
>>>>> 
...
>>>> **u/TridentTine** [+1]  (6 days later)
>>>> 
>>>> Haha, preach.

>> **u/WarZealot92** [+8]  (4 days later)
>> 
...
>> **u/Do_Not_Go_In_There** [+11]  (10 hours later)
>> 
>> The [Bastion Academy Series](https://www.royalroad.com/fiction/36325/bastion-academy-series) by Jess D. Astra is set in Korea. The Mark Lawrence story sounds similar to it. It's set in a post-apocalyptic society that rebuilt itself with "magic" that is really misunderstood/forgotten technology.
>> 
>> [The Windup Girl](https://www.goodreads.com/book/show/6597651-the-windup-girl) by Paolo Bacigalupi is set in Thailand. It's a biopunk/corporate dystopia set in the future where climate change has caused the sea to rise beyond habitable limits.

>>> **u/KilotonDefenestrator** [+6]  (20 hours later)
>>> 
>>> Second the recommendation for Windup Girl. It's the future where Monsanto and Nestle were allowed to run rampant.

>> **u/Charlie___** [+5]  (17 hours later)
>> 
...
>> **u/KilotonDefenestrator** [+5]  (20 hours later)
>> 
...
> **u/DangerouslyUnstable** [+24]  (8 hours later)
> 
...
>>> **u/DangerouslyUnstable** [+13]  (a day later)
>>> 
...
>>>> **u/Dragfie** [+0]  (a day later)
>>>> 
>>>> mk

>>>> **u/fassina2** [+1]  *Progressive Overload* (13 days later)
>>>> 
...
>>>>> **u/DangerouslyUnstable** [+5]  (14 days later)
>>>>> 
...
>>>>> 
>>>>> But even if he was actually more attractive than usual (which, again, doesn't seem to be the case), it just adds to the overall Marty-Stue-ness of the story. He's witty, smart, competent, _and_ attractive. I have no problem with attractive characters. But characters without realistic flaws are uninteresting and boring.

>>>>>> **u/fassina2** [+1]  *Progressive Overload* (14 days later)
>>>>>> 
...
>>>>>>>>> **u/DangerouslyUnstable** [+3]  (14 days later)
>>>>>>>>> 
...
>> **u/WISHFULFILLMENTSUCKS** [+9]  (a day later)
>> 
...
> **u/AnythingMachine** [+8]  (2 hours later)
> 
> Just read the new sf story Threshold - linked by u/FTL_wishes, which seems to be setting up a rational protagonist type in a decidedly irrational situation, who's presented with an incredibly obvious good vs bad story that seems to not make a lot of sense upon second thought. Also, some nice transhumanist themes. Excited for the rest of that,
> 
...
>>> **u/AnythingMachine** [+5]  (a day later)
>>> 
>>> It's currently a short story but set in a wider universe and the author said he's intending to [follow-up](https://dm.reddit.com/r/rational/comments/likkpl/rt_threshold/gn3n8d7/), so I'd just read the story and see if it suits you.
>>> 
...
>>> 
>>> There's some backstory already in place - a first contact story with a fairly similar premise to Eliezer Yudkowsky's Three Worlds Collide but with a very different resolution, if that sort of [thing's more your speed](https://ascentuniverse.wordpress.com/).

>>>> **u/chiruochiba** [+3]  (a day later)
>>>> 
>>>> Thanks, I'll definitely check out that story and the author's other works!

>>>>> **u/AnythingMachine** [+3]  (a day later)
>>>>> 
>>>>> Cool - It'd be nice to know if the recommendation panned out! The short stories are all over the place in terms of sci-fi subgenres - there's also [cyberpunk stuff](https://ascentuniverse.wordpress.com/2018/04/02/the-facilitator-2099/), actiony [out there space opera](https://ascentuniverse.wordpress.com/2018/04/02/bows-and-arrows-against-the-lightning/), more philosophical stuff about [weird alien cultures](https://ascentuniverse.wordpress.com/2018/08/30/seeker/) and the main story is kind of an [adventure thriller about overthrowing a corrupt government](https://ascentuniverse.wordpress.com/2017/09/28/chapter-1-necessity/) at least for the first three quarters, except you see half the plot from the POV of the leader of the supposedly evil dystopian government that rules Earth. I think they're all eventually supposed to tie together somehow, and I'm probably totally messing up the intended reading order, lol

>>>> **u/jls17** [+2]  (8 days later)
>>>> 
...
>>>>>>>>> **u/AnythingMachine** [+2]  (9 days later)
>>>>>>>>> 
>>>>>>>>> I think that u/TheUtilitaria said at one point that there is an overarching plot that's being set up in all the stories
...
>>>>>>> 
>>>>>>> Corbin's line, 'We can't ever live in peace - and I don't want to' was said by [Christopher Hitchens about Jihadis.](https://i.pinimg.com/originals/28/6b/71/286b7196dbfb752e804f0f60c5d61156.jpg) Basically a giant hint about Corbin's view of himself as a moral crusader.
>>>>>>> 
...
> **u/ThePhrastusBombastus** [+7]  (an hour later)
> 
...
> * [The Salamanders](https://www.royalroad.com/fiction/16717/the-salamanders/chapter/195291/101)
> * [Towers of Heaven](https://www.amazon.com/Towers-Heaven-LitRPG-Adventure-Book-ebook/dp/B07QH93BMR)

>> **u/Amagineer** [+6]  (2 hours later)
>> 
...
>> 
>> [The Abyssal Dungeon](https://www.royalroad.com/fiction/21045/the-abyssal-dungeon) which has lots of themed layer building it sounds like you're interested in.
>> 
>> [Labyrinthia's Maze](https://www.royalroad.com/fiction/33118/labyrinthias-maze) also scratched some of that same itch, though if I recall correctly the writing was a little rough around the edges, both grammatically and plot-wise.
>> 
>> [The Infinite Labyrinth](https://www.royalroad.com/fiction/27263/the-infinite-labyrinth)'s "Georgian Era Steampunk alternate history meets litRPG" premise seemed interesting, (and is from the perspective of some delvers rather than the dungeon) though I only read the first couple chapters and don't remember why I stopped, so I'm not sure how well it ultimately delivers.
>> 
>> [Titan of Steel](https://www.royalroad.com/fiction/26480/titan-of-steel) is a bit of a subversion of the usual dungeon delving stuff, in that the dungeon decides to build itself a nuclear-powered mech, but I found it still scratched some of the same itch.
>> 
>> [There is no Epic Loot here, Only Puns.](https://www.royalroad.com/fiction/15935/there-is-no-epic-loot-here-only-puns) is, as the title might suggest, rather lighthearted and *definitely* subverts the a lot of the "deathtrap" parts of the dungeon-building genre, but otherwise has the themed layer-cake stuff going on in spades.

>> **u/cultureulterior** [+4]  (3 days later)
>> 
...
>> **u/EdenicFaithful** [+8]  (11 hours later)
>> 
...
>> 
>> These are possibly not what you're looking for, but: Perhaps the magisterial noir [Dark City](https://www.rogerebert.com/reviews/dark-city-1998), which uses injections for >!altering memories!<. There's sociopathic-overachiever film *Equilibrium* which also uses injections, this time to regulate emotions.
>> 
...
>> **u/Do_Not_Go_In_There** [+8]  (7 hours later)
>> 
>> The closest I can think of is
>> [*The Tower of Somnus*](https://www.royalroad.com/fiction/36983/tower-of-somnus). It's a cyberpunk corporate dystopia where the MC is trying to claw her way up (socially/economically), in large part by stealing and killing rich people.
>> 
>> You might like [*The Last Angel*](https://forums.spacebattles.com/threads/the-last-angel.244209/). It has some of the same elements - a battleship AI, interesting factions, and cool alien species, but the AI is fighting what it call "The Long War" after humanity was nearly wiped out by aliens 2000 years ago.
>> 
...
> **u/xXxXx_Edgelord_xXxXx** [+5]  (2 days later)
> 
> Are there any fanmade epilogues to Mother of Learning? I want more Kirielle.

>> **u/serge_cell** [+6]  (2 days later)
>> 
>> [The Menocht Loop](https://www.royalroad.com/fiction/31514/the-menocht-loop) was inspired by question - what happens after MoL end? It's original though, not MoL fic.
...
> **u/SimoneNonvelodico** [+5]  *Dai-Gurren Brigade* (3 days later)
> 
...
>>>> **u/fassina2** [+2]  *Progressive Overload* (13 days later)
>>>> 
...
>> 
>> I like to play Star Sector as a roguelike (there's a mode to disallow savescumming).  Characters in that game exclusively improve via perks, which ends up being a skill-like system.  This guy can explain the game better than I can:
>> https://www.youtube.com/watch?v=acqpulP1hLo

>> **u/sprague-grundy** [+3]  (4 days later)
>> 
...
>>> **u/SimoneNonvelodico** [+2]  *Dai-Gurren Brigade* (4 days later)
>>> 
>>> > SILQ
>>> 
>>> The Angband fork? I didn’t know about it, just googled it, but it seems interesting - thanks!

>>>> **u/SvalbardCaretaker** [+3]  *Mouse Army* (4 days later)
>>>> 
...
>> **u/timelessarii** [+3]  (14 hours later)
>> 
>> RE: Monarch is a good political fantasy with time loops. I've rec'd it here before but it's worth doing so again. I'd give it a shot and see if it's your cup of tea. 
>> https://www.royalroad.com/fiction/37951/re-monarch

>>> **u/serge_cell** [+0]  (2 days later)
>>> 
...
> **u/SimoneNonvelodico** [+3]  *Dai-Gurren Brigade* (5 days later)
> 
> Just read through the transcript of [this podcast discussion](http://rationallyspeakingpodcast.org/show/episode-252-understanding-moral-disagreements-jonathan-haidt.html) which I found pretty interesting. It's a discussion about what are the "taste buds" of morals, how different people weigh them differently, and how this turns into political disagreement (also about rationalism, by the way). Means I'll probably keep an eye (ear? haha) on the podcast as a whole as well.

> **u/ADotSapiens** [+5]  (5 hours later)
> 
...
>> **u/Dufaer** [+7]  (a day later)
>> 
>> Have you watched [Yes Minister](https://en.wikipedia.org/wiki/Yes_Minister)?

> **u/NinteenFortyFive** [+4]  (5 hours later)
> 
