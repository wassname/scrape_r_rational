## Rationally Writing, Episode 3 - Originality

* Author: u/DaystarEld  *Pokémon Professor**
* URL: http://www.daystareld.com/podcast/rationally-writing-3/
* Score: 26

* Created: 2016-07-24T21:58:30

### Post:

[Link to content](http://www.daystareld.com/podcast/rationally-writing-3/)

### Comments:

> **u/veruchai** [+3]  (a day later)
> 
> Originality is an interesting topic. 
> A common motivation for writers is the desire to share thoughts and ideas with the world. So one would assume a more original work would have more appeal for writers as well. For example, I recently had a desire to write a hpmor fic focusing on harry having to deal with his vow. This idea seemed interesting enough to share with others. However, after checking the  continuation stories that I had not read before, I found out 'Significant Digits' had already explored the subject in chapter 2. Now it seemed mostly to be used as a subplot there, so if my desire was strong enough I could still write a story that would explore the idea further and more in-depth. While it wouldn't be completely original it would then hopefully add enough to still be interesting and new. In contrast since my desire was not very strong I could decide my idea had been shared with the world and not write anything on the subject. 
> 
...
> **u/DaystarEld** [+3]  *Pokémon Professor* (57 seconds later)
> 
...
> **u/TennisMaster2** [+3]  (42 minutes later)
> 
...
>> **u/DaystarEld** [+5]  *Pokémon Professor* (47 minutes later)
>> 
...
> 
> Since /u/alexanderwales mentioned how much he likes familiar stories reimagined in different settings, I'd like to re-recommend Superman: Red Son. I found a free copy [here](http://m.imgur.com/gallery/OIaKj).
