## [RT][HSF] Living in Weirdtopia: Week One

* Author: u/DataPacRat  *Amateur Immortalist**
* URL: http://www.datapacrat.com/weirdtopia/index.html
* Score: 48

* Created: 2016-05-16T05:03:04

### Post:

[Link to content](http://www.datapacrat.com/weirdtopia/index.html)

### Comments:

> **u/blazinghand** [+7]  *Chaos Undivided* (an hour later)
> 
...
> 
> For everyone who is curious, there was a little discussion behind the world-building in this story from the Wednesday World-Building thread [here](https://www.reddit.com/r/rational/comments/4ixzrw/d_wednesday_worldbuilding_thread/d32651s).

> **u/Meneth32** [+2]  (6 hours later)
> 
> I like the swearing by trees. Inspired by *[MLP Time Loops](https://www.fimfiction.net/story/98568/)*? :)

>> **u/DataPacRat** [+3]  *Amateur Immortalist* (7 hours later)
>> 
...
>>>> **u/DataPacRat** [+2]  *Amateur Immortalist* (9 hours later)
>>>> 
>>>> Maybe, but how could I pass up the chance, when talking about reactionless thrusters, to make a reference to Doc Smith's Lensman series, via [he](http://dd-b.net/dd-b/Ouroboros/sf/klono.shtml) of the carballoy claws and tungsten teeth?
...
>> **u/DataPacRat** [+9]  *Amateur Immortalist* (8 hours later)
>> 
>> The art credits are at the bottom: [Trunchbull](https://sfw.furaffinity.net/user/trunchbull/) for the skele-robo-rat, [Cervelet](https://sfw.furaffinity.net/user/cervelet/) for the robo-maid, [Valy J. Thunderbeast](https://sfw.furaffinity.net/user/valery91thunder/) for the comic, and [ECMajor](https://sfw.furaffinity.net/user/ecmajor/) for the ostrich-taur.
>> 
>> > you two could be
>> 
...
>>> **u/Chronophilia** [+6]  *sci-fi ≠ futurology* (9 hours later)
>>> 
>>> My opinion exactly. I'll add that he's a very good writer with absolutely no ability to manage his Internet fandom/hatedom, much like [another well-known MLP fanwriter with a transhumanist streak](https://www.fimfiction.net/user/Chatoyance). I still occasionally check in on the QQ comics, but if his politics don't dull my interest soon then the lack of updates will.
>>> 
>>> ----
>>> 
...
>>>> **u/DataPacRat** [+8]  *Amateur Immortalist* (9 hours later)
>>>> 
...
>>> **u/TennisMaster2** [+1]  (20 hours later)
>>> 
...
> **u/Towerowl** [+2]  (16 hours later)
> 
> Very very enjoyable read.
> Kind of sad you might not update it, but also glad you don't just keep updating with bad chapter when you run out of steam like some webwritter do.
> Now looking for your other stuff ...
...
>> **u/DataPacRat** [+7]  *Amateur Immortalist* (7 hours later)
>> 
>> > Is this supposed to be a one-shot (about the first week) or the first chapter of a new series?
>> 
...
>>> **u/nolrai** [+1]  (14 hours later)
>>> 
>>> It doesn't feel like to much dialog to me.

>>>> **u/DataPacRat** [+1]  *Amateur Immortalist* (14 hours later)
>>>> 
