...
* URL: https://www.reddit.com/r/rational/comments/l1atdc/d_wednesday_worldbuilding_and_writing_thread/
* Score: 5

* Created: 2021-01-20T15:00:17
...
> **u/Username2upTo20chars** [+6]  (3 hours later)
> 
...
>>> **u/Username2upTo20chars** [+1]  (7 hours later)
>>> 
...
> **u/PastafarianGames** [+6]  (8 hours later)
> 
...
>>>>>>>> >The ISS's solutions aren't sustainable, though. The zeolite stuff is cool (really cool!) but only just effective enough even with the use of a gel-based dessicant (which they ship from Earth).
>>>>>>>> 
>>>>>>>> There's better solutions available with extensions of future if energy is abundant. [This tech](https://phys.org/news/2017-06-low-cost-carbon-dioxide.html) has recently allowed co2 to be split far more cheaply and method for doing so have existed far longer but are energy intensive. Though this method produces carbon monoxide as a waste product which requires you have a system for dealing with it [such as using it as the base for the production of hydrocarbons](https://en.wikipedia.org/wiki/Electrochemical_reduction_of_carbon_dioxide). Importantly though a much larger habitat with a lot of vegetation can do most of the work for you, we just don't do this on the ISS because mass is at such a premium.
>>>>>>>> 
