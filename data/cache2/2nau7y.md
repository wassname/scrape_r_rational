...
> Sweet Cthulhu Who Only Swims Left, this could have been a *really good* anime/manga if they'd fixed the pacing and given the [AoT ep7](#s "Titan shifter powers") to Mikasa instead of Eren.
> 
...
>> **u/MadScientist14159** [+9]  *WIP: Sodium Hypochlorite (Rational Bleach) Eventually. Maybe.**
>> 
...
>>>> In terms of real life, if there is a connection then I'd say that the author of AoT is probably more likely to be commenting on Japan's relations with China, which the right wing in Japan perceives as a threat in terms of their economy and their numbers. The walls are supposed to represent [Japanese isolationism](http://www.animenewsnetwork.com/interview/2013-07-23/interview-george-wada-producer-of-attack-on-titan#) and there is some weak evidence that the author is right wing [see here](http://seldomusings.wordpress.com/2013/10/19/migiteorerno/). Apparently the author has admitted that the general, Pixis, who is portrayed as a good man, is based on the Imperial war criminal Yoshifuru Akiyama.
>>>> 
...
>>> 
>>> I think you might be reading into this a bit too much, [Everyone is Jesus in Purgatory](http://tvtropes.org/pmwiki/pmwiki.php/Main/EveryoneIsJesusInPurgatory) style.
>>> 
...
>>>> ----
>>>> ____
>>>> Memories of that overzealous English teacher, who forced you to accept that
>>>> every character, every scene and every action had a _ [ deep inner meaning
>>>> ![](http://static.mediatropes.info/pmwiki/pub/external_link.gif)
>>>> ](http://en.wikipedia.org/wiki/Allegory) _ have led to widespread fear on the
>>>> part of readers and viewers everywhere that every tale secretly contains some
>>>> other story being told in [ subtext
>>>> ](http://tvtropes.org/pmwiki/pmwiki.php/Main/Subtext) . The end result of this
>>>> is a state of mind that interprets every plot as an allegory for the
>>>> rebuilding of one's soul, every setting as a manifestation of purgatory, and
>>>> every protagonist as a stand-in for the Christ: [ Everyone Is Jesus In
>>>> Purgatory ](http://tvtropes.org/pmwiki/pmwiki.php/Main/TitleDrop) !
>>>> [Read More](http://tvtropes.org/pmwiki/pmwiki.php/Main/EveryoneIsJesusInPurgatory)
>>>> ____
...
>>> **u/None** [+1] *
>>> 
>>> Please, enlighten us.  I keep checking the TVTropes WMG pages regularly to see what's been revealed, and *still* nobody has explained: [AoT](#s "where the Shifters come from, what they can use the Coordinate for, what Grisha Jaeger was up to with the Reiss family, who made the Titans, and how it all physically works such that all major powers are Titan-related and all Titan-related powers are just perverse to use.")
>>> 

>>>> **u/triangleman83** [+1] *
>>>> 
>>>> Um there's a lot of info on the latest issues of the manga on the wiki page.  Read this for lots of SPOILERS
