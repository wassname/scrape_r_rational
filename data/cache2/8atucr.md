...
* Author: u/SpeculativeFiction *
* URL: https://www.reddit.com/r/rational/comments/8atucr/the_march_north_rtchf/
* Score: 13

* Created: 2018-04-08T23:01:56
...
> **u/xamueljones** [+4]  *My arch-enemy is entropy* (36 minutes later)
> 
...
>> **u/AezyDesu** [+6]  *The Culture* (4 hours later)
>> 
...
>>> **u/SpeculativeFiction** [+3]  (16 hours later)
>>> 
...
>>>> **u/sparkc** [+1]  (23 hours later)
>>>> 
>>>> As someone who doesn’t frequent r/fantasy, why would you be disinclined to read a work from an author who posts there?
...
>>>>> 
>>>>> They did have a period sometime after the [sad puppies](https://en.wikipedia.org/wiki/Sad_Puppies) (I'm not a fan of the extremes of either side. Both care too much about what other people are writing and reading.) campaign started where they became rather political, but that's died down.
>>>>> 
...
>>>>>> **u/AdventurerSmithy** [+1]  (2 days later)
>>>>>> 
...
>> **u/SpeculativeFiction** [+2]  (an hour later)
>> 
...
>>>> 
>>>> [Personally, ](#s "I don't see another reason to use no gender pronouns to describe anyone (although IIIRC, the genders of other characters like Rust or Halt are given away early), then deliberately reveal her to be a woman by suddenly using a pronoun near the end of the book. That's a very deliberate move. Writing without pronouns is hard--I seriously doubt he simply forgot one at the end by accident. I think he knew readers would assume the captain was a man by default, and wanted to make them question their biases.")
>>>> 
>>>> Then again, I've seen an [author](https://forums.spacebattles.com/threads/the-world-waits-on-evil-hivers-eoa-ww-a-finished-story.274791/) that used a base-16 number system and prevented himself from using english idioms as a writing experiment. so I suppose it's possible.

> **u/sparkc** [+2]  (an hour later)
> 
...
> **u/SpeculativeFiction** [+1]  (20 minutes later)
> 
...
> 
> You can get [The March North here](https://play.google.com/store/books/details?id=MoIOAwAAQBAJ).

>> **u/serge_cell** [+1]  (8 hours later)
>> 
>> "Sorry! This content is not available in your country yet. We're working to bring the content you love to more countries as quickly as possible.
