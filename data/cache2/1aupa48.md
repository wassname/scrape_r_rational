...
* URL: https://www.reddit.com/r/rational/comments/1aupa48/d_monday_request_and_recommendation_thread/
* Score: 35

* Created: 2024-02-19T15:00:11
...
>>> **u/sl236** [+1]  (9 days later)
>>> 
>>> ...as are the light novels.

> **u/PancakeMenace** [+17]  (10 hours later)
> 
...
>> **u/viewlesspath** [+13]  (14 hours later)
>> 
...
>>> **u/ahasuerus_isfdb** [+12]  (a day later)
>>> 
>>> Most, although not all, Worm fics are indexed by [wormstorysearch.com](https://wormstorysearch.com/?direction=desc&is_nsfw_eq=any&limit=20&page=1&searching=true&sort=stories.story_updated_at). (Make sure to check/uncheck the "NSFW" box under "Options".) It includes [a link to the SpaceBattles version](https://wormstorysearch.com/?is_nsfw_eq=any&story_keywords=daring+synthesis&page=1&limit=20&sort=stories.story_updated_at&direction=desc&searching=true) of *A Daring Synthesis*.
>>> 
>>> As an aside, [according to the author](https://www.reddit.com/r/WormFanfic/comments/m674oa/tips_for_writing_greg/gr4o7c8/):
>>> 
>>> > To actually write Greg as himself, as Wildbow portrays him, wouldn't be terribly hard if you read the parts where he shows up and use them for reference as you go. For me, that was boring because Greg is a boring person. [snip]
>>> 
...
>>>> 
>>>> Greg “Dark Smoke Puncher” Veder is physically painful to read, which I guess is a good sign. Holy shit.

> **u/AmarakSpider** [+8]  (12 hours later)
> 
...
>> **u/Relevant_Occasion_33** [+7]  (23 hours later)
>> 
...
>> 
>> Had an idea for a story once, called "Pilot of History", where Earth is doomed to be destroyed by a fleet of aliens called the Exterminators in the year 2486. This guy finds a "time rift" and goes back 12,000 years, and tries to unify and advance humanity enough to fight the aliens.
>> 
>> Humanity loses every time. The Pilot gets desperate and defiles civilization into a dystopian nightmare with 100% efficiency and utter fanaticism to the Cause, just so they *might* beat the aliens, but for hundreds of thousands of cycles, the Exterminators mop the floor and destroy humans so utterly that the surface of the Earth is incinerated by 30% and glowing white hot for thousands of years.
>> 
>> But other civilizations are ruled from the shadows by an organization called the Vigil, who's aware of time travel and wants to preserve normalcy and make sure the timeline doesn't get *too* fucked, so when they notice humanity stripmining the solar system and building huge shipyard rings around Jupiter when they should be still in the Stone Age, they get pretty worried and try to dismantle human civilization before something really bad happens. They've noticed that for the last couple of cycles, an incomprehensibly vast warfleet of extremely advanced technology just appears in Sol, destroys humanity, and deactivates, it's purpose having been finished.
>> 
>> Each timeline is slightly different and time travel is stupidly difficult and kind of unreliable, relying on "time rifts" that at exactly the right moment, take you to a different patch of spacetime. Therefore, not a lot of knowledge is preserved in the Vigil between each cycle, but they still know time travel when they see it and know something's amiss with humanity.

> **u/Dragfie** [+7]  (a day later)
> 
...
>>>>> 
>>>>> No links cos mobile but some notables are:
>>>>> 
>>>>> A backwards grin (and others by same author)
>>>>> Super minion
>>>>> I thought this was a pokemon mystery dungeon
>>>>> 
>>>>> A range of youjo senki crosses
>>>>> Blue core
>>>>> Tree of aeons
...
>>>>> Kumo desuga nanika?
>>>>> 
>>>>> And probably a tone I'm forgetting.

> **u/AutopoieticBeing** [+6]  (a day later)
> 
...
>>> **u/AutopoieticBeing** [+3]  (2 days later)
>>> 
...
>>> **u/AutopoieticBeing** [+1]  (a day later)
>>> 
>>> lol I've already read both of those, but thanks

> **u/mack2028** [+9]  (11 hours later)
> 
...
>> **u/GlueBoy** [+28]  *anti-skub* (15 hours later)
>> 
...
>> **u/YankDownUnder** [+4]  (6 days later)
>> 
...
>>>>>> **u/YankDownUnder** [+2]  (10 days later)
>>>>>> 
>>>>>> Which book is that in?

>>>>>>> **u/mack2028** [+1]  (10 days later)
>>>>>>> 
>>>>>>> Karis brings up that it is a weird cultural taboo in the second or third book and "we don't mention it outloud where we think the visages can hear us." gets talked about in more length in the third book where the twins thing first becomes a plot point. They discuss the taboo as part of a scenero floor where they are doing a murder mystery where they are at a party and someone tries to murder one of a pair of twins as part of a religious honor killing. I don't even know how you would be upset about that part of the story without having gotten that far though, they actually barely mention it before that.

>>>>>>>> **u/YankDownUnder** [+2]  (10 days later)
>>>>>>>> 
>>>>>>>> No, I mean in which book is it explained as originating from Selys? I've read all 4 and I don't remember the origin ever being explained.

>> **u/GrizzlyTrees** [+1]  (21 days later)
>> 
>> I've read AA and at no point was it clear if I actually like it (I read 4 books, don't know if any more are out). Some of it is well written, the plot in general seems messy, I don't particularly care for the main characters, and I dislike the amount of handholding they get from Keras, and it always felt forced to me that he remained with them for so long (or even joined them at all). 
>> 
>> I'm currently in book 2 of mage errant and again I don't particularly like or dislike it. At least it's pretty short, so I'll finish the series in a few weeks, probably. I'm actually currently on a break from it because I've found the AI cast for project lawful, and have been listening to it instead.

> **u/CaramilkThief** [+13]  (a day later)
> 
...
>>> **u/jacksofalltrades1** [+9]  (2 days later)
>>> 
...
>> 
>> How far into the story does he get the cheat-like power?

>>> **u/CaramilkThief** [+3]  (2 days later)
>>> 
>>> He doesn't really get the power as much as it's an innate part of him, to intuitively understand magic and how it's made. This starts early on, around chapter 10 or so I think? He's basically a savant at magic, and can easily pick up most of the different schools of thought on magic creation. 
>>> 
>>> However, he has to work hard to catch up to the other immortals and archmages in the setting, who have had decades or centuries to refine and learn magic. It's not until very late into the story that he's actually a match for the other archmages, even though technically he's had their status for a long time. However it works out, since magic battles are more rock-paper-scissors fights and less "my numbers are bigger than yours."
