...
* URL: https://www.royalroad.com/fiction/25225/delve/chapter/690548/148-weight
* Score: 26

* Created: 2021-05-30T05:05:21

### Post:

[Link to content](https://www.royalroad.com/fiction/25225/delve/chapter/690548/148-weight)

### Comments:

> **u/Redditor-K** [+6]  (2 days later)
> 
> Is Rain gunning for five rank ten skills in each of his five skill trees to get access to a legendary class? 
> 
> If so, barring a new hidden skill revealing itself, I'm guessing they're going to be Shear, Shroud, Corrosion, Arcane Ward, Light Ward, Mental Ward, and Suppression. 
> 
> The logic is like this, the distribution is 3 skill points to offensives and 4 to defensive. Rain would want Suppression since it synergizes extremely well with his high mana, but that requires an aura of each of the 8 elements. Rain already has heat, cold, and force.
> 
> Of all the possible combinations, it comes down to Rain needing less chemical resistance due to Purify, so he'll take that element in the offensive form of Corrosion, which also requires shroud. The last offensive point goes to Shear as it has a unique tactical quality in that it isn't occluded by mundane materials. Radiance doesn't give Rain anything special as Purify can produce light as well.
> 
> 3 defensive skill points go for the mental, arcane, and light wards, completing the requirements allowing Rain to spend his 25th skill point on Suppression.
> 
> WDYT?

>> **u/Veedrac** [+3]  (3 days later)
>> 
>> Rain already has 6 points in Aura Metamagic, so by level 24 he'll have to drop Shear (or Suppression, if he's nuts), which he'll pick up at level 25.

>>> **u/Redditor-K** [+2]  (3 days later)
>>> 
>>> Right! I missed that. So it won't be a perfectly even spread at level 25... But still *at least* five of five. I guess that's a non-issue since it's impossible anyway unless you hold off on allocating a skill point before choosing a class, and we haven't seen any hidden requirements so far that would suggest that to be an issue.

>> **u/interested_commenter** [+1]  (3 days later)
>> 
>> Yes, that's definitely what Rain is going to do, unless a hidden defensive or offensive aura shows up. Only real question is whether he goes Shroud/corrosion/light ward/arcane ward or radiance/fulmination/dark ward/chem ward. Mental ward and Suppression are certain, and while he could get both shroud and radiance instead of Shear, that seems like a poor decision.

> **u/teasingsmile** [+10]  (2 hours later)
> 
...
>>> **u/LLJKCicero** [+2]  (6 hours later)
>>> 
>>> Same. And Rain has (probably) leveled up!

>>>> **u/eaglejarl** [+12]  (6 hours later)
>>>> 
...
>>>>> **u/LLJKCicero** [+2]  (11 hours later)
>>>>> 
>>>>> Right, right.

>>>>> **u/MilesSand** [+1]  (3 days later)
>>>>> 
>>>>> He's been staying pretty close to the cap iir~~c~~ the blue boxes correctly. If he doesn't immediately level up I expect him to do so within a chapter or 2, not counting more base building but doing nothing chapters.

>>> **u/teasingsmile** [+2]  (a day later)
>>> 
>>> Yeah fair enough i guess we enjoy different things. At least the author is catering to all.

> **u/Rorschach_And_Prozac** [+17]  (7 hours later)
> 
...
>>>> **u/eaglejarl** [+6]  (23 hours later)
>>>> 
>>>> *checks wiki*
>>>> 
>>>> Right you are. My bad.

>>> **u/Rorschach_And_Prozac** [+7]  (9 hours later)
>>> 
...
>>>>> **u/Rorschach_And_Prozac** [+7]  (14 hours later)
>>>>> 
...
>>>>>> **u/SleepThinker** [+4]  (16 hours later)
>>>>>> 
...
>>>>>>> **u/Rorschach_And_Prozac** [+2]  (16 hours later)
>>>>>>> 
...
>>>>>>>>> **u/Rorschach_And_Prozac** [+6]  (17 hours later)
>>>>>>>>> 
...
>>>>>>>>>>>> 
>>>>>>>>>>>> Hmmm... as far as it taking a week to change yes. As far as having Ameliah change builds at any point underground, no.
>>>>>>>>>>>> 
>>>>>>>>>>>> She's still out of commission for about 2 days and neither Tallheart nor Rain have any way to handle a reaper class if it catches them off-guard.
>>>>>>>>>>>> 
>>>>>>>>>>>> If they had a party with more non-support units then that would be different.

> **u/bigbysemotivefinger** [+2]  (10 hours later)
> 
...
> **u/PriestofNight** [-9]  (10 hours later)
> 
...
>> **u/fassina2** [+9]  *Progressive Overload* (14 hours later)
>> 
...
>>> **u/PriestofNight** [-9]  (13 hours later)
>>> 
...
>>> How many of the top 5 fiction in RR are isekai? How many in top web fiction?
>>> I know you can take any other japanese oriented website and make a counter argument.

>>>> **u/Dragfie** [+5]  (23 hours later)
>>>> 
>>>> >Objectively speaking, isekai fantasy is worst than the rest. In fact, isekai is a an actual way to justified anacronism and the use of pop culture to attrack younger audience.
>>>> 
