...
* Author: u/eaglejarl *
* URL: https://www.fanfiction.net/s/9669819/49/The-Two-Year-Emperor
* Score: 14

* Created: 2014-07-06T03:17:06
...
> **u/mycroftxxx42** [+4]  (8 hours later)
> 
...
>>> **u/mycroftxxx42** [+1]  (23 hours later)
>>> 
...
> **u/Drazelic** [+1]  *Dai-Gurren Brigade* (15 hours later)
> 
...
>> 
>> The rules of the world are:  real world physics works, unless explicitly trumped by D&D Rules As Written.  So explosive reactions *do* work in 2YE.  [The reason the cannon](#s "didn't work isn't that the explosion isn't viable, it's that there were issues with the design and implementation of the cannon itself.")

> **u/omgimpwned** [+1]  *Sunshine Regiment* (20 hours later)
> 
...
> 
> Also, I kinda wonder how well Grǫfhamr would react with a [locate city bomb](http://ihititwithmyaxe.tumblr.com/post/22331104288/breaking-d-d-3-5-the-locate-city-nuke)...  The explosion could be centered on the entrance hole, no?  And if you had a second guy there to close the passage up on the same round as the mage casts (readied action?)  then the townspeople would be safe from the blast... I think
...
>>> **u/drageuth2** [+1]  (a day later)
>>> 
>>> Eh, I like the gods thing.  It makes me think that there must have been some _previous_ two-year-emperor that put the fear of gods into them.
>>> 
>>> I did some more searching around, and it turns out there *are* rules for money weight.  According to [this wiki](http://dungeons.wikia.com/wiki/Gold_Piece) the offcial rules are that 50gp weighs one pound, in second edition and up  (first edition it was 10gp to the pound.)  So I guess whether goldshot works in TYE would depend on whether they honor that rule, or go with the more common unwritten weightless-money house rule.
