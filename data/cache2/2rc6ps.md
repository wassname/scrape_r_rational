...
* Author: u/eaglejarl *
* URL: https://www.reddit.com/r/rational/comments/2rc6ps/mkqbst_munchkin_the_rule_and_the_hourglass/
* Score: 7

* Created: 2015-01-04T22:11:04
...
>>> 
>>> [the affected object can be shrunk and expanded an indefinite number of times](http://1d4chan.org/wiki/RAW)
>>> 
...
>>>>>>> 
>>>>>>> Could you still embiggen viruses, seeing as how A) their aliveness is questionable, and B) diseases aren't really creatures, but ~~status effects~~ [special abilities](http://www.d20srd.org/srd/specialAbilities.htm#disease)?
>>>>>>> 
...
> How do these work at the atomic level? Are more atoms added/removed?
>  What if you grew something, changed one atom, and shrunk it again? Would it return to normal? There's probably something you can do to get free energy/matter.
> 
...
>> 1. Enlarge
>> 1. A coin the size of a quarter is now about 8" across and 1" thick.  Dig into the side of it, scoop the gold out from the inside of the object.  
>> 1. Shrink it down again -- your digging site is now not even a scratch.  Unless someone checks it with a microscope, it's undetectable!
>> 
...
>> 1. Change its own size in a way totally different from IEI / ISI
>> 1. Be unbreakable.
>> 
