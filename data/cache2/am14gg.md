## [RST] Pokemon: The Origin of Species, Chapter 64 - Purpose

* Author: u/DaystarEld  *Pokémon Professor**
* URL: https://www.fanfiction.net/s/9794740/64/Pokemon-The-Origin-of-Species
* Score: 106

* Created: 2019-02-01T11:33:39

### Post:

[Link to content](https://www.fanfiction.net/s/9794740/64/Pokemon-The-Origin-of-Species)

### Comments:

> **u/Gummysaur** [+39]  (2 hours later)
> 
...
>> **u/OmniscientQ** [+28]  (7 hours later)
>> 
...
>>> **u/Trips-Over-Tail** [+14]  *Death of Crabs* (14 hours later)
>>> 
...
>>>>> **u/The_Magus_199** [+3]  *Ankh-Morpork City Watch* (12 hours later)
>>>>> 
>>>>> Yup, that’s fair!

> **u/Memes_Of_Production** [+27]  (3 hours later)
> 
...
> **u/kurtofconspiracy** [+18]  (9 hours later)
> 
...
> **u/The_Wadapan** [+17]  *ice to meet ya* (23 hours later)
> 
...
>>> **u/LazarusRises** [+9]  (9 hours later)
>>> 
...
>>> **u/Trips-Over-Tail** [+7]  *Death of Crabs* (14 hours later)
>>> 
...
>>>> **u/DaystarEld** [+7]  *Pokémon Professor* (16 hours later)
>>>> 
...
>>>>> **u/Trips-Over-Tail** [+4]  *Death of Crabs* (16 hours later)
>>>>> 
...
>>>>>> **u/DaystarEld** [+6]  *Pokémon Professor* (17 hours later)
>>>>>> 
...
>>>>>>> **u/Trips-Over-Tail** [+5]  *Death of Crabs* (17 hours later)
>>>>>>> 
...
>> **u/phylogenik** [+13]  (6 hours later)
>> 
>> Rainfall does [boost the power of water-type attacks](https://bulbapedia.bulbagarden.net/wiki/Rain#In_battle) lol.
>> 
...
>>> **u/Electric999999** [+3]  (3 days later)
>>> 
...
> 
> Non-psychic pokemon might work, too -- humans may be [fairly exceptional throwers](https://www.nature.com/articles/nature12267), but give a fast, nimble, prehensile pokemon a ball and have it run up and do the delicate, dangerous work of pokemon-capture for you. It doesn't seem like there'd be a risk of it getting sucked in itself, since iirc pokeball technology is just as compatible with humans as it is with pokemon (just with the TBI being more obvious and debilitating for human subjects)?
> 
> edit: also, what's the word on [other technological weaponry](https://bulbapedia.bulbagarden.net/wiki/Weaponry_in_the_Pok%C3%A9mon_world) in this fic? Humans and pokemon have supernatural durability, sure, but they're not literally bulletproof, are they? And if, idk, [Zubat poop](https://en.wikipedia.org/wiki/Potassium_nitrate#From_caves) doesn't work for black powder, could you still harness the rapid expansion of an exploding Voltorb to propel a piece of metal down another metal cylinder at high speeds? Also, the legendary birds are always flying and never land, right? b/c otherwise, couldn't you [strap a bunch of Electrode together](https://en.wikipedia.org/wiki/Largest_artificial_non-nuclear_explosions) and have some tamed Dragonite drop them down from a mile up (with maybe some teleporting psychic types to provide barriers from auto-kill auras and steering until contact)? (even if this doesn't work, I wouldn't mind an interlude/omake chapter detailing its failure, similar to e.g. [Weaver Nine](https://www.fanfiction.net/s/10898446/1/Weaver-Nine)'s initial attempts to kill Leviathan)

>> **u/DaystarEld** [+30]  *Pokémon Professor* (8 hours later)
>> 
...
>>>>> **u/I_Probably_Think** [+6]  (a day later)
>>>>> 
...
> **u/DuplexFields** [+11]  *New Lunar Republic* (4 hours later)
> 
> Guess I need to read this.  I had a r/rational style headcanon for the games anyway, might as well read someone else's.

>> **u/DaystarEld** [+5]  *Pokémon Professor* (9 hours later)
>> 
>> Hope you enjoy it!
...
>> **u/Aretii** [+12]  *Cultist of Cthugha* (4 hours later)
>> 
...
>>>> **u/Aretii** [+10]  *Cultist of Cthugha* (9 hours later)
>>>> 
>>>> I award myself a cookie for divining authorial intent.

> **u/TheGreatTactician** [+7]  (13 hours later)
> 
...
>> **u/DaystarEld** [+17]  *Pokémon Professor* (14 hours later)
>> 
...
>>> **u/Trips-Over-Tail** [+4]  *Death of Crabs* (14 hours later)
>>> 
...
>>> **u/elysian_field_day** [+3]  (a day later)
>>> 
>>> This seems like an opportunity to plug [Reborn](http://www.rebornevo.com/index.php?/pr/download/), a fan-made game with many years of development backing it. It solves a lot of the problems of the original games, most notably the lack of difficulty - it can be quite fiendish, at times, like a pokemon/dark souls crossover. The story is also more than set dressing, much better than in the original games for sure, although that is a bit more of a matter of taste (I like some bits of the writing quite well, others felt more mediocre, but still head and shoulders above the originals).
>>> 
>>> &#x200B;
>>> 
...
>>>>>>> **u/elysian_field_day** [+3]  (3 days later)
>>>>>>> 
...
>>>>>>>>> **u/elysian_field_day** [+4]  (4 days later)
>>>>>>>>> 
...
>>>> 
>>>> It's also amusing to note that such a trade-evolution pair *does* exist now: [Accelgor](https://bulbapedia.bulbagarden.net/wiki/Accelgor_(Pok%C3%A9mon)) and [Escavalier](https://bulbapedia.bulbagarden.net/wiki/Escavalier_(Pok%C3%A9mon)).
>>>> 
...
>> **u/DrunkenQuetzalcoatl** [+3]  (4 hours later)
>> 
>> but with once
>> 
>> and gym member.
...
>> **u/Addictedtobadfanfict** [+2]  (2 hours later)
>> 
...
>> **u/LazarusRises** [+2]  (6 hours later)
>> 
...
>> **u/personalensing** [+2]  (10 hours later)
>> 
>> From chapter 63:
>> "his eyes as the the dark flood"
>> 
>> Double the
...
>> **u/The_Wadapan** [+2]  *ice to meet ya* (23 hours later)
>> 
