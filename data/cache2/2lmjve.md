...
* Author: u/squitar *
* URL: https://www.reddit.com/r/rational/comments/2lmjve/thinking_of_starting_a_rational_fan_fiction_based/
* Score: 14

* Created: 2014-11-07T23:15:18
...
>> **u/squitar** [+1] *
>> 
>> Thanks again for your help and info eaglejarl.
>> The dislikes of FFN gave me more of an idea of how I want to set the site up.(Once I get the basics down, I'm new to web development and wordpress)
>> 
...
> **u/squitar** [+1] *
> 
> Is there anyone willing to let me use their stories as opening posts?
> I need Authors
> 

>> **u/alexanderwales** [+5]  *Time flies like an arrow**
>> 
>> Sure, you can use anything I've posted to [my fanfic page.](https://www.fanfiction.net/u/4976703/alexanderwales) Though fanfic.net doesn't allow copy+paste, so you'd have to use an intermediary scraper, or dev tools to turn that off. And then there are the formatting concerns, like italics, bold, line breaks, etc. But so long as I don't have to do anything much with it, go ahead.
>> 

>>> **u/PeridexisErrant** [+4]  *put aside fear for courage, and death for life**
>>> 
>>> Or [an extension](https://chrome.google.com/webstore/detail/selectable-for-fanfiction/jcidlhgdoojamkbpmhbpgldmajnobefd) which disables copypaste-disablers.
>>> 
...
> . I unfortunately haven't had much free time and probably won't have much more in the coming week, however I still want to add at least something everyday.  Thanks again for you support guys! Please feel free to check things out at Rationalfiction.com to see how things are going.
> 
...
>> **u/squitar** [+1] *
>> 
>> I'd like to see if there's a decent user base.
>> (edit: if so i will begin work this evening)
>> 
