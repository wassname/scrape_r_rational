...
* URL: https://www.reddit.com/r/rational/comments/934u5b/d_monday_general_rationality_thread/
* Score: 7

* Created: 2018-07-30T15:06:34
...
> 
> >Besides the powerlifting competitor database linked above, some other datasets I found after a quick search included [historical Olympic athletic stats](https://www.kaggle.com/heesoo37/120-years-of-olympic-history-athletes-and-results), [marathon times under different training volumes](https://www.kaggle.com/girardi69/marathon-time-predictions), [dumbbell curl accelerometer measurements](http://groupware.les.inf.puc-rio.br/har#weight_lifting_exercises), various population level summaries of stuff like obesity frequency and activity level ([e.g.](https://catalog.data.gov/dataset/nutrition-physical-activity-and-obesity-behavioral-risk-factor-surveillance-system-f645f)), and assorted APIs for accessing public data (e.g. [Strava's](https://developers.strava.com/)). One could also probably compile some pretty large datasets through scraping places like reddit or instagram or [bodybuilding.com](https://bodyspace.bodybuilding.com/member-search), but that's a bit more questionable.
