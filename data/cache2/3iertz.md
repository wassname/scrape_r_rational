...
>>>>> And even if the friendly neighbourhood mutant tells you that all he can do is grow itty bitty body spikes, you can't actually *know* that he's telling [the whole truth](http://vignette1.wikia.nocookie.net/prototype/images/3/34/Prototype_3a.jpg/revision/latest?cb=20120527142639).
>>>>> 
...
> **u/PeridexisErrant** [+29]  *put aside fear for courage, and death for life**
> 
...
>> **u/noggin-scratcher** [+10]  *I am a happy tree**
>> 
>> > No mind magic.
...
>> [Well that does tend to leave quite the mess](https://what-if.xkcd.com/1/).  
>> If course, a relativistic punch would also be a nuclear weapon.  
>> Re:  
>> >no railguns  
>> [This is how you Lantern](https://forums.spacebattles.com/threads/with-this-ring-young-justice-si-story-only.272850/). 
>> Edit: formatting
>> 
...
>>>>>>>>> I can't argue against that, but given how often it happens it's likely there is _some_ specific mechanism. I just used "safety protocols" because that's the usual handwavium.
>>>>>>>>> 
...
>>>>>>>>>>> My point is that if it's that easy to happen by accident, why aren't they doing it _deliberately_? AI is clearly not _hard_. It doesn't take a lone genius to make a positronic brain to get AI.
...
>>>>>>>> **u/Quillwraith** [+3]  *Red King Consolidated**
>>>>>>>> 
...
> In Young Justice he [takes Clayface down with a taser.](https://www.youtube.com/watch?v=SUlmUAf-x-g)  (It's actually a Moment of Awesome; the superpowered members of YJ have just been beaten unconscious by Clayface, who is about to finish them off when Batman comes through the skylight and takes him down in seconds.
...
> In the Justice League cartoon, he drops freeze bombs from his Batjet in order to shut down an alien nanofactory.  In [The Dark Knight Returns](https://www.youtube.com/watch?v=9DUz38n-fvQ&t=25s) he uses the Batmobile for starlight rounds and rubber-bullet machineguns to take down a crowd.
