...
>>>>>>>> If it's C) using the computer example what 
>>>>>>>> If I make a computer is the cpu a part or does every component of it  count as a part? .is a computer made of a few components( ram , cpu ....) ?or does it count as being made of x number of transistors?. 
