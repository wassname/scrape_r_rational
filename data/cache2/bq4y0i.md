...
* URL: https://www.reddit.com/r/rational/comments/bq4y0i/d_saturday_munchkinry_thread/
* Score: 7

* Created: 2019-05-18T15:05:34
...
>>> 
>>> ```
>>> 1000kg / (1 cm diameter sphere) =
>>> 1000kg / 0.523599 cubic centimeters =
>>> 1909.86 kilograms per cubic centimeter = 
>>> 
>>> ≈ (9×10^-10 to 2×10^-8) × neutron star density ( 8×10^13 to 2×10^15 g/cm^3 )
>>> ≈ (0.2 to 190.9) × density of a white dwarf ( 10000 to 1×10^7 g/cm^3 )
>>> ≈ 1×10^8 × mean density inside the Schwarzschild radius of a supermassive black hole (≈ 20 kg/m^3 )
>>> ```
>>> 
...
>>>>> **u/red_adair** [+2]  *{{explosive-stub}}* (13 days later)
>>>>> 
...
>>>>>> **u/CCC_037** [+1]  (13 days later)
>>>>>> 
>>>>>> Fair enough. But sometimes you need a hole smashed through a steel door.

> **u/LazarusRises** [+5]  (23 minutes later)
> 
> You may cast one [Wish](https://roll20.net/compendium/dnd5e/Wish) spell each year on January 1. If you don't cast it by 12:00am on the 2nd, you lose your wish for the year.
> 
...
>>> **u/LazarusRises** [+2]  (22 hours later)
>>> 
...
>> 
>> >• You allow up to twenty creatures that you can see to regain all [Hit Points](https://roll20.net/compendium/dnd5e/Monsters#h-Hit%20Points), and you end all [Effects](https://roll20.net/compendium/dnd5e/Designing%20Simple%20Traps#h-Effects) on them described in the [Greater Restoration](https://roll20.net/compendium/dnd5e/Greater%20Restoration#h-Greater%20Restoration) spell.
>> 
...
>>> **u/LazarusRises** [+1]  (22 hours later)
>>> 
