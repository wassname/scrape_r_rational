...
* URL: https://www.reddit.com/r/rational/comments/7nv6sf/d_wednesday_worldbuilding_thread/
* Score: 11

* Created: 2018-01-03T15:06:54
...
>>> **u/callmesalticidae** [+2]  *writes worldbuilding books* (14 hours later)
>>> 
>>> That works pretty well. I don't know why I didn't think of that!

>> **u/Peewee223** [+2]  (4 hours later)
>> 
>> > People can beat each other to death with their fists, so are weapons banned? That seems going kind of overboard!
>> 
...
>>> **u/callmesalticidae** [+1]  *writes worldbuilding books* (14 hours later)
>>> 
...
>>> **u/callmesalticidae** [+3]  *writes worldbuilding books* (3 hours later)
>>> 
...
>> 
>> But if it's just kill counts that are impressive, then the crew of the [Enola Gay](https://en.wikipedia.org/wiki/Enola_Gay) certainly racked up quite the score. I remember seeing this discussion in Heinlein's [*Starship Troopers*](https://www.goodreads.com/book/show/17214.Starship_Troopers), when the protagonist considers why infantry exist when a tech type can push a button and destroy whole cities.
>> 
...
> **u/Nulono** [+3]  *Reverse-Oneboxer: Only takes the transparent box* (2 days later)
> 
