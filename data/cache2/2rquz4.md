...
* URL: http://marshallbrain.com/manna1.htm
* Score: 16

* Created: 2015-01-08T14:39:34
...
>>> **u/literal-hitler** [+1]  (18 hours later)
>>> 
...
>>>>> **u/literal-hitler** [+0]  (a day later)
>>>>> 
...
>>> 
>>> That was where [](#s "It turned out that they always assumed he'd be reading their private messages?") or something else. It's been a long time. I liked "Digital: a love story".
...
>>>>>> 
>>>>>> [](#s "The AI loves you, but in an 'adolescent infatuation' way, not actual love- which is why at the end it/she decides that saving its 'family' by sacrificing itself is the correct choice, and you don't have anyway of convincing it otherwise due to its love for you. It doesn't even seriously contemplate staying with you instead.")

>>>>>>> **u/Timewinders** [+1]  (3 days later)
>>>>>>> 
>>>>>>> That would make sense, though I didn't read it that way. [](#s "In a lot of stories the "love at first sight" trope is played straight, so it can be hard to tell when a story is trying to portray it as not being actual love. I played it before I had become familiar with Christine Love's other stories, so that might have played a role too. I disagree on the interpretation of the AI's decision, though. I think many people who are in real love would still not let their family die just to stay with their lover, especially when the lover is not in any danger. Anyway, my main point about the romance being underdeveloped was that you don't correspond with the AI enough to really get to know and care about her so, for me at least, the ending wasn't as touching as it could have been.")
...
>> **u/MadScientist14159** [+3]  *WIP: Sodium Hypochlorite (Rational Bleach) Eventually. Maybe.* (3 days later)
>> 
>> "What's to stop someone from taking over the system and turning us into an army of zombies?" I asked.
>> 
>> "Nothing."
...
> **u/AmeteurOpinions** [+7]  *Finally, everyone was working together.* (4 minutes later)
> 
...
> **u/WriterBen01** [+7]  (21 hours later)
> 
