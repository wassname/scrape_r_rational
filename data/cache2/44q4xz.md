...
* Author: u/MugaSofer *
* URL: https://www.reddit.com/r/rational/comments/44q4xz/meta_do_we_have_anyone_here_who_works_in/
* Score: 7

* Created: 2016-02-08T09:02:04
...
>>> 
>>> There are two ways to make money on Amazon.  First is selling the book, obviously.  The second is the [Kindle Unlimited](http://www.amazon.com/gp/feature.html?docId=1002872331) program, which is effectively a lending library.  It costs $10/month and allows you to read as much as you want -- you check out a book, read it, put it back, check out another one, etc.  You can have up to 10 books out at a time.  
>>> 
>>> The way authors make money on KU is this:
>>> 
>>> 1. People sign up for a Kindle Unlimited membership.  
>>> 1. When an author publishes something, she can choose to put it in the KU program.
>>> 1. A KU member checks out your book and reads it.
>>> 1. For every page they read, you get paid half a penny.
>>> 1. **Amazon thinks that there are roughly 175 words to a Kindle page.** (This is the only place in their entire system were they are nice to authors, so be grateful.)  That means that 5k words is about 28 pages.
>>> 
>>> Here's the fallout of that:
>>> 
>>> 1. Short form work is worthless.  That 15k novella is worth $0.42.  Don't bother.
>>> 1. Long form is good.  A 110k-word novel like [The Two Year Emperor](http://www.amazon.com/The-Two-Year-Emperor-Deor-ebook/dp/B011DQOT74) (/shameless_plug) is considered to be 628 pages, so if someone borrows it and reads the whole thing I would get paid $3.14, which is a mathematically pleasing accident.  (2YE is not currently in KU, though.)  
>>> 1. *People often don't finish reading something, so don't expect to make that figure.*
>>> 
...
>>> 1. Search link (DO use this form): http://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Daps&field-keywords=the+two+year+emperor+storrs&rh=i%3Aaps%2Ck%3Athe+two+year+emperor+storrs
>>> 
>>> Amazon's interface bites, so you won't have information that you really want.  The solution to this is [Book Report](https://www.getbookreport.com/). If you're publishing on Amazon, you can't afford not to have it, period.  It's free unless you're making >$1,000 / month, and Liam (the author) is very responsive, so there's no reason not to.  (I'm not affiliated with BR in any way except as a delighted user.)
>>> 
>>> Covers are critical.  You can get them made on [Fiverr](https://www.fiverr.com/search/gigs?utf8=%E2%9C%93&search_in=category&source=guest-hp&locale=en&query=ebook+cover&category=3&sub_category=51&page=1&layout=auto) or you can use a professional.  I was going to provide a link to the professional that I've used in the past -- she does *amazing* work and is very inexpensive -- but her domain name has expired.  If I can track her down I'll edit it in.
>>> 
