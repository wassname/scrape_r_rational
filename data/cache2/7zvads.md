...
* URL: https://www.reddit.com/r/rational/comments/7zvads/i_can_fix_you/
* Score: 26

* Created: 2018-02-24T08:04:11
...
>>> Furthermore trying to tie a definition of identity which actually predicts experience to transient properties like personality/memory doesn't seem very workable because you can't make any real convincing points for why complete change in those traits should result in "death" but not the many tiny such similarly instant changes that happen to one's mind constantly (after all at some level the human brain must be quantized in its functions). Given such matters have great relevance when it comes to predicting future subjective experience it seems like a system that couldn't seem to _even in principle_ give definitive answers on that shouldn't make sense unless you think human minds are magic.
>>> 
