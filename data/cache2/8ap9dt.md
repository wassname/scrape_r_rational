...
* URL: https://www.fanfiction.net/s/12863641/4/The-Optimised-Wish-Project
* Score: 42

* Created: 2018-04-08T10:57:30
...
> **u/Noumero** [+14]  *Self-Appointed Court Statistician* (53 minutes later)
> 
...
>>> 
>>> [Microwave ](#s "Would that be a good idea? If there's no signatures, they could use that as their bargaining chip: "you can't kill us if you ever want to find the Dragon Balls". Absence of anything on the radars would confirm their words, and probably look unsettling. But if there's any signature, even a fake one, they could be just not believed and killed before they could prove it. I suppose they could have brought a fake signature in the castle...")

>>>> **u/Silver_Swift** [+1]  (a day later)
>>>> 
>>>> [More microwave!](#s "If they stashed the dragonballs in the wilderness they would have to be carrying the fake signature generator with them. Otherwise Pilaf and co. could take one look at their dragon radar and realize the bag of tennis balls was a bluff.")
>>>> 
>>>> Edit with a [separate microwave](#s "Carrying the fake signal is still a risk, as Mai could have killed Bulma thinking she could just search her body for the capsule with the dragonballs, but then I also don't think Bulma is sufficiently aware of her own mortality and is relying too much on Goku to keep her safe.") (because long spoilers are annoying to read)
...
>>> 
>>> [chapter 4](#s " Just me complaining. ;-) And she shouldn't because I misread something. Hiding the signal would be the first priority and then moving (Maybe leaving one dragon ball behind). So I thought she couldn't have time to make a fake signal, since they got invited into the castle immediately. (I didn't understand they only got an invitation for dinner.) Personally, I also don't like Gadgeteers building stuff too fast and with the first try. But all that is *just me complaining* about minor stuff, so I can complain ;-).")
>>> 
>>> [chapter 3](#s " Which would be okay, but his actions are stupid *and counterproductive* in this case. RGoku did always think before he acts. And always rationalize good behavior. I would understand him killing someone pointing a gun at Bulma. He could have killed Mai and regretting it later, and I wouldn't care about it. But the Rabbit Boss should have been knocked out. Goku being smarter than RGoku is just wrong. And honestly, the fight wasn't stressing him or pushing him.Also, this complain is more serious. Just show that RGoku is still Saijan brainwashed somehow different. Like killing Mai, or the Ox-King. Or Oolong. Or destroying stuff. Or breaking the legs of Rabbit Boss. Or killing Rabbit Boss after he turned Bulma back.")
>>> 
>>> [new prediction 80%](#s " RGoku will use his stick of insta kill on Piccolo. And that probably will not work.")
...
>>>> 
>>>> Also [about magic](#s " I'm not sure about whether him being knocked out cold would/should have worked. Knocked out isn't as unconscious as dead, there's still some part of the brain that's working, and we don't know at what level does magic connect to all this.").

>>>>> **u/None** [+1]  (3 days later)
>>>>> 
>>>>> [Magic](#s " Oh, sorry the misunderstanding. I didn't mean knocking him out should have worked. I meant RGoku should have tried knocking him out first. Then rescue the carrot (If Bulma didn't change back) and force the rabbit to free her (aka breaking some legs). If he has to kill the rabbit, so be it. But if killing doesn't work, it would prevent trying out other options.")
