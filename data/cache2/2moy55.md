...
* Author: u/ianstlawrence *
* URL: https://www.reddit.com/r/rational/comments/2moy55/the_olympics_create_geniuses_can_we_use_this/
* Score: 6

* Created: 2014-11-18T19:27:59
...
>>> **u/firstgunman** [+3]  (10 hours later)
>>> 
...
>>> **u/qznc** [+0]  *Chaos Legion* (a day later)
>>> 
>>> The problem with chess is that it most certainly can be solved optimally. We don't have the compute power yet, though. You can observe that it is increasingly about memorizing openings and endings. Instead we should look for [mixed solution games](http://www.sirlin.net/articles/solvability).
