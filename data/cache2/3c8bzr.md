...
* Author: u/eaglejarl *
* URL: https://www.fanfiction.net/s/11087425/13/Team-Anko
* Score: 24

* Created: 2015-07-05T21:12:17
...
>>> **u/eaglejarl** [+1] *
>>> 
>>> Naruto/Sasuke?  I assume Sasuke walks around in [leather pants](http://tvtropes.org/pmwiki/pmwiki.php/Main/DracoInLeatherPants)?
...
>>>> **u/ATRDCI** [+1] *
>>>> 
>>>> I assure you, Naruto/Sasuke is at the very [tip of the iceberg] (https://www.fanfiction.net/s/3096379/1/First-Encounter) as far as pairings go
>>>> 
...
>>>> You should probably be aware of what I (just now) said in an [earlier comment](https://www.reddit.com/r/rational/comments/3c8bzr/ffrst_team_anko_chapter_13/csuysju).
>>>> 
...
>>> **u/IomKg** [+1] *
>>> 
>>> I thought that it might be problematic, but I figured this falls into the "wise reading" mentioned on the right so I wrote it anyway..
>>> If I'll have time I might try figuring out what exactly bothered me in it..
>>> 
...
>>>>>>>>>>>> That said, take a look at [Kurama's entry on the wiki](http://naruto.wikia.com/wiki/Kurama) and see if you can spot it.
>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>>> **u/avret** [+1]  *SDHS rationalist**
>>>>>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>>>>>> he is...certainly not somebody I'd emulate.
>>>>>>>>>>>>>>>>>>> EDIT:  he's not a soldier(I don't think), just someone with a good deal of MMA training
>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>> **u/eaglejarl** [+1] *
>>>>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>>>>> Nope. I try not to do spoilers, but I'll just tell you rather than driving you nuts with guessing games. It's [this bit ](#s "appearing suddenly out of nowhere to attack areas that have been breeding grounds for the darkest aspects of human nature.")
>>>>>>>>>>>>>>>>>> 
