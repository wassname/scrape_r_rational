...
* URL: https://www.reddit.com/r/rational/comments/26xfxi/selfindulgent_selfinsert_ratfic_first_book/
* Score: 11

* Created: 2014-05-31T02:42:48

### Post:

I've just finished my first draft over at [GDocs](https://docs.google.com/document/d/1AU8o3wSAiufh-Eg1FtL-6656dNvbCFILCi2GbeESsb4/edit?usp=sharing). After writing over 4,000 words a day for over a week, I'm going to take a break for a day or two (there's a new Harry Dresden novel out) before I start on the next arc.
...
> **u/7149** [+7]  (2 days later)
> 
> I'm going to try [wise reading](http://www.reddit.com/r/rational/comments/1w4llw/by_request_two_kinds_of_involved_responses_to/) while reading this.
> 
...
>> **u/DataPacRat** [+2]  *Amateur Immortalist* (22 hours later)
>> 
>> I've got datapacrat.com under my dominion, so I can stick any custom HTML pages I desire there. (And occasionally do, such as a page describing a [Completely Useless Calendar](http://www.datapacrat.com/calendar/).)
...
>>>>>> 
>>>>>> As for what to make it look like, I do have one bookmark I archived for if-and-when I ever did get around to trying to formatting text to look non-awful: [Butterick's Practical Typography](http://practicaltypography.com/). The points in the [summary](http://practicaltypography.com/summary-of-key-rules.html) seem to be at least as good an approach as any other I've found.
...
> 
> [Book Two](https://docs.google.com/document/d/17xCeMCTkTYih3kYexWZ3zuI5MWWab1TArfUfoMqpkLo/edit?usp=sharing) has been started. Well, technically - 250-ish words to get my typing fingers back into the groove, provide a minor bit of recap, and allow me the luxury of being pointlessly verbose about fire in a way that's nearly totally unrelated to the plot. :)
