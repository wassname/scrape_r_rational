...
* URL: https://www.reddit.com/r/rational/comments/63mxkf/monthly_recommendation_thread/
* Score: 40

* Created: 2017-04-05T17:16:17
...
> **u/Afforess** [+33]  *Hermione Did Nothing Wrong**
> 
...
> [The Wandering Inn](https://royalroadl.com/fiction/10073) - Follows a girl from Earth mysteriously dropped into a fantasy world with no special abilities. Barely survives and gains a job as an innkeeper in a burned out village. It's quite good, albeit a bit slower paced.
> 
...
> **u/lsparrish** [+11] *
> 
> [People Watching](https://www.youtube.com/playlist?list=PL_saLI-LH-VrxFpFgk467Jn02i46arTyD) is extremely good. Explores themes of depression, identity, death, relationships, and so on from a comical yet mature and thoughtful perspective.
> 
...
>>> [Henry spoilers](#s " For example, the most annoying part to me was that the time travel, timelines, and how Ouroborans are born didn't make sense from the perspective of the Chronus Club. The whole issue was that 'someone' was causing the world to end sooner and thus Chronus Club members were not being born(i.e. dying). This was a huge deal, but nobody even cared that other Ouroborans were being born/not being born because of the regular choices that every member makes. They thought, as long as you don't try to advance technology, no problem, you can have 100 children, or none at all in every life. And those 'small' choices, affected nothing, which was ridiculous to think. It discounted an incredibly reasonable line of thought just to make the story work. And Ouroborans weren't the rarest things on Earth, any one of the club members could have had a child in one life that was an Ouroboran, but nobody ever found out because they decided not to have that child in a future life.")
>>> 

>>>> **u/Anderkent** [+1] *
>>>> 
>>>> [Moar spoilers](#s " I don't think 'minor things affect nothing' is the only reasonable motivation for the rules of the Chronus Club. It's not possible to have a rule whereas every Ouroboran must live their life in exactly the same way each time. No one would follow that rule. Thus, practical compromises must be made - do not intentionally upset the grand order of history; do not intentionally prevent ouroborans from being born.")
>>>> [](#s "But you make each member responsible for every accidental grandfather paradox. There's no point to it, either - even if they all tried to live exactly the same lives, it wouldn't work out - not all of them have perfect memory.")
>>>> [](#s "It's not that the small choices affect nothing; it's more likely that you can't know what they affected. In one timeline you have sex with person X, in another you don't. Twenty generations later in the first timeline an ouroboran is born to descendants of that union; in the second the don't exist. Someone might remember them, but who can connect the two facts causally?")
>>>> 

>>>> **u/Revisional_Sin** [+1] *
>>>> 
>>>> I know it's a bug, not a feature, but I was able to accept [Worldbuilding](#s " the stability of the Cronus club as a fact of worldbuilding and enjoyed thinking about the cause.")
>>>> [Worldbuilding](#s 
>>>> " Maybe they are more resistant to being rippled out of time? Do they exhibit some kind of anchoring effect on the timeline? Is that why they exist? But why would you need this anchoring effect if you don't have oreos in the first place?")
>>>> 

>>> **u/Anderkent** [+1] *
>>> 
>>> [Henry spoilers](#s " But the negative externalities - primarily the premature end of the world, and the end of the ouroboron society - are tightly tied to the goal that the antagonist is pursuing! Hubris ('You are playing with powers you don't understand') is a very fitting charge, and the cause of the disaster. Present-time concerns are hardly significant compared to the risk of ending the word prematurely, or possibly destroying the mechanism by which ouroborons are reborn.")
...
> **u/Tomas_Votava** [+6] *
> 
> I found a story called [infrastructure](https://forums.spacebattles.com/threads/infrastructure-an-illustrated-original-work.209283/) that despite the amount of work that goes into it doesn't receive that much attention. it updates every few months and is guaranteed to have some pictures. the art isn't that good but you can see the work that goes into it.
...
> [You can watch the entire thing here, on YouTube.](https://www.youtube.com/playlist?list=PLf-9CurfzeAHBg-zG3JbAsRH1otqDBHQj)
...
>>> **u/ElizabethRobinThales** [+1]  *Practically Perfect in Every Way**
>>> 
>>> I found the [spoiler](#s "stay in the present and allow the tornado to destroy the town and kill literally every other character in the game") ending to be lacking depth, like they just made up whatever just so they could offer players a choice at the end. I was disappointed in that ending.
>>> I found the "true" ending, where you choose to [spoiler](#s "go back to when it all started and allow Chloe to die"), to be narratively satisfying. It felt like the inevitable result of an internally consistent chain of causality, like this was what the story had been leading up to the entire time and that there was no other way the story could resolve.
...
>>>> **u/Murska1FIN** [+2] *
>>>> 
>>>> I did like the game as a whole, much of the dialogue and such was very good, but as is common with these kinds of games
>>>> [Spoiler](#s "the choices given in the game tend to end up feeling rather meaningless when the plot draws you to the same path every time regardless.")
>>>> Specifically for Life is Strange's ending, 
>>>> [Spoiler](#s "The 'kill everyone for Chloe' ending is just bad and makes no sense, but having to go back and undo literally everything I did during the entire game kind of made everything I had do feel rather pointless. Why was Max even given the power if there was nothing that could be done with it anyway? I found the whole thing about saving Chloe's dad ending up with her paralyzed a more interesting, if still somewhat contrived thing.")
>>>> [Spoiler](#s "I'd have been more satisfied with having the choice to have Max sacrifice herself for some suitable purpose like Chloe or Arcadia Bay or the sum total of her beneficial changes so far, since there were plenty of indications that using her power was causing her brain damage. That'd have made sense within the game's context, to me. The ending the game had just felt like it was trying to give me the message that 'you can't change the past', but the whole premise of the game was being given the power to change the past.")
>>>> [Spoiler](#s "In fact, what I would've found a truly beautiful way to write the game would've been that Max's mind is her limit, that every use of the power damages her more until at some point if she doesn't stop using it she'll fall into a coma or die. And then if you waste your power on frivolous uses like finding out the right words to say to people to make them like you, you'll find out later on that that's away from using it to change truly important things. In the end, you have to choose whether you are willing to give yourself the right to some selfishness, by shelving the power for good when you're close to your limit, or whether you believe you have to spend everything of yourself to help as many people as you can, for as long as you can. All made more difficult by not knowing your exact limits. I'd like to believe if I were given that choice in reality I would choose the latter, but given my actual true behaviour where I do not sacrifice as much of myself as I could for others I expect I would choose the former. And /this/ is the choice that I would want the game to make people consider.")
>>>> 
...
>>>>>>>>> That sounds a lot like the game, though. How many times does [Spoiler](#s " Chloe get killed") over the course of the game? You said it yourself, we spend the entire game fighting against said inevitability.
>>>>>>>>> 
...
>>>>>>>>>>> **u/ElizabethRobinThales** [+1]  *Practically Perfect in Every Way**
>>>>>>>>>>> 
>>>>>>>>>>> But that's precisely why I found the ending to be narratively satisfying. [Spoiler.](#s "Max saw Chloe get killed at the beginning and felt a strong impulse of wanting that to have not happened, so magically/supernaturally she got the ability to rewind time. The entire game is fighting against the universe as it attempts to restore balance. You had this ability and you shouldn't have had it; think about the scene near the end with the other Max in the diner. 'You had this ability, and in the end the result is exactly the same as if you'd never had it, never started the game and made any choices at all. Nothing you did had any lasting impact or meaning.' That's simply not true. Max hadn't seen Chloe in years, Rachel Amber wouldn't've been found, Jefferson wouldn'tve been found out. Etcetera.")
>>>>>>>>>>> 

>>>>>>>>>>>> **u/Murska1FIN** [+1] *
>>>>>>>>>>>> 
>>>>>>>>>>>> I've seen two possibilities as to that. 
>>>>>>>>>>>> [Spoiler](#s "Either everything is undone, so everything goes exactly as if Max hadn't ever changed anything (Amber is found, Jefferson is caught, etc. etc.) which is what seems to happen if we go according to the ruleset the game has shown us so far (Max post-bathroom but pre-ending shouldn't have memories of altered timelines) - already mentioned as pretty pointless - or Max can literally change everything else (like saving Kate's life) but not Chloe's death, which seems to me like the universe has a rather strange hate-on for Chloe and makes no real sense either way.")
...
>>>> **u/None** [+1] *
>>>> 
>>>> The [spoiler](#s "sacrifice Chloe ending") was definitely much better satisfying story-wise. However, there were a few problems with it:
>>>> [spoiler](#s "My first reaction when presented the choice was, so you want me to use time travel to fix the mess time travel caused? No, I think I'll stop any time travel whatsoever, right this moment. It's not like all time travel effects would be erased either. After all, picture-travel results in Max that, after the point when she looked at the picture, has the memory of original-version Max, so she'd still remember everything learned through time travel.")
>>>> 

>>>>> **u/ElizabethRobinThales** [+1]  *Practically Perfect in Every Way**
>>>>> 
>>>>> That's the thing, this isn't a "rational" story. The [spoiler](#s "time travel") isn't scientific, it's magical/supernatural; it didn't really cause the mess, it was "magically" caused by the inciting incident in the bathroom, and the rest of the story is the universe trying to restore balance and put things back the way they're supposed to be. Or something.
>>>>> 
...
> 
> *[I, Claudius](https://www.goodreads.com/book/show/18765)* and *[Claudius the God](https://www.goodreads.com/book/show/52251)*, which compose a two-part fictional autobiography of [Emperor Claudius of Rome](https://en.wikipedia.org/wiki/Claudius), are fairly fun to read (though rather dry at times, as must be expected from books published in the 1930s).
> *[Cold Waters](https://www.fanfiction.net/s/10917624)* (7k words, complete): A Hyuuga bastard is born far away from the Village Hidden in the Leaves.
> *[Rewritten](https://www.fanfiction.net/s/7040809)* (45k words, dead): Eragon rewinds to when he found Saphira's egg.
> *[Guy Fawkes Day](https://www.fanfiction.net/s/4081448)* (3k words, complete): Harry puts a Bag of Holding into a Portable Hole--several hundred times over.
> 

> **u/GaBeRockKing** [+3]  *Horizon Breach: http://archiveofourown.org/works/6785857**
> 
> So normally I actively avoid deadfics, to the point where I regularly remove fics I liked and followed from my bookmarks because they haven't gotten updated in a few months. However, there's one fic I read in particular despite the fact that it was dead, because it was just so good. That being, [Equestion: Total War](https://www.fimfiction.net/story/2354/equestria-total-war). If you can't tell from the name, it's an MLP:FiM fic. It's a fascinating depiction of warfare, and I'm just a sucker for darkfics that come from a really lighthearted canon, so long as those darkfics respect the original work.
> 
...
> [The Uncanny Valley](https://www.amazon.com/Uncanny-Valley-Tales-Lost-Chronicles/dp/149485287X) is a very entertaining anthology of simple horror stories. Normally I only go for psychological and cosmic horror whereas this book leans more towards goofy ghost stories for children, but what sells it for me is the extremely tight pacing. Not one of these stories beats around the bush, the author knows how simple and straightforward these tales are so they all get right to the point without leading you on. 
...
> [K-On!](https://myanimelist.net/anime/5680/K-On) (first season) is definitely not for everyone, but for someone who needed something mindless to calm me down it was perfect. It exists purely to show cute anime girls hanging out and having a good time, with very little emotional or intellectual depth, but it's well executed for what it is. The animation is excellently directed with a surprising amount of visual storytelling, the characters are charming, the writing consistently made me smile or chuckle, and what little plot there is has good pacing.
> 

> **u/xamueljones** [+2]  *My arch-enemy is entropy**
> 
> [Changeling Space Program](https://www.fimfiction.net/story/327551/changeling-space-program) (My Little Pony) - the changelings are attempting to be the first on the moon. It has realistic depictions of rocket research and the author is basing the characters' progress on his ability to build a rocket on the Kerbal space game. It's a great read and hilarious. But the updates are on the order of months in between.
> [Replay](https://www.amazon.com/Replay-Ken-Grimwood/dp/068816112X) (Original) - it involves a man repeating his life with the repeats getting closer to his death date each time. It's not what I consider rational in the character's investigation and use of the power, but his emotional struggles were very vivid and well written.
> [The Red Knight](https://www.fanfiction.net/s/12141684/1/The-Red-Knight) (Harry Potter) - A great story where Ron goes back in time to his birth, but the world he is reborn into is an AU so he has no idea of what to expect from the future.
> [Forged Destiny](https://www.fanfiction.net/s/12044591/1/Forged-Destiny) (RWBY) - It's a re-imagining of RWBY as an RPG-like world where everyone is a gamer character and the plot of RWBY is dramatically different as a result. I would recommend anything written by [Couer Al'aran](https://www.fanfiction.net/u/6272865/Coeur-Al-Aran). He's a *brilliant* writer.
> [Auburn](https://www.fanfiction.net/s/12326784/1/Auburn) (RWBY) - RWBY with Jaune, Weiss, Blake, and Ruby on a team together. The author [Super Saiyan Syndaquil](https://www.fanfiction.net/u/6098148/Super-Saiyan-Cyndaquil) has written some other good fanfics, but Auburn's my favorite.
> 
...
>>> * [Super Saiyan Cyndaquil](https://www.fanfiction.net/u/6098148/Super-Saiyan-Cyndaquil) - Very RWBY focused
>>> * [Tsume Yuki](https://www.fanfiction.net/u/2221413/Tsume-Yuki) - Mostly her most recent story, Tell it to the Marines, is what I'm drawn to.
>>> 
...
>> 
>> My favourite Bleach fanfic is ... not really rationalist in any way, and I really can't make an unqualified recommendation of it. I am totally aware that it will not be everyone's cup of tea. [Walk Two Lifetimes](https://www.fanfiction.net/s/10572048/1/Walk-Two-Lifetimes) is a SI type of thing with a fairly Mary-Sue-ish main character, like unto such Naruto fics as Dreaming of Sunshine; Inasmuch as it has a plot and tension, it is mostly a romance story. A revised version of the canon Hisana / Byakuya romance is the center of the story. The story goes through some severe tonal changes as the story progresses, starting pretty dark and gritty and moving towards light and wholesomeness and comedy. It's got pretty good writing overall, though. 
>> In a similar boat is Tozette's [Four Body Problem](http://archiveofourown.org/works/8748340/chapters/20054959) where everyone has PTSD from an endless and terrible war, and then a core part of the cast is sent back in time from a dystopic future to the start of Bleach with their mental issues but also their abilities. Then a bunch of comedy, healing, etc occur, with a side order of slightly ambiguous gay romance stuff. Again, *definitely* not something that will be everyone's cup of tea. Again, not particularly rationalist. 
>> I also liked comedy crossover fic [There May Be Some Collateral Damage](http://archiveofourown.org/works/5030443/chapters/11562568) - a HP/Bleach cross where Ichigo ends up guarding Harry Potter. It's basically pure humor/crack, but I enjoyed it a lot without taking it at all seriously.
>> 
...
>> One Piece
>> * [But Mom I Don't wanna be a Pirate](https://forums.spacebattles.com/threads/but-mom-i-dont-wanna-be-a-pirate-rewrite-one-piece-si.355474/)
>> * [New Game Plus](https://www.fanfiction.net/s/10415350/1/New-Game-Plus)
>> * [Twelve Red Lines](https://www.fanfiction.net/s/12318087/1/Twelve-Red-Lines)
>> * [This Bites!](https://forums.spacebattles.com/threads/this-bites-one-piece-si.356819/) - Tv Tropes [page](http://tvtropes.org/pmwiki/pmwiki.php/Fanfic/ThisBites) (with helpful links to read this fanfic on a site that's not SB)
...
>> EDIT: I completely forgot about this Bleach fanfic, [A Destiny of Strife](https://forums.sufficientvelocity.com/threads/a-destiny-of-strife-a-hollows-quest-bleach.29076/). It's a quest where the players control a Hollow and there's very little overlap with the canon events of Bleach (even though they are still happening) which is why it sometimes feels like an original work. It's very far along with a very rapid update pace.
>> 
...
>>>>>> 
>>>>>> As a fan of Hellsing Abridged I recommend [The Seventh Horcrux](https://www.fanfiction.net/s/10677106/1/Seventh-Horcrux).  Sorry I don't know about any hellsing fics but this has the same kind of abridged humor.
>>>>>> 
...
> 
> Undertale fics:
> [All We Left Unsaid](http://archiveofourown.org/works/8551069/chapters/19604944) - [](#s "Post-genocide; the fallen human gives up at the judgement hall, leaving Flowey, Sans, and the rest of the underground to pick up the pieces of their mistakes.")
> 
