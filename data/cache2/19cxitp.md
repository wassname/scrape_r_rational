...
* URL: https://www.reddit.com/r/rational/comments/19cxitp/d_monday_request_and_recommendation_thread/
* Score: 26

* Created: 2024-01-22T15:00:13
...
> **u/_brightwing** [+23]  *Feathered menace* (10 hours later)
> 
...
>>> 
>>> Some people have a totally opposite take on it though, where they think the beginning is a slog, and it gets good later. 
>>> 
>>> Johnny Sims is a great voice actor though, fully agree.

>>>> **u/Lemerney2** [+1]  (3 days later)
>>>> 
>>>> I think the overarching story is really amazing and hits its peak in seasons 4 and 5, but I understand wanting more of the earlier standalone format. I'm lucky I enjoy both. 
>>>> 
>>>> They even (BIG SPOILERS Season 5) >!Do the most interesting thing imaginable and have the protagonists actually fail and end the world, after it's revealed the entire series has been a big set up by the big bad. Then they spent the whole of Season 5 desperately trying to reverse the apocalypse where everyone is in their own person hell/fear dimension, and it all hinges on an insanely complicated moral dilema that's very well explored. And even though they do manage to revert the fearpocalypse, *everyone on Earth* remembers what happened and is insanely traumatised!<
>>>> 
>>>> Overall, it's a great horror story, and an excellent deconstruction of what's the moral thing to do when your only options are Villain or Victim, and a further investigation on how to be moral when you're caught in an immoral system that's borderline impossible to escape.

>>> **u/Amonwilde** [+1]  (2 days later)
>>> 
>>> How is it? Still working my way through the Magnus Archive. I only listen on winter evenings.

>>>> **u/Lemerney2** [+2]  (2 days later)
>>>> 
>>>> I've only listened to the first two episodes so far. I'm a little bit less of a fan of the setting so far, but it sounds like they're setting up for a really cool myth arc with the connections to the first series, so I'm excited.

>>>>> **u/Amonwilde** [+1]  (3 days later)
>>>>> 
>>>>> OK. At this rate I'll probably listen in 2027 or something. :)

>> **u/CodexesEverywhere** [+1]  (3 days later)
>> 
>> I enjoyed it somewhat, but it's barely a game (it's a cyoa with no seemingly no stats and barely any variables beyond what story node you are on). 
>> 
>> There's some good stuff in there that made me doubt my loosely held in-game convictions, but I wouldn't call it incredible.

> **u/Tiraon** [+12]  (4 hours later)
> 
...
>> 
>> He has a couple of other books that are broadly similar. *Kill Decision* is about drones, *Change Agent* has a lot of biotech stuff, and *Influx* is probably a bit outside what you're looking for but is basically "what if the government was secretly suppressing science fiction technology".

> **u/Tell31** [+6]  *A Practical Guide to Evil* (a day later)
> 
...
>> **u/Relevant_Occasion_33** [+9]  (a day later)
>> 
...
>> **u/ThePhrastusBombastus** [+5]  (3 days later)
>> 
...
>> **u/Do_Not_Go_In_There** [+4]  (4 days later)
>> 
...
> **u/UnrealPixels** [+5]  (10 hours later)
> 
...
>> **u/goodnightclay** [+5]  (12 hours later)
>> 
...
>>> **u/iemfi** [+1]  (4 days later)
>>> 
>>> Surprisingly good. Reminds me a little of the cradle series somehow, but without all the bits you have to skip through...

>> **u/N0_B1g_De4l** [+3]  (a day later)
>> 
...
>> **u/AnotherShadowBan** [+3]  (17 hours later)
>> 
...
>> 
>> If you're looking to get into it, maybe... read any of the 300+ official books instead of "what if Space Marines were My Little Ponies?"
>> 
>> Here's a couple of decent articles with suggestions:
>> 
>> https://fanfiaddict.com/so-you-want-to-start-reading-warhammer-40000-heres-where-to-start/
>> 
>> https://www.grimdarkmagazine.com/warhammer-40k-where-to-start-reading/

>> **u/CodexesEverywhere** [+1]  (16 hours later)
>> 
>> Can't speak to how much canon knowledge is required (canon is overrated in 40k anyway), but I recommend [https://forums.spacebattles.com/threads/hope-and-silence-in-the-hive-warhammer-40k-complete.583942/](https://forums.spacebattles.com/threads/hope-and-silence-in-the-hive-warhammer-40k-complete.583942/) . It's about a daemon of hope that gets spawned when a latent psyker in the underhive has an accident (don't worry too much if half the words in this sentence are meaningless to you. The daemon is just as confused).

> **u/Sevens3th** [+2]  (5 days later)
> 
...
>> **u/ahasuerus_isfdb** [+39]  (3 hours later)
>> 
...
>>> **u/viewlesspath** [+6]  (4 hours later)
>>> 
