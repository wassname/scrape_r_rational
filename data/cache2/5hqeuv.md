...
* URL: https://www.reddit.com/r/rational/comments/5hqeuv/d_sunday_writing_skills_thread/
* Score: 26

* Created: 2016-12-11T15:01:07
...
> 
> **Fiddling with [Extracts](https://docs.google.com/document/d/1jPU6QKEohcrw6l6O3SxorIxf2Tnq54h36LtQO6Qv86w/edit)**
...
> **Title**. "Extracts" was good enough for a working title during NaNoWriMo, but doesn't have anything in particular to do with what the story's turned into. The main theme seems to have become something like "I work at being [Crazy Prepared](http://tvtropes.org/pmwiki/pmwiki.php/Main/CrazyPrepared), and you the reader can do it too! And it's worth it!" (In particular, our protagonist only survives due to making backup copies of himself, which carry on when the original snuffs it.) Do any bits of phrasing come to mind?
> **Cover**. At one point, my protagonist ends up with the physical form of many dozens of rats. I'm thinking of finding a Creative Commons image of a line-drawing of a reasonably nice-looking rat (as a starting point, maybe [this one](https://pixabay.com/en/mouse-rodent-animal-mammal-rat-311396/)), and tiling that image across the cover. (Well, maybe paying a couple of bucks for an actual graphic-focused person to do the manipulation.) Have any better ideas?
...
>>> (Insert "I knew Weir back when he was doing a [webcomic](http://www.galactanet.com/comic/view.php?strip=1) on mad science" hipsterism here.)
>>> > programming joke
>>> My first thought at reading that is 'The Journal File', referencing [The Jargon File](http://www.catb.org/jargon/html/), which is at least an idea I haven't come up with before.
>>> 
...
> Probably the best example of me *trying* to do that is [chapter 19 of Horizon Breach](https://www.fanfiction.net/s/11936165/19/Horizon-Breach) because I flip between a number of viewpoints, but I still have this overly academic vocabulary throught.
...
> Over in this week's [Worldbuilding](https://www.reddit.com/r/rational/comments/5ib10o/d_wednesday_worldbuilding_thread/) thread, I've pasted some notes I've jotted down on the setting for [Extracts](https://docs.google.com/document/d/1jPU6QKEohcrw6l6O3SxorIxf2Tnq54h36LtQO6Qv86w/edit), in the form of part of a journal entry of my protagonist. The whole story is in the form of such entries; and at the moment, I'm wondering how to avoid infodump syndrome, or whether I should even try. I honestly haven't decided how many of the described details are going to be relevant to my protagonist's forthcoming shenanigans, as he tries to leverage various aspects of the world he finds himself in to accomplish his goals. So should I just leave the whole thing in now, and be ready to trim out anything that turns out to be excessively irrelevant by the story's conclusion? Should I move pretty much the whole entry to the authour's notes that won't be part of the story proper? Should I try something completely different?
...
> 
> > prosidy
> [\*prosody](https://en.wiktionary.org/wiki/prosody#English)
> > Considering issues outside the story's plain text, such as titles, cover design, included imagery, or typography?
> I recently stumbled across [this fascinating discussion](https://eegg.wordpress.com/2010/01/25/page-margins-in-principle-and-practice/) of ideal margin sizes for books. [The Wikipedia page](https://en.wikipedia.org/wiki/Canons_of_page_construction) also is rather interesting.
> 
...
>> For some other margin suggestions, I found Butterick's [Practical](http://practicaltypography.com/) [Typography](http://practicaltypography.com/summary-of-key-rules.html) pages handy, such as his thoughts on [margins](http://practicaltypography.com/).
>> 

>>> **u/ToaKraka** [+1]  *https://i.imgur.com/OQGHleQ.png**
>>> 
>>> > digital's infinite canvas
>>> Margins still must be considered in [PDF files](http://www.sjgames.com/gurps/), and I assume that Javascript could allow even [an HTML page](http://luminous.elcenia.com/all.shtml) to have dynamic margins based on the window size.
>>> 
...
>>>> Actually, you don't even need Javascript, or even CSS, just a bit of HTML. For example, in my page for [Weirdtopia](http://www.datapacrat.com/weirdtopia/index.html), I try to keep the line-lengths be roughly a certain number of characters wide, but still adapt to a wide variety of window sizes with this HTML:
...
>>>>> 
>>>>> > Oddly, GURPS is one of the only sources I still enjoy getting PDF files of, as opposed to non-fixed-text Epubs or the like.
>>>>> I had [some fun](http://i.imgur.com/0HwhYMA.png) a few months ago with manually converting *[Low-Tech](http://www.sjgames.com/gurps/books/low-tech/)* to HTML, but it got boring pretty quickly.
