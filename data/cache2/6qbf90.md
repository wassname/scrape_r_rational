...
* URL: https://www.reddit.com/r/rational/comments/6qbf90/d_saturday_munchkinry_thread/
* Score: 13

* Created: 2017-07-29T15:06:57
...
> **u/cthulhuraejepsen** [+10]  *Fruit flies like a banana* (2 hours later)
> 
...
>>> **u/eternal-potato** [+7]  *he who vegetates* (6 hours later)
>>> 
...
>>>>>>> **u/cthulhuraejepsen** [+2]  *Fruit flies like a banana* (6 hours later)
>>>>>>> 
>>>>>>> That works wonderfully, thank you.

>>>>>>>> **u/eternal-potato** [+1]  *he who vegetates* (6 hours later)
>>>>>>>> 
>>>>>>>> Thank _you_. _Worth the Candle_ is wonderful so far.
...
>>> * The busiest airport in Wichita is [ICT](https://en.wikipedia.org/wiki/Wichita_Dwight_D._Eisenhower_National_Airport) with **1.6 million passengers** per year. The busiest airport in Armenia is [EVN](https://en.wikipedia.org/wiki/Zvartnots_International_Airport) with **2.1 million passengers** per year. The busiest airport in Albania is [TIA](https://en.wikipedia.org/wiki/Tirana_International_Airport_N%C3%ABn%C3%AB_Tereza) with **2.2 million passengers**.
...
>>>> 
>>>> I worked those same numbers for the throughput. The US serves more than the year's teleport key passenger number *daily*, according to the [FAA](https://www.faa.gov/air_traffic/by_the_numbers/).
>>>> 
...
>>> **u/Daneels_Soul** [+1]  (5 hours later)
>>> 
...
>> **u/Hard_Avid_Sir** [+2]  (19 hours later)
>> 
...
>> 
>>  - siphon economic flows to acquire such anti-precog/precog stealth resources (tech or people) as are available and boot the self-replicating droid factories (the droids will _not_ have single point of failure control ships)
>> 
