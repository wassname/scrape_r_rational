...
* URL: https://heroessavetheworld.wordpress.com/2016/09/27/big-change-ch-7-simon-martin/
* Score: 13

* Created: 2016-09-27T06:52:04
...
> **u/callmebrotherg** [+2]  *now posting as /u/callmesalticidae* (51 seconds later)
> 
...
>>> > "stable timeloops"
>>> 
>>> "Visions can't be changed" implies stable _something_.
>>> 
...
>>> 
>>> Why would that terminate the loop? All that'll happen is that you won't get a message from any people who live longer than that. Alternatively, they can just arrange for them to say that Simon died. And yes, _Branches_ is great but it assumes a mutable future. All I'm saying is either the future is mutable or it's not; even if having a vision _forces_ the future to become immutable that still means you don't get to pick your message like this, you just get the first one that's stable because it _makes_ itself stable.
...
>>>>> **u/CreationBlues** [+8]  (20 hours later)
>>>>> 
...
>>>>>>> 
>>>>>>> [spoilers](#s "The details are more complicated, but it wouldn't be wrong to say that his power has a broadcasting component to it as well: if there is no vision to receive, then the power stops receiving *at all.* Instead, when the target dies, the power records and transmits the vision back into the past. Original Timeline Simon never got anything out of his powers, and for a long time probably thought that he was just going crazy.")
>>>>>>> 
...
>>>>>>>> 
>>>>>>>> Oh, so [visions](#s " once a vision is received, it becomes, in Who parlance, a "fixed point" that cannot be changed? Ie. visions are one-shot self-fulfilling? Meaning, visions cannot be changed but they can be created? In which case, the 'pass messages back in time' hack should work as long as you have enough bodies.")
>>>>>>>> 
