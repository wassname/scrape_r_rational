...
* URL: https://www.reddit.com/r/rational/comments/1xu1zn/d_romance_in_rationalist_fiction/
* Score: 12

* Created: 2014-02-13T20:53:51
...
> **u/alexanderwales** [+15]  *Time flies like an arrow* (25 minutes later)
> 
...
>> **u/trifith** [+13]  *Man plans, god laughs. Like the ant and the grasshopper.* (an hour later)
>> 
>> > Clear communication
>> 
...
>>>> **u/PeridexisErrant** [+4]  *put aside fear for courage, and death for life* (5 hours later)
>>>> 
...
>>>> **u/Izeinwinter** [+4]  (14 days later)
>>>> 
>>>> Easy. 
>>>> Step one : Laverne - being moderately bright, but a shining exemplar of the rationalist virtues of Luminosity, Conscientiousness and Honesty is very good at monogamy. Over 130 years she marries trice, all three unions ending in the untimely demise and subsequent freezing of her spouse. (Traffic, War, lab accident) 
>>>> Step two: The march of progress finally achieves the grail of resurrection of the frozen. 
>>>> Step Three: Drama.

>> **u/EliezerYudkowsky** [+10]  *Godric Gryffindor* (2 days later)
>> 
...
>>> **u/DeliaEris** [+5]  *Fully General Idealist* (3 days later)
>>> 
...
>>>> **u/OffColorCommentary** [+4]  (3 days later)
>>>> 
...
>>>>>>> **u/alexanderwales** [+5]  *Time flies like an arrow* (3 days later)
>>>>>>> 
...
> **u/Suitov** [+6]  *The Culture* (19 hours later)
> 
...
> * Luminosity's Bella and Edward. Not interesting, to me, for romance's sake alone. Interesting because of the worldbuildy predestiny soulmates thing, which turned out to be minorly exploitable [later in the story](#s " when they deliberately showed a mugshot of a kidnapped vampire to a bunch of unattached vampires, *with the intention* of one of them bonding to her and thus persuading her to leave her current situation. Also exploitable because soulbondy pairings turn out to be immune to other relationship-affecting powers.")
> * Got more examples? Feel free to add them in a reply! I can't think of any at the moment.

>> **u/derefr** [+5]  (23 hours later)
>> 
...
>> 
>> [The other Bells](http://edgeofyourseat.dreamwidth.org/2121.html) (who seem to have rather more fun) at some point describe Luminosity!Bella as using Edward as "a glorified thought radio" (and thereby, likely, a firewalled container for moral agency, relieving her of the Bad Feelings she'd get from *choosing* to invade other people's minds herself.) Not too romantic, that.

>>> **u/LuminousAlicorn** [+4]  (5 days later)
>>> 
>>> [Effulgence] (#s "I have plans to do some Bell/Edward relationships that I think will show off the virtues of the pairing to better effect in forthcoming Effulgence universes.  (The Animorphs verse is going to have an Edward, too, but in that one the pairing isn't overwhelmingly likely for various reasons having to do with setting details.)")  The way Bells interpret each other's relationships has to do with more factors than how good I think those relationships are!
>>> 
>>> [Effulgence] (#s "(Also, after Golden has coins she renders Edward's power voluntary, although we've been doing an inconsistent job of mentioning that, so she's not even doing the thing you're suggesting with the firewalled container for moral agency.")
>>> 
>>> Feel free to ask anybell (and anybell's partner(s)) about this and related topics in the [thread for that](http://belltower.dreamwidth.org/8955.html) if you want a more context-free character opinion.

>>> **u/Suitov** [+1]  *The Culture* (3 days later)
>>> 
...
>> 
>> I was reading [this article](http://lesswrong.com/lw/70u/rationality_lessons_learned_from_irrational/#more) on Less Wrong, and this sounded almost exactly the same:
>> 
...
> **u/DeliaEris** [+2]  *Fully General Idealist* (an hour later)
> 
> There was a comment thread somewhere in here or /r/hpmor a while back about this. I can't find it now.

> **u/p_prometheus** [-5]  *These are not sins of omission but signs of preoccupation.* (a day later)
> 
> >I'm sorry Jack, but I my friends and I talked it over for sixty minutes by the clock and now uniamously agree that the optimal outcome is for you to be friendzoned for exactly four months while watching me date a series of increasingly suitable males before your heart breaks and you stop following me around like a creep.
> 
...
>>> **u/p_prometheus** [+2]  *These are not sins of omission but signs of preoccupation.* (2 days later)
>>> 
...
>>>>> **u/p_prometheus** [+1]  *These are not sins of omission but signs of preoccupation.* (2 days later)
>>>>> 
...
>>>>>>> **u/p_prometheus** [+0]  *These are not sins of omission but signs of preoccupation.* (4 days later)
>>>>>>> 
>>>>>>> Thanks. I was worried that it wasn't clear that I advocate rape and murder of women for being rude.

>> **u/DeliaEris** [+1]  *Fully General Idealist* (3 days later)
>> 
