## [HSF][D] Why Charlie Stross hates Star Trek and other space operas

* Author: u/None *
* URL: http://www.antipope.org/charlie/blog-static/2009/10/why_i_hate_star_trek.html
* Score: 10

* Created: 2014-08-30T22:32:37

### Post:

[Link to content](http://www.antipope.org/charlie/blog-static/2009/10/why_i_hate_star_trek.html)

### Comments:

> **u/Geminii27** [+12]  (5 hours later)
> 
...
>> **u/ItsaMe_Rapio** [+1]  (18 hours later)
>> 
...
>>> **u/dysfunctionz** [+4]  (19 hours later)
>>> 
...
>>> 
>>> Fun fact: Accelerando made _me_ a fan after falling through the Stross rabbit-hole that began in the form of the very article linked.

> **u/comport** [+9]  (13 hours later)
> 
...
> 
> What if the transporter malfunctions and created two copies of you? [Second Chances](https://en.wikipedia.org/wiki/Second_Chances_%28Star_Trek:_The_Next_Generation%29) raises all the issues of what it means to have an identity and what we lose when we're no longer unique which you'd expect to come up when dealing with duplicating teleporter. This is a plot where technological teleportation is integral, not an afterthought or part of the background.
> 
> What if there were a computer game that was so addictive it stopped you functioning properly? In [The Game](https://en.wikipedia.org/wiki/The_Game_%28Star_Trek:_The_Next_Generation%29) such a video game arrives on the Enterprise. It's very addictive and encourages people to share it with others, sometimes by force. It eventually turns out that the main intention of the game is to be used as a form of mind control. Here we have an episode of a tv show where concepts relating to technological superstimulus and memetic hazards are the driving force in the plot, this isn't an example of a space opera.
> 
...
> 
> What if you have the technology to wipe out an irredeemable enemy? In [I, Borg](https://en.wikipedia.org/wiki/I,_Borg) the crew debate the ethics vs the necessity of wiping out the Borg by sending a captured drone back carrying a highly destructive memetic hazard. 
> 
> Sure there are episodes such as [The Measure of a Man](https://en.wikipedia.org/wiki/The_Measure_of_a_Man_%28Star_Trek:_The_Next_Generation%29) which deals merely with the issues of whether or not a sentient robot can be considered property, a topic which could have been dealt with as easily, if not as effectively in a slave-trade era setting. 
> 
> And there are episodes such as [The Best of Both Worlds](https://en.wikipedia.org/wiki/The_Best_of_Both_Worlds_%28Star_Trek:_The_Next_Generation%29) which only deals with the loss of your individual consciousness, and the concept of humans-as-wetware. You could do that in an 18th century setting, right? 
> 
> TLDR
> 
...
>> **u/TimeLoopedPowerGamer** [+2]  *Utopian Smut Peddler* (14 hours later)
>> 
>> >What if a trickster god appears and forces you to re-live the events of Robin Hood? Okay.. lets skip this one. Let's just skip all Q episodes.
>> 
...
> **u/TimeLoopedPowerGamer** [+9]  *Utopian Smut Peddler* (10 hours later)
> 
