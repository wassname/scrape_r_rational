...
> [Disclaimer:  I will not have an opportunity to play this game for at least several years.  Spoilered thoughts nonetheless in case they give you ideas:  ](#s "What is the reason that the Vessel needed to be made?  Is it exclusively to give non-guardians the ability to use guardians' abilities, and previously shown to not exceed the strength of guardians' abilities?  Or (based on some reading), does it exist to gradually store up Light and then use it all at once for things exceeding a guardian's capacity?  Note that even if a guardian had access to infinite Light, that might not be sufficient if a guardian's body only allowed an instantaneous output of X and resurrection required an instantaneous output (from a single source?) of 2X or 20X or 200X or [greater than highest-ever number of guardians alive at the same time]X.  Rather than resurrection without the Vessel, I find myself curious about whether the Vessel can be reused, and if so how long it will take to recharge.")
> 
