## [D] Rationally Writing 54 - Irrational Fiction

* Author: u/DaystarEld  *Pokémon Professor**
* URL: http://daystareld.com/podcast/rationally-writing-54/
* Score: 24

* Created: 2020-05-22T18:38:37

### Post:

[Link to content](http://daystareld.com/podcast/rationally-writing-54/)

### Comments:

> **u/Kuiper** [+11]  (7 hours later)
> 
> The discussion toward the end (where both hosts talked about appreciating film more for its craft than the rationality of its plot) reminded me of a previous discussion on this subreddit about [when the needs of the medium outweigh the needs of the rational](https://www.reddit.com/r/rational/comments/ai2xuc/when_the_needs_of_the_medium_outweigh_the_needs/).
> 
...
>> 
>> According to one view, stories "[allow people to see patterns where there is chaos, meaning where there is randomness](https://www.theatlantic.com/health/archive/2014/11/the-psychological-comforts-of-storytelling/381964/)." As such, you could say storytelling is the subjective signalling of order from chaos; it follows that the simpler the signal, the more likely it will reach its target. So irrationality would just be a side effect of toning down the signal to more effectively penetrate the collection of heuristics that people are comprised of. Yet no two signals penetrate the same way. So counterintuitively, for the detail-oriented audience with many running heuristics, the signal turns into a lock and key metaphor: it needs to preemptively account for all the filters that scrutinize or distort the signal. The hard part then is optimally tuning the signal so it feels *right* to the maximum amount of people (by definition, the middle of the bell curve). Thus some people will always be left out, victims of standard deviation.

>> **u/TheVenomRex** [+1]  (2 days later)
>> 
>> On a tangent.
>> 
>> I remember being disappointed by the thing  in The Winter Soldier, because the situation without the twist is more interesting, and also follows from gerne convention.
>> >!IE. England has association with Spies!<

> **u/alexanderwales** [+5]  *Time flies like an arrow* (an hour later)
> 
> [Rational Fiction as Narrative Focus](http://thingswhichborepeople.blogspot.com/2020/05/rational-fiction-as-narrative-focus.html) is a blog post that I mentioned in the podcast and hurriedly finished today, as I'd sort of forgotten about it. Hopefully it's still illuminating (we talk about some of the things that it contains within it)

>> **u/TaoGaming** [+1]  *No Flair Detected!* (2 hours later)
>> 
>> That blog has some great ideas in it, thanks for the link.

> **u/TheVenomRex** [+3]  (2 days later)
> 
> I just want to say that I disagree that cinemasins has gotten worse.
> 
> [They were never any good to begin with.](https://youtu.be/BA9LwE20YK8)
> 
> Edit:    
...
> **u/DaystarEld** [+2]  *Pokémon Professor* (a minute later)
> 
> Apologies for the click-bait title :) Hope everyone's staying safe!

> **u/Sailor_Vulcan** [+1]  *Champion of Justice and Reason* (9 days later)
> 
...
>> [https://www.lesswrong.com/posts/GMTjNh5oxk4a3qbgZ/the-foundational-toolbox-for-life-introduction-1](https://www.lesswrong.com/posts/GMTjNh5oxk4a3qbgZ/the-foundational-toolbox-for-life-introduction-1#comments)  
>> 
