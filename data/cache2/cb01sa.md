...
* Author: u/wizzwizz4  *LessWrong (than usual)**
* URL: https://www.reddit.com/r/rational/comments/cb01sa/mk_you_are_cassandra_how_do_you_abuse_your_curse/
* Score: 65

* Created: 2019-07-09T12:12:12
...
> **u/Silver_Swift** [+64]  (20 minutes later)
> 
...
>> **u/wizzwizz4** [+25]  *LessWrong (than usual)* (28 minutes later)
>> 
...
>>> **u/Silver_Swift** [+28]  (56 minutes later)
>>> 
...
>>>> **u/RandomDamage** [+19]  (7 hours later)
>>>> 
...
>>>>>> **u/RandomDamage** [+5]  (10 hours later)
>>>>>> 
...
> **u/Vampyricon** [+29]  (an hour later)
> 
> >I do mean a probability of 0!
> 
> I don't think that's how the Cassandra curse works.

>> **u/cryptologicalMystic** [+16]  (2 hours later)
>> 
>> /r/unexpectedfactorial

>> **u/wizzwizz4** [+5]  *LessWrong (than usual)* (2 hours later)
>> 
>> How does it work, then?

>>> **u/Vampyricon** [+29]  (2 hours later)
>>> 
>>> They assign a probability of 0.

>>>> **u/wizzwizz4** [+18]  *LessWrong (than usual)* (3 hours later)
>>>> 
>>>> … >:-( You know _full well_ that I meant zero, not one.

>>>>> **u/ulyssessword** [+12]  (11 hours later)
>>>>> 
>>>>> )
>>>>> 
...
>>>>>>> **u/osmarks** [+8]  *There is no Antimemetics Division* (3 days later)
>>>>>>> 
>>>>>>> .

>>>> **u/SimoneNonvelodico** [+10]  *Dai-Gurren Brigade* (3 hours later)
>>>> 
>>>> *glares angrily*

> **u/JesradSeraph** [+19]  (5 hours later)
> 
...
> **u/melmonella** [+23]  *Tremble, o ye mighty, for a new age is upon you* (an hour later)
> 
> Easy as pie, surely. 
> 
...
>>> **u/melmonella** [+24]  *Tremble, o ye mighty, for a new age is upon you* (an hour later)
>>> 
...
>>> **u/SimoneNonvelodico** [+3]  *Dai-Gurren Brigade* (3 hours later)
>>> 
...
>>>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (4 hours later)
>>>> 
>>>> Sadly not.

> **u/thrasherfect92** [+8]  (3 hours later)
> 
...
>> **u/wizzwizz4** [+5]  *LessWrong (than usual)* (3 hours later)
>> 
...
>>> **u/thrasherfect92** [+2]  (3 hours later)
>>> 
...
>> **u/wizzwizz4** [+4]  *LessWrong (than usual)* (8 hours later)
>> 
>> >:-) Yesssssss.

> **u/Argenteus_CG** [+9]  (8 hours later)
> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (8 hours later)
>> 
>> Ok, you win, everybody go home.
>> 
>> (This can't work. Surely. This isn't _that_ broken.)
...
>>>>> **u/ShiranaiWakaranai** [+3]  (12 hours later)
>>>>> 
...
>> **u/wizzwizz4** [+2]  *LessWrong (than usual)* (an hour later)
>> 
>> > Will that actually make them assign a probability of 0 to the sun setting in the west tomorrow, even though it is obviously true?
>> 
>> Yes.
...
>>>> **u/wizzwizz4** [+2]  *LessWrong (than usual)* (3 hours later)
>>>> 
...
>>>>> **u/Silver_Swift** [+2]  (6 hours later)
>>>>> 
...
>>>>>> **u/wizzwizz4** [+3]  *LessWrong (than usual)* (8 hours later)
>>>>>> 
...
>>>>> **u/ShiranaiWakaranai** [+1]  (3 hours later)
>>>>> 
...
>>>>>> **u/wizzwizz4** [+2]  *LessWrong (than usual)* (4 hours later)
>>>>>> 
>>>>>> Well, the world _won't_ last forever, and you don't have countably infinite time to prophesy.
...
>> **u/RandomDamage** [+1]  (7 hours later)
>> 
...
>>> **u/ShiranaiWakaranai** [+1]  (12 hours later)
>>> 
>>> >It only works if it's a prophesy. 
>>> 
>>> Which it is.
...
>>>> **u/RandomDamage** [+1]  (15 hours later)
>>>> 
...
> **u/TheRealEndfall** [+3]  *System No. 6* (4 hours later)
> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (4 hours later)
>> 
>> Nice try. But they disbelieve your _prophecy_, not your words.
>> 
>> > In the meantime, I'll set up a timestamped random character generator and predict timestamps to read a total syntheses for the most powerful lifesaving drugs that will ever be invented, and other useful knowledge.
>> 
>> You won't be able to use that knowledge, unless you work alone _and manually subdue and drug ill people_.

>>> **u/Argenteus_CG** [+2]  (10 hours later)
>>> 
...
> **u/TrebarTilonai** [+3]  (6 hours later)
> 
...
>>> **u/TrebarTilonai** [+2]  (9 hours later)
>>> 
...
>> **u/wizzwizz4** [+4]  *LessWrong (than usual)* (an hour later)
>> 
...
>> **u/melmonella** [+2]  *Tremble, o ye mighty, for a new age is upon you* (an hour later)
>> 
>> >So go absolutely nuts and pre-commit to killing yourself unless your desired outcomes happen, and the universe will bend to your will to ensure you survive until 10 years later.
>> 
>> do that
...
>>> **u/ShiranaiWakaranai** [+3]  (an hour later)
>>> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (an hour later)
>> 
>> Well, it is revealing future events. They'll think "oh, the tanker's going to explode" then they'll think "pssh, that's never going to happen" and then they'll be _less_ cautious around it and then they'll die in a hideous fireball.
...
>>>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (3 hours later)
>>>> 
>>>> I'd say "maybe". How much information (probably measured in bits) are you conveying by your action?

>>>>> **u/FeepingCreature** [+2]  *GCV Literally The Entire Culture* (3 hours later)
>>>>> 
...
>> **u/wizzwizz4** [+2]  *LessWrong (than usual)* (5 hours later)
>> 
...
> **u/ThatEeveeGuy** [+2]  (11 hours later)
> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (19 hours later)
>> 
>> > I'm assuming this isn't how that works.
>> 
>> You're assuming right. _Technically_, that's a loophole in the wording, but everyone knows it's not intended.
>> 
>> > How does their mind reconcile this?
>> 
>> See: [_Springtime for Hitler: A Gay Romp With Adolf and Eva at Berchtesgaden_](https://en.wikipedia.org/wiki/Springtime_for_Hitler).

>>> **u/ThatEeveeGuy** [+2]  (a day later)
>>> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (35 minutes later)
>> 
...
>>>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (45 minutes later)
>>>> 
...
> **u/Trips-Over-Tail** [+1]  *Death of Crabs* (7 hours later)
> 
...
>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (8 days later)
>> 
...
>>>> **u/wizzwizz4** [+1]  *LessWrong (than usual)* (9 days later)
>>>> 
>>>> But you won't be.
