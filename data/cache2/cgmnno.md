...
* Author: u/BoxSparrow *
* URL: https://www.reddit.com/r/rational/comments/cgmnno/mk_munchkining_super_strength/
* Score: 21

* Created: 2019-07-23T02:23:27
...
>>>>> **u/TOTMGsRock** [+1]  *NERV**
>>>>> 
>>>>> Which means they are also projecting sound faster than light. It's amazing they haven't destroyed planets by *literally* talking them to death.
>>>>> 

>>>>>> **u/Luminous_Lead** [+1] *
>>>>>> 
>>>>>> Some characters do have deadly breath weapons, but most of them don't physically chew the scenery while figuratively chewing the scenery (except maybe Majin Buu)
>>>>>> 
...
>>> **u/TOTMGsRock** [+1]  *NERV**
>>> 
>>> >But on the other hand they could just use a gun. The great equalizer.
>>> Depends. If the person's super strength is powerful enough to outcompete the force of gun propellant, then throwing weapons would be better than guns (and yes, better than throwing a gun). Imagine being strong enough to throw bowling balls at speeds greater than Mach 5.
>>> 

>>>> **u/kaukamieli** [+1] *
>>>> 
>>>> Sure, but... For most targets there is no need for more strength than a gun. Superman ofc has his eye lazors, so he doesn't even need that.
>>>> But if we only assume super strength and not skill, agility, coordination and such, most throwing weapons would still lose in accuracy. Unless they were heavily trained.
>>>> There are stories of (masses of) people with slings breaking some kind of a ship. If a superpowered dude was to use a sling, which is a force multiplier...
>>>> Edit: guns also tend to have multiple ammo. Throwing weapons make for more dramatic scenes, tho.
>>>> 

>>>>> **u/TOTMGsRock** [+1]  *NERV**
>>>>> 
>>>>> If you're up against enemies who are near or at your caliber (hehe), firearms become increasingly less useful as their power does not scale with a person's physical strength while throwing weapons do. For example, fighting a superhuman who has the usual small-arms-fire-proof durability means that you're going to need to expend much more kinetic energy than a high-caliber bullet. You could use your fists (or if you really want to be brutal, brass knuckles) once you're at close range, but you'd benefit even more from abusing super strength to get a range advantage when your enemy is not within swinging distance. Of course, you'd need training, but the benefits far outweigh the costs. Picture a person with super strength who is really good at throwing tungsten rods to simulate kinetic bombardment. Their enemies will become blood mist.
>>>>> 

>>>> **u/Luminous_Lead** [+1] *
>>>> 
>>>> I think a bowling ball at accelerated to mach 5 would become a shotgun blast of superheated goop before it fully left the throwing arm.
>>>> 

>>>>> **u/TOTMGsRock** [+1]  *NERV**
>>>>> 
>>>>> If you don't want the projectile to melt, there's always your friendly neighborhood tungsten.
>>>>> 
