...
* Author: u/lsparrish *
* URL: http://worldbuilding.stackexchange.com/questions/14442/how-to-eat-the-moon
* Score: 13

* Created: 2015-04-24T23:11:25
...
>> 
>> ####&#009;
>>  [**Volatiles**](https://en.wikipedia.org/wiki/Volatiles): [](#sfw) 
>> 
>> ---
>> 
>> >
>> 
>> >In [planetary science](https://en.wikipedia.org/wiki/Planetary_science), __volatiles__ are the group of [chemical elements](https://en.wikipedia.org/wiki/Chemical_elements) and [chemical compounds](https://en.wikipedia.org/wiki/Chemical_compounds) with [low boiling points](https://en.wikipedia.org/wiki/Volatility_(chemistry\)) that are associated with a [planet](https://en.wikipedia.org/wiki/Planet)'s or [moon](https://en.wikipedia.org/wiki/Moon)'s [crust](https://en.wikipedia.org/wiki/Crust_(geology\)) and/or [atmosphere](https://en.wikipedia.org/wiki/Atmosphere). Examples include [nitrogen](https://en.wikipedia.org/wiki/Nitrogen), [water](https://en.wikipedia.org/wiki/Water), [carbon dioxide](https://en.wikipedia.org/wiki/Carbon_dioxide), [ammonia](https://en.wikipedia.org/wiki/Ammonia), [hydrogen](https://en.wikipedia.org/wiki/Hydrogen), [methane](https://en.wikipedia.org/wiki/Methane) and [sulfur dioxide](https://en.wikipedia.org/wiki/Sulfur_dioxide). In [astrogeology](https://en.wikipedia.org/wiki/Astrogeology), these compounds, in their solid state, often comprise large proportions of the crusts of [moons](https://en.wikipedia.org/wiki/Moons) and [dwarf planets](https://en.wikipedia.org/wiki/Dwarf_planet).
>> 
>> >In contrast with volatiles, elements and compounds with high boiling points are known as *[refractory](https://en.wikipedia.org/wiki/Refractory_(planetary_science\)) substances*. 
>> 
>> >Planetary scientists often classifly volatiles with exceptionally low melting points, such as [hydrogen](https://en.wikipedia.org/wiki/Hydrogen) and [helium](https://en.wikipedia.org/wiki/Helium), as __gases__ (as in [gas giant](https://en.wikipedia.org/wiki/Gas_giant)), while those volatiles with melting points above about 100 K are referred to as __ices__. The terms "gas" and "ice" in this context can apply to compounds that may be solids, liquids or gases. Thus, [Jupiter](https://en.wikipedia.org/wiki/Jupiter) and [Saturn](https://en.wikipedia.org/wiki/Saturn) are referred to as "gas giants", and [Uranus](https://en.wikipedia.org/wiki/Uranus) and [Neptune](https://en.wikipedia.org/wiki/Neptune) are referred to as "ice giants", even though the vast majority of the "gas" and "ice" in their interiors is a [hot, highly dense fluid](https://en.wikipedia.org/wiki/Supercritical_fluid) that gets denser as the center of the planet is approached.
>> 
>> >====
>> 
>> >[**Image**](https://i.imgur.com/buyjETl.png) [^(i)](https://commons.wikimedia.org/wiki/File:Jupiter_interior.png) - *This cut-away illustrates a model of the interior of Jupiter, with a rocky core overlaid by a deep layer of metallic hydrogen.*
>> 
>> ---
>> 
>> ^Interesting: [^Volatility ^\(chemistry)](https://en.wikipedia.org/wiki/Volatility_\(chemistry\)) ^| [^Green ^leaf ^volatiles](https://en.wikipedia.org/wiki/Green_leaf_volatiles) ^| [^Volatility ^\(finance)](https://en.wikipedia.org/wiki/Volatility_\(finance\)) 
>> 
>> ^Parent ^commenter ^can [^toggle ^NSFW](/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+cqopml9) ^or[](#or) [^delete](/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+cqopml9)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)
