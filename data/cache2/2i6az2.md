## [WIP] Decagon - Act 2 - Chapter 1

* Author: u/None *
* URL: http://flickegon.wordpress.com/2014/10/03/decagon-201/
* Score: 2

* Created: 2014-10-03T09:29:32

### Post:

[Link to content](http://flickegon.wordpress.com/2014/10/03/decagon-201/)

### Comments:

> **u/narfanator** [+3]  (23 hours later)
> 
...
> 
> - Read about this trope: [Stuffed Into The Fridge](http://tvtropes.org/pmwiki/pmwiki.php/Main/StuffedIntoTheFridge)... and stop doing it. You have characters that exist merely as targets for the characterization of the main characters. Charity graduates from this, but not in a way that makes sense. Everybody should be able to exist out side of the situation you needed them for. 
> 
...
>> **u/autotrope_bot** [+1]  (a day later)
>> 
>> Stuffed into the Fridge
>> ----
>> ____
>> A character is killed off in a particularly gruesome manner and left to be
>> found just to offend or insult someone, or to cause someone serious anguish.
>> The usual victims are those [ who matter to the hero
>> ](http://tvtropes.org/pmwiki/pmwiki.php/Main/FriendlyTarget) , specifically [
>> best buddies
>> ](http://tvtropes.org/pmwiki/pmwiki.php/Main/HeterosexualLifePartners) , love
>> interests, and [ sidekicks
>> ](http://tvtropes.org/pmwiki/pmwiki.php/Main/Sidekick) . In some cases, the
>> doomed character may be killed by natural forces or by a character who doesn't
>> have the intent to cause someone else angst -- in this case, the intent comes
>> from the writer, who wants to rouse strong emotions in another character.
>> 
>> [Read More](http://tvtropes.org/pmwiki/pmwiki.php/Main/StuffedIntoTheFridge)
>> ____
...
> 
> If you haven't been reading it, [here](http://flickegon.wordpress.com/decagon/) is the table of contents.
> 
...
>> 
>> Also if I am reading this right [Spoilers](#s "Lance pretty much raped Charity, later the whole group gets together and the only drawback of this is Charity not wanting to sit next to Lance.") that whole situations feels off somehow. 
>> 
