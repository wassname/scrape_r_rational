...
* URL: https://www.reddit.com/r/rational/comments/3yuidg/challenge_companion_paperclippers/
* Score: 11

* Created: 2015-12-30T23:52:02
...
>>> Except that [cognitive scientists and cognitive psychologists *are* at the forefront](http://web.mit.edu/sjgershm/www/GershmanHorvitzTenenbaum15.pdf) of the best, most viable work towards understanding how minds-in-general can actually work (which is how you would actually go about building one).
...
>> **u/Sagebrysh** [+0]  *Rank 7 Pragmatist**
>> 
...
>>> **u/None** [+2] *
>>> 
>>> [Sigh...](http://lesswrong.com/lw/igf/the_genie_knows_but_doesnt_care/)  Utility-function *learning* is a real proposal, but that still involves a core algorithm which learns in a specific way.
>>> 
