...
* URL: https://www.fictionpress.com/s/3238329/83/A-Hero-s-War
* Score: 25

* Created: 2016-06-22T14:42:48
...
>> **u/OutOfNiceUsernames** [+2]  *fear of last pages* (3 days later)
>> 
...
>>> 
>>> [Re WMDs and environment:](#s "There is a reason why the First and the Tsar aren't around anymore, tremors and zombies alone couldn't possibly collapse civilization as they knew it.  Also, the Elka Clan Two legend about the Fort Yang valley is a clue about how the war ended.  ")

>>>> **u/Nthrown** [+1]  (3 days later)
>>>> 
...
>>>>>> Compare: 
>>>>>> 
>>>>>> > [Re WMDs and environment:](/s "There is a reason why ... the war ended.")
>>>>>> 
...
>>>>>> -
>>>>>> 
>>>>>> > [](#s "There is a reason why ... the war ended.")
>>>>>> 
>>>>>>  * should work only if the custom-CSS is enabled on this sub
>>>>>> 
>>>>>> -
>>>>>> 
>>>>>> > [There is a reason why ... the war ended.](/spoiler)
>>>>>> 
...
>>>>>>> **u/Nthrown** [+2]  (4 days later)
>>>>>>> 
>>>>>>> You replied to me, not u/jseah

>>>>>>>> **u/OutOfNiceUsernames** [+1]  *fear of last pages* (4 days later)
>>>>>>>> 
>>>>>>>> [I replied to him,](https://www.reddit.com/r/rational/comments/4pazqc/rt_a_heros_war_ch83/#d4oexdc) you just got a redbox because you were mentioned in my comment.

>>>>>>>>> **u/Nthrown** [+2]  (5 days later)
>>>>>>>>> 
>>>>>>>>> Oh cool, didn't know that was a thing

>>>>>> **u/Nthrown** [+1]  (4 days later)
>>>>>> 
...
>> **u/bumbiedumb** [+1]  *The Polity* (2 days later)
>> 
...
>> 
>> I love to hear more about this as in the past banks helps safeguard money for merchants travelling from one place to another without the risk of transporting large amount of coins (e.g. Minmay -> Corbin) to do transaction. 
>> Coins such as Rime and Telins takes time and resources to be minted. Banks plays a huge role in financing new technology that Cato is churning out and as the cost grows, Credit is needed to finance large projects. Banks could be used as a diplomatic edge for foreign relations (e.g. World Bank/IMF/AIIB). Providing loans and aids may ease talks and bring advantage to Minmay. I'm Excited to see how Minmay becomes a gamechanger in terms of Inath's progress, politics & technology!
...
>> 
>> [It appears that] (#s "the tremors exist as organisms whose bodies extend into four spatial dimensions. Moving through the extra dimension would allow them to appear in the ground and not leave continuous trails in the fashion that they do, as well as hatch from their eggs without breaking them. It also explains the lack of entrances and exits in their bodies in the slice of them we see, as well as their apparently haphazard internal construction; when killed, in their death throes they may rotate randomly and we end up seeing a slice that's at an oblique angle, in which case the connectivity would not make any sense compared to the orientation they typically present themselves with. In addition, the Elkas can lower their mass apparently, which suggests that they are rotating their mass to a position not affected by gravity. The magic itself seems to be inherently four-dimensional as well, with the descriptions of folding it inside itself to conceal its signature. I suspect this is another kind of rotation. I don't quite see how it all fits together yet but it looks like that's a big part of what's going on.")
>> 
...
> **u/OutOfNiceUsernames** [+3]  *fear of last pages* (16 hours later)
> 
...
>> **u/elevul** [+2]  *Cyoria Observer* (18 hours later)
>> 
...
> **u/Linear_Cycle** [+2]  (a month later)
> 
...
> **u/__2BR02B__** [+1]  *Marxist-Lurianism* (23 hours later)
> 
