...
* URL: https://www.reddit.com/r/rational/comments/141fhyr/d_monday_request_and_recommendation_thread/
* Score: 40

* Created: 2023-06-05T14:00:16
...
>> **u/lucidobservor** [+6]  (13 hours later)
>> 
...
>>>> **u/ProfessorPhi** [+2]  (a day later)
>>>> 
>>>> Got me to play OW, that's how good it was. Benedict clearly loved the world of OW.

>> **u/traverseda** [+8]  *With dread but cautious optimism* (5 days later)
>> 
...
> **u/Master_Gazelle_6068** [+9]  (8 hours later)
> 
...
> **u/Bowbreaker** [+9]  *Solitary Locust* (a day later)
> 
...
> **u/hi____nsa** [+21]  (40 minutes later)
> 
...
>> **u/EdLincoln6** [+1]  (14 days later)
>> 
>> This makes your story sound way better then the blurb.    
>> The opening of the book was a bit hard for me to get through.

> **u/evesoup** [+4]  (a day later)
> 
...
>>> **u/EdLincoln6** [+1]  (14 days later)
>>> 
>>> This one is about as far from the idea of Rationalist fiction as you can possibly get.  The MC is sorta an insane murder hobo and an extraordinarily bad teacher.

>> **u/EdLincoln6** [+1]  (14 days later)
>> 
>> It seems to have been dropped, but **A Sect Elder's Journey** fits and was great.  
>> Arguably **Beware of Chicken**.   
>> In both teaching isn't quite the main story, but mentoring plays a big role.

> **u/mkalte666** [+4]  (4 days later)
> 
...
>>> **u/CatInAPot** [+2]  (10 hours later)
>>> 
>>> Hope you enjoy it!

>>>> **u/hoja_nasredin** [+1]  *Dai-Gurren Brigade* (2 days later)
>>>> 
>>>> so far yes. A little bit too Korean for me.
...
>>> 
>>> Afraid I haven't played Disco Elysium yet (planning to soon), so I wouldn't really know even if there were

>>>> **u/UnterVectorRaum** [+2]  (3 days later)
>>>> 
>>>> Play it with a friend if your planning on playing Disco Elysium is my tip. Like stream it through discord and discuss which options you will take.
>>>> 
>>>> It gives you the emotional distance to choose the crazy options (especially in politics). And the writing is engaging enough that it can go from lighthearted slapstick comedy (nice as an introduction) to some pretty dark places and back without missing a beat.

> **u/AviusAedifex** [+6]  (18 hours later)
> 
...
>> **u/Stefan-NPC** [+1]  *A Practical Guide to Evil* (7 days later)
>> 
>> >I'm looking for recommendations for a specific story format. It's about traveling from one scenario to another, accomplishing goals in each and then moving to the next
>> 
>> I too love this format, unfortunetly there aren't a lot of stories like that. I have a few in mind, but please if you have more than the ones mentioned above don't hesitate to give them to me. Even if it's fanfic, give them to me.
>> 
>> Here is list of what i can remmeber.
>> 
>> Apocalypse Gates,  by Daniel Schinhofen - Later books feature lots of NSFW. The world hopping don't come early but it have some very in dept mechnics. >!The character go to Fantasy world, while driving a Jeep and using autmatic rifle as weapon, which turn out to not be as useful due to "Mana Shield" and "Deflect Metal" spells!<
>> 
>> Scottie Futch - Author on both RR and Amazon. Quite a few of his works have such elements, but all of them are either dropped or incompleated at the moment. I have read "Galactic Fist of Legend" and "Blackthorne" and had fun. His "Power Fantasy" series also use the same premise.
>> 
>> Terror Infinity - Side B , It's like "Terror InfinityCN" but by another author, with new worlds and characters.
...
>>> 
>>> Huh. This doesn't show up on hpmorpodcast.com like the previous ones did. Thank you!

> **u/Bowbreaker** [+3]  *Solitary Locust* (6 days later)
> 
...
> **u/CaramilkThief** [+5]  (2 hours later)
> 
...
>> **u/AviusAedifex** [+2]  (17 hours later)
>> 
...
>> **u/DM_ME_YOUR_HUSBANDO** [+1]  (7 hours later)
>> 
>> This is kind of the opposite of what you asked for but Hinamatsuri is a similar manga but more slice of life. A Yakuza member ends up adopting a young girl with telekinetic powers from the future, and all sorts of hijinks ensue. Very similar dynamics to Spy x Family but even less romance really. https://mangadex.org/title/8a3d319d-2d10-4364-928c-0f30fd367c24/hinamatsuri
>> 
>> Honeypot Shared House is kind of similar in that it’s about spies pretending to be normal, but it’s an ecchi harem manga where they’re trying to seduce each other to get state secrets. https://mangadex.org/title/7493b91c-c906-4fd8-85f4-900c4c1538f9/honey-trap-shared-house

>> **u/hoja_nasredin** [+1]  *Dai-Gurren Brigade* (8 hours later)
>> 
>> Mr and Mrs Smith movie is a similar idea but without kids.so more romantic comedy

>> **u/bildramer** [+1]  (4 days later)
>> 
>> Not sure if it has the (right aspects of the) dynamic you're looking for, but [We Are Each Our Own Devil](https://forums.spacebattles.com/threads/we-are-each-our-own-devil-youjo-senki-saga-of-tanya-the-evil.815438/reader/) by victoriakay is a Youjo Senki fanfic. It's more about Tanya and Lehrgen comedy-of-errorsing themselves into a romantic relationship. Warning: long, slow and not yet finished, but very good IMO. Also, Miraculous Ladybug fanfics have secret-identity-based romance in spades, and there are hundreds of acceptable quality ones (amongst the over 60k on AO3).
