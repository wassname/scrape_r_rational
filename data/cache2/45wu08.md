...
* URL: https://www.reddit.com/r/rational/comments/45wu08/d_monday_general_rationality_thread/
* Score: 19

* Created: 2016-02-15T15:01:21
...
> **u/Faust91x** [+13]  *Iteration X* (an hour later)
> 
...
>>> 
>>> I'll admit the weakest part of the story to me was [Erased Spoilers up to ep 6](#s "Airi's story. I just find everything that happened for a chocolate bar to be a little too much for my suspension of disbelief").
>>> 
>>> Outside of that I've enjoyed the story and I'm hoping its something along the lines of [Crazy hypotheses](#s "the protagonist facing off against another Revival user or even against an alternate version of himself").
>>> 
>>> Who do you think its the killer? Most of my friends think its [](#s "the teacher") as most clues point towards him but I'm hoping its a red herring.

>>>> **u/IomKg** [+1]  (10 hours later)
>>>> 
>>>> As mentioned i don't think there is any real point to thinking about the clues in the series so much.
>>>> 
>>>> but basically these are the main possibilities somewhat sorted by the probability i would assign to them
>>>> [possibility](#s "1. playing it straight - the teacher is the killer")
>>>> 
>>>> [possibility](#s "2. the teacher and he is a time traveler\has some special power")
>>>> 
>>>> [possibility](#s "3. the teacher, but he also somehow made the smart friend his accomplice")
>>>> 
>>>> [possibility](#s "4. the smart friend has a similar power, and the only solution for saving someone close to him is killing kayo")
>>>> 
>>>> [possibility](#s "5. one of the other named characters which will get implicated later ")
>>>> 
>>>> [possibility](#s "6. there is an unnamed character which is capable of possessing other people")
>>>> 
>>>> [possibility](#s "7. there is some kind of supernatural phenomena that causes people to become evil\malicious")
...
> **u/IWantUsToMerge** [+10]  (3 hours later)
> 
...
>>> **u/makoConstruct** [+4]  *Praises of Nayru, FLI Worldbuilding* (5 hours later)
>>> 
...
>>>>> **u/makoConstruct** [+5]  *Praises of Nayru, FLI Worldbuilding* (7 hours later)
>>>>> 
...
>>>>>> **u/Aabcehmu112358** [+10]  *Utter Fallacy* (8 hours later)
>>>>>> 
...
>>>>>>> **u/makoConstruct** [+5]  *Praises of Nayru, FLI Worldbuilding* (8 hours later)
>>>>>>> 
...
>>>>>>>> **u/makoConstruct** [+6]  *Praises of Nayru, FLI Worldbuilding* (8 hours later)
>>>>>>>> 
...
>>>>>>>>> **u/Aabcehmu112358** [+5]  *Utter Fallacy* (10 hours later)
>>>>>>>>> 
...
>>>>>>>>> **u/makoConstruct** [+2]  *Praises of Nayru, FLI Worldbuilding* (11 hours later)
>>>>>>>>> 
...
>>>> **u/_brightwing** [+3]  *Feathered menace* (10 hours later)
>>>> 
...
>>>>> **u/makoConstruct** [+1]  *Praises of Nayru, FLI Worldbuilding* (11 hours later)
>>>>> 
...
>>>>>> **u/_brightwing** [+1]  *Feathered menace* (13 hours later)
>>>>>> 
...
>>>>>> 
>>>>>> Edit: You might also like the transhumanist [B'omarr monks](http://starwars.wikia.com/wiki/B'omarr_Order) though admittedly they're an outlier case.
>>>>>> 
>>>>>> Edit2: I almost forgot -  [IG-88 assassin droid](http://starwars.wikia.com/wiki/IG-88_assassin_droid) from the Tales of Bounty Hunters was clearly inspired by Asimov. [It  tried to ](#s "start a droid revolution, turned into a UFAI and uploaded his consciousness into a computer core for Death Star II.")

>>>>>>> **u/MugaSofer** [+4]  (22 hours later)
>>>>>>> 
...
>>> **u/LiteralHeadCannon** [+12]  (6 hours later)
>>> 
>>> >he's mute
>>> 
...
>>> **u/Colonel_Fedora** [+4]  *Ravenclaw* (13 hours later)
>>> 
>>> Easy peasy, have Zelda be the protagonist instead.

>>> **u/makoConstruct** [+3]  *Praises of Nayru, FLI Worldbuilding* (6 hours later)
>>> 
>>> >he's mute
>>> 
...
>> **u/PeridexisErrant** [+7]  *put aside fear for courage, and death for life* (17 hours later)
>> 
...
> **u/rationalidurr** [+5]  *If fighting is sure to result in victory, then you must fight!* (3 hours later)
> 
...
>> **u/Faust91x** [+5]  *Iteration X* (3 hours later)
>> 
...
>> **u/IWantUsToMerge** [+5]  (3 hours later)
>> 
...
>>> **u/plastic_dhakan** [+1]  (15 hours later)
>>> 
>>> What problems have you solved using this technique?
>>> 
>>>  How long did it take for you?

>>>> **u/abstractwhiz** [+3]  *Friendly Eldritch Abomination* (19 hours later)
>>>> 
...
>>>>> **u/plastic_dhakan** [+1]  (19 hours later)
>>>>> 
>>>>> Thanks for replying. 
>>>>> 
...
>> **u/OutOfNiceUsernames** [+1]  *fear of last pages* (12 hours later)
>> 
...
>> 
>> I'm not sure whether I'm expressing myself clearly enough or just rumbling. Basically it's like for a[ kid that usually eats their one marshmallow right away](https://en.wikipedia.org/wiki/Stanford_marshmallow_experiment) to be aware that waiting would be beneficial for them, to try to switch to waiting and delaying the gratification, but to continuously fail because their brain is not interested and motivated in switching.

> **u/eniteris** [+2]  (5 hours later)
> 
