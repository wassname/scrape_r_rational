## [RT][WIP][HSF] Set In Stone: Follower Chapter 26 Rational Stonepunk

* Author: u/Farmerbob1  *Level 1 author**
* URL: https://setinstonestory.wordpress.com/2015/08/18/chapter-26/
* Score: 11

* Created: 2015-08-18T23:54:51

### Post:

[Link to content](https://setinstonestory.wordpress.com/2015/08/18/chapter-26/)

### Comments:

> **u/4t0m** [+3]  *Chaos Legion* (2 hours later)
> 
...
>>> **u/varno2** [+2]  (a day later)
>>> 
>>> Also pure carbon electrodes are relitively possible, I did some math and you could reasonable make an arc furnace using hydro-power, and a graphite wired generator. 
>>> You could make dicyano-acetylene, in a furnace burning acetylene, which can be produced semi-readily.
