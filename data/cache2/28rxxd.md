## Chapters 9 and 10 of Rationalising Death

* Author: u/None *
* URL: https://www.fanfiction.net/s/9380249/9/Rationalising-Death
* Score: 20

* Created: 2014-06-22T05:28:05
...
> **u/FeepingCreature** [+2]  *GCV Literally The Entire Culture* (a month later)
> 
...
> **u/Traiden04** [+0]  (51 minutes later)
> 
...
>>> **u/philip1201** [+5]  (11 hours later)
>>> 
>>> It isn't exactly rationalist fiction, but [1/0](http://www.undefined.net/1/0/) sounds similar to what you're looking for. The author features directly in the story though, so it's pretty different from what you would get if there is no line of information to outside the Matrix.
>>> 
...
>>>> **u/Suitov** [+1]  *The Culture* (a day later)
>>>> 
>>>> Well well. I thought [Bob and George](http://en.wikipedia.org/wiki/Bob_and_George) was the first online comic (or first I'd seen, anyway) that had the author hirself appearing in the strip, but I checked the date and B&G started a few months after 1/0. Totally going to read that.
...
>>>>> 
>>>>> ####&#009;
>>>>>  [**Bob and George**](https://en.wikipedia.org/wiki/Bob%20and%20George): [](#sfw) 
>>>>> 
>>>>> ---
>>>>> 
>>>>> >
>>>>> 
>>>>> >___Bob and George___ was a [sprite-based](https://en.wikipedia.org/wiki/Sprite_comic) [webcomic](https://en.wikipedia.org/wiki/Webcomic) which parodied the fictional universe of [Mega Man](https://en.wikipedia.org/wiki/Mega_Man_(series\)). It is written by David Anez, a physics instructor who lives in the American [Midwest](https://en.wikipedia.org/wiki/Midwestern_United_States).  The comic first appeared on April 1, 2000 and ran until July 28, 2007. It was updated daily, with there being only 29 days without a comic in its seven years of production and with 2568 comics being made altogether.
>>>>> 
>>>>> >Most *Bob and George* strips are still images. The initial strips were mostly done in [GIF](https://en.wikipedia.org/wiki/GIF) format (occasionally using [JPEG](https://en.wikipedia.org/wiki/JPEG) for more graphic-intensive comics) before converting to [PNG](https://en.wikipedia.org/wiki/Portable_Network_Graphics) in May 2004. In addition, occasional comics are animated using either animated GIFs or [Macromedia Flash](https://en.wikipedia.org/wiki/Macromedia_Flash). Some of the Flash comics have the characters speaking, voiced by Anez and others (often forum members). Animated comics are generally used for the annual week-long anniversary parties (usually culminating in a brief animated comic that recaps the events of the past year in a matter of seconds), for especially climactic scenes, and for a series of videos depicting an in-comic event known as "the Cataclysm".
>>>>> 
>>>>> >The comic's plot is mostly made up of [story arcs](https://en.wikipedia.org/wiki/Story_arc) of varying lengths. Amongst past story arcs there have been retellings of various Mega Man games (which often play out quite differently from the originals), as well as battles against powerful foes. In addition, many of the story arcs involve either [time travel](https://en.wikipedia.org/wiki/Time_travel), [dimensional](https://en.wikipedia.org/wiki/Parallel_universe_(fiction\)) travel, and villains who want to kill all the characters.
>>>>> 
>>>>> >====
>>>>> 
>>>>> >[**Image**](https://i.imgur.com/B5NaPJN.png) [^(i)](https://en.wikipedia.org/wiki/File:BnG_Strip_06-07-2000.png)
>>>>> 
>>>>> ---
>>>>> 
>>>>> ^Interesting: [^Bob ^Newhart](https://en.wikipedia.org/wiki/Bob_Newhart) ^| [^Bob ^Uecker](https://en.wikipedia.org/wiki/Bob_Uecker) ^| [^Bob ^Halverson](https://en.wikipedia.org/wiki/Bob_Halverson) ^| [^Bob ^Willis](https://en.wikipedia.org/wiki/Bob_Willis) 
>>>>> 
>>>>> ^Parent ^commenter ^can [^toggle ^NSFW](http://www.np.reddit.com/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+cierd5k) ^or[](#or) [^delete](http://www.np.reddit.com/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+cierd5k)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)
