...
* Author: u/ianyboo *
* URL: https://www.reddit.com/r/rational/comments/34y4ch/q_is_there_a_rational_choice_for_us_president_in/
* Score: 0

* Created: 2015-05-05T15:02:57
...
> **u/alexanderwales** [+28]  *Time flies like an arrow* (40 minutes later)
> 
...
>>>> **u/faul_sname** [+1]  (20 hours later)
>>>> 
>>>> That's really interesting, and makes quite a bit of sense. [80k hours seems to agree with you as well](https://80000hours.org/2012/10/how-to-be-a-high-impact-volunteer/). I can definitely see why the enthusiasm would be important, especially for political causes.

> **u/ArgentStonecutter** [+12]  *Emergency Mustelid Hologram* (8 minutes later)
> 
...
> **u/OffColorCommentary** [+17]  (19 minutes later)
> 
...
>> **u/therearetoomanydaves** [+0]  (12 hours later)
>> 
>> In order to evaluate a presidential candidate on a rational basis, you have to look at their
>> actual record (votes cast or laws signed or vetoed in lower offices) and behavior prior to any ambition toward the presidency.
>> 
...
>> 
>> In order to be a rational choice for president (or any other office), a candidate must advocate and support
>> a rational government.  Essentially, a rational government protects its citizens from force and fraud, both
>> internal and external.  It interferes with the lives of its citizens to the minimum extent necessary to achieve
>> this goal.
>> 
...
>>>> **u/therearetoomanydaves** [+0]  (a day later)
>>>> 
...
> **u/trifith** [+9]  *Man plans, god laughs. Like the ant and the grasshopper.* (37 minutes later)
> 
...
> **u/libertarian_reddit** [+0]  (an hour later)
> 
> The only winning move is not to play-Count Chocula

> **u/deccan2008** [+0]  (24 minutes later)
> 
> Isn't the rational choice just to vote in your personal self-interest?

>> **u/alexanderwales** [+8]  *Time flies like an arrow* (42 minutes later)
>> 
...
> **u/trifith** [-6]  *Man plans, god laughs. Like the ant and the grasshopper.* (12 minutes later)
> 
> Ha
> 
> Ha ha ha
...
>>> **u/trifith** [+1]  *Man plans, god laughs. Like the ant and the grasshopper.* (22 minutes later)
>>> 
...
>>>>>>> 
>>>>>>> [Note](#s "I say this as a devil's advocate and climate change believer")
...
>>>>>>>> 
>>>>>>>> [The experts give a >95%](https://www.ipcc.ch/publications_and_data/ar4/wg1/en/ch9s9-7.html) [Bayesian (probability of an event, not `1-p(event | H_0)`) probability](https://www.ipcc.ch/publications_and_data/ar4/wg1/en/ch1s1-6.html) to global climate change due to forcible addition/retention of energy in the Earth's climate system.  I encourage you to read the applicable sections of the report yourself.
>>>>>>>> 
...
>>>>>>> **u/trifith** [+4]  *Man plans, god laughs. Like the ant and the grasshopper.* (5 hours later)
>>>>>>> 
>>>>>>> >What happened to Gary Johnson and the other nonreligious, pro-science libertarians?
>>>>>>> 
