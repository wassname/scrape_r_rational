...
* URL: http://www.fimfiction.net/story/300693/shears
* Score: 13

* Created: 2015-11-19T04:06:44
...
> P.S. [Elements Change](#s "An Element added for Spike, so he wouldn't be 'a seventh wheel'?")
> 

>> **u/Charlie___** [+3] *
>> 
>> It's the element... [](#s "OF SURPRISE!")
>> 

>>> **u/daydev** [+2] *
>>> 
>>> No, silly, it's the Element of [](#s "Peace").
>>> But seriously, though, when I think about it, /u/Calamitizer, one could argue that [](#s "Peace is non in line with other Elements. 'Peace' is more or less a synonym for Harmony, and not a virtue a person could manifest, like other Elements. Unless, of course, this is all intended to illustrate how history is unreliable, i.e. some historian made up an Element so they would add up to a more 'magical' number").
>>> 
...
>>>>> [](#s "Short")
>>>>> [](#s "A sufficiently long spoiler is indistinguishable from monitor failure")
>>>>> 
