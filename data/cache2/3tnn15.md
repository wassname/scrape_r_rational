## [RT][FF] Shears, Chapter 3 (r!MLP)

* Author: u/Calamitizer  *Shears**
* URL: http://www.fimfiction.net/story/300693/3/shears/bridges-3
* Score: 14

* Created: 2015-11-21T04:28:16

### Post:

[Link to content](http://www.fimfiction.net/story/300693/3/shears/bridges-3)

### Comments:

> **u/Gurkenglas** [+5]  (22 hours later)
> 
...
> **u/Riddle-Tom_Riddle** [+3]  (47 minutes later)
> 
...
> 
> I would love to read more, but the vast majority of my reading is on my phone(the rest is physical copies of a book), and using the stock browser compared to my preferred [fanfiction reader](https://play.google.com/store/apps/details?id=com.apps.webreader) is like switching *to* viscera-covered, freshly-removed animal hide(with patches of coarse fur still attached!) pants *from* silk pants.

>> **u/FaceDeer** [+2]  (2 hours later)
>> 
>> Does that app take epubs or other ebook formats? I recommend trying out [Calibre](http://calibre-ebook.com/)'s "FanFicFare" plugin, it can download and convert fanfiction from over a hundred different sites - including Fimfiction. I use it to collect and organize all of the fanfic I follow, and transfer stuff to my Kobo to read.

>>> **u/Riddle-Tom_Riddle** [+2]  (3 hours later)
>>> 
>>> It only downloads stories from fanfiction.net. The reason it is so awesome is because of that limitation.

> **u/Calamitizer** [+2]  *Shears* (4 minutes later)
> 
...
>> **u/Transfuturist** [+3]  *Carthago delenda est.* (27 minutes later)
>> 
>> :c
>> 
>> *encourages you in multifarious ways*

> **u/michaelos22** [+2]  (8 hours later)
> 
