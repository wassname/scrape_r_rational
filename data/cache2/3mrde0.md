...
* URL: https://www.reddit.com/r/rational/comments/3mrde0/q_if_you_could_copy_yourself_would_you/
* Score: 21

* Created: 2015-09-28T22:41:10
...
> **u/None** [+23]  (48 minutes later)
> 
> [deleted]

>> **u/noggin-scratcher** [+3]  *I am a happy tree* (56 minutes later)
>> 
...
>>>> **u/noggin-scratcher** [+5]  *I am a happy tree* (an hour later)
>>>> 
...
>> **u/puesyomero** [+6]  *The Culture* (2 hours later)
>> 
>> seconded
...
>> **u/Empiricist_or_not** [+1]  *Aspiring polite Hegemonizing swarm* (3 hours later)
>> 
>> thirded

> **u/LeonCross** [+8]  (an hour later)
> 
> One of me isn't a productive member of society. I'd be a dick to make clones, so no. Lol.

>> **u/FuguofAnotherWorld** [+2]  *Roll the Dice on Fate* (14 hours later)
>> 
...
> **u/literal-hitler** [+3]  (2 hours later)
> 
...
> **u/mhd-hbd** [+3]  *Writes 'The World is Your Oyster, The Universe is Your Namesake'* (12 hours later)
> 
...
>>> **u/TheStevenZubinator** [+2]  *Chaos Legion* (2 hours later)
>>> 
...
>>>> **u/RobertWinslow** [+1]  (17 hours later)
>>>> 
>>>> [Here is a video of Carl Sagan mixing together the chemical components of a human body.](https://youtu.be/FRTF4UMhTDc?t=92) No corpse required.

> **u/Chosen_Pun** [+2]  *The Chosen Ones* (7 hours later)
> 
...
> **u/nicholaslaux** [+2]  (22 hours later)
> 
...
> **u/NotAHeroYet** [+1]  *City of Angles Municipal Government* (4 hours later)
> 
...
> **u/IWearTheMask** [+0]  (4 hours later)
> 
> >Let's say I have a sci-fi replication machine that creates atomically perfect duplicates of whatever you put inside. Its not a magic mass-energy violation engine, it has to be supplied with raw material. The goal of the post is *not* to munchkin the machine, so don't worry about that. It won't damage the original either so don't worry about that as well.
> 
> >Anyway, I have this machine and I offer to let you use it to copy yourself. The copy will have your memories, personality, its identical to you in every way. Would you take me up on my offer?
...
> 
> [](/disshrug "Yes, I have sociopathic tendencies, why do you ask?")
