...
* Author: u/None *
* URL: https://www.reddit.com/r/rational/comments/2unmm7/qd_rationalist_wile_e_coyote_and_the_road_runner/
* Score: 17

* Created: 2015-02-03T17:34:53

### Post:

You are Wile E. Coyote.
How can you exploit the knowledge a higher power will cause your actions to comedically backfire when you attempt to catch the Road Runner? Also, can you catch the Road Runner?

### Comments:

> **u/EliezerYudkowsky** [+30]  *Godric Gryffindor* (2 hours later)
> 
...
>> **u/OffColorCommentary** [+13]  (4 hours later)
>> 
...
>>>>>>> **u/Transfuturist** [+2]  *Carthago delenda est.* (23 hours later)
>>>>>>> 
>>>>>>> Literal anti-optimization setting.

>>>> **u/Cruithne** [+2]  *Light Sith epistemologist* (a day later)
>>>> 
...
> **u/alexanderwales** [+18]  *Time flies like an arrow* (36 minutes later)
> 
...
>> **u/EliezerYudkowsky** [+4]  *Godric Gryffindor* (23 hours later)
>> 
...
> 
> [Sleeping with the Girls](https://www.fanfiction.net/s/5792734/1/Sleeping_with_the_Girls_Vol_I_Fictional_Reality) isn't rationalist, but the protagonist does make multiple rational decisions and he does have very good excuses for most irrational behavior.

>> **u/Sailor_Vulcan** [+6]  *Champion of Justice and Reason* (an hour later)
>> 
>> You mean this?
>> 
>> http://forums.sufficientvelocity.com/threads/no-matter-what-happens-i-still-wont-become-an-anime-character.9848/

> **u/Topher876** [+4]  (2 hours later)
> 
...
>> **u/Darth_Hobbes** [+6]  *Ankh-Morpork Guild of Assassins* (2 hours later)
>> 
...
>>>> **u/Darth_Hobbes** [+5]  *Ankh-Morpork Guild of Assassins* (3 hours later)
>>>> 
>>>> What if you flipped the audience off or made other obscene hand gestures? I've never seen a Loony Toon use a blur censor.

>>>> **u/Chosen_Pun** [+5]  *The Chosen Ones* (3 hours later)
>>>> 
>>>> > Now observe as I @#$% the bird with this @$#%@$#&%#.

>>> **u/endtime** [+3]  (9 hours later)
>>> 
>>> ...and out of the rifle pops a flag that says "BANG".

>>>> **u/Darth_Hobbes** [+3]  *Ankh-Morpork Guild of Assassins* (9 hours later)
>>>> 
>>>> [But wait, there's more.](http://goodcomics.comicbookresources.com/wp-content/uploads/2014/03/banggun.jpg)

> **u/puesyomero** [+3]  *The Culture* (7 hours later)
> 
...
> **u/psychothumbs** [+3]  (5 hours later)
> 
...
> **u/IomKg** [+3]  (6 hours later)
> 
> catching or actually eating the road runner, and by eating the question is it ok for the roadrunner to respawn in the end after i "win" or not.
> if the requirement is for an absolute zero-sum win then i would have to say it is impossible as its essentially a physics rule of that universe.
> 
> if the requirement is merely for me to catch it then all i would need to do is look sorry\sad etc and then "catch" the roadrunner in a friendly manner.
> that kind of thing is plausible.
> 
> if i need to specifically eat him but it doesn't "really" need to be him i would engineer some kind of situation where multiple roadrunners will exist(hire a few from a company, where i am expected to return them or other wise suffer a fine\pain), where most are not the real road runner and make some kind of an elaborate plan which is supposed to get me to eat him.
> which will backfire and cause me to eat one of my own roadrunners , thus for example needing to pay lots of money to the organization i rented it from.
> which would be funny. and would for a split second allow me to eat the roadrunner, before reality changed to me actually eating something else and the roadrunner being intact.

>> **u/IomKg** [+2]  (9 hours later)
>> 
>> thinking about this a bit more it might be possible to eat the "actual" road runner and let a fake\different one live.
>> 
>> there are 2 ways that i can see that hapenning depending on a condition.
>> am i on camera all of the time?
>> 
...
>> 
>> if no then i need to get into an alternate universe, thus i will lose the camera forever(it will follow the clone i switched with in that alternate universe during the mayhem) and i will get to eat the roadrunner.
>> it will just never be shown on screen.
>> 
...
> **u/chaosmosis** [+3]  *and with strange aeons, even death may die* (11 hours later)
> 
