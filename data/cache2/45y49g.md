...
>>>> **u/OrzBrain** [+7]  **Fingers* to *dance*, *hands* to *catch*, *arms* to *pull** (8 hours later)
>>>> 
>>>> > Might be a reference to the "can you recommend anything about a badass" thread that went through a little while ago. I never saw the actual text -- the OP deleted it before I got there -- but apparently it was to the effect of "literature has been getting feminized and we need to bring back the awesomeness of men". 
>>>> 
...
>>>> **u/FuguofAnotherWorld** [+6]  *Roll the Dice on Fate* (23 hours later)
>>>> 
...
> **u/Empiricist_or_not** [+5]  *Aspiring polite Hegemonizing swarm* (4 hours later)
> 
> Odysseus anyone?

> **u/khafra** [+5]  (18 hours later)
> 
...
> **u/mhd-hbd** [+4]  *Writes 'The World is Your Oyster, The Universe is Your Namesake'* (3 hours later)
> 
