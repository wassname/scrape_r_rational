...
* URL: https://www.reddit.com/r/rational/comments/64k3vi/d_monday_general_rationality_thread/
* Score: 14

* Created: 2017-04-10T15:04:19
...
>>>> 
>>>> While I agree that humans are not at all standardized, I think there are clearly better and worse teaching methods. Compare [video 1](https://www.youtube.com/watch?v=FzcTgrxMzZk) with [video 2](https://www.youtube.com/watch?v=hE37G6zVkFY). Obviously, video 1 is more for college level students while video 2 could be a high school to college level lecture, but I don't think I even need to say which one would be a more valuable teaching aid.
...
>>>> 
>>>> In any case, are people more likely to learn if you try to force them to? Or will they just regurgitate the teacher's password?
>>>> How many of the skills or knowledge that you learned in school do you still remember? And of the things you still remember, how much of it is things that were uninteresting or unuseful enough that you did not think it was worth it for you to learn it in the first place?
>>>> 
...
>> 
>> I'm not sure what you mean by non-standard, so I'm going to recommend the nuttiest thing I'm reading right now, [Sluggy Freelance](http://www.sluggy.com/nvg). It's a online comic strip that's been running for about twenty years and the best description I have for it is Bill & Ted's Bogus Journey meets Seinfeld. 
>> 
...
> 
> Anyone know something shorter and less move-to-San-Francisco than [this](https://www.appacademy.io/) for learning web development?  I've probably just about found a new job (finally), but I really do feel like holy shit, I've waaaaay missed out on *most* of the job market by not learning web.
> 
...
>> **u/space_fountain** [+1]  (9 hours later)
>> 
...
>> **u/rebusglider** [+1]  (16 hours later)
>> 
>> For web development you could try [FreeCodeCamp](https://www.freecodecamp.com).

>>> **u/None** [+1]  (20 hours later)
>>> 
>>> Thanks a ton!

>> **u/thekevjames** [+1]  (6 days later)
>> 
...
>> 
>> Check out a list like [this](https://github.com/tastejs/awesome-app-ideas) for inspiration.
...
>>> 
>>> I know you probably meant in 1700s France/breaking the curse, but I'll just [leave my polycule diagram here](http://imgur.com/HM9XXvt) as a counter-example just in case. (I'm Carp in the diagram)
...
>> 
>> Here's a nice [story](https://forums.sufficientvelocity.com/threads/like-gaston-a-disneys-beauty-and-the-beast-si.29906/) about *Beauty and the Beast* that you might like, but it's dead so be warned.

> **u/blazinghand** [+1]  *Chaos Undivided* (10 hours later)
> 
> Hackernews thread on how much of time at work is spent working: [(link)](https://news.ycombinator.com/item?id=14082599)

> **u/Teal_Thanatos** [+1]  (12 hours later)
> 
> Previous monday had people declare that they were incapable of being persuaded to release an AI from a box.
> Is it just me or is that completely irrational that they have a belief yet no evidence?
