...
* Author: u/jacky986 *
* URL: https://www.reddit.com/r/rational/comments/lb5yb7/rational_works_of_fiction_about_interspecies/
* Score: 31

* Created: 2021-02-02T20:46:03
...
> **u/ArgentStonecutter** [+22]  *Emergency Mustelid Hologram* (10 minutes later)
> 
...
> **u/PastafarianGames** [+11]  (37 minutes later)
> 
...
>> **u/plutonicHumanoid** [+1]  (7 hours later)
>> 
...
>>> **u/D0TheMath** [+3]  *Dragon Army* (4 hours later)
>>> 
>>> I'd argue it's a bit more nuanced than that, but fair enough.

> **u/Kheldarson** [+6]  (7 hours later)
> 
...
>>>> **u/Roneitis** [+16]  (11 hours later)
>>>> 
>>>> The capacity to consent is /everything/

>>>> **u/RMcD94** [+6]  (11 hours later)
>>>> 
...
>>>>>> **u/RMcD94** [+7]  (17 hours later)
>>>>>> 
>>>>>> Did anyone say "first instinct"?

>> **u/ArmokGoB** [+17]  (an hour later)
>> 
>> ... You're new to the internet, aren't you?

>> **u/zombieking26** [+6]  (3 hours later)
>> 
...
>> **u/callmesalticidae** [+1]  *writes worldbuilding books* (7 hours later)
>> 
...
>>> **u/callmesalticidae** [+5]  *writes worldbuilding books* (8 hours later)
>>> 
...
>>> **u/MagmaDrago** [+1]  (15 hours later)
>>> 
>>> > why can't Mass Effect let me romance all of the hot aliens at once?
>>> 
>>> muh immersion

>> **u/jacky986** [+2]  (7 hours later)
>> 
...
>>> **u/NestorDempster** [+1]  (4 days later)
>>> 
...
>> **u/Bowbreaker** [+17]  *Solitary Locust* (2 hours later)
>> 
...
>> **u/RavensDagger** [+10]  (5 hours later)
>> 
>> >Relationships are about sex and sex is about children. 
>> 
...
>> **u/Putnam3145** [+7]  (12 hours later)
>> 
>> > Relationships are about sex and sex is about children. 
>> 
>> why do you think you know this?

>> **u/zombieking26** [+5]  (3 hours later)
>> 
...
>>> **u/callmesalticidae** [+6]  *writes worldbuilding books* (18 hours later)
>>> 
...
>>>>> **u/callmesalticidae** [+10]  *writes worldbuilding books* (21 hours later)
>>>>> 
...
>>>>>> **u/dobri111** [-1]  (22 hours later)
>>>>>> 
>>>>>> Honestly, author made mention of coupling of people from different cultures, but basicaly human and asked about "inter species relationship". I just mentioned that his examples are same species, not different and that the struggles if biological are minor and most problems come from culture differences.
>>>>>> All of those fictions he mentioned do not even atempt to disguse that their "aliens" are just different cultures from earth.

>>>>>>> **u/callmesalticidae** [+10]  *writes worldbuilding books* (22 hours later)
>>>>>>> 
...
>>>>>>>> **u/LameJames1618** [+2]  (a day later)
>>>>>>>> 
>>>>>>>> Actually, Superman has a canon half-Kryptonian half-human child with Lois.

> **u/edwardkmett** [+1]  (5 days later)
> 
> Perdido Street Station dips into forbidden man-bug romance. I don't recall how seriously it takes the cultural divisions other than the forbidden love angle, and a girl with a bug head, as it has been a long time since I read it. It isn't _particularly_ rational, except insofar as China Miéville generally tries to make characters live with consequences of their actions.

> **u/DomesticatedDungeon** [+1]  (7 days later)
> 
> * [*Symbiote*](https://farmerbob1.wordpress.com/2014/04/18/table-of-contents/) (non-romantic relations, high quality, high-ratinoal) — the psychology of the symbiote species is explored quite thoroughly, some edge cases and bad developments are showcased.
> 
> * [*Outer Sphere, The*](https://www.royalroad.com/fiction/21178/the-outer-sphere) (romantic relations, mid-to-high quality, mid-to-high rational) — long-term romantic relations with an anglerfish-type monstergirl are described, some difficulties of everyday life are explored, etc.
> 
> * [*The \(questionable\) burdens of leadership of a troll Emperor*](https://www.fanfiction.net/s/10917821/1/The-questionable-burdens-of-leadership-of-a-troll-Emperor)  — (non-romantic relations, average quality / rationality) IIRC, this story had descriptions of society in which [symbiotic](https://stargate.fandom.com/wiki/Symbiote) relations were quite common, described some difficult decisions some characters had to make, etc. Note of warning: is the 4th book in the series, smut is a major genre for the series.
