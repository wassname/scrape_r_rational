...
>>> **u/SimoneNonvelodico** [+10]  *Dai-Gurren Brigade* (9 hours later)
>>> 
...
>>>> **u/Frommerman** [+10]  (10 hours later)
>>>> 
...
>>>>> **u/SimoneNonvelodico** [+9]  *Dai-Gurren Brigade* (11 hours later)
>>>>> 
...
>>>>>>> **u/SimoneNonvelodico** [+12]  *Dai-Gurren Brigade* (11 hours later)
>>>>>>> 
...
>>>> **u/Bowbreaker** [+11]  *Solitary Locust* (5 hours later)
>>>> 
>>>> Lots of scarcity is artificial or due to hoarding.

>>>>> **u/vimefer** [+0]  (5 hours later)
>>>>> 
>>>>> Only if you include "intellectual property".

>>>>>> **u/Frommerman** [+6]  (5 hours later)
>>>>>> 
>>>>>> Why should we not?

>>>>>>> **u/vimefer** [+9]  (5 hours later)
>>>>>>> 
...
>>>>>> **u/Frommerman** [+20]  (7 hours later)
>>>>>> 
>>>>>> Compelled in the sense of a [Hobson's Choice](https://en.m.wikipedia.org/wiki/Hobson%27s_choice#:~:text=A%20Hobson's%20choice%20is%20a,take%20it%20or%20leave%20it%22.) where the other option is being erased from existence. It's not an actual free choice, because rational actors don't choose to die except under some kind of compulsion. The off switch problem is one of the biggest issuses with AI alignment for a reason.
>>>>>> 
...
>>>>>>> 
>>>>>>> I think ownership of the production means has been largely [regulatorily recaptured](https://en.wikipedia.org/wiki/Regulatory_capture) by a socially-reproducing undeserving elite.

>>>>>>>> **u/Frommerman** [+2]  (7 hours later)
>>>>>>>> 
>>>>>>>> Look at me doing the whole, "socialism is good, actually" speech to someone who already seems to get it. Don't I feel silly.

>>>>>>>>> **u/vimefer** [+4]  (7 hours later)
>>>>>>>>> 
...
>>>>>>>>>>> **u/vimefer** [+3]  (7 hours later)
>>>>>>>>>>> 
>>>>>>>>>>> If you really want a label, I'll take "stigmergic socialist".

>> **u/SimoneNonvelodico** [+9]  *Dai-Gurren Brigade* (9 hours later)
>> 
...
>> **u/GreenSatyr** [+3]  (3 months later)
>> 
>> They are blueberries and red lollipops don't worry ❤💙❤💙

> **u/Empiricist_or_not** [+7]  *Aspiring polite Hegemonizing swarm* (a day later)
> 
...
>> **u/natron88** [+1]  *Ankh-Morpork City Watch* (3 months later)
>> 
>> >For those of us signed up for cryonics or planning that way, what legal machinery have you set up to preclude this, or other forms of mind capture?
>> 
...
>> 
>> It would be pretty surprising and disappointing to me if humans couldn't manage to make a reasonably good future _even with_ brain uploading level tech. We should be well into post scarcity by then.

> **u/None** [+7]  (5 hours later)
> 
> Hopefully, we'll have a friendly AI to protect our uploaded minds from this.

> **u/Nic_Cage_DM** [+5]  (3 hours later)
> 
> well that's terrifying

> **u/VanPeer** [+2]  *The shard made me do it* (14 hours later)
> 
