...
* URL: https://www.reddit.com/r/rational/comments/zvov5c/d_monday_request_and_recommendation_thread/
* Score: 37

* Created: 2022-12-26T15:00:08
...
> **u/everything_is_rigged** [+56]  (3 hours later)
> 
...
>> **u/NTaya** [+13]  *Tzeentch* (4 hours later)
>> 
...
>>> **u/FeO_Chevalier** [+11]  (6 hours later)
>>> 
...
>>>> **u/NTaya** [+9]  *Tzeentch* (11 hours later)
>>>> 
...
>>>>> **u/FeO_Chevalier** [+11]  (13 hours later)
>>>>> 
...
>>>>>>> **u/FeO_Chevalier** [+10]  (a day later)
>>>>>>> 
>>>>>>> >Seiji is not happy to have been plucked from his life and is in fact extremely pissed and resistant to the process.
>>>>>>> 
...
>> **u/numdegased** [+10]  (17 hours later)
>> 
...
> **u/fassina2** [+7]  *Progressive Overload* (2 days later)
> 
...
>> **u/_brightwing** [+2]  *Feathered menace* (3 days later)
>> 
...
>> 
>> Edge tts uses Microsoft Natural Voices, which is cloud based AI powered text to speech. If you want something as good you're going to have to use another AI powered text to speech service. The commercial services are pretty pricy, with Microsoft's own going for about $16 per 1M characters (which is like one book? 1.5?).
>> 
>>  It's possible to set up your own AI tts service hosted on your own machine, but you'll probably need a beefy gpu and quite a bit of tinkering. If you have knowledge of python it'll probably be possible to parse an epub into sentences then feed each sentence into the AI using tensorflow or pytorch. But as I said, you'll probably have to tinker a lot with the pretrained models and epub parsing.

>>> **u/fassina2** [+1]  *Progressive Overload* (3 days later)
>>> 
>>> Every extension that does it on chrome is open source, so it's technically not hard to do. What you need is the voice files, you can download several for free but they tend to be low quality. 
>>> 
>>> &#x200B;
>>> 
>>> Windows by itself has the functionality to do tts and it can use any voices you have installed. The thing is the good ones are not available to download because they think everyone is going to use it for business, to make ads and other content which is valuable so they charge people for it. 
>>> 
>>> &#x200B;
>>> 
>>> It's inconvenient for us though, I just want to read some fiction.

> **u/Aggravating-Error679** [+6]  (3 days later)
> 
...
>>> **u/Aggravating-Error679** [+1]  (5 days later)
>>> 
...
>> **u/MrEreN** [+1]  (8 days later)
>> 
>> Can you link the swiss confederation? I can not find it.

>>> **u/Aggravating-Error679** [+2]  (8 days later)
>>> 
>>> https://forums.spacebattles.com/threads/swiss-arms-historical-gamer-si.980610/
>>> 
>>> Enjoy!
...
> **u/TOTMGsRock** [+6]  *NERV* (6 days later)
> 
