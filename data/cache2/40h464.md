...
* URL: https://www.reddit.com/r/rational/comments/40h464/d_monday_general_rationality_thread/
* Score: 7

* Created: 2016-01-11T15:05:03
...
> **u/trifith** [+13]  *Man plans, god laughs. Like the ant and the grasshopper.* (45 minutes later)
> 
...
> **u/scooterboo2** [+2]  *Tinker 3: Embeded Systems* (an hour later)
> 
...
>>> **u/Transfuturist** [+9]  *Carthago delenda est.* (13 hours later)
>>> 
>>> Top reasons we're not having FUN:
>>> 
>>> * Moloch
...
>>>> **u/Roxolan** [+6]  *Head of antimemetiWalmart senior assistant manager* (9 hours later)
>>>> 
...
>>>>> **u/Transfuturist** [+4]  *Carthago delenda est.* (13 hours later)
>>>>> 
>>>>> The power consumption (I think), switching time, and read/write/cache speed of physical memory is one of the biggest bottlenecks for performance. [See Agner's blog.](http://www.agner.org/optimize/blog/read.php?i=417)
>>>>> 
...
>> **u/Predictablicious** [+4]  *Only Mark Annuncio Saves* (2 hours later)
>> 
...
>>> **u/Jace_MacLeod** [+3]  (12 hours later)
>>> 
>>> 10,000 years to beat the second law of thermodynamics might be a *wee bit* optimistic.

>>>> **u/Predictablicious** [+2]  *Only Mark Annuncio Saves* (18 hours later)
>>>> 
...
>>>>>> **u/UltraRedSpectrum** [+1]  (15 hours later)
>>>>>> 
...
>>>> **u/UltraRedSpectrum** [+2]  (15 hours later)
>>>> 
...
>>>>> **u/BoilingLeadBath** [+2]  (20 hours later)
>>>>> 
...
>> 
>> RE: Normative Theory, maybe I can help, since I don't know what normative theory is. Is it "Normative Ethics" [(wikipedia link)](https://en.wikipedia.org/wiki/Normative_ethics#Normative_ethical_theories)? I don't know anything about it so it's not packed in with other things for me.
>> 
...
> 
> Well [this](http://www.eurekalert.org/pub_releases/2016-01/lu-twy011116.php) is an interesting tool.
> 
