...
* URL: https://www.reddit.com/r/rational/comments/8taios/d_saturday_munchkinry_thread/
* Score: 23

* Created: 2018-06-23T15:06:39
...
> **u/Kaos_Dragon** [+8]  *Ankh-Morpork Guild of Assassins* (an hour later)
> 
...
>> 
>> * using it to make electricity [(with a generator)](https://gravitylight.org/) maybe moving a generator wheel with your earthbending
>> 
...
>> **u/TheJungleDragon** [+6]  (4 hours later)
>> 
...
>> **u/Ironsides1985** [+2]  (2 hours later)
>> 
...
>> **u/Kuratius** [+2]  (3 hours later)
>> 
>> Bore holes. Mining. Undersea tunnels. Tunnel from Japan to Korea? No problem, won't take decades, just a few months.
>> Edit: Mars/Moonbase made out of rock tunnels? If you can get there somehow, that is.

>> **u/babalook** [+2]  (10 hours later)
>> 
...
> **u/keeper52** [+5]  (14 hours later)
> 
> [Borrowing from Marginal Revolution](https://marginalrevolution.com/marginalrevolution/2018/06/what-if-sleep-was-a-commodity.html), what if sleep was a commodity that could be bought or sold?
> 
...
>>>>>>> 
>>>>>>> Well yeah I haven't actually seen the scene so I was saying _based on the information in your comment_ that some versions of the scenario described wouldn't requiere superhuman hearing.
...
>>>>>> 
>>>>>> This isn´t like normal technology or other surveillance systems, this kind of thing enhances individual people. At worst it would result in a few elite super spies, but that wouldn´t be a major survilance concern in the same way wire tapping is.
>>>>>> Also, at least in the Daredevil Netflix Series, Matt doesn´t have incredibly powerful supernatural hearing, just enhanced hearing and the supernatural ability to process what he hears (as shown when can´t hear when someone is saying on phone to Foggy unless he focuses). 
>>>>>> 
...
>>>>>>> **u/vakusdrake** [+1]  (3 days later)
>>>>>>> 
>>>>>>> Well firstly it may not be supernatural hearing but another comment mentioned him hearing conversations from a block away so that's certainly super_human_. 
>>>>>>> 
...
>>>>>>>> Seeing where how far we´ve come from being hunter gatherers, humans have already adapted to many, many things; why not super senses?
...
>>>>>>>>>>>>> 
>>>>>>>>>>>>> The evidence for something like this does seem pretty good; after all how many people that rant about insane shit on their personal twitter would feel comfortable doing that in "public", despite _less_ people hearing them, and it being _less_ likely to personally affect them (since employers check people's social media)? 
>>>>>>>>>>>>> 
