...
* URL: http://www.crunchyroll.com/blast-of-tempest
* Score: 11

* Created: 2015-02-09T14:55:55
...
> **u/AmeteurOpinions** [+6]  *Finally, everyone was working together.* (a minute later)
> 
...
>>>> 
>>>> well, first three episodes is not that little.
>>>> sure plenty of reviewers go with the "let's just summarize episode 1" as their approach to making a synopsis, but even then its just 1 episode.
>>>> And actually the really good descriptions usually don't do even that..
>>>> 
>>>> [not wanting anyone who has yet to figure it out to do so because of me](#s " you did hint at something which i'm pretty sure wasn't shown at episode 3.. sure you didn't actually say who it is but if someone will remember what you said and as a result try to figure it out from the beginning it is actually possible they will do so, which will ruin the surprise")
...
>>> **u/Adamantium9001** [+3]  *United Federation of Planets* (12 hours later)
>>> 
...
>>>>> **u/Adamantium9001** [+2]  *United Federation of Planets* (13 hours later)
>>>>> 
...
>> **u/triangleman83** [+2]  (an hour later)
>> 
