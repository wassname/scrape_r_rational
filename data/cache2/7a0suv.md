...
>>>>>>>>>>> **u/ben_oni** [+3] *
>>>>>>>>>>> 
>>>>>>>>>>> So, no back-of-the-envelope calculations. Just outright lies. Fine. You know, you could just read [the actual reports](https://www.ipcc.ch/publications_and_data/publications_and_data_reports.shtml).
...
>>> Nah. The overwhelmingly vast proportion of the population will 
>>>  be emulated minds because it'll be far cheaper to spin up EMs that it would be to make a biological person. Compared to the preponderance of people living in digital space, only a minority of people would die in any techno revolution.
>>> 
...
>>>>>>>>>>> When it comes to clusters of computers, well, [as of 2012, google had ~40*10^15 petaflops of processing power available to it](https://plus.google.com/+JamesPearn/posts/gTFgij36o6u), and of course that number has only grown (exponentially) since then. Yeah, that was the computing power of a megacorporation, but currently, [the US and China are competing to build an exascale (10^18 flops) supercomputer](https://arstechnica.com/information-technology/2017/06/us-doe-the-machine-exascale-supercomputer/). And again, computers have been getting better, cheaper, and more efficient for more than forty years straight, and the process shows no signs of stopping (even if it does show signs of slowing down.)
...
>>>>>>>>>>>>>> **u/ben_oni** [+1] *
>>>>>>>>>>>>>> 
>>>>>>>>>>>>>> These are good points, and I have to admit I go back and forth on the issue, depending on how cynical I am at the time. I'll just give one argument right now that is likely to appeal to the r/rational community: the anthropic principle.
>>>>>>>>>>>>>> If synthetic intelligence is possible, we would expect, as u/GaBeRockKing has been arguing, that they would be the dominant form of life. Since I find that I am a meat-form intelligence and not a synthetic intelligence, I must consider that either synthetic minds are rare throughout all of time and space (relative to expectations); or else that most synthetic minds begin existence as a meat-form intelligence.
