...
>>>> **u/drageuth2** [+2]  (6 hours later)
>>>> 
>>>> Finding a renewable source of negentropy would prolly be close enough to 'defeating' entropy to count.  Otherwise, finding a way to travel to different universes/_create_ new universes, or just to induce and survive a big-crunch-big-bang reboot of our own universe.
...
>>>>>> **u/drageuth2** [+3]  (6 hours later)
>>>>>> 
>>>>>> Yyyyyep.  But there could always be some way around that.  Fold a little section of space off into a  sub-universe that we _can_ crunch, maybe?  Some trick with black holes?  Just plain clarke's-third-law stuff that we can't even imagine yet?
>>>>>> 
...
>>>>>>>> 
>>>>>>>> [A](#s " The sobernost, are simulating history and to make everyonoe, but they will only keep people that actually lived, the drafts made from whole cloth are drafts even if they were sentient in simulation. The sobernost are the early  anti-death transhumanists that lost the first revolution, emigrated to the virtual and then off earth, then later came back with diamond computuers in the planet sizes in close solar orbit.  They aren't running.  They don't run AIs they just fork, AIs turned out to be something they had to keep locked up. ")

>>>>>>>>> **u/None** [+2]  (a day later)
>>>>>>>>> 
>>>>>>>>> Yes, that's completely infeasible and also appalling.

> **u/VorpalAuroch** [+4]  *Life before Death* (9 hours later)
> 
> One of the interesting deviations from MoR is that Professor Verres is much more rational here.

>> **u/tilkau** [+2]  (20 hours later)
>> 
...
> **u/Evilness42** [+3]  *And even myth is long forgotten...* (10 hours later)
> 
> Why exactly did the posts of this story skip from 17 to 98 and keep climbing up from there?

>> **u/Putnam3145** [+3]  (11 hours later)
>> 
>> ? They started at 81.

>>> **u/Evilness42** [+0]  *And even myth is long forgotten...* (11 hours later)
>>> 
...
>>>>> **u/Evilness42** [-1]  *And even myth is long forgotten...* (11 hours later)
>>>>> 
>>>>> Gah... This sort of thing annoys me.

>>>> **u/heiligeEzel** [+1]  (11 hours later)
>>>> 
...
>>>>> **u/Evilness42** [-2]  *And even myth is long forgotten...* (11 hours later)
>>>>> 
>>>>> Gah... This sort of thing annoys me.
