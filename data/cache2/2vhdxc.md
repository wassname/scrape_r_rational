## [FF][RST] The Waves Arisen [Ch.17]

* Author: u/Wertifloke *
* URL: https://wertifloke.wordpress.com/2015/02/10/the-waves-arisen-chapter-17/
* Score: 29

* Created: 2015-02-11T01:01:21

### Post:

[Link to content](https://wertifloke.wordpress.com/2015/02/10/the-waves-arisen-chapter-17/)

### Comments:

> **u/PeridexisErrant** [+14]  *put aside fear for courage, and death for life* (8 minutes later)
> 
> Team Seven is *absurdly* overpowered.
> 
> I love it.

>> **u/eaglejarl** [+10]  (3 hours later)
>> 
>> You want absurdly overpowered?  Here's what they need to learn: [Chakra Transfer Technique](http://naruto.wikia.com/wiki/Chakra_Transfer_Technique). In canon, Naruto was able to mold chakra into the recipient's elemental nature for their convenience. It's also possible to pass on nature chakra, so Hinata doesn't have to bother learning Sage Mode. 
>> 
...
>>>>>>>> **u/Izeinwinter** [+1]  (14 hours later)
>>>>>>>> 
...
>>> **u/autowikiabot** [+2]  (3 hours later)
>>> 
>>> #####&#009;
>>> 
>>> ######&#009;
>>> 
>>> ####&#009;
>>>  [**Chakra Transfer Technique**](https://naruto.wikia.com/wiki/Chakra%20Transfer%20Technique): [](#sfw) 
>>> 
>>> ---
>>> >This technique was originally created by [Hagoromo Ōtsutsuki](https://naruto.wikia.com/wiki/Hagoromo_%C5%8Ctsutsuki) in order to "connect" the spiritual energies of every living person. His intention was for it to be used to build and maintain peace through his religion of [ninshū](https://naruto.wikia.com/wiki/Ninsh%C5%AB), but this technique ended up becoming another tool for war when humanity weaponised chakra. This technique is used by many shinobi, each one of them has shown to use technique in different ways. Once, the user transfers its chakra, he/she is able to manipulate that chakra remotely.
>>> >
>>> ^Interesting: [^Chakra](https://naruto.wikia.com/wiki/chakra) ^| [^Tailed ^Beast ^Transfer ^Technique](https://naruto.wikia.com/wiki/tailed beast transfer technique) ^| [^Mind ^Body ^Switch ^Technique](https://naruto.wikia.com/wiki/mind body switch technique) ^| [^Chakra ^Threads](https://naruto.wikia.com/wiki/chakra threads) 
>>> 
>>> ^Parent ^commenter ^can [^toggle ^NSFW](http://www.np.reddit.com/message/compose?to=autowikiabot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+cohtonh) ^or[](#or) [^delete](http://www.np.reddit.com/message/compose?to=autowikiabot&subject=AutoWikibot Deletion&message=%2Bdelete+cohtonh)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikiabot/wiki/index) ^|  [^Source](https://github.com/Timidger/autowikiabot-py)
...
> **u/adad64** [+13]  *Chaos Legion* (20 minutes later)
> 
...
> **u/scruiser** [+10]  *CYOA* (55 minutes later)
> 
...
> **u/blockbaven** [+6]  (54 minutes later)
> 
> So many fucking powerups

>> **u/Transfuturist** [+12]  *Carthago delenda est.* (an hour later)
>> 
>> I know, isn't it *awesome?* :D

>> **u/gabbalis** [+4]  (an hour later)
>> 
>> -A-
>> 
>> Get Equipped
...
> **u/traverseda** [+3]  *With dread but cautious optimism* (29 minutes later)
> 
...
>> **u/PeridexisErrant** [+5]  *put aside fear for courage, and death for life* (42 minutes later)
>> 
...
>>>>>> **u/PeridexisErrant** [+1]  *put aside fear for courage, and death for life* (11 hours later)
>>>>>> 
...
>>>>>>>> **u/Izeinwinter** [+2]  (14 hours later)
>>>>>>>> 
...
>>>>>>>>>> 
>>>>>>>>>> You can check out [Shoemaker-Levy](https://en.wikipedia.org/wiki/Comet_Shoemaker%E2%80%93Levy_9) for an example of 2-km fragments from orbit, which is roughly what I was proposing.  Our median 8-km comet would be ~64 times more energetic even before the higher speed was taken into account!

>>>>>>>>>>> **u/autowikibot** [+1]  (20 hours later)
>>>>>>>>>>> 
>>>>>>>>>>> #####&#009;
>>>>>>>>>>> 
>>>>>>>>>>> ######&#009;
>>>>>>>>>>> 
>>>>>>>>>>> ####&#009;
>>>>>>>>>>>  [**Comet Shoemaker–Levy 9**](https://en.wikipedia.org/wiki/Comet%20Shoemaker%E2%80%93Levy%209): [](#sfw) 
>>>>>>>>>>> 
>>>>>>>>>>> ---
>>>>>>>>>>> 
>>>>>>>>>>> >
>>>>>>>>>>> 
>>>>>>>>>>> >__Comet Shoemaker–Levy 9__ ([formally designated](https://en.wikipedia.org/wiki/Astronomical_naming_conventions#Comets) __D/1993 F2__) was a [comet](https://en.wikipedia.org/wiki/Comet) that broke apart and collided with [Jupiter](https://en.wikipedia.org/wiki/Jupiter) in July 1994, providing the first direct observation of an extraterrestrial collision of [Solar System](https://en.wikipedia.org/wiki/Solar_System) objects.  This generated a large amount of coverage in the popular media, and the comet was closely observed by [astronomers](https://en.wikipedia.org/wiki/Astronomy) worldwide. The collision provided new information about Jupiter and highlighted its role in reducing [space debris](https://en.wikipedia.org/wiki/Space_debris) in the [inner Solar System](https://en.wikipedia.org/wiki/Solar_System#Inner_planets).
>>>>>>>>>>> 
>>>>>>>>>>> >The comet was discovered by astronomers [Carolyn](https://en.wikipedia.org/wiki/Carolyn_S._Shoemaker) and [Eugene M. Shoemaker](https://en.wikipedia.org/wiki/Eugene_Merle_Shoemaker) and [David Levy](https://en.wikipedia.org/wiki/David_H._Levy).  Shoemaker–Levy 9, at the time captured by and orbiting Jupiter, was located on the night of March 24, 1993, in a photograph taken with the 40 cm (16 in) [Schmidt telescope](https://en.wikipedia.org/wiki/Schmidt_camera) at the [Palomar Observatory](https://en.wikipedia.org/wiki/Palomar_Observatory) in [California](https://en.wikipedia.org/wiki/California). It was the first comet observed to be orbiting a planet, and had probably been captured by the planet around 20 – 30 years earlier.
>>>>>>>>>>> 
>>>>>>>>>>> >Calculations showed that its unusual fragmented form was due to a previous closer approach to Jupiter in July 1992. At that time, the orbit of Shoemaker–Levy 9 passed within Jupiter's [Roche limit](https://en.wikipedia.org/wiki/Roche_limit), and Jupiter's [tidal forces](https://en.wikipedia.org/wiki/Tidal_force) had acted to pull apart the comet. The comet was later observed as a series of fragments ranging up to 2 km (1.2 mi) in diameter. These fragments collided with Jupiter's southern hemisphere between July 16 and July 22, 1994, at a speed of approximately 60 km/s (37 mi/s) or 216,000 km/h (134,000 mph). The prominent scars from the impacts were more easily visible than the [Great Red Spot](https://en.wikipedia.org/wiki/Great_Red_Spot) and persisted for many months.
>>>>>>>>>>> 
>>>>>>>>>>> >====
>>>>>>>>>>> 
>>>>>>>>>>> >[**Image**](https://i.imgur.com/VNhYx1D.jpg) [^(i)](https://commons.wikimedia.org/wiki/File:SL9_BDGLNQ12R_hst19.jpg)
>>>>>>>>>>> 
>>>>>>>>>>> ---
>>>>>>>>>>> 
>>>>>>>>>>> ^Interesting: [^118P/Shoemaker–Levy](https://en.wikipedia.org/wiki/118P/Shoemaker%E2%80%93Levy) ^| [^138P/Shoemaker–Levy](https://en.wikipedia.org/wiki/138P/Shoemaker%E2%80%93Levy) ^| [^129P/Shoemaker–Levy](https://en.wikipedia.org/wiki/129P/Shoemaker%E2%80%93Levy) ^| [^Eugene ^Merle ^Shoemaker](https://en.wikipedia.org/wiki/Eugene_Merle_Shoemaker) 
>>>>>>>>>>> 
>>>>>>>>>>> ^Parent ^commenter ^can [^toggle ^NSFW](/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+coikviy) ^or[](#or) [^delete](/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+coikviy)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)
...
>>> **u/scruiser** [+1]  *CYOA* (3 hours later)
>>> 
>>> Capture a significant portion of the energy output of the sun, then convert energy to mass?

>>>> **u/PeridexisErrant** [+1]  *put aside fear for courage, and death for life* (3 hours later)
>>>> 
...
> 
> Edit:
> Actually, whether the nine-tailed beast is a mind virus depends on what happens if Naruto becomes the beast while there are still clonces running around. Strictly speaking it depends on the details of how shadow clones transfer their memories.

> **u/dodriohedron** [+0]  (11 hours later)
> 
...
>>> **u/dodriohedron** [-1]  (20 hours later)
>>> 
...
>>>>> **u/dodriohedron** [+2]  (21 hours later)
>>>>> 
