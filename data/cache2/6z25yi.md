...
* URL: https://www.reddit.com/r/rational/comments/6z25yi/d_saturday_munchkinry_thread/
* Score: 13

* Created: 2017-09-09T15:06:43
...
> **u/IgnorantTwit** [+7]  (2 hours later)
> 
...
>>> **u/IgnorantTwit** [+2]  (2 hours later)
>>> 
...
>>>>> **u/addmoreice** [+1]  (3 hours later)
>>>>> 
>>>>> or I put it in my mouth.

>>> **u/xkcd_transcriber** [+1]  (2 hours later)
>>> 
>>> [Image](https://imgs.xkcd.com/comics/wings.png)
>>> 
>>> [Mobile](https://m.xkcd.com/620/)
>>> 
>>> **Title:** Wings
>>> 
>>> **Title-text:** Please do not try any of this and die or get arrested\.
>>> 
>>> [Comic Explanation](https://www.explainxkcd.com/wiki/index.php/620#Explanation)
>>> 
>>> **Stats:** This comic has been referenced 47 times, representing 0.0280% of referenced xkcds.
>>> 
>>> ---
>>> ^[xkcd.com](https://www.xkcd.com) ^| ^[xkcd sub](https://www.reddit.com/r/xkcd/) ^| ^[Problems/Bugs?](https://www.reddit.com/r/xkcd_transcriber/) ^| ^[Statistics](http://xkcdref.info/statistics/) ^| ^[Stop Replying](https://reddit.com/message/compose/?to=xkcd_transcriber&subject=ignore%20me&message=ignore%20me) ^| ^[Delete](https://reddit.com/message/compose/?to=xkcd_transcriber&subject=delete&message=delete%20t1_dms1wa2)
...
>>> **u/Tinfoil_Haberdashery** [+12]  (4 hours later)
>>> 
...
>> **u/metric_units** [+4]  (2 hours later)
>> 
>> 80 lb ≈ 36 kg  
>> 400 lb ≈ 180 kg
>> 
...
>>> **u/phylogenik** [+1]  (13 hours later)
>>> 
>>> > Also nobody mentioned Randi's prize yet so this is the obligatory reference.
>>> 
>>> By that do you mean [this thing](http://web.randi.org/the-million-dollar-challenge.html)? Or is there some other one in play now?
>>> 
...
> **u/I_Hump_Rainbowz** [+1]  (6 hours later)
> 
...
>>> **u/I_Hump_Rainbowz** [+1]  (9 hours later)
>>> 
...
>>> **u/AnimalFactsBot** [+2]  (a day later)
>>> 
...
>> **u/ShiranaiWakaranai** [+6]  (12 hours later)
>> 
...
>>> **u/696e6372656469626c65** [+4]  *I think, therefore I am pretentious.* (12 hours later)
>>> 
...
>>>>>> **u/ShiranaiWakaranai** [+1]  (17 hours later)
>>>>>> 
...
>>>>>>>>>> Importantly here cleaning an object will _never_ be the same as reverting it's temporal state. Because a few atoms of the material will always have escaped due to processes ranging from sublimation to quantum tunneling.
>>>>>>>>>> 
>>>>>>>>>> >Maybe I'm just being dense here, but I'm not seeing how this works. Elaborate? I'm not even seeing how to get one bit of the AI in this way (though if I can get one bit reliably, I can then see how to get all the bits)
>>>>>>>>>> 
...
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> This is one potential point of trouble, and it is a big one. What happens when you search through future worlds for [the perfect AI](http://lesswrong.com/lw/jao/siren_worlds_and_the_perils_of_overoptimised/) according to your list of criteria might not be what you intend to happen...
...
>>>>>>>>>>>> >I don't think it would be completely post-scarcity, though the world would certainly have different scarcities while you and your power remain present. (Major scarcity: matter. Your power works only by destroying it, never creating it, so your power has a limit there.)
>>>>>>>>>>>> 
>>>>>>>>>>>> While at pre singularity tech levels we would have _some_ limits that seems besides the point that this still meets the criterion for a post scarcity civilization even if it's not post singularity.                        
...
>>>>>>>>>>>> >...not so helpful. Wanting to get there before the "other guy" tends to help humans to work harder. (The easy fix for this, of course, is to control two or three different tech companies yourself and play them off against each other...)
>>>>>>>>>>>> 
>>>>>>>>>>>> Yeah I suppose I mostly agree with you. The issues I was concerned with really are only an issue with AI wherein rushing it almost certainly kills everyone. Why competition is a terrible idea was of course covered in _Superintelligence_ and also I'm pretty sure it was in one of [Robert Miles Youtube](https://www.youtube.com/channel/UCLB7AzTwc6VFZrBsO2ucBMg/videos?shelf_id=1&sort=dd&view=0) videos, though I'm not sure which one, though they're all pretty great and that channel and the videos he did on computerphile are probably the best videos on the topic on youtube if not anywhere online.
...
>>>>>>>>>>>>>> >This depends a lot on exactly how the brain stores memories. Does it really compartmentalise to that extent, or are memories built on top of each other, such that every individual memory touches on almost every neuron in some way?
>>>>>>>>>>>>>> 
>>>>>>>>>>>>>> I think neuroscience would generally support a significant degree of compartmentalization [based on research that was able to link memories to individual neurons](https://www.extremetech.com/extreme/123485-mit-discovers-the-location-of-memories-individual-neurons).
...
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> Hmmm. Your article says that a memory can be triggered by poking at the right neuron. That's a long way away from saying that the memory is *only* held on that neuron. (Also, apparently, memories can [move](https://www.extremetech.com/extreme/218730-the-more-we-learn-about-memory-the-weirder-it-gets) after a few months... so it's possible that this will not only delete a recent memory, but also damage the brain's ability to form new memories at all)

>>>>>>>>>>>>>>>> **u/vakusdrake** [+2]  (3 days later)
>>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>>> Given the sheer number of neurons in the brain killing a few of them really isn't likely to cause any issues, like I'm not sure you get _just how many_ neurons there are just involved with memories, ~9,000 neurons die every day anyway so I'm _extremely_ confident there won't be any issues.             
