...
>>> ######&#009;
>>> ####&#009;
>>>  [**Fuck for Forest**](https://en.wikipedia.org/wiki/Fuck%20for%20Forest): [](#sfw) 
>>> ---
>>> >__Fuck for Forest__ (__FFF__) is a non-profit [environmental organisation](https://en.wikipedia.org/wiki/Environmental_organisation) founded in 2004 in [Norway](https://en.wikipedia.org/wiki/Norway) by Leona Johansson and Tommy Hol Ellingsen. It funds itself through a website of sexually explicit videos and photographs, charging a membership fee for access. A portion of funds are donated to the cause of rescuing the world's [rainforests](https://en.wikipedia.org/wiki/Rainforest).   It is the world's first eco-porn organization and may be the only porn website specifically created to raise money for a cause.   The group moved from [Oslo, Norway](https://en.wikipedia.org/wiki/Oslo,_Norway) to [Berlin, Germany](https://en.wikipedia.org/wiki/Berlin,_Germany) following the trial of its founders for having sex in public. 
>>> >====
>>> >[**Image from article**](https://i.imgur.com/ANuXOZz.jpg) [^(i)](https://en.wikipedia.org/wiki/File:Fuck_for_Forest_\(emblem\).jpg)
>>> ---
>>> ^Interesting: [^Fuck ^for ^Forest ^\(film)](https://en.wikipedia.org/wiki/Fuck_for_Forest_\(film\)) ^| [^The ^Cumshots](https://en.wikipedia.org/wiki/The_Cumshots) ^| [^Kristopher ^Schau](https://en.wikipedia.org/wiki/Kristopher_Schau) ^| [^Anarchism ^and ^issues ^related ^to ^love ^and ^sex](https://en.wikipedia.org/wiki/Anarchism_and_issues_related_to_love_and_sex) 
>>> ^Parent ^commenter ^can [^toggle ^NSFW](/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+clcl0tq) ^or[](#or) [^delete](/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+clcl0tq)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)
>>> 
