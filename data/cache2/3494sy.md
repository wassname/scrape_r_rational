...
* URL: https://www.reddit.com/r/rational/comments/3494sy/dwip_explaining_multiple_history_time_travel/
* Score: 13

* Created: 2015-04-29T07:44:25
...
>> **u/ArgentStonecutter** [+4]  *Emergency Mustelid Hologram* (5 hours later)
>> 
>> This.
...
>>> **u/noggin-scratcher** [+3]  *I am a happy tree* (6 hours later)
>>> 
...
>>>> 
>>>> You can read some of that in [*Timeline*](https://docs.google.com/document/d/1rZ5xBiQhyBy7iCgt1P7PHq8EuoHZvtU0bUd4qBlj3aw/edit?usp=sharing), which is a short written in that setting with some reused characters, or in the (probably to be completely rewritten) first chapter of *The Murder That Wasn't* linked in the OP.
>>>> 
...
> **u/DataPacRat** [+1]  *Amateur Immortalist* (14 minutes later)
> 
...
> **u/narfanator** [+1]  (24 minutes later)
> 
...
> **u/tomintheconer** [+1]  (2 hours later)
> 
...
>>> 
>>> _Note: I am assuming you are refering to [Mental Time Travel](http://tvtropes.org/pmwiki/pmwiki.php/Main/MentalTimetravel) since that is the only thing I can find to reference that story._

>>>> **u/ArgentStonecutter** [+1]  *Emergency Mustelid Hologram* (7 hours later)
>>>> 
>>>> > In the first place, the timeline still gets erased.
>>>> 
>>>> Have you read the story? [Spoiler](#s "It ends in the original time line after the corpse of the time traveler is discovered in his time machine, having sent himself back in time and killing his current body")
>>>> 
...
>> **u/psychothumbs** [+1]  (11 hours later)
>> 
...
> **u/psychothumbs** [+1]  (7 hours later)
> 
...
> **u/Liberticus** [+1]  (8 hours later)
> 
> A fanfic on FiMfiction uses this form of time travel, here's a [link](http://www.fimfiction.net/story/187595/the-king-is-dead-long-live-the-emperor). The explanation is magical not technological and is given in the very beginning if you're interested to take a look at it.
...
> **u/ishaan123** [+1]  *Sidebar Contestant* (13 hours later)
> 
...
>> **u/alexanderwales** [+1]  *Time flies like an arrow* (16 hours later)
>> 
...
>> 
>> For whatever it's worth, this was the model used in [*Branches on the Tree of Time*](https://www.fanfiction.net/s/9658524/1/Branches-on-the-Tree-of-Time).
...
>> 
>> Eh? It is  perfectly consistent. You travel back and are now in a new timeline. The future of this new timeline is your future. Traveling forward drops you in that future just the same as if you just sat on your ass and waited. 
>> Inconsistency would be if it dropped you back in the future you left. 
>> 
...
> 
> I was distracted by your mention of _Terminator_ originally.
> 
...
> **u/thecommexokid** [+1]  (14 days later)
> 
