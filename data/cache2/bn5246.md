...
* Author: u/EOTenkey *
* URL: https://www.reddit.com/r/rational/comments/bn5246/rt_my_life_is_not_a_manga_or_maybe_or_am_i/
* Score: 61

* Created: 2019-05-10T22:58:35
...
> **u/AssadTheImpaler** [+10]  (3 hours later)
> 
...
>> **u/hyphenomicon** [+1]  *seer of seers, prognosticator of prognosticators* (8 days later)
>> 
...
>>> **u/ashinator92** [+6]  (17 hours later)
>>> 
...
> **u/slambsbridge** [+3]  (17 hours later)
> 
...
>>> **u/verbalshadow** [+1]  (3 days later)
>>> 
>>> Which static site generation do you use? I like [Nikola](https://getnikola.com/) myself. I normally disable the RSS and turn on the Atom feed gen.

>>>> **u/EOTenkey** [+1]  (3 days later)
>>>> 
>>>> I'm using [Gridsome](https://gridsome.org/), which doesn't have any good feed generation plugins yet (it's not even a 1.0--you should see the horrible, horrible hack I had to implement to do next/previous links--but I reeaaaally wanted to try out a JAMStack framework running Node.js).
