...
* URL: https://www.reddit.com/r/rational/comments/8zwaes/d_wednesday_worldbuilding_thread/
* Score: 9

* Created: 2018-07-18T15:07:04
...
>> **u/xamueljones** [+7]  *My arch-enemy is entropy* (22 hours later)
>> 
...
>>> 
>>> They'd create it by acting as [momentum wheels](https://en.wikipedia.org/wiki/Reaction_wheel). Once the useable mass is transferred from the rock to the starfish it would have a respectable mass ratio against it, so by elongating and 'muscling' itself around, the rock would spin the other way. They don't even have to launch themselves whole, but just whip out the far half of their tentacle as a kind of missile. In fact it would make more sense that it would keep sending "drones" around while the root part of it stays behind and further settles in the rock.
>>> 
...
>>>> **u/vimefer** [+1]  (a day later)
>>>> 
>>>> Some of the [top achievers of life](https://en.wikipedia.org/wiki/List_of_long-living_organisms#Clonal_plant_and_fungal_colonies) on Earth are clonal colonies, like Pando the aspen, or that one huge Posidonia Oceanica.

>>>>> **u/CreationBlues** [+2]  (2 days later)
>>>>> 
