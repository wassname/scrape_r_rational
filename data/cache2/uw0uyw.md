...
* URL: https://www.reddit.com/r/rational/comments/uw0uyw/d_monday_request_and_recommendation_thread/
* Score: 46

* Created: 2022-05-23T14:00:10
...
>> **u/Dent7777** [+14]  *House Atreides* (a day later)
>> 
...
>>> **u/Jokey665** [+3]  *Worth the Candle* (22 hours later)
>>> 
...
>>> **u/vorpal_potato** [+1]  (6 days later)
>>> 
...
> **u/IICVX** [+16]  (2 hours later)
> 
> Some stories about fun narcissists: 
> 
> * [Dungeon Park](https://www.royalroad.com/fiction/52187/dungeon-park-funny-litrpg-dungeon-core-romp) - another of those "dungeons as a business" stories, except in this case the MC is not actually a dungeon core himself; he just appoints himself as a consultant to the core, and points out the obvious "make it nice in here and people won't want to leave". Tries a bit too hard to be Pratchetty, especially at first, but it's good if you can get over that. 
> * [Getting Hard](https://www.royalroad.com/fiction/54001/getting-hard-rise-of-a-tank) - a middle aged former CEO uses a VRMMO to relive his childhood dream of being the best tank ever, by exploiting unusual mechanics. Takes a while to get going (but it's pretty realistic about it), and now the MC's picked up an ability he can exploit a little (and used it to good effect). 
> 
> Also, people on this subreddit might appreciate [They Shall Call Me EMPRESS](https://www.royalroad.com/fiction/53780/they-shall-call-me-empress-cultivation-tales-of) (yoga instructor with no clue about genre conventions gets isekaied into a xianxia, but fortunately she's a savant at meditation), but I think people would really like the author's other work: [The Shadows Become Her](https://www.royalroad.com/fiction/52964/the-shadows-become-her). It's a little bit fantasy Ender's Game (without the bugs), a little bit "what if Hogwarts taught espionage and piracy". The start is a bit long; it takes a while for the MC to actually get to the magic school, but the story's fun the whole time.

>> **u/Anderkent** [+12]  (2 days later)
>> 
>> Empress MC is so annoying though - likely on purpose but geeez does she trigger me hard.

>> **u/FireCire7** [+11]  (2 days later)
>> 
...
>> **u/degenerate__weeb** [+8]  (2 days later)
>> 
...
>>> 
>>> If that makes you think about dropping the story I'd suggest maybe skipping to [Pirates and Prisoners IV](https://www.royalroad.com/fiction/52964/the-shadows-become-her/chapter/882075/10-pirates-and-prisoners-iv) (the denouement of the ship arc, which kinda acts as a resolution for the misery of the beginning of the story) or [Scamps I](https://www.royalroad.com/fiction/52964/the-shadows-become-her/chapter/888512/18-scamps-i), the beginning of the magic school segment, to see if you like it better from there.

>>>> **u/Dragfie** [+2]  (4 days later)
>>>> 
>>>> Thanks for that, hate misery porn so the bookmarks are appreceated

> **u/self_made_human** [+28]  *Adeptus Mechanicus* (4 hours later)
> 
> Recommending [Warhammer Fantasy: Divided Loyalties ](https://forums.sufficientvelocity.com/threads/warhammer-fantasy-divided-loyalties-an-advisors-quest.44838/) at Sufficient Velocity:
> 
...
>> **u/XxChronOblivionxX** [+12]  (6 hours later)
>> 
...
>>>> **u/XxChronOblivionxX** [+11]  (23 hours later)
>>>> 
...
>>>> **u/Flashbunny** [+2]  (17 hours later)
>>>> 
>>>> My best guess is >!Roswita meeting us for the first time.!<

>> **u/bridge4shash** [+6]  (a day later)
>> 
>> +1 as well, my current favorite ongoing fiction.

>> **u/jaghataikhan** [+6]  *Primarch of the White Scars* (3 days later)
>> 
...
> **u/dankuck** [+14]  *Good Afternoon, Good Evening, and Goodnight* (6 hours later)
> 
...
>> **u/Sure-Manufacturer-47** [+18]  (7 hours later)
>> 
>> [Pact](https://pactwebserial.wordpress.com/2013/12/17/bonds-1-1/) and [Pale](https://palewebserial.wordpress.com/2020/05/05/blood-run-cold-0-0/) do this, protagonists start in the dark with unreliable mentors, and we learn essential elements of the magic system along with them through in-universe texts and experimentation. 
>> 
...
>> **u/PastafarianGames** [+9]  (an hour later)
>> 
...
>>> **u/Alternative-Carob-91** [+3]  (2 days later)
>>> 
...
>>>> **u/jordynelson7777777** [+2]  (2 days later)
>>>> 
...
>> **u/Sinity** [+7]  (a day later)
>> 
>> [Ra](https://qntm.org/ra), maybe? I'm not sure if it fits other criteria, but there are  two competing theories about _some stuff_, experiments...
>> 
...
>>> **u/FatFingerHelperBot** [+4]  (a day later)
>>> 
>>> It seems that your comment contains 1 or more links that are hard to tap for mobile users. 
>>> I will extend those so they're easier for our sausage fingers to click!
>>> 
>>> [Here is link number 1 - Previous text "Ra"](https://qntm.org/ra)
>>> 
>>> ----
>>> ^Please ^PM ^[\/u\/eganwall](http://reddit.com/user/eganwall) ^with ^issues ^or ^feedback! ^| ^[Code](https://github.com/eganwall/FatFingerHelperBot) ^| ^[Delete](https://reddit.com/message/compose/?to=FatFingerHelperBot&subject=delete&message=delete%20i9uwhz1)

>> **u/Dent7777** [+3]  *House Atreides* (2 hours later)
>> 
...
>> **u/Do_Not_Go_In_There** [+3]  (16 hours later)
>> 
>> [*The Powder Mage*](https://www.goodreads.com/series/99602-powder-mage) series by Brian McClellan. It's basically gunpowder + magic, and there's not much else than that.

>> **u/Alternative-Carob-91** [+3]  (2 days later)
>> 
>> [A Budding Scientist in a Fantasy World](https://www.royalroad.com/fiction/41521/a-budding-scientist-in-a-fantasy-world) might meet your requirements in the future but it is moving slowly so far.

>> **u/None** [+2]  (7 hours later)
>> 
>> We should rebuild the quantum drive booster, captain.

>> **u/Revlar** [+2]  (9 hours later)
>> 
...
> **u/SHADOWBANNEDWTFADMIN** [+5]  (a day later)
> 
...
>>>> **u/DangerouslyUnstable** [+2]  (5 days later)
>>>> 
>>>> Is super minion not abandoned? I have up on it after it had gone several months without updating a while back

>>>>> **u/sohois** [+1]  (6 days later)
>>>>> 
>>>>> Seems very likely, must have been 2 years since the last update

>> **u/PastafarianGames** [+8]  (2 days later)
>> 
...
>> **u/TheColourOfHeartache** [+1]  (8 days later)
>> 
...
>> **u/RegnarFle** [+6]  (4 days later)
>> 
>> How do you feel about Webcomics?
>> 
>> Ones recommended on this sub frequently are :
>> 
>> [Strong Female Protagonist](https://strongfemaleprotagonist.com/issue-1/page-0/)
>> 
>> [Fleep](http://www.aaronsw.com/2002/fleep/) <- Strong content warning 
>> 
>> [Seed](https://www.webtoons.com/en/sf/seed/list?title_no=1480&page=1)
>> 
>> And this one that may not be rational but is very fun to read -> [Paranatural](https://www.paranatural.net/comic/chapter-1)
>> 
>> [XKCD](https://xkcd.com/) and [SMBC](https://www.smbc-comics.com/) are one-page math/science/ psychology/philosophy/academia gags
...
>>>>> 
>>>>> KSBD is not rational, but it's super gorgeous and has some of the best worldbuilding, both backstory-wise and design-wise, I've ever seen. It's a joy for the eyes.

>>>>>> **u/k5josh** [+1]  (6 days later)
>>>>>> 
>>>>>> TBH at this point if a story has basic internal consistency and verisimilitude I consider it rational-ish.
...
>> **u/Do_Not_Go_In_There** [+1]  (4 days later)
>> 
