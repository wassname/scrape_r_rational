...
* Author: u/erwgv3g34 *
* URL: https://www.greaterwrong.com/posts/EKu66pFKDHFYPaZ6q/the-hero-with-a-thousand-chances
* Score: 48

* Created: 2020-09-06T03:20:56
...
> **u/IamJackFox** [+86]  (15 minutes later)
> 
...
>>> **u/PresentCompanyExcl** [+12]  *The Culture* (9 hours later)
>>> 
...
>>>> **u/Nimelennar** [+19]  (10 hours later)
>>>> 
...
>>> **u/ArgentStonecutter** [+6]  *Emergency Mustelid Hologram* (10 hours later)
>>> 
...
>>>>>> **u/Bowbreaker** [+4]  *Solitary Locust* (19 hours later)
>>>>>> 
...
>>>>>>> **u/ArgentStonecutter** [+0]  *Emergency Mustelid Hologram* (19 hours later)
>>>>>>> 
...
>>>>>>>>>>>>> 2. There are no astronomical odds involved. The odds _in any one universe_ don't matter, because only the universes that have beaten the odds can be observed by a hero summoned from another universe.
...
>>>>>>>>>>>>>>>>>>>>>>> **u/ArgentStonecutter** [+2]  *Emergency Mustelid Hologram* (7 days later)
>>>>>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>>>>>>>>>>> **u/ArgentStonecutter** [+2]  *Emergency Mustelid Hologram* (11 days later)
>>>>>>>>>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>> **u/ArgentStonecutter** [+1]  *Emergency Mustelid Hologram* (15 days later)
>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> **u/ArgentStonecutter** [+1]  *Emergency Mustelid Hologram* (18 days later)
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> **u/ArgentStonecutter** [+1]  *Emergency Mustelid Hologram* (21 days later)
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 
...
>>>>>>>>>>> **u/VanPeer** [+1]  *The shard made me do it* (8 days later)
>>>>>>>>>>> 
...
>>>>>>>>>>>>>>> **u/VanPeer** [+3]  *The shard made me do it* (9 days later)
>>>>>>>>>>>>>>> 
...
>>>>> **u/Bowbreaker** [+13]  *Solitary Locust* (11 hours later)
>>>>> 
>>>>> > Well..sort of. That isn't quite enough for science. It would need to be reproducible for everyone, and ultimately the underlying mechanism that allows it to occur must be identified and found to be consistent with other known laws. The laws we have defined aren't arbitrary and it would take a lot to cause us to throw them out.
>>>>> 
...
> **u/ArgentStonecutter** [+8]  *Emergency Mustelid Hologram* (10 hours later)
> 
...
>>> **u/conradin6622** [+6]  *Challenge Winner* (8 hours later)
>>> 
...
>> **u/erwgv3g34** [+12]  (45 minutes later)
>> 
>> No; it's a one-shot and that's the final line.

> **u/Aphrodite_Ascendant** [+3]  (6 days later)
> 
...
>> **u/alexanderwales** [+3]  *Time flies like an arrow* (6 days later)
>> 
