...
* Author: u/Stop_Sign *
* URL: https://www.reddit.com/r/rational/comments/2sf58d/how_could_a_transformation_technique_be_abused/
* Score: 12

* Created: 2015-01-14T17:42:01
...
>> 
>> Momentum is conserved, according to the shuriken thing (2:20+ [here](https://www.youtube.com/watch?v=wv2QswVxf6c) for reference). It's not definite in the anime, but it doesn't look like he continues on at the speed of the thrown Shuriken. He's able to throw a kunai back, too, which also implies momentum is conserved.
>> 
>> "Sasuke could tell instantly that the shuriken was me, so he pulled out his own ..." There's a weight difference somewhere in the middle, but it's not exactly average. It can also be changed depending on chakra use. Making something lighter or heaver is an earth jutsu (and it can be done to the extreme, including flying) so it's definitely possible. Naruto also henge'd into Akamaru to fool Kiba, but didn't move so he might've been unable to. Re-watching it, though, he *layered two henge* (6:00 at [here](http://www.narutonine.com/NarutoEpisode45EnglishDubbed.html)) which I hadn't noticed before.

>>> **u/IWantUsToMerge** [+3]  (4 hours later)
>>> 
...
>>>>>> **u/Stop_Sign** [+2]  (23 hours later)
>>>>>> 
>>>>>> Maybe, but in the manga, chapter 135 page 17 [link](http://mangasee.co/manga/?series=Naruto&chapter=135&index=1&page=17) it shows only 1 tail not 9, and Sasuke said "A fox" rather than "the kyuubi". As no mention of it actually being the Kyuubi was made in the anime, it probably only had the extra tails for embellishment.

>>>> **u/IWantUsToMerge** [+1]  (4 hours later)
>>>> 
...
>>>>> **u/Draconomial** [+1]  *Sunshine Regiment* (17 hours later)
>>>>> 
...
>>>>> 
>>>>> There's some optimization of Hiraishin in [Vapors](http://archiveofourown.org/works/1377508), if you haven't read that already. 
>>>>> 
...
>>> **u/noggin-scratcher** [+1]  *I am a happy tree* (7 hours later)
>>> 
...
>>>>> **u/noggin-scratcher** [+3]  *I am a happy tree* (8 hours later)
>>>>> 
...
>>>>> 
>>>>> Ah, I'm mostly coming at this from the manga side. At least in [this translation] ( http://www.mangapanda.com/93-82-5/naruto/chapter-77.html), Sakura is pretty clear that it was a quick transformation. It could be that he used the smoke of the dispelling henge to make seals, or this is one of his first seal-less henge. It could really go either way, as the surprising bit is going from one henge in to another while the first is forcibly dispelled.

>>>>>> **u/Stop_Sign** [+2]  (9 hours later)
>>>>>> 
...
>>>>>>>> 
>>>>>>>> Clone is how bunshin (分身) was translated, but [it means something closer to doppelganger or avatar](http://en.wiktionary.org/wiki/%E5%88%86%E8%BA%AB) and, in the series, clones are more like temporary extentions of oneself. In the case of the basic clone technique, this avatar is intangible and is really only useful for a visual distraction.
>>>>>>>> 
...
>> **u/Stop_Sign** [+1]  (8 hours later)
>> 
>> This can all be done with earth spells anyways - covering yourself in rock and using extra chakra to strengthen it, and then making yourself [heaver](http://naruto.wikia.com/wiki/Earth_Release:_Aggravated_Rock_Technique) or [lighter](http://naruto.wikia.com/wiki/Earth_Release:_Light-Weight_Rock_Technique) already exist. Still good ideas.

>>> **u/clawclawbite** [+1]  (8 hours later)
>>> 
...
>>> 
>>> 2) What exactly does "lack of imagination" mean? How much time do you need to study perfect athlete's body (does he needs to be dissected and preserved? Can you study this from books?) to get it working at least at 80%? If it's a year or something, it would be worth, otherwise too much of a hassle.
>>> Combat Stance Henge doesn't seem like it's worth the effort. Henging some iron spikes while blocking strike or charge, however...
>>> 
