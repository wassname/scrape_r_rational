...
* URL: https://www.reddit.com/r/rational/comments/2ket47/rthfrunelords/
* Score: 8

* Created: 2014-10-26T23:02:36
...
> **u/notentirelyrandom** [+4]  (an hour later)
> 
...
>>> **u/notentirelyrandom** [+3]  (2 hours later)
>>> 
...
>>>> 
>>>> Endowments are broken only on the death of the dedicate or of the endowed--there is no other way to break them, IIRC. The third spoiler-tag above has a workaround for that, though--[spoiler](#s "a circle of identical endowments is flexible, and gives the attribute to whoever's using it most, IIRC, so a circle of Metabolism endowments lets the more active people live faster and the less active people live slower, depending on the needs of the moment. I don't think anyone tried a circle of Mind endowments in-story, unfortunately...")
>>>> 
...
>>>>> **u/notentirelyrandom** [+5]  (3 hours later)
>>>>> 
...
>> **u/ToaKraka** [+1]  *https://i.imgur.com/OQGHleQ.png* (6 days later)
>> 
...
>> 
>> A dedicate of Mind goes into a coma, while the endowed person gains the use of the dedicate's brainpower. If the endowed person dies, the dedicate wakes from his coma, retaining fragments of the endowed's memory; I'm not sure what happens if the dedicate dies. [spoiler](#s "Circular mind-endowments work like Pain's ability in Naruto--the participants share perception. The Days, members of an order of impartial observers, work in pairs with this technique--one person takes a vow of non-interference and accompanies his assigned Runelord everywhere, while the other sits in a monastery and compiles the biography of that Runelord.")
>> 
...
>>>> **u/ToaKraka** [+1]  *https://i.imgur.com/OQGHleQ.png* (6 days later)
>>>> 
>>>> It's a straight IQ-boost for the normal version; [spoiler](#s "the two-way version--where A gives an endowment to B and B gives an endowment to A--is the one that gives ongoing telepathic contact.")
