...
* URL: https://www.reddit.com/r/rational/comments/kn3psn/d_wednesday_worldbuilding_and_writing_thread/
* Score: 14

* Created: 2020-12-30T15:00:25
...
> 
> Starting in January, I'll be running a new D&D campaign, and [here is the provisional worldbuilding doc](https://docs.google.com/document/d/1myLJHKWlukHTvJQuVMC0AxEj93i1xr1Te3xQpJ6K5jE/edit?usp=sharing). It is, as usual, hampered by my unwillingness to write custom rules for everything, and by my desire to be accommodating to whatever races or classes people want to play, and it will undoubtedly expand in whatever direction the players push it in. I don't really *need* feedback, but would appreciate anything you think might be cool, given what's there.

>> **u/AlmostNeither** [+3]  (a day later)
>> 
...
> **u/WorldHateCenter** [+5]  (an hour later)
> 
...
>>> **u/WorldHateCenter** [+4]  (6 hours later)
>>> 
...
>>>> 
>>>> It’s something with relativity and frames of reference. [This seems to be a good explanation](http://www.physicsmatt.com/blog/2016/8/25/why-ftl-implies-time-travel) but to be honest I didn’t get the last part where it’s actually explained.
>>>> 
...
> **u/Camaraagati** [+1]  *The Emperor's Text-to-Speech Device* (3 hours later)
> 
...
>> **u/callmesalticidae** [+4]  *writes worldbuilding books* (5 hours later)
>> 
...
>> **u/ricree** [+2]  (3 hours later)
>> 
>> How about a rational [Julian](https://en.m.wikipedia.org/wiki/Julian_(emperor\))?
>> 
...
>>> **u/Camaraagati** [+2]  *The Emperor's Text-to-Speech Device* (4 hours later)
>>> 
>>> This is another great idea from Antiquity.

>> **u/Camaraagati** [+1]  *The Emperor's Text-to-Speech Device* (3 hours later)
>> 
>> One idea I had was [rational!Kawus](https://en.wikipedia.org/wiki/Kawus), the more politically/militarily experienced and socially radical brother of the much more famous Khosrow I. This was a highly malleable time in Iranian history and Old World history as a whole. 
>> 
