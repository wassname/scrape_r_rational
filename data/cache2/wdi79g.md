...
* URL: https://www.reddit.com/r/rational/comments/wdi79g/d_monday_request_and_recommendation_thread/
* Score: 39

* Created: 2022-08-01T14:00:12
...
> **u/TornSkippito** [+27]  (18 minutes later)
> 
...
>>>> **u/thomas_m_k** [+1]  (4 hours later)
>>>> 
>>>> Thanks! Those sound great.

>>>>> **u/lo4952** [+2]  (5 days later)
>>>>> 
>>>>> A bit late, but if you want more Shirou / EMIYA stuff I've got a few that fit the bill:
>>>>> 
>>>>> [Man off the Moon](https://archiveofourown.org/works/23107792/chapters/55287130) is a Fate / Mass Effect crossover that is... long. It has quite a few words. Some of them are very good! Some of them are 'okay.' Overall I enjoyed the story, but expect slow pacing and certain arcs to go way, way longer than they should have any right to. Still, EMIYA running around as a gremlin through ME is pretty enjoyable.
>>>>> 
>>>>> [Swords and Sorcery](https://forums.spacebattles.com/threads/swords-and-sorcery-fate-stay-night-harry-potter.399084/) is an altogether much better crossover between Fate and Harry Potter, where post-canon Shirou gets teleporter-accidented into a HP universe with some small changes. Relatively light-hearted, but not to the point I'd call it slice-of-life. There's still stuff going on, and the story diverges from canon more and more as it progresses. First 'book' is complete, so there's a solid chunk to read.
>>>>> 
>>>>> [Pure Land](https://archiveofourown.org/works/18913132) is a very nice one-shot where Saber tries to figure out if she's actually alive after running into some Buddhist thought on the soul.

>> **u/Nick_named_Nick** [+5]  (3 hours later)
>> 
>> Can I just skip the Taylor & Co in Eberron parts of Door to the Unknown?

>>> **u/TornSkippito** [+9]  (3 hours later)
>>> 
>>> The storylines seem segregated enough for now that it's probably fine? I've been skimming them, myself.

>>>> **u/chiruochiba** [+4]  (4 hours later)
>>>> 
...
>> **u/Zeitfor** [+1]  (9 hours later)
>> 
>> Is there anyway to tell when the rewrite is done for SAPR? I'd like to wait until that point.

>>> **u/TornSkippito** [+2]  (9 hours later)
>>> 
>>> I was a little ambiguous is my post, but 900k is my guess as to how long the rewrite currently is. Given the original work was put on hold until the rewrite catches up, you might be waiting a while. Rewritten chapters have parenthesis after their names, informing if the chapter is rewritten or just newly inserted

>> **u/Anderkent** [+1]  (9 days later)
>> 
>> >As N Approaches Infinity
>> 
>> Oh man this was really good! Shame it's on a long hiatus

> **u/IICVX** [+26]  (22 minutes later)
> 
...
>>>>> 
>>>>> I mean, even "novel" has a primary story arc that gets resolved, even though they're part of a larger universal one.
>>>>> 
>>>>> Like, I get what you're getting at, but I feel like while the criticism has some merit it's somehow less egregious in this case than for most RR writers that I've seen.

>>>> **u/Judah77** [+0]  (6 days later)
>>>> 
>>>> You can publish a novel and not finish the story at all.  Macro has not finished any of the stories he's written.  Sometimes he leaves them at a lull in the conflict, but none of the big plots ever get resolution.
...
>> **u/TornSkippito** [+2]  (2 hours later)
>> 
>> I would totally read this if it didn't have the "Sexual Content" warning tag. Given the author's description saying it's a "just in case" tag, maybe It'll vanish by the time the story is done.
>> 
>> I can hope, anyway.

>>> **u/GlimmervoidG** [+19]  (2 hours later)
>>> 
>>> Judging by the authors other work, it's unlikely to be much more than some cheese cake, kissing and fade to black.

>>>> **u/IICVX** [+10]  (3 hours later)
>>>> 
>>>> Yup can confirm that as of chapter 58 there's nothing more than a bit of "supers are sexy in spandex" and "whoops battle damage means my abs are showing" (which is actually immortalized in the cover)

>>>>> **u/TornSkippito** [+3]  (4 hours later)
>>>>> 
>>>>> Good to know, thanks!

>>>> **u/Luck732** [+2]  (a day later)
>>>> 
>>>> Author had some more explict stuff on his patreon for Wake of the Ravager, but it never made it to RR.  I would expect the same here.

> **u/thebastardbrasta** [+8]  (an hour later)
> 
...
>>> **u/self_made_human** [+2]  *Adeptus Mechanicus* (21 hours later)
>>> 
...
> **u/GaBeRockKing** [+22]  *Horizon Breach: http://archiveofourown.org/works/6785857* (3 hours later)
> 
...
>> **u/scndnvnbrkfst** [+5]  (4 hours later)
>> 
...
>>>> **u/scndnvnbrkfst** [+4]  (11 hours later)
>>>> 
...
>> **u/DangerouslyUnstable** [+4]  (4 hours later)
>> 
...
>> **u/fassina2** [+1]  *Progressive Overload* (7 hours later)
>> 
>> In my case I use checklists and streaks, but for working out consistently when I began 6-7y ago was making it unavoidable. 
>> 
>> &#x200B;
>> 
>> Things like "I can't eat until X is done", or "I can't sleep until Y is done". I could cheat if I wanted to, doing 10 push ups would count technically, but the barrier tends to be starting so after starting I just ended up doing it. It's a bit extreme but it worked for me initially, after the habits are formed I just do it automatically. 
>> 
>> &#x200B;
>> 
>> >whether I exercised that day, with thresholds for 30/60 minutes
>> 
>> &#x200B;
>> 
>> You don't need to exercise that much mate, I work out like 20-30min/d and I'm likely among the top 1-5% males on the planet in fitness terms. Sure you can work out more and get results faster, but that's shortsighted in my view. You want fitness for the long term not the short term, the goal is to be consistent and keep at it indefinitely. 
>> 
>> &#x200B;
>> 
>> The optimal exercise program is one where you can maintain indefinitely without effort, same with your diet. Unless you're an athlete who is competing or somebody that lives off of having a perfect physique, you don't need to work out particularly hard or for long periods of time. 
>> 
>> &#x200B;
>> 
>> You just need to be consistent and in 1-2y you'll be very good, maybe top 5-10% depending on the starting conditions you have. The time will pass either way, it can pass with you getting better, stagnating, or worsening. The choice is yours.
>> 
>> &#x200B;
>> 
>> Make sure you're doing anaerobic exercises though, aerobic exercises / cardio don't really work or so research shows. What you want to do is build muscle, which will increase your BMR and that will make it easier to lose weight. You can't really lose significant weight by exercising, that's mostly diet based at least that's what research has found.

>>> **u/IICVX** [+2]  (10 hours later)
>>> 
>>> > Make sure you're doing anaerobic exercises though, aerobic exercises / cardio don't really work or so research shows.
>>> 
>>> Depends on what you mean by "work". Cardio is very beneficial along a whole lot of metrics - particularly low- or zero- impact cardio, like bicycling or swimming - but it's not going to be a huge calorie sink or anything like that. 
>>> 
>>> The thing is that _no_ exercise is going to be a noticeable calorie sink, unless you're spending most of a work day doing it. Our bodies are just too damn efficient. 
>>> 
>>> That being said I do agree that more people should try anaerobic exercise (e.g, powerlifting), because I always thought I hated exercise as a child but it turns out I just hate cardio; I'm great at lifting heavy things a few times and putting them back down. The best exercise is something you actually enjoy doing safely, regardless of what class of exercise it is.

>>>> **u/fassina2** [+1]  *Progressive Overload* (11 hours later)
>>>> 
>>>> I meant it for the purpose of weight loss. Anaerobic exercises also work your heart at similar rates, so cardio is actually kind of a misnomer I just used it for the sake of clarity for the average reader. 
>>>> 
>>>> &#x200B;
>>>> 
>>>> Humans are optimized for stamina and endurance hunting so exercising in that manner isn't particularly effective. Also gym equipment that claims to show you how many calories you're losing, are mostly inaccurate like 20-60% inaccurate, so it's not really worth relying on it too much.
>>>> 
>>>> &#x200B;
>>>> 
>>>> Weight loss is basically 95% diet based so yep, exercising mostly helps with muscle gain which raises BMR. It has other health and aesthetic purposes of course but that's besides the point.

>>> **u/GaBeRockKing** [+1]  *Horizon Breach: http://archiveofourown.org/works/6785857* (13 hours later)
>>> 
>>> >You don't need to exercise that much mate, I work out like 20-30min/d and I'm likely among the top 1-5% males on the planet in fitness terms. Sure you can work out more and get results faster, but that's shortsighted in my view. You want fitness for the long term not the short term, the goal is to be consistent and keep at it indefinitely.
>>> 
>>> Don't get me wrong; I didn't design this spreadshee with the intent to hit every category every day. When I started out, I was mostly just grtting 30 mins in 2 or 3 times a week. Nowadays I'm exercising much more, but that's because I count stuff like long walks and bike rides as exercise. I exercised 60 minutes today just from biking to downtown and back for a writers group, for example.
>>> 
>>> The additional benefit is that, since I work from home, it's an indirect encouragement to get me out of the house for long periods of time, which I've discovered dramatically improves my mood.
>>> 
>>> The only downside is that biking around so often makes it too easy for me to justify trying new restaurants out ... I've canvassed a lot of my city just finding new places to go. The caloric cost isn' t terrible, but if I wasn't making software engineer money I'd quickly go broke 😅
>>> 
>>> >Make sure you're doing anaerobic exercises though, aerobic exercises / cardio don't really work
>>> 
>>> Yeah, I've avoided falling into the mental trap of "exercize lets me eat more", at least, and I try to lift the dumbells I have at home/do pushups regularly. But even though I live right next to the gym, I just find it so boring to go... In an ideal world, I'd find an anaerobic exercise that's as fun as biking or playing rythm games.
>>> 
>>> If I can't, I'm happy enough with my schedule though. I'm not going to get yoked, but the resear h on positive health effects indicate that a small amount of weoght training is necessary for maintenence, but aerobic exercize is the more effective intervention against maladies like heart disease and dementia.

> **u/None** [+4]  (an hour later)
> 
> [deleted]

>> **u/Do_Not_Go_In_There** [+1]  (2 days later)
>> 
>> I didn't find that particular uplift too bad since you can figure it out given a starting point and a lot of trial and error. But then again I've read some fics that are way worse as far as inventions go.
>> 
>> But yeah, *Sunrise* is a fun read. Definitely one of the better SI fics

>>> **u/k5josh** [+5]  (5 days later)
>>> 
>>> "A lot of trial and error" is an understatement. It requires _massive_ trial and error. Like, if you aren't industrial or post-industrial, you'll struggle to assemble a workforce and supply chain large enough. Fun fact: >!when Fleming first discovered penicillin, the penicillium he had wasn't suitable to mass-production; it just didn't make enough penicilin. They ended up using the penicillium from a single canteloupe found in a farmer's market in Peoria, Illinois, which happened to produce vastly more and higher-quality penicillin than any other sample!<

>>>> **u/Nick_named_Nick** [+3]  (6 days later)
>>>> 
>>>> Shoutout to >!cantaloupe!<!!!

>>>> **u/ProfessorPhi** [+2]  (7 days later)
>>>> 
>>>> Yep, scaling up is a skill in of itself. Most industrial processes are very far removed from intuitive processes that we have now. 
>>>> 
>>>> The chemical processes that we use for ammonia production look almost nothing like the original process that got it working in a lab.

> **u/plutonicHumanoid** [+1]  (6 days later)
> 
> I’ll repost this in the next thread, but does anyone remember what that webcomic about a shut-in in a utopian transhumanist future? Colorful, cartoony style, main character is immature and annoying. I can’t remember the name of it, and google isn’t being helpful.

>> **u/Dragongeek** [+1]  *Path to Victory* (6 days later)
>> 
>> You mean the one with the sexbot? 
>> 
>> It's *[Forward](https://forwardcomic.com/)*
