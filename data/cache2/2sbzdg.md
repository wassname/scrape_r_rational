...
* Author: u/rumblestiltsken *
* URL: https://www.fanfiction.net/s/10377231/1/Security
* Score: 0

* Created: 2015-01-13T22:35:23

### Post:

[Link to content](https://www.fanfiction.net/s/10377231/1/Security)

### Comments:

> **u/scruiser** [+9]  *CYOA* (6 hours later)
> 
...
>> 
>> I just realized exactly how scary contessa would be if she wanted information out of you.
>> Most people could be destroyed in a sentence or two.
>> 
>> Others?
>> 
...
>> 
>> Everything I can say to this is [here](https://www.reddit.com/comments/2sbzdg/slug/cnoyk00) really. 
>> 
...
>> **u/rumblestiltsken** [+0]  (a day later)
>> 
...
>>> **u/Integrated_Delusions** [+3]  *The Flying Kiwi* (2 days later)
>>> 
...
>>>> **u/rumblestiltsken** [+2]  (2 days later)
>>>> 
...
> **u/capsless** [+8]  *despiser of hpmor* (6 hours later)
> 
> nopenopenopenope
> 
...
> 
> First: We do not want underage sexual content on this site. This means that the following are not at all acceptable:
> A) Minors bringing each other to orgasm with their powers. On screen.
> B) Descriptions of teenagers straddling each others naked bodies.
> C) Teenagers describing, in way too much detail, how good the sex they just had was.
> D) Things along those lines. Don't try to game this. You know who you are.
> Second: If you see underage sexual content on the site, fucking report it. Jesus christ. Even if you don't want to report it, then tell the writer that they are breaking the rules and should edit if they do not want to be punished.
> Third: Do not assume that because one post is OKed everything else in the story was. This thing is five hundred thousand words long, and this judgement is only based on four chapters of that. This is now a recurring problem, as it has happened in Panacea Quest and this story.
> Fourth: To all CrW writers, please improve your prose. The moderation staff has to read a lot of your work in the process of doing our job, and if doing so is annoying, confusing, tedious, or actively painful before we get to the creepy sex stuff, we are going to be rather more annoyed than we were otherwise. (As hard as that may seem)
> Five: There are romances that are not underage girls in lesbian relationships or underage harems. This seems to be a common misconception among rule-breakers, so in the name of getting some variety in our reports, I feel this part of the PSA is necessary. Also, we give a bit more leeway to characters that aren't minors.
> 
...
>> 
>> Disincentivize underage erotica by not promoting it, sure.
>> Just one problem: this fic is not underage erotica, nor does it contain allusions to it. You don't think he's going to change what he writes based on intangible feedback on a story that is unrelated to the issue, surely?
>> 
...
>>> **u/capsless** [+5]  *despiser of hpmor* (15 hours later)
>>> 
...
>>> **u/rumblestiltsken** [+1]  (21 hours later)
>>> 
...
>> **u/AugSphere** [+2]  *Dark Lord of Corruption* (10 hours later)
>> 
...
>>> **u/capsless** [+2]  *despiser of hpmor* (14 hours later)
>>> 
...
>>> **u/capsless** [+4]  *despiser of hpmor* (14 hours later)
>>> 
...
>>>> **u/rumblestiltsken** [+0]  (20 hours later)
>>>> 
>>>> Every argument made in this thread ignores Worm canon though.
>>>> 
>>>> Worm is a coherent but [worm spoilers](#s "explicitly irrational world where *all* of the important characters are forced into making "the wrong decisions for the right reasons" by mind altering space magic that has the purpose of *creating conflict*. Literally every bad thing that happens in worm apart from Zion is the result of enforced irrationality.")
>>>> 
>>>> In that context an outside agent who can think rationally and can convince the main characters to listen to them would probably have as much success as mike has had. Especially because he knows their [worm spoilers](#s "space magic induced psychological weaknesses and can exploit them, like with Accord"). 
>>>> 
...
> **u/rumblestiltsken** [+0]  (4 minutes later)
> 
...
>>> **u/rumblestiltsken** [+3]  (10 hours later)
>>> 
...
>> **u/JackStargazer** [+2]  *Primordial Apologist* (32 minutes later)
>> 
>> >It essentially revolves around the idea of what a relatively smart person would do knowing the big dangers coming, but being completely personally vulnerable in a world of capes.
>> 
>> I assume step 1 is "steal some of the Superpower in a Can".

>>> **u/rumblestiltsken** [+1]  (53 minutes later)
>>> 
>>> [Spoiler](#s "nope")

>>>> **u/nerdguy1138** [+1]  *GNU Terry Pratchett* (8 hours later)
>>>> 
>>>> I loked over your ffn profile, and I rather liked Aftermath.

>>>>> **u/tilkau** [+1]  (7 days later)
>>>>> 
