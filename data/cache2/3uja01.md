...
* Author: u/None *
* URL: https://www.reddit.com/r/rational/comments/3uja01/how_can_you_weaponize_aerokinesis_or_the_ability/
* Score: 6

* Created: 2015-11-28T02:01:09
...
>>>>>>> > I agree on the compressed air thing, what would you do with the compressed air though, just release tons of compressed air to create an extra large blast? 
>>>>>>> 
>>>>>>> You'd probably have to fall back on using tubes to do stuff with, either as a normal gun, a [vortex ring gun](https://en.wikipedia.org/wiki/Vortex_ring_gun) or the thrusters for a jetpack.
...
>>>>>>>>> 
>>>>>>>>> ...actually, making a shockwave using this power (and no equipment) might not be impossible.  It would take very good coordination and a lot of practice, but I don't see anything *fundamentally* different between doing that and something like a [finger wave](https://www.youtube.com/watch?v=Qmt-wPmLbm0).
...
>>>> **u/Chosen_Pun** [+6]  *The Chosen Ones* (5 hours later)
>>>> 
...
>>>>> **u/None** [+1]  (5 hours later)
>>>>> 
>>>>> That is true, and funny that you bring up Naruto this is actually for a rational reincarnated SI naruto story that I plan on doing alongside my main project [Wanderlust](http://royalroadl.com/fiction/3670). 
>>>>> 
...
>>>> **u/DaGeek247** [+1]  *Nudist Beach* (4 hours later)
>>>> 
...
>>> 
>>> [Not that small](http://m.homedepot.com/p/Lotos-50-Amp-Dual-Voltage-Plasma-Cutter-LT5000D/205438858?cm_mmc=Shopping%7CTHD%7CG%7C0%7CG-BASE-PLA%7C&gclid=CKHtmY2bs8kCFU0XHwodPFYEcA&gclsrc=aw.ds). And we're at a medieval tech level, right? How will you generate and store significant electricity?  (Obviously you can make up magic for it, but that rather defeats the purpose.)
...
>> 
>> >Of course, air is nearly 1000 times less dense than water, right? Would the jet need to be 1000 times faster than a normal industrial water jet to cut through a metal sheet?
>> To my knowledge water jets already expel their water at a velocity exceeding the speed of sound (in air). Air moving at 100s to 1000 times its speed of sound would be... plasma?

>>> **u/FuguofAnotherWorld** [+1]  *Roll the Dice on Fate* (16 hours later)
>>> 
>>> Ah, here's what I was looking for. Observe [this](https://youtu.be/P6HXn7HdawY?t=131) abrasive [jet cutting](https://en.wikipedia.org/wiki/Abrasive_jet_machining) machine. 
>>> 
...
> 
> For some standard applications, you could look at air benders from Avatar, for example [this one](https://www.youtube.com/watch?v=zHlqmwI-Bd0).
> 
...
> **u/CosmicPotatoe** [+1]  (8 days later)
> 
...
> **u/EsperTouch** [+1]  (8 years later)
> 
> Air manipulation is basically gas manipulation meaning you have access to many different atoms at your disposal. You can steal air from someone to make them suffocate, Spiral air around a jab or blade to drill through opponents, 
> 
> Yes air is capable of cutting through things as compressed air is viable for projectiles, using your body as the medium. If you wish to throw solidification into the mix, then you have air constructs which would technically be invisible to your opponent. Excluding Combat based techniques, you could also make mirages to make yourself invisible, make smoke-clouds, sensing through the wind, and vacuums. 
> 
> If you wanna get even darker you are capable of dehydrating the body or absorbing all nutrients and fluid from the body which is technically just a supreme vortex so, depends on how you use the things. 
> If you have a demonic or holy nature, i guess you could also add status effects into it but that’s a story for another time.

> **u/Gauntlet** [+1]  (21 hours later)
> 
