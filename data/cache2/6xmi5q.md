...
* URL: https://www.reddit.com/r/rational/comments/6xmi5q/d_saturday_munchkinry_thread/
* Score: 14

* Created: 2017-09-02T15:06:48
...
>>>> **u/ColeslawHappiness** [+2]  (12 hours later)
>>>> 
...
>> **u/Predictablicious** [+7]  *Only Mark Annuncio Saves* (3 hours later)
>> 
...
>>>> **u/Predictablicious** [+2]  *Only Mark Annuncio Saves* (7 hours later)
>>>> 
...
>> **u/TheJungleDragon** [+1]  (an hour later)
>> 
...
>> **u/Daneels_Soul** [+1]  (2 hours later)
>> 
...
>>>>>> 
>>>>>> Of course, you can't actually give me such a proof, just as I can't give you a proof of *impossibility*. So I suppose one possible claim someone might think to make is that because our positions happen to be symmetrical in this one respect, they are equally likely to be correct. This claim would be [false](http://www.patheos.com/blogs/friendlyatheist/2013/01/05/they-must-not-teach-probability-in-seminary-school/), of course.
>>>>>> 
>>>>>> ***
>>>>>> 
>>>>>> **EDIT:** I was using a slightly different computational model than you were when writing that section, sorry. To be more precise, I was using Yudkowsky's model presented [here](http://lesswrong.com/lw/fok/causal_universes/), but in the interest of saving you the time of reading a decently lengthy article (unless of course you want to!), here's the relevant bit:
>>>>>> 
