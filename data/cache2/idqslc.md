...
* Author: u/None *
* URL: https://www.reddit.com/r/rational/comments/idqslc/resources_for_understanding_how_the_world_works/
* Score: 49

* Created: 2020-08-21T05:23:12
...
> **u/alexanderwales** [+55]  *Time flies like an arrow* (an hour later)
> 
...
>> **u/alexanderwales** [+32]  *Time flies like an arrow* (2 hours later)
>> 
...
>> 
>> * [engineerguy](https://www.youtube.com/user/engineerguyvideo), science and engineering, including a production of Faraday's *The Chemical History of a Candle*, which is well done
>> * [Then & Now](https://www.youtube.com/channel/UCkS_HP3m9NXOgswVAKbMeJQ), history, philosophy, politics
>> * [3Blue1Brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw), math
>> * [LegalEagle](https://www.youtube.com/channel/UCpa-Zb0ZcQjTCPP1Dx_1M8Q), law
>> * [Adam Neely](https://www.youtube.com/channel/UCnkp4xDOwqqJD7sSM3xdUiQ), music and music theory
>> * [Voices of the Past](https://www.youtube.com/channel/UCqoGR_EedlhKDVuWNwYWRbg), readings of historical accounts
>> * [Technology Connections](https://www.youtube.com/channel/UCy0tKL1T7wFoYcxCe0xjN6Q), inner workings of technology, typically 1980s or later
>> * [Wendover Productions](https://www.youtube.com/channel/UC9RM-iSvTu1uPJb8X5yp3EQ), logistics
>> * [Townsends](https://www.youtube.com/channel/UCxr2d4As312LulcajAkKJYw), historical cooking
>> * [Todd's Workshop](https://www.youtube.com/channel/UCWnlQMQ-ACfhpD68yWRsnJw), historical archery, arms, and armor
>> 
...
>>> **u/DuplexFields** [+2]  *New Lunar Republic* (4 days later)
>>> 
...
>>> **u/Reply_or_Not** [+1]  (9 hours later)
>>> 
...
>> **u/banfieldpanda** [+6]  (13 hours later)
>> 
...
> **u/Mason-B** [+17]  (44 minutes later)
> 
> The obvious answer is of course [the sequences](https://www.lesswrong.com/rationality), if you haven't read them (along with classical philosophy often found in college or highschool just so you can understand what the hell everyone else is saying; I'm sure someone somewhere has a better list within easy googling). The author (of the sequences) also self inserts a list of books into his [HPMOR fiction](https://hpmor.fandom.com/wiki/List_of_books#Non-fiction) that one might consider a new rationalist to have read (note the ***context*** of some of these books; some of them were used by the *villain* as justification, some were mentioned as books people should look at with a critical eye). [This post by the same community](https://www.lesswrong.com/posts/wfJebLTPGYaK3Gr8W/recommended-reading-for-new-rationalists) (read the comments for the primary response; though the post itself and the pingbacks are meta-links to other lists) is a great jumping off point for related stuff ([Paul Graham's essays](http://www.paulgraham.com/articles.html) show up a lot), though mostly in article format. I'd be curious if there was a better list of books by this (the less wrong) community I missed somewhere.
> 
> For continuing learning the issue becomes a bit more difficult. One could use the above to build a good base of knowledge, but to continuously update and exercise that knowledge is also important. For financial news and theory I follow [Money Stuff](https://www.bloomberg.com/opinion/authors/ARbTQlRLRjE/matthew-s-levine) ([subscribe link](http://link.mail.bloombergbusiness.com/join/4wm/moneystuff-signup&hash=54223001ca3ffcf40f2629c25acea67a) to beat the paywall) as a jumping off point every day. Professionally I use the news aggregator [Hacker News](https://news.ycombinator.com/) (managed(-ish?) by Paul Graham from above) along with various reddit communities (including this one!), as well as some interpersonal connections I maintain. But this is a very personal answer.

>> **u/lumenwrites** [+9]  (8 hours later)
>> 
...
>> **u/None** [+1]  (55 minutes later)
>> 
>> Yes, this is exactly what I was looking for.

> **u/jtolmar** [+13]  (an hour later)
> 
...
>> Edit:
>> 
>> Yeah, I think that I am going to avoid anything by Yudkosky, even if none of [this](https://rationalwiki.org/wiki/Eliezer_Yudkowsky) is true. Perhaps it would be better to judge based off of my own thoughts, but I doubt the benefits from reading the sequences will be worth the time investment,

>>> **u/haikusbot** [+6]  (20 hours later)
>>> 
...
> **u/happyfridays_** [+2]  (12 hours later)
> 
> [Naked Economics](https://www.goodreads.com/book/show/40180021-naked-economics) was required reading in AP Macro econ when I took that class a decade ago. I really liked that book.
> 
> I think /r/econmonitor is great for deeper economics exposure.
> 
> Edit:
> Also, [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/) is the best philosophy reference.

>> **u/DuplexFields** [+2]  *New Lunar Republic* (4 days later)
>> 
>> And for fun takes on this stuff and lots more, Zach Weiner's [Saturday Morning Breakfast Cereal](https://www.smbc-comics.com/) webcomic is great at poking the absurdities of philosophy and economics.
>> 
>> [Superman could save the world more efficiently](https://www.smbc-comics.com/comic/2011-07-13)... but at what cost?

> **u/iftttAcct2** [+2]  (a day later)
> 
> If you go the Wiki route, I'd probably start [here](https://en.m.wikipedia.org/wiki/Epistemology), with Epistemology. 
> 
> MIT has an [undergrad course](https://ocw.mit.edu/courses/linguistics-and-philosophy/24-211-theory-of-knowledge-spring-2014/index.htm) on the subject, in OpenCourseware, though I don't know how good it is. (You can also look up Theory of Knowledge syllibi for a good high-school level view. This will probably have a broad range of accessible readings on random topics from history to behavioural economics.)
> 
...
> **u/ALowVerus** [+4]  *Chaos Legion* (11 minutes later)
> 
