...
* URL: https://www.reddit.com/r/rational/comments/13bqbgs/d_monday_request_and_recommendation_thread/
* Score: 41

* Created: 2023-05-08T14:01:14
...
> **u/ansible** [+30]  *The Culture* (22 minutes later)
> 
...
>> **u/OutOfNiceUsernames** [+23]  *fear of last pages* (3 hours later)
>> 
...
>> **u/Omoikane13** [+18]  (48 minutes later)
>> 
...
>>> **u/NinteenFortyFive** [+5]  (17 hours later)
>>> 
...
>> **u/ahasuerus_isfdb** [+15]  (6 hours later)
>> 
...
>> **u/i_dont_know** [+7]  (34 minutes later)
>> 
>> No, I don’t find that interesting either.

>> **u/vegicannibal** [+7]  (2 hours later)
>> 
...
>> **u/fassina2** [+11]  *Progressive Overload* (22 hours later)
>> 
...
> **u/Krakenarrior** [+17]  *Absurdist disguised as a Rationalist* (2 hours later)
> 
...
>> **u/lucidobservor** [+15]  (13 hours later)
>> 
...
>> **u/vegicannibal** [+12]  (2 hours later)
>> 
...
>>> **u/Krakenarrior** [+6]  *Absurdist disguised as a Rationalist* (2 hours later)
>>> 
...
>> **u/LockedRoomMystery** [+12]  (20 hours later)
>> 
...
>> **u/Dragongeek** [+9]  *Path to Victory* (9 hours later)
>> 
...
>> **u/dogcomplex** [+15]  (16 hours later)
>> 
...
>>>>> **u/JanDis42** [+1]  (22 days later)
>>>>> 
>>>>> I basically agree to all of this, I love the issues that creep up as conflicts with other organizations. I really enjoy the basebuilding and thinking about how to use dungeontech.   
>>>>> 
>>>>> Here a more specific example of what I dislike:  
>>>>> When the characters start with >!Response!< they begin to help many many people. That is amazing. But at the same time this is often portrayed as a failure of other institutions who are talked about with derision and critiqued. >!Policework is (probably) very hard, and while I personally dislike interacting with police and law enforcement, I acknowledge that police enforcement is a very complex issue. Providing the characters with easy solutions for such problems is fine, but I dislike that I get the feeling that they are then shitting on people who have to manage without these solutions. 
>>>>> Similarily, I believe it is completely understandable that police or governments are extremely worried about Response. What they are doing is akin to vigilantism, in that they are unofficial people messing with highly risky situations. They are net good, \*but the government cannot know that\*. From the perspective of the Police force and the government this is really scary! For good reason! !<  
>>>>> 
>>>>> Having a positive organization culture is not enough protection against bad actors. And it is fine to just gloss over that because it is fantasy, okay, but if you interface with the real world, I would like it to be at least partially honest.   
>>>>> 
>>>>> For example, Chapter 145:  
...
>>>>> !<
>>>>> 
>>>>> This is how I am reading this: >!"If we give random activists magical god like powers without any reasonable safeguards except from our own organization, that would be better than our current police system." 
>>>>> I think there are many people that \*do\* believe that, but it is a highly political opinion which in my worldview would cause massive harm.!<  
>>>>> 
>>>>> But this is just my opinion and how I feel about it. For the most part the fic is enjoyable and has amazing worldbuilding.

>>>>>> **u/dogcomplex** [+3]  (23 days later)
>>>>>> 
>>>>>> >!hahaha I think to me it sounds like what you're describing is foreshadowing for an arc that I fully expect to happen - when the consequences of growing your own chaotic organization too fast with too much power in the hands of unregulated individuals bites back.!<
>>>>>> 
>>>>>> >!That said, I think the realistic parts of the above scenario are that - when you have such an excess of force, particularly non-violent force like cameracondas, you can easily afford to make confrontations much less violent, and do the job of police 10x better.  Are they being fair to who came before, operating on much stricter budgets and capabilities? Not particularly.   Though are police forces known for a massive amount of corruption and excessive use of force?  Well, yeah.  So they're kicking an institution while it's down, and it's not an especially forgiving attitude.  Does is deserve to be?  I'm not so sure.  It's a character/story choice, and it's sure cathartic.  Should it have consequences down the line, though?  I'd say so!!<
>>>>>> 
>>>>>> >!One other aspect I think is important though is that they did (I think?!) make at least some token attempts to cooperate with police/government to use these cheat powers in tandem with existing institutions, but were rejected handily for infringing on the monopoly of force.  That's not an unrealistic situation either - and honestly I think just making a parallel institution that does the same role better is not a bad way to use their power if this were real life.  At some point people have to come to the negotiation table and accept that the power balance has shifted and so have the capabilities of these institutions - at which point (I expect) the Order will be retraining cops with a new mantra and new tools  - probably after firing a huge chunk of em.  Or maybe all, because there is definitely a ridiculously high hiring correlation of cops who get off on the power.!<
>>>>>> 
>>>>>> >!And like I said - I'd also expect some attempts by infiltrators (or just a few bad apples, as any group eventually gets) to subtly shift things in a direction that's not so hunky-dory, taking advantage of lax internal standards as things grow.!<
>>>>>> 
>>>>>> >!As an institution, the Order is still completely in the Easy Mode realm - they're still small enough they can rely on relationships and informal decision making to self-regulate.  That's unlikely to work so well at the much more massive scales of governments.  And they're operating on a temporary favorable power imbalance within their group - what happens if these powers start becoming prevalent in the general public or among a growing majority of less-moral Order members?  Definitely drama to come if written right - and I have faith we'll get some meat there!!<
>>>>>> 
>>>>>> >!\> From the perspective of the Police force and the government this is really scary! For good reason!!<
>>>>>> 
>>>>>> >!Yep!  And I think the way the police's reaction is written is fair and accurate - they have no reason to trust this new force, or let them undermine their institution.  But not much they can do... yet.  Drama's a-brewing.!<
>>>>>> 
>>>>>> >!Personally though, my political beliefs here are that technology largely governs the way things unfold.  If a police force (or Response force) can maintain the abilities to employ overwhelming non-lethal force, they'll do a stellar non-lethal job on average, even if they get a few bad actors.  If that spreads out to the masses and every Response call is dealing with a fellow superhuman messy situation, we're back to the same old problem of regular police vs potential gun-toting aggressors, and eventually all the institutional problems that grow from such situations being the norm.  Teleporting cameracondas are gamechangers though and the fic is portraying that advantage - at least - accurately.!<

>>> **u/LaziIy** [+2]  (6 days later)
>>> 
>>> Any others from your list of 50 that aren't commonly mentioned or would be  among your top tier recommendations?

>>>> **u/dogcomplex** [+2]  (18 days later)
>>>> 
...
>>>>>> **u/dogcomplex** [+1]  (20 days later)
>>>>>> 
>>>>>> Oh, my apologies!  I didn't know I was speaking to such a fellow degenerate.  Hmmm...  Yeah I'll have to do some dredging through book lists to re-track what I've even read, but if we already overlap this much might not be much left on the fringe.  I'll throw a few more in though that landed well with me, though I doubt any are niche enough you've missed them either (gonna compile all these in my full list eventually):  
>>>>>> 
>>>>>> Purple Days (ASOIAF) - I never read the full fiction canon, but this fic actually kinda outdid the Game of Thrones TV canon for overall plot for me.  Something about a well-written military (and politics) fic just sits right - and the choice of making Jeoffrey the main character actually really really worked by the end.  This fic leaned into that feeling of humanity gathering around a tiny fire in the deep cold, and despite all their sweaty bloody greedy (and sometimes psychopathic) natures - pulling together when it really matters.  The war against Winter is deeply fleshed out and made into a campaign that feels nearly impossible - even with the time-based powers and forces in play - and every victory in the fic is well earned.  Great use of the canon characters too, and just a fic I highly enjoyed my time in, with an ending worthy of applause.  LONG, but worth it!
>>>>>> 
>>>>>> There is no Epic Loot here, only Puns - The quirkiest, nichest, cutest, funniest little dungeon core keeping fic out there.  I don't know how to describe this one - there's such a cozy cottage-coreness to it - it's just a fic you enjoy inhabiting, and uncovering each new room and feature, right alongside its protagonists.  I think if the author excels at one thing in particular, it's making new interesting characters that you fall in love with (even as the roster grows and grows!)  - there's a style and skill to it.  Almost like Pokemon, you find an attachment to each new find.  And the setting and lore of the whole fic seems to be growing more interesting too as the grander story emerges - looking forward to reading more.  (it's maybe halfway or 3/4s through it's arc now?)  
>>>>>> 
>>>>>> Brockton's Celestial Forge (Worm + Jumpchain) - Definitely requires a very particular niche of interests to appreciate, but once you do - it's really an impressive feat of writing, and one of those few fics that starts to emotionally tackle the "everything everywhere all at once" problem of the modern overwhelming multiversal post-internet pre-AI world by imposing it on the Worm universe and living it through a main character enduring ridiculous levels of power creep (with randomized rules governing the writing).  There's a silliness to it taking each new power on its face, and I find myself repeatedly laughing at every side character's interlude basically just being another "Where's Poochie??" moment dominated by recapping how their world view has been impacted by the main character's power creep, but it's still just - done so well, with such an ambitious and interesting buildup revitalizing what's already a near-perfect canon, I can't fault it.  The new characters are very interesting, especially Fleet, Survey, and the Matrix - and I've found myself re-reading this fic last month just to get my mind wandering through possibilities in the light of this AI revolution we're living through.  We need more fics dealing with the feeling of having your entire worldview upended daily - because that churn is real and about to get real-er.  Commendable epic fic and deserving a high tier.

>>>>>>> **u/LaziIy** [+2]  (21 days later)
>>>>>>> 
>>>>>>> Oh dear, we happen to be kindred spirits in degeneracy because our overlap is too large. Thanks for taking the time to type these recommendations out though, appreciate it. I look forward to your eventual full list.
...
> **u/CaramilkThief** [+15]  (2 days later)
> 
...
>> **u/YankDownUnder** [+3]  (6 days later)
>> 
...
>>> **u/CaramilkThief** [+5]  (4 days later)
>>> 
...
>>>> 
>>>> Ive read a handful of chapters. I like the hook and story direction, but... it's going awfully slowly. It feels like there's one chapter of actual story progression for every 3 chapters of digression. Does this improve, or is this just the style of the writing?

>>>>> **u/CaramilkThief** [+1]  (7 days later)
>>>>> 
>>>>> It's a sort of slow paced story I'd say. From what I remember the story picked up when the time looping started, and then maintained a fairly medium/slow pace and rate of progression for both plot and the protagonist's power. Like Re:Zero, there's a cycle of learning where the savepoint is and slowly trying different things until he comes to the solution. This takes a lot of character interaction and results in arcs starting slow and ending fast. It's a more character focused than plot focused story overall, and if you're not into that then yeah you're not into that.

>>>>>> **u/cthulhusleftnipple** [+1]  (7 days later)
>>>>>> 
>>>>>> Hmm. I'm not not into character driven stories. Maybe I just haven't quite gotten a feel for the story yet. I'll give it a few more chapters at least. 
>>>>>> 
...
>>> **u/ThePhrastusBombastus** [+1]  (5 days later)
>>> 
>>> I bought the first book but dropped it around halfway through, iirc. I think I got frustrated with the pacing or something.
...
> **u/Do_Not_Go_In_There** [+11]  (3 hours later)
> 
...
>> **u/plutonicHumanoid** [+5]  (4 hours later)
>> 
...
> **u/Linearts** [+6]  (6 days later)
> 
> Is there a good rational fanfic of Death Note anywhere?

>> **u/Phoneaccount25732** [+4]  (6 days later)
>> 
>> I don't think humans are smart enough to write that yet.

>>> **u/Tourfaint** [+1]  (7 days later)
>>> 
>>> It's almost impossible, because the basic premise of death note is "when armed with the most perfect weapons possible, how could a serial killer still fuck it up".
>>> Like, you have to make the protagonist fuck up in some way for there to even be a story in the first place, but if you the mc fuck up you arrive at the problem of "is the story even rational? the mc did a dumb!!!". I don't think you can square this circle in any believable way without messing with the core premise a lot.

>>>> **u/Phoneaccount25732** [+3]  (7 days later)
>>>> 
>>>> From Light's perspective, the fundamental problem is that he won't have the Death Note forever and has to somehow transition the globe into a system with low crime and corruption based on a one-time windfall. Ideally he also needs the system to be resilient to other Death Notes, which may mean playing politics with the shinigami, "being interesting" on purpose, and similar. Canon Light essentially tries to start a religion which would maybe work for a few hundred years but not much longer. His goal wasn't to remain undetected, but to permanently change the world. 
>>>> 
>>>> L can be nerfed by increasing his reluctance to believe that supernatural means of killing are possible.

>>>>> **u/Tourfaint** [+1]  (7 days later)
>>>>> 
>>>>> While this does seem like an interesting story, this sounds like a story about manipulating a civilization, sociology, empire building, stuff like that. And that does sound right up my ally, but it's not death note anymore. Death note is a story about a detective and a criminal trying to catch each other. I still don't see how would L even come into the picture as long as the death note user doesn't make mistakes. I would still read the hell out of the story you described tho.
>>>>> 
>>>>> So in conclusion, i suppose you can write a rational story that has a Death Note in it, but i don't think you can write a rational version of 'Death Note'

>>>>>> **u/Phoneaccount25732** [+2]  (8 days later)
>>>>>> 
>>>>>> Light comes to L's attention canonically because Light is trying to build a cult of personality around Kira in order to deter crime and fundamentally change the world. That same motivation can be used (Doylistically, not in the Watsonian sense) to force Light out into the open in a rational fanfiction. Light doing any sufficiently big move will attract outside attention, even if he doesn't try to create a cult of personality.

> **u/Gold_To_Lead** [+18]  (6 hours later)
> 
...
>>> **u/Gold_To_Lead** [+11]  (16 hours later)
>>> 
...
>> 
>> Good thing you spoilered most of this comment. It is more than just a bit mean. Authors spend a lot of time writing, for free in this case. If you don’t like it, just don’t read it.

>>> **u/Tourfaint** [+5]  (7 days later)
>>> 
>>> "free things cannot be criticized, never, for any reason"
>>> 
>>>  --- you
...
>>> **u/cthulhusleftnipple** [+1]  (6 days later)
>>> 
>>> What made disco elysium so good, in your opinion? I played an hour or two of it, and while the dialog and art were amazing, I didn't really get drawn into the gameplay.

>>>> **u/megazver** [+1]  (6 days later)
>>>> 
>>>> I mean, that's the gameplay. 
>>>> 
>>>> If you play it for an hour and aren't into it, that's fine. Hope you find something else you enjoy!

>> **u/cthulhusleftnipple** [+12]  (3 days later)
>> 
>> Strong rec. for Outer Wilds.

>>> **u/TheColourOfHeartache** [+10]  (5 days later)
>>> 
>>> Seconded.

>> **u/DangerouslyUnstable** [+2]  (6 days later)
>> 
...
>>> **u/lucidobservor** [+1]  (7 days later)
>>> 
>>> > Slowly having the backstory of the world revealed was one of the most rewarding video game experiences I've ever had...Does anyone have any recommendations for games that are similar in that one respect? 
>>> 
>>> Already mentioned as a rec in a comment above, but Outer Wilds is this 100%.

> **u/None** [+6]  (an hour later)
> 
> [deleted]

> **u/Denswend** [+2]  (2 days later)
> 
...
>> 
>> Ever tried World of Prime? It starts off kind of slow and mopey but gets pretty good by the second half of the first book and increasingly great with every book after that(imo).
