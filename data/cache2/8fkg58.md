...
* URL: https://www.reddit.com/r/rational/comments/8fkg58/d_saturday_munchkinry_thread/
* Score: 14

* Created: 2018-04-28T15:07:04
...
>>>>> **u/KilotonDefenestrator** [+3]  (20 hours later)
>>>>> 
...
>> **u/ulyssessword** [+8]  (8 hours later)
>> 
...
>> **u/mrdoomydoom** [+3]  (14 hours later)
>> 
...
>> **u/TheJungleDragon** [+3]  (23 hours later)
>> 
...
>>> 
>>> ["Don't push your luck, buster."](https://www.reddit.com/r/rational/comments/3j6jh9/pi_one_day_autocorrect_starts_correcting_for/)

>>> **u/plushiemancer** [+1]  (2 days later)
>>> 
...
> **u/UltimateRockPlays** [+3]  (an hour later)
> 
...
>>> **u/UltimateRockPlays** [+8]  (4 hours later)
>>> 
>>> [I assume that] (#s " Step 1 is what is currently happening")

>> **u/martindevans** [+2]  *Chaos Legion* (10 hours later)
>> 
...
>>> **u/UltimateRockPlays** [+1]  (11 hours later)
>>> 
>>> [also](#s " does Thanos not understand reproduction?")

>> **u/iemfi** [+1]  (7 hours later)
>> 
>> I spent some time thinking about how they could synergise their powers better. Surely with so many heroes they can come up with better combos than just hulk smashing things. [](#s " The only things of note are Dr. Strange's portals and some minor tech sharing. I think the main issue is most of their powers are pretty much the same thing.")
...
>> **u/MereInterest** [+8]  (9 hours later)
>> 
...
>>> 
>>> You can't ask such a question because the device is just 'looking' into the future. Not asking some AI to 
>>> guide you towards some desired future.
>>> 
...
>> **u/iemfi** [+1]  (7 hours later)
>> 
>> Isn't this really trivial with something like [Keno](https://en.wikipedia.org/wiki/Keno), or blockchain dice games, or most games of chance really.
...
>> **u/mrdoomydoom** [+1]  (14 hours later)
>> 
...
>>> **u/sickening_sprawl** [+1]  (4 days later)
>>> 
...
>>>> 
>>>> I'm not talking about relying on energy being put out through the window, ([though with very efficient technology in a very cold universe it could still power a civilization](https://www.youtube.com/watch?v=Qam5BkXIEhQ)) rather I'm talking about the fact that if you can generate massive amounts of energy inside the chamber then that's still going to be released when you open it, even if that causes the physics there to revert back to normal it still won't undo the extra energy created.
>>>> 
