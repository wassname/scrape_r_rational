## [RT] New chapter of Lighting Up the Dark, a rationalist Naruto fic.

* Author: u/Velorien *
* URL: https://www.fanfiction.net/s/9311012/14/Lighting-Up-the-Dark
* Score: 18

* Created: 2014-07-21T23:49:35
...
> **u/Riddle-Tom_Riddle** [+5]  (2 hours later)
> 
...
>> **u/Kodix** [+1]  (11 hours later)
>> 
>> [Regarding your spoiler](#s "It's cool that he did that, but seems pretty futile. Detrimental, even. Nine-brains now knows that Hinata poses some considerable danger to him, and will target her accordingly should she ever be in a position to use it. Previously he wouldn't have targeted her above other people.")

>>> **u/None** [+4]  (11 hours later)
>>> 
>>> [removed]

>>>> **u/Kodix** [+0]  (11 hours later)
>>>> 
...
>>>> 
>>>> [As to your response](#s "Definitely makes sense, some of it is among the lines of what I considered. The other alternative Naruto had was waiting until Hinata is a bit more competent, but in the meantime catastrophe could strike and the village would have a significantly decreased ability to deal with it - and it's also not as if Hinata not being targeted directly is necessarily good enough for her to survive.")
>>>> 
>>>> [In short](#s "It may not be the optimal solution he could employ (though I can't immediately think of a better one), but I do not think it's dumb.")

> **u/FeepingCreature** [+2]  *GCV Literally The Entire Culture* (4 hours later)
> 
> Whee!

> **u/liamash3** [+2]  *Mizu* (10 hours later)
> 
...
>>>>> 
>>>>> ####&#009;
>>>>>  [**Clone Technique**](https://naruto.wikia.com/wiki/Clone%20Technique): [](#sfw) 
>>>>> 
>>>>> ---
>>>>> 
>>>>> >
...
>>>>> ---
>>>>> 
>>>>> ^Parent ^commenter ^can [^toggle ^NSFW](http://www.np.reddit.com/message/compose?to=autowikiabot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+cje9law) ^or[](#or) [^delete](http://www.np.reddit.com/message/compose?to=autowikiabot&subject=AutoWikibot Deletion&message=%2Bdelete+cje9law)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikiabot/wiki/index) ^|  [^Source](https://github.com/Timidger/autowikiabot-py)
...
> **u/JackStargazer** [+2]  *Primordial Apologist* (19 hours later)
> 
...
> **u/Jello_Raptor** [+1]  *The Last Tool User* (8 days later)
> 
