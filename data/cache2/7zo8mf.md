...
> **u/TooShortToBeStarbuck** [+22]  (3 hours later)
> 
...
>>> **u/TooShortToBeStarbuck** [+5]  (7 hours later)
>>> 
>>> [More spoiling, of course](#s " Heaps of lgb-but-not-t all over the place. Nothing recognisable as polyamory; the vampire pair bonding gets treated as an immutable thing that happens instantaneously upon encountering your mate for the first time, with dramatic psychological effects that Bella and Aro both demonstrate contempt for, despite themselves having mates, because they don't like being cosmically manipulated that way, nor having their mental health tethered to someone else's survival. The vampires who want children universally use human surrogates, then turn the surrogates into vampires after birth. This is treated as a voluntary but incentivised process that can fast-track getting turned into a vamp, if that's what one is seeking deliberately. Regarding the thirst thing, it was basically one part 'eating animals instead of humans gives you better self-control,' one part 'if you know in advance you're going to be a vampire, it gives you better self-control,' and one part 'Carlisle is doing R&D on the blood substitute, but in the meantime we've bought out a bunch of slaughterhouses of livestock.'")

>>>> **u/thrawnca** [+2]  *Carbon-based biped* (20 hours later)
>>>> 
>>>> Plus, Bella's long-term goal [is](#s " to populate the world with vampire-human hybrids, who generally enjoy blood but don't have the same compulsion and can eat other food.")

> **u/dalr3th1n** [+9]  (6 hours later)
> 
> Now let's try for a 5 minute version of Effulgence!

>> **u/Ephemeralen** [+8]  (a day later)
>> 
...
>>> **u/mathemagical-girl** [+7]  (22 hours later)
>>> 
