...
* URL: https://www.reddit.com/r/rational/comments/yv1vx4/d_monday_request_and_recommendation_thread/
* Score: 33

* Created: 2022-11-14T15:00:09
...
> **u/GlueBoy** [+24]  *anti-skub* (3 hours later)
> 
...
>> **u/AccretingViaGravitas** [+4]  (a day later)
>> 
...
>>>>> **u/Kaljinx** [+2]  (4 hours later)
>>>>> 
>>>>> What is the moral inclination of the protagonist?

>>>>>> **u/LaziIy** [+5]  (7 hours later)
>>>>>> 
...
>>>>>>> **u/chiruochiba** [+13]  (8 hours later)
>>>>>>> 
...
>>> **u/Gold_To_Lead** [+12]  (3 hours later)
>>> 
...
>>>> **u/DomesticatedDungeon** [+5]  (4 hours later)
>>>> 
...
>>> **u/R_FURRIES_SUBHUMAN** [+9]  (5 hours later)
>>> 
...
>>>> **u/vorpal_potato** [+5]  (9 hours later)
>>>> 
...
>>>>>> **u/chiruochiba** [+4]  (19 hours later)
>>>>>> 
...
>> **u/R_FURRIES_SUBHUMAN** [+8]  (5 hours later)
>> 
...
>>> **u/SpeakKindly** [+20]  (7 hours later)
>>> 
...
>>>> **u/ahasuerus_isfdb** [+5]  (7 hours later)
>>>> 
>>>> Rational-adjacent?

>>>>> **u/Revlar** [+0]  (a day later)
>>>>> 
>>>>> That's a community, not a genre.
>>>>> 
>>>>> To be honest I wouldn't call any of these self-inserts even remotely rational. They're way too self-indulgent and extremely prone to giving people the idiot ball.

>>>> **u/Dragfie** [-1]  (23 hours later)
>>>> 
>>>> No, from how I and how I've seen it used "rationalist" is an mc or characters which use rational principles (basically a story with smart chatacters regardless of authors execution) 
>>>> 
>>>> while "rational" is how much sense the story actually makes (basically how well written it is, regardless of characters actual intelligence)
>>>> 
>>>> They often overlap but are mutually exclusive.

>>>>> **u/Revlar** [+8]  (a day later)
>>>>> 
>>>>> Rationalist stories are meant to be didactic and to express rationalist ideas. Rational stories are stories that hold themselves to a set of standards that include things like "if Luke has a lightsaber, Darth Vader needs a Death Star" and "No idiot balls", plus some number of intelligent characters. There's usually a lot of worldbuilding involved.
>>>>> 
>>>>> Rationalist stories are rational by definition, because "rational fiction" started as a less strict recreation of the standard set by Harry Poter and the Methods of Rationality.

>>> **u/Amonwilde** [+6]  (4 days later)
>>> 
...
>>>> **u/Ratvar** [+2]  (2 days later)
>>>> 
>>>> Read their current username. I'd guess a normal, well deserved ban.

>> **u/GeneratedSymbol** [+2]  *The Foundation* (3 days later)
>> 
...
>>>> **u/CaramilkThief** [+2]  (23 hours later)
>>>> 
...
>>> **u/cthulhusleftnipple** [+5]  (6 hours later)
>>> 
>>> Is it good?

>>>> **u/MarbledMythos** [+28]  (9 hours later)
>>>> 
...
>>>> **u/TheColourOfHeartache** [+20]  (19 hours later)
>>>> 
...
> **u/GlimmervoidG** [+26]  (7 hours later)
> 
...
>> **u/N0_B1g_De4l** [+10]  (11 hours later)
>> 
...
>>> **u/cultureulterior** [+1]  (6 days later)
>>> 
>>> Second this rec

>> **u/cthulhusleftnipple** [+6]  (14 hours later)
>> 
...
>> **u/Krakenarrior** [+3]  *Absurdist disguised as a Rationalist* (13 hours later)
>> 
...
>>> **u/Radioterrill** [+3]  (23 hours later)
>>> 
...
>> **u/Dragongeek** [+6]  *Path to Victory* (20 hours later)
>> 
...
>> 
>> I've tried to read it three times now, but every time I end up bouncing off it within a few chapters. Plenty of people here enjoy it, so I'm not saying it's poorly written, but it doesn't seem to be the story for me.  I can't articulate what precisely I don't like about it, but I find it very grating and difficult to track what's even happening. Does that resolve itself, or is the entire novel written in the same style as the start?

> **u/LaziIy** [+8]  (2 hours later)
> 
> Anyone have any Bleach fanfiction recommendations? Any self insert would be ideal

>> **u/lo4952** [+14]  (4 hours later)
>> 
...
>> **u/Relevant_Occasion_33** [+5]  (3 hours later)
>> 
...
> **u/plutonicHumanoid** [+5]  (12 hours later)
> 
...
>> **u/Dragfie** [+6]  (23 hours later)
>> 
>> Ar'kendrithest. Book one just ended and is this 100%

>>> **u/CaramilkThief** [+8]  (23 hours later)
>>> 
