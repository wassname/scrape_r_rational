## Unsong Chapter 20: When the Stars Threw Down Their Spears

* Author: u/Lord_Drol  *NERV**
* URL: http://unsongbook.com/chapter-20-when-the-stars-threw-down-their-spears/
* Score: 58

* Created: 2016-05-15T17:09:11

### Post:

[Link to content](http://unsongbook.com/chapter-20-when-the-stars-threw-down-their-spears/)

### Comments:

> **u/Frommerman** [+17]  (an hour later)
> 
> >Everyone ignored Uriel, as usual.
> 
> Best part.

> **u/Escapement** [+15]  *Ankh-Morpork City Watch* (2 hours later)
> 
...
>> **u/ScottAlexander** [+9]  (2 hours later)
>> 
>> What's your source? I'm looking at [Wikipedia](https://en.wikipedia.org/wiki/Watcher_%28angel%29#Book_of_Enoch) and it says "Gadreel (or Gader'el) taught the art of cosmetics, the use of weapons and killing blows."

>>> **u/Escapement** [+7]  *Ankh-Morpork City Watch* (2 hours later)
>>> 
>>> From [wikipedia](https://en.wikipedia.org/wiki/Azazel):
>>> 
...
>> **u/JulianWyvern** [+1]  *Wayward Wanderer* (9 hours later)
>> 
...
> **u/Green0Photon** [+15]  *Student in Cyoria, Minmay, and Ranvar* (4 hours later)
> 
...
> **u/Green0Photon** [+8]  *Student in Cyoria, Minmay, and Ranvar* (8 hours later)
> 
> Scott said [here][1] that he switched Uriel with Sandalphon for a bunch of complicated reasons he didn't want to say. I was bored and looked it up, even though I probably won't get it.
> 
> Scott uses 10 archangels, the jewish version (kabbalah and stuff he uses in the story), but in Eastern Orthodox, there are 7 archangels, one of which is Uriel. He's an archangel throughout Christianity, but not in Judaism. His name also means "Light of God". (I've used [this][2] and [this][3] so far.)
> 
> Of the ten [Sephirot][4], Sandalphon is Malchuth. In that link, Scott uses that first set, but with different spellings. Malchuth is "Kingship". It is the one sephirot on the bottom of the diagram. Unlike the other Sephirot, [Malchuth][5] is an attribute of God that does not emanate from Him directly. It rather emanates from God's creation. It is the furthest from the Divine Light.
> 
> It's not the physical world though. There are the [four worlds of Adam Kadmon][6] that Uriel mentions. The lowest world is Assiah, whose dominant sephirot is Malchuth. Assiah is the concealment of God. The lower part of that is Assiah Gashmi, physical existence.
> 
...
> 
> [1]:http://slatestarscratchpad.tumblr.com/post/144421318151/how-much-of-the-roles-and-characters-of-archangels
> [2]:https://en.wikipedia.org/wiki/Archangel
> [3]:https://en.wikipedia.org/wiki/Jewish_angelic_hierarchy
> [4]:https://en.wikipedia.org/wiki/Sephirot
> [5]:https://en.wikipedia.org/wiki/Malkuth
> [6]:https://en.wikipedia.org/wiki/Four_Worlds

>> **u/ScottAlexander** [+3]  (8 hours later)
>> 
...
> **u/Aretii** [+1]  *Cultist of Cthugha* (10 hours later)
> 
