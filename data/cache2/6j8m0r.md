...
* URL: https://www.reddit.com/r/rational/comments/6j8m0r/d_saturday_munchkinry_thread/
* Score: 11

* Created: 2017-06-24T15:06:41
...
> **u/TheJungleDragon** [+5]  (an hour later)
> 
...
>>> **u/TheJungleDragon** [+1]  (17 hours later)
>>> 
...
>> **u/avret** [+2]  *SDHS rationalist* (3 days later)
>> 
...
>>> **u/TheJungleDragon** [+2]  (3 days later)
>>> 
...
> **u/Nulono** [+7]  *Reverse-Oneboxer: Only takes the transparent box* (27 minutes later)
> 
...
>> **u/InfernoVulpix** [+13]  (42 minutes later)
>> 
...
>>>>>>> **u/Nulono** [+1]  *Reverse-Oneboxer: Only takes the transparent box* (a day later)
>>>>>>> 
>>>>>>> That one was _Sphereland_. _Spaceland_ stars human protagonists, and takes a more science-fantasy approach, not really introducing much in the way of new mathematical concepts.
...
>>>>>> 
>>>>>> He would be an amazing theif btw.
>>>>>> Float small objects out to determine what security cameras can see.
>>>>>> 
...
> **u/None** [+7]  (43 minutes later)
> 
> Use Avast! Antivirus on Agent Smith?
> 
> Err, I'm new to this.

>> **u/Patronicus** [+4]  (an hour later)
>> 
...
>>>>>>>> 
>>>>>>>> I think the main way you'll need to run this isn't that the human brains are being used as pure processing but rather as fuzzy logic simulators. 
>>>>>>>> to a species with limited creativity this is very useful, people are fed details and information about disparate fields and they 'dream' about what happens or run simulations during 'sleep time' which is why we have such bizarre dreams sometimes that so quickly fade away.

>>>>>>>>> **u/None** [+1]  (a day later)
>>>>>>>>> 
>>>>>>>>> I don't know. We're talking about technology that can upload kung fu to your brain. What else is possible?

>>>>>>>>> **u/kuilin** [+1]  (9 days later)
>>>>>>>>> 
...
>>>>>> **u/General_Urist** [+1]  (20 days later)
>>>>>> 
...
>> **u/Adeen_Dragon** [+6]  (17 hours later)
>> 
