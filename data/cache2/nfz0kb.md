...
* Author: u/numberoneus *
* URL: https://www.reddit.com/r/rational/comments/nfz0kb/are_there_any_short_rationalist_stories_detailing/
* Score: 25

* Created: 2021-05-19T07:18:40
...
> **u/PeridexisErrant** [+1]  *put aside fear for courage, and death for life* (5 hours later)
> 
...
> 
> On LessWrong, the [AI Risks](https://www.lesswrong.com/tag/ai-risk) and [AI Takeoff](https://www.lesswrong.com/tag/ai-takeoff) tags have some good further reading.  In particular, I recommend
> 
> - [Superintelligence FAQ](https://www.lesswrong.com/posts/LTtNXM9shNM9AC2mp/superintelligence-faq)
> - [AlphaGo Zero and the FOOM debate](https://www.lesswrong.com/posts/shnSyzv4Jq3bhMNw5/alphago-zero-and-the-foom-debate)
> - [Intelligence Explosion Microeconomics](https://www.lesswrong.com/posts/CZQuFoqgPXQawH9aL/new-report-intelligence-explosion-microeconomics)
> - [What Failure Looks Like](https://www.lesswrong.com/posts/HBxe6wdjxK239zajf/what-failure-looks-like) (a "slow", understandable scenario)
> 
...
> **u/SpecialMeasuresLore** [+21]  (an hour later)
> 
...
>> **u/RandomChance** [+6]  (9 hours later)
>> 
...
>>> **u/SpecialMeasuresLore** [+6]  (9 hours later)
>>> 
...
>>>>> **u/SpecialMeasuresLore** [+9]  (12 hours later)
>>>>> 
...
>>>>>> **u/lumenwrites** [+7]  (18 hours later)
>>>>>> 
...
>>>>>>> **u/SpecialMeasuresLore** [+1]  (22 hours later)
>>>>>>> 
...
>>>>>>>> **u/fish312** [+6]  *humanifest destiny* (a day later)
>>>>>>>> 
...
>>>>>>>>> **u/SpecialMeasuresLore** [+2]  (a day later)
>>>>>>>>> 
...
>>>>>>>>>> **u/fish312** [+4]  *humanifest destiny* (a day later)
>>>>>>>>>> 
...
>>>>>>>>>>> **u/SpecialMeasuresLore** [+0]  (a day later)
>>>>>>>>>>> 
...
>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (18 days later)
>>>>>> 
>>>>>> Well, this to me is just the teleportation paradox all over again. Honestly, it’s the one thing that IMO can’t be figured out unless we understand consciousness properly first. Which you probably should do anyway if you plan to upload any brains.

>>>>> **u/Xxzzeerrtt** [+2]  (2 days later)
>>>>> 
>>>>> Continuity of self I believe

>>>>>> **u/Nimelennar** [+3]  (2 days later)
>>>>>> 
...
>>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (18 days later)
>>>>>>> 
>>>>>>> My general answer is: if the teleportation requires that one side is “destroyed” as the other is created because of the no-cloning theoretical, then it’s probably a complete enough copy that it truly counts as teleportation.

>>>> **u/RandomChance** [+4]  (a day later)
>>>> 
...
> **u/Dezoufinous** [+17]  (an hour later)
> 
...
> **u/scruiser** [+9]  *CYOA* (8 hours later)
> 
...
> **u/C_Densem** [+14]  *LessWrong (than usual)* (4 hours later)
> 
...
>>>> **u/SimoneNonvelodico** [+2]  *Dai-Gurren Brigade* (18 days later)
>>>> 
>>>> I would say it’s kind of a modern version of religion. When the idea was originally coined, “sky man who decides everything” was as reasonable an explanation as you could give for the world having rules and harmony. Really, the only difference today is that we don’t have to believe any complex computational system is conscious (it’s no coincidence that analogies for a godless universe improved markedly when clockwork - namely, mechanical computation - became a thing). 
>>>> 
>>>> It’s entirely possible that there are other reasons why nigh-omnipotent AIs are impossible. Personally I lean that way. They feel to me like they ought to violate thermodynamics or something like it, but I can’t formalise that argument. So in that way, there’s really not all that difference, AIs are just the best model compatible with a current understanding of what a real physical God *could* be like. But in the future that idea might look silly.

>>>> **u/None** [-1]  (10 days later)
>>>> 
>>>> just replace "ai" with "God" lol

> **u/CCC_037** [+4]  (3 hours later)
> 
...
> **u/ParadoxSong** [+5]  (11 hours later)
> 
...
>> **u/Reply_or_Not** [+1]  (11 hours later)
>> 
>> >Charles Stross
>> 
>> Are you thinking of the Eschaton?

>>> **u/RandomChance** [+2]  (a day later)
>>> 
>>> I think that one was relatively benign... 
>>> I was thinking of a short story where two "Agents" from an alternate reality pop in and find out that everyone in what looks like a normal 20th century "western" city are running a Singularity AI in their wetware on top of / instead of their normal consciousness.  Good end twist.

> **u/Copiz** [+7]  (12 hours later)
> 
...
>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (18 days later)
>> 
>> > how does an evil AI go from upgrading its own software, to upgrading its HARDWARE?
>> 
>> Well, if it has humans it can either persuade or deceive, even just into connecting it to a fabrication plant or robots of some sort, it all snowballs from there.

> **u/Zephyr101198** [+2]  (9 days later)
> 
...
> **u/PastafarianGames** [-1]  (13 hours later)
> 
...
>> **u/numberoneus** [+3]  (13 hours later)
>> 
...
>>> **u/PastafarianGames** [+6]  (14 hours later)
>>> 
...
>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (18 days later)
>>>> 
>>>> > However, I am also not pretending that Unaligned AGI is a real problem which deserves mental resources
>>>> 
>>>> I mean, the research field of AI ethics is broader than that, and certainly necessary in a world in which AI controlled drones are becoming a thing (not that honestly I believe ethicists can do much when the goal is killing people to begin with). I think AGI does deserve some thought too, though personally I don’t think it could just snowball exponentially. But it would also be silly to be completely blindsided by it. 
>>>> 
>>>> In the end, this is a small community, and the way humanity splits its efforts among issues is generally more “a bunch of groups each pour energies into one specific pet cause they care a lot about”. We can’t all give our all to The Most Important Problem. There’s also people who run kitten shelters, and while I don’t think kitten suffering is the biggest problem we have by far, I also wouldn’t tell everyone caring that they’re wrong to make it their first priority, as long as it doesn’t become the first priority *of the world* as a whole.

>>>>> **u/PastafarianGames** [+1]  (19 days later)
>>>>> 
>>>>> Kitten suffering is empirically verifiable. "how we might align future superintelligent AIs with our values", which is the question as posed, possesses no such truth-value.
>>>>> 
>>>>> It's not that it's not the Most Important Problem, though by and large MIRI/CFAR cultists will absolutely preach about how it *is* the Most Important Problem. It's that runaway/exponential AGI as Apocalypse Or Salvation is _ludicrous_. It's a non-problem. Research into it is strictly equivalent, to me, to research into questions of theology; there is equal truth value in both. Comparing it to kitten shelters does it too much credit.

>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (19 days later)
>>>>>> 
>>>>>> > "how we might align future superintelligent AIs with our values", which is the question as posed, possesses no such truth-value.
>>>>>> 
>>>>>> I don't see why this would be so ludicrous. Superintelligent doesn't have to mean supernaturally intelligent or semidivine. It could mean just reasonably smarter than humans, enough to be a threat. We don't need to face a cybernetic demigod that can be decompose us into atoms with its nanites in seconds, you could also imagine a number of incidents which are winnable but still cause lots of damage and death. The general sense being, we don't want to create something that is both creative and has an alien morality. While singularity level AIs might be impossible (it is my belief too), we have evidence that you can make a human level intelligence CPU in a very compact form running on a ludicrously low energy budget: you and I carry one in our skulls. So it's not IMO too wild to assume that something smarter than humans could be built with realistic amounts of resources.
>>>>>> 
>>>>>> > It's that runaway/exponential AGI as Apocalypse Or Salvation is ludicrous.
>>>>>> 
>>>>>> On this I agree, but look at it this way. SARS-CoV-2 can't grow exponentially forever either; but the moment it peaks naturally is when it already has done a shit-ton of harm. So we wouldn't need a "perfect" runaway AGI for it to be dangerous. It could take a lot less. That's why I'm saying the general framework of the problem IMO makes sense, even if some of the specific scenarios do indeed feel unrealistic to me too.

>>>>>>> **u/PastafarianGames** [+1]  (19 days later)
>>>>>>> 
>>>>>>> > we have evidence that you can make a human level intelligence CPU in a very compact form running on a ludicrously low energy budget: you and I carry one in our skulls. So it's not IMO too wild to assume that something smarter than humans could be built with realistic amounts of resources
>>>>>>> 
>>>>>>> The closest we can come to making human level intelligences takes a nine month gestation time and thirty years or so to stop being completely full of shit! I mean, yeah, sure, we can do it, and the question of how do we make smarter humans through that method and align them with good ethics is super important, but oddly the proposed methods for AI ethical alignment have nothing to do with ethical alignment for the only actual intelligences we know about.
>>>>>>> 
>>>>>>> Anyway, I don't think we have any reasonable basis to believe that even non-runaway/non-exponential AGI has any path to fruition, but I do think we're all going to die when AGW changes the composition of the atmosphere enough to kill off the ocean phytoplankton, so hopefully you're right and I'm wrong.

>>>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (19 days later)
>>>>>>>> 
>>>>>>>> > but oddly the proposed methods for AI ethical alignment have nothing to do with ethical alignment for the only actual intelligences we know about.
>>>>>>>> 
>>>>>>>> Well, because goals are different. You don’t want to teach it ethics, which sometimes fails, you want to embed them into it, like instinct. There’s an argument that some of our moral intuitions work that way too.
>>>>>>>> 
>>>>>>>> I agree AGW is a more pressing problem. But while it’s not dedicated as many resources as it should, it’s certainly dedicated a lot more than anything AGI related. As it should. So overall I don’t think we have that priority wrong, at least. But as a species we prioritise both those things less than making sure rich people aren’t taxed too much or immigrants don’t come in too large numbers, so that’s a much bigger issue.

>>>>>>>>> **u/PastafarianGames** [+1]  (20 days later)
>>>>>>>>> 
>>>>>>>>> I will believe that the goals being different is relevant when AI ethical alignment people demonstrate an understanding of the subject material they're dismissing.
>>>>>>>>> 
>>>>>>>>> I still won't think it's anything but a waste of time, mind you, because anything AGI related has (IMO) zero value except as science fiction and leisure research (which is, I will grant, valuable and important), so anything we spend on it can't justify itself on a utility / return basis and nobody seems to be arguing for it on a "we research this because it's nifty and we don't need any other reason" basis. (I would find that basis to be perfectly valid.)
>>>>>>>>> 
>>>>>>>>> Taxing the hell out of the rich sounds nice. I'll make a deal with the AGI catastrophists: get unrealized capital gains taxed as income, and y'all can have all the moral high ground and social capital in the world.

>>>>>>>>>> **u/SimoneNonvelodico** [+1]  *Dai-Gurren Brigade* (20 days later)
>>>>>>>>>> 
>>>>>>>>>> > anything AGI related has (IMO) zero value except as science fiction and leisure research
>>>>>>>>>> 
>>>>>>>>>> This seems like a stretch in the other direction though. As I said, again, we have human brains as an obvious example that AGI is possible in compact, economic form. AGI simply means an AI that is general, not an ascending cybergod. No reason why it shouldn't be possible (or fraught with ethical issues in its own right).

>>>>>>>>>>> **u/PastafarianGames** [+0]  (20 days later)
>>>>>>>>>>> 
>>>>>>>>>>> I define "won't be happening this century" as leisure research. We *might* come to understand how the brain works this century; I strongly doubt we'll be having AGI this century.
>>>>>>>>>>> 
>>>>>>>>>>> (There are a lot of things that are leisure research and I definitely think it's fine to research them! Research doesn't have to have practical value, it can just be interesting and fulfilling to the people researching it. But probably they should publish.)
>>>>>>>>>>> 
>>>>>>>>>>> (Yes, this means I pretty much consider AGI-related researchers, SF/F authors, and pure mathematicians to be science pets. Give them salaries, stipended grad students, and head-scritches, and occasionally drag them outside into the sun for walkies.)
