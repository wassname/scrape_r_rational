...
* URL: http://io9.com/forget-skynet-how-person-of-interest-depicts-a-realist-1679304088
* Score: 9

* Created: 2015-01-13T23:09:21
...
> **u/psychothumbs** [+3]  (40 seconds later)
> 
> I haven't seen much of Person of Interest. Has anybody here been watching?

>> **u/Integrated_Delusions** [+9]  *The Flying Kiwi* (4 hours later)
>> 
...
>>>> **u/Integrated_Delusions** [+1]  *The Flying Kiwi* (a day later)
>>>> 
>>>> [Actually](#s " it's Samaritan that I have the issue with. Like the unhackable phone network, for instance. Samaritan had the same info the Machine did, but didn't even check to see if anyone had set up communications it couldn't tap? I mean, I can't know what it thought the probabilities of anyone actually using that network would be, but you would think the expected result/invested effort ratio would be more than high enough to justify a tap.")
>>>> 
>>>> Edited for formatting. Again.

>>>>> **u/iemfi** [+1]  (a day later)
>>>>> 
>>>>> [](#s "Again you can just hand wave it away by saying that the machine with its head start already has an iron grip on a lot of things, Samaritan could well be very aware of the network but just be unable to do anything about it for now.")

>>>>>> **u/Integrated_Delusions** [+1]  *The Flying Kiwi* (2 days later)
>>>>>> 
>>>>>> [](#s "It can create a system to distribute itself to every child in the state, but fails to undermine a network being run on outdated tech? I guess it depends on how much probability Samaritan puts on the gang all still being in New York. I'm not sure how much damage those turned servers are doing. But I find it a hard justification to make that "Oh, it's all those server's doing it" or "Samaritan isn't as entrenched as the Machine is yet" without something more concrete from the show to back it up.")

>>> **u/randallsquared** [+2]  (6 hours later)
>>> 
...
>>>> **u/Integrated_Delusions** [+1]  *The Flying Kiwi* (a day later)
>>>> 
>>>> [Huh.] (#s "That's something I hadn't thought of. That would imply the Machine is effectively smarter, since it doesn't need the same resources to reach the same results. Though that still doesn't resolve all my issues. Unless.... New theory: The servers that were infected to protect their identities also contained Machine clones, who have been sabotaging Samaritan from the inside. And Samaritan can't tell, because the sabotage has been going on right from the start - there's no deviating data points for it to create a pattern from. As Samaritan expands, the Machine takes up a proportional amount of the expansion space, so the results return as Samaritan expects from it's flawed curve - which gives just enough room for the Machine to keep twisting the knife in. It would explain a few things...")
...
>>>>> **u/Integrated_Delusions** [+2]  *The Flying Kiwi* (2 days later)
>>>>> 
...
>> **u/CeruleanTresses** [+3]  (17 hours later)
>> 
