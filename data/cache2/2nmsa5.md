...
* Author: u/shulme45 *
* URL: https://www.reddit.com/r/rational/comments/2nmsa5/rationalbig_hero_6/
* Score: 11

* Created: 2014-11-28T02:50:32
...
>> Fist chip: Oy, that's a spoiler, shh. Secondly, because he's a character, as far as meta goes, and thirdly, because [SPOILER](#s "His hiro's only link to his deceased brother aside from a hat") , and so of course he's important, at least to Hiro. I will admit he is kind of cripplingly dumb at times, so I'm not sure how a rationalist! upgrade would fit him.
>> 

>>> **u/shulme45** [+2] *
>>> 
>>> Additionally, I had another plot idea for a fanfic, less rationlist by core but still maybe worth considering: [SPOILER](#s "Hiro's brother dies a few seconds after Hiro argues with him. If Hiro had managed to distract him for even 10 seconds more, he would have survived.") I am very interested in seeing how that additional plot detail would change the story.
>>> 
...
>>>> **u/shulme45** [+1] *
>>>> 
>>>> Frankly, I'm not sure if I'd be up to such a challenge. Functionally speaking, when Directed, Baymax actually is shown to be useful- [SPOILER](#s "He is shown to be able to break tendrils of micro-bots that attack him when Hiro calls out an appropriate karate counter-move early in the movie. ") If you take away the kid-friendliness, [SPOILER](#s " And give him that same useful effective downloaded strategies, massive strength, and single-minded red-death-chip focus, without his team-mates fighting him, able to move with robotic precision with no movement wasted... He'd be scary levels of strong, like a terminator at 1.5 speed. He even moved faster after the "I am not fast" comment- Hiro upgraded his speed. ")
>>>> 

>>>>> **u/shulme45** [+1] *
>>>>> 
>>>>> actually, even just adding in [SPOILER](#s "The ability to scan incoming attacks and automatically use an appropriate counter") would be an amazing combat boost compared.
>>>>> 
...
>>>>>> **u/shulme45** [+1] *
>>>>>> 
>>>>>> Maybe so, but [SPOILER](#s " The controller is shown, at least on screen during the final showdown, to focus on whatever the villian's focusing on. He gestures, presumably as a focusing measure, which seems to lend itself to single-targeting. I will give you "Not fast enough", though.")
>>>>>> 
...
>> **u/shulme45** [+1] *
>> 
>> This was also an obvious plothole to me. [SPOILER](#s "Why then? Why now? Advanced technology suddenly sparks your desire for revenge, which you were clearly living with and had gotten over until this demonstration? you are SURROUNDED BY ADVANCED TECHNOLOGY. IT IS YOUR JOB. The whole reason and snapping didn't make any sense.")
>> 

>> **u/fljared** [+1]  *United Federation of Planets**
>> 
>> I assumed that the [](#s " explosion really was an accident") 
>> But if it was not:
>> [There's the fact that](#s " faking his own death allows him to use the microbots without being seen, tracked, or monitored. Hard to borrow them under Hiro's watch, especially if you want to do illegal things with them.") 
>> [One thing that stuck out to me was](#s " the fact that the general quarantined the base. Why? Was he afraid the wormhole was going to escape?")
>> 

>>> **u/shulme45** [+2] *
>>> 
>>> My question then is [SPOILER](#s "Why Hiro's Microbots?") If he wanted [SPOILER](#s "to take revenge using high technology"), then everything he needed was around him. Hell, [SPOILER](#s "Aside from Baymay and his hanger-on Hero, most of technology used to make up the rest of the team's powers isn't Hiro's- It was ALREADY LYING AROUND in the guy's building. Why not use THAT stuff? the plasma cutter could have supermurdered him and left nothing left to be identified.")
>>> 

>>>> **u/fljared** [+1]  *United Federation of Planets**
>>>> 
>>>> [He wanted to] (#s "kill Krei in the same way that Krei killed his daughter. He spotted the opportunity in the microbots.")
>>>> Also, your second suggestion is not as foolproof as you think [](#s " It'd be hard to kill Krei without evidence; All the plasma cutter does is give you a slightly easier method to murder with. Blood, alibis, etc. are still a problem.")
>>>> It's all rather moot though [since](#s "He does it out in the open with no regard for secrecy. That may or may not have been due to being unmasked by Hiro and expecting the police to strike at any minute, but even then he could've killed and slunk away without anyone knowing it was him with a little preparedness.")
>>>> 

>>>>> **u/shulme45** [+1] *
>>>>> 
>>>>> Maybe so, .[SPOILER](#s "but the whole irony motivation is... A little flimsy. I don't know about you, but I would not wait for the perfect revenge. I'd just take revenge")
>>>>> 

>> **u/shulme45** [+1] *
>> 
>> [SPOILER](#s "Then again, Hiro would have never been the wiser, if the guy had remembered to change his own stolen and replicated batch to a different band- If Hiro's remnant bot didn't automaticallly track it, he'd be home free.")
>> 
...
> **u/fljared** [+1]  *United Federation of Planets**
> 
> [On your Beymax question](#s " He either 1. Had the shutdown and obedience drives in a deeper firmware, which would be useful for early testing of features; 2. Placed an extra copy of his software in the second chip, probable given that he's shown resistance to changing his programming before and would want to prevent a change to his helpful nature")
> 
...
> [SPOILER](#s "I remember a throwaway line from the beginning, where Hiro starts to describe how he built what would become the microbot's prototype- "Hey genius, he invented those!" Well, if the Big Bad invented the technology Hiro uses, then why didn't HE invent the Microbots first? ")
> 

> **u/Sylocat** [+1]  *Canterlot Campaign**
> 
> Well, the easy answer to most of these is, ["](#s "The entire character arcs of both the hero and the villain were about overcoming the toxic cocktail of grief, regret and rage that was clouding their judgment while driving their actions... in other words, the main challenge for Hiro was to overcome an enormous fundamental obstacle to rationality anyway")." But that's no fun for this subreddit, so let's break it down further.
> There's another counter to your first idea:
> > [On](#s "Why doesn't Hiro rebuild the bots?")
> [I think](#s "he didn't have time. When he first designed the bots, the montage indicated it took weeks to even build a few recycling bins full of them, let alone the massive stockpile that Callaghan had.")
> 
...
>>>>> Pfft. Look at [what we did for *Frozen*](http://www.reddit.com/r/rational/comments/1w14i4/bstspoilers_rationalfrozen/) which eventually resulted in the excellent [*A Bluer Shade Of White* fanfiction](https://www.fanfiction.net/s/10327510/1/A-Bluer-Shade-of-White).
>>>>> 
