...
* URL: https://www.reddit.com/r/rational/comments/5mkuk2/d_saturday_munchkinry_thread/
* Score: 8

* Created: 2017-01-07T15:04:22
...
>> **u/InfernoVulpix** [+11]  (5 hours later)
>> 
...
>>> 
>>> See that's only an issue if researchers were already on the cusp of creating GAI _last year_ which seems _extremely_ implausible.                 
...
>>>> 
>>>> 10% chance in the 2020s, 50% chance between 2035 and 2050. 50% is the median of the distribution, but since it's normal that's also the mean. 10% is [1.28](https://en.wikipedia.org/wiki/Standard_deviation) standard deviations from that. 1.28 standard deviations is (2035-2029=)6 to (2050-20[20](https://en.wikipedia.org/wiki/20s)=) 30 years. 2016 is ((2035-2017)/6=)3\*1.28=3.84 to ((2050-2016)/30)~=1.13\*1.28~=1.45 standard deviations from the mean. 2017 is 3.63 to 1.41. The probability that it happens up to 2016/2017 [is](http://sampson.byu.edu/courses/z2p2z-calculator.html) 0.0062% to 7.35% for 2016, 0.0142% to 7.93% for 2017. The expected number of playthroughs of 2016 is (1/(0.000142-0.000062)=)12500 - (1/(0.0793-0.0735)=)172.
>>>> 
...
>>>>>>>>>>> **u/xamueljones** [+10]  *My arch-enemy is entropy* (13 hours later)
>>>>>>>>>>> 
>>>>>>>>>>> "Ha-banana."
>>>>>>>>>>> 
...
> **u/callmebrotherg** [+6]  *now posting as /u/callmesalticidae* (2 hours later)
> 
...
>> **u/space_fountain** [+2]  (a day later)
>> 
...
>>>> **u/space_fountain** [+1]  (4 days later)
>>>> 
...
>> 
>> [My guess, to only be read by DM once the game is done](#s "rot13: FHVPVQR")
...
>>>>>> 
>>>>>> If it says hubris then just kill yourself, it doesn't really seem like hubris would make sense as a cause of death there. If it says paradox testing _then_ you might try to live your life normally. Obviously the thing to consider there is that you might get killed in some unrelated paradox testing incident so it can still kill you after all.        
...
>>>>>>>>>>>>>>> > See just relying on self consistency doesn't make much sense either, since having the machine invented in the first place will necessarily lead to a reality that involves a much higher number of extraordinarily unlikely events.
>>>>>>>>>>>>>>> 
>>>>>>>>>>>>>>> This, on the other hand, is not as big of an issue as it appears. All you have to do is condition on the fact of the machine's existence, i.e. even if the _overall_ probability of the machine being invented is extremely low, we're only interested in timelines where it _is_ invented.
