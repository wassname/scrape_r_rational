...
* URL: http://www.scp-wiki.net/scp-2521
* Score: 27

* Created: 2015-11-29T20:00:14

### Post:

[Link to content](http://www.scp-wiki.net/scp-2521)

### Comments:

> **u/blazinghand** [+9]  *Chaos Undivided* (4 minutes later)
> 
...
>> **u/Transfuturist** [+6]  *Carthago delenda est.* (28 minutes later)
>> 
...
>>> **u/mycroftxxx42** [+4]  (16 hours later)
>>> 
>>> It's worth noting that minds _can_ be considered fundamental in the SCP-verse.   Coincidentally, this from the point of view of [another](https://www.fanfiction.net/s/5389450/1/The-Finale-of-the-Ultimate-Meta-Mega-Crossover) piece of Yudkowski fanfic:
>>> 
>>> _Anyway, Maria, the logic of the events you're describing is one where consciousness has effects that take precedence over the laws of physics - where lower levels of organization give way to higher levels of organization. There are universes where the visible rules are simple, mathematical, and fundamental, and everything that happens, happens within them. And there are universes where the visible rules are complicated and have explicit special cases for surface phenomena - and usually some of the visible rules are about mental phenomena, and don't visibly reduce to rules about non-mental parts. We call the former sort of universe 'natural', and the latter sort 'magical'._
>>> 
...
> **u/Revisional_Sin** [+5]  (13 minutes later)
> 
> Very cool.
> 
> What does X(0123) O(45) mean? (Just below the do not write on paper, on a computer or talk)

>> **u/alexanderwales** [+13]  *Time flies like an arrow* (17 minutes later)
>> 
>> That's clearance level for the document. Security clearance 0-3 are not allowed to look at the document, while clearance level 4 and 5 (or O5) are. [See here](http://www.scp-wiki.net/security-clearance-levels-arc) for more on SCP security clearance levels.

>>> **u/blazinghand** [+15]  *Chaos Undivided* (29 minutes later)
>>> 
>>> Yeah this is actually kinda a bad introduction to SCP Wiki since this article requires you be pretty familiar with an SCP entry, now that I think about it. [SCP-140](http://www.scp-wiki.net/scp-140) may be a better introduction, or [SCP-2602, which used to be a library](http://www.scp-wiki.net/scp-2602).
...
>>> **u/JackStargazer** [+6]  *Primordial Apologist* (53 minutes later)
>>> 
...
>>>>> **u/ZeroNihilist** [+9]  (3 hours later)
>>>>> 
...
> 
> It doesn't really work for me. I saw the format, and got really excited for a spin on the [Yucca Mountain nuclear waste repository](http://www.damninteresting.com/this-place-is-not-a-place-of-honor/) - here is a containment procedure that must be readable to people even after the English language no longer exists! The actual document was something of a letdown then.
> 
