...
* Author: u/ILL_BE_WATCHING_YOU *
* URL: http://i.imgur.com/4B6wPoK.png
* Score: 173

* Created: 2017-05-30T01:25:23
...
> **u/trekie140** [+26]  (27 minutes later)
> 
...
>> **u/AntiTwister** [+18]  (49 minutes later)
>> 
>> Permutation City also explores this concept in depth.

>>> **u/trekie140** [+11]  (13 hours later)
>>> 
...
>>>> **u/AntiTwister** [+2]  (16 hours later)
>>>> 
...
>> **u/literal-hitler** [+8]  (2 hours later)
>> 
...
>> **u/CellWithoutCulture** [+3]  (22 hours later)
>> 
...
>> **u/Imperialgecko** [+1]  (2 hours later)
>> 
...
>> **u/TastyBrainMeats** [+3]  (16 hours later)
>> 
...
>>>> **u/TastyBrainMeats** [+12]  (a day later)
>>>> 
...
>>>>>> **u/TastyBrainMeats** [+3]  (a day later)
>>>>>> 
...
>>>>>>>> **u/TastyBrainMeats** [+2]  (a day later)
>>>>>>>> 
...
>> **u/FeepingCreature** [+4]  *GCV Literally The Entire Culture* (20 hours later)
>> 
...
>>>>>> 
>>>>>> Far from it. We're not talking about a mind who is in all respects identical to a mind that is conscious; we're talking about a mind that had its seat of consciousness _physically_ subtracted. A P-Zombie is a mind that had its _qualia metaphysically_ subtracted. What I described is more of a ... Q-Zombie?
>>>>>> 
>>>>>> A P-Zombie behaves like a human despite feeling nothing on the inside. A Q-Zombie believes they _feel_ conscious despite having no consciousness. Mind you I don't believe that a Q-Zombie behaves identically, I just think they _think_ they do. The diagnostic in their brains that says they're conscious is set permanently to "on".
>>>>>> 
>>>>>> If we allow for the existence of Q-Zombies, then no reasoner can decide _even from the inside_ that they are conscious with 100% certainty.
>>>>>> 
>>>>>> As opposed to P-Zombies, Q-Zombies have precedent in neuroscience; there exist disorders that destroy parts of our sensory apparatus while denying us the ability to even _notice_ that we've lost them. Read Blindsight!
...
>> **u/LeifCarrotson** [+6]  (13 hours later)
>> 
...
>>>> **u/LeifCarrotson** [+2]  (17 hours later)
>>>> 
...
>> **u/robobreasts** [+6]  (17 hours later)
>> 
...
>> **u/TakeTheOarOutOfSnore** [+3]  (18 hours later)
>> 
...
>>>>>>>> 
>>>>>>>> It feels like you're passing the recursive buck: "how do you know an upload is _really_ experiencing the illusion of really experiencing things and aren't just behaving as if?"
>>>>>>>> 
...
>>>>> **u/TastyBrainMeats** [+1]  (18 hours later)
>>>>> 
...
>>>> **u/everything-narrative** [+2]  *Coral, Abide with Rubicon!* (20 hours later)
>>>> 
...
>>>>>> > Why even upload then? Why not just build a general AI (conscious or not, you don't care as long as it is smart) and leave the galaxy to the AI? You are not important, not even to you. The only thing that matters is that something smart gets to do all the cool stuff.
>>>>>> 
>>>>>> And now I'm both sorry for not clarifying my last point, but also I'm laughing my arse off at your naive approach. It's endearing and I love you in a genuine and non-patronizing manner. It is _good_ that you are inquisitive.
>>>>>> 
...
>>>>>> 
>>>>>> I wanna upload because then a version of me which is close enough to my meatself will get to do a lot of cool stuff, and I care about _that._ I don't care about whether it is "conscious" only that it is _me_.
>>>>>> 
...
>>>>>> Lots of good stuff.
>>>>>> 
>>>>>> I _want_ a mind-clone of me to get some good stuff.
>>>>>> 
...
>>>>>>>> 
>>>>>>>> Say I put you under general anaesthetic with zero-EEG and in a state of protective hypothermia so your metabolic rate is basically zero, and construct a physical replica of you, accurate to
>>>>>>>> sub-molecular scale, then wake you both up in identical rooms?
>>>>>>>> 
>>>>>>>> Say I reduce you to a brain-in-a-jar and let you pilot an incredibly realistic android body?

>>>>>>>>> **u/KilotonDefenestrator** [+0]  (a day later)
>>>>>>>>> 
>>>>>>>>> > Enjoyment sits in the brain. Check for the enjoyment related neuron clusters and see that they function normally.
>>>>>>>>> 
>>>>>>>>> How do you give an MRI to a CPU running atom-level simulations of chemical reactions?

>>>>>>>>>> **u/FeepingCreature** [+1]  *GCV Literally The Entire Culture* (3 months later)
>>>>>>>>>> 
>>>>>>>>>> Very late answer, but... run an atom-level simulation of an MRI. :-)

>>> **u/rhaps0dy4** [+4]  (18 hours later)
>>> 
...
>>>> **u/everything-narrative** [+7]  *Coral, Abide with Rubicon!* (20 hours later)
>>>> 
...
>>>> 
>>>> As far as I can tell, the key is to _identify yourself with the pattern itself_. For a simple System 1 proxy, you can just identify yourself with the surviving copy.

>>> **u/GopherAtl** [+1]  (12 hours later)
>>> 
...
>>>>> 
>>>>> A fully qualified upload of me would have to be able to accurately simulate all the [thousands of billion billion chemical reactions **per second** that goes on in the human body](https://www.quora.com/On-average-how-many-chemical-reactions-happen-in-the-body-in-one-second).
...
>> **u/ZeroNihilist** [+11]  (9 hours later)
>> 
...
>> **u/FeepingCreature** [+2]  *GCV Literally The Entire Culture* (20 hours later)
>> 
>> Yes, which is why we consider people conscious _if we have evidence for this_.
>> 
>> The point of the argument is that we have the same [edit kind] of evidence for ourselves being conscious as the upload being conscious. But that is _not nearly_ the same degree as we have for rocks being conscious.
