...
* URL: https://www.reddit.com/r/rational/comments/3c1m5x/rational_urban_fantasy_novel_idea_low_level/
* Score: 5

* Created: 2015-07-03T22:43:52
...
> 
> The Mistborn Adventure Game is a heavily story-based system that's geared towards people telling stories together. It naturally lives in that setting, but I think could probably be extracted from it fairly easily. [You can read the rules primer here [PDF]](http://www.crafty-games.com/files/File/Mistborn_Adventure_Game_Primer-Pre-Release-v3.pdf). It's very "dice light", and I think sort of the model that I would use for my own RPG.

>> **u/None** [+1]  (an hour later)
>> 
>> I'll second that.

>>> **u/DreamingOfGoats** [+1]  (2 days later)
>>> 
