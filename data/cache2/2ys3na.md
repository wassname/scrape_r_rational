...
>> >Paladin equipment. Items such as weapons of light (lasers) that are set to only hurt or heal people of a particular alignment.
>> 
>> Bah, everyone knows [the Sword of Light is actually a spaceship](http://kanzaka.wikia.com/wiki/Sword_of_Light)!
...
> **u/DCarrier** [+3]  (7 hours later)
> 
> The Mahou Shoujo could have their brains uploaded into computers so that damage to their body isn't debilitating.
> Utility fog
> Rapid prototyping
> Super strong and light materials, although if the main character isn't a material scientist, he might not notice.
> 
...
> 
> [Clark's Laws](http://en.wikipedia.org/wiki/Clarke%27s_three_laws)
> 
> [Also, some suggestions](http://tvtropes.org/pmwiki/pmwiki.php/Main/MagicFromTechnology)

>> **u/autowikibot** [+2]  (an hour later)
>> 
>> #####&#009;
>> 
>> ######&#009;
>> 
>> ####&#009;
>>  [**Clarke's three laws**](https://en.wikipedia.org/wiki/Clarke%27s%20three%20laws): [](#sfw) 
>> 
>> ---
>> 
>> >
>> 
>> >__Clarke's Three Laws__ are three ["laws"](https://en.wikipedia.org/wiki/Adage) of prediction formulated by the British science fiction writer [Arthur C. Clarke](https://en.wikipedia.org/wiki/Arthur_C._Clarke). They are:
>> 
>> >
>> 
...
>> ---
>> 
>> ^Interesting: [^Deep ^magic](https://en.wikipedia.org/wiki/Deep_magic) ^| [^Hanlon's ^razor](https://en.wikipedia.org/wiki/Hanlon%27s_razor) ^| [^The ^View ^from ^Serendip](https://en.wikipedia.org/wiki/The_View_from_Serendip) 
>> 
>> ^Parent ^commenter ^can [^toggle ^NSFW](/message/compose?to=autowikibot&subject=AutoWikibot NSFW toggle&message=%2Btoggle-nsfw+cpcfynt) ^or[](#or) [^delete](/message/compose?to=autowikibot&subject=AutoWikibot Deletion&message=%2Bdelete+cpcfynt)^. ^Will ^also ^delete ^on ^comment ^score ^of ^-1 ^or ^less. ^| [^(FAQs)](http://www.np.reddit.com/r/autowikibot/wiki/index) ^| [^Mods](http://www.np.reddit.com/r/autowikibot/comments/1x013o/for_moderators_switches_commands_and_css/) ^| [^Magic ^Words](http://www.np.reddit.com/r/autowikibot/comments/1ux484/ask_wikibot/)
...
>> 
>> [The kind of stuff used in this film, for instance](http://tvtropes.org/pmwiki/pmwiki.php/Film/SherlockHolmes), but with a *much* higher level of scientific knowledge.
...
> 
> Basically, if you have mature nanotech, ... a lot goes. A book of nanostuff, contains an entire interactive wikipedia/learning programms, freefloating nanites in the air can have an area-denying effect (think fog of death), enormous energy density and low weight/high strenght materials allow for all manners of small, intelligent drones. That same level on nanotech if used on the body allows telepathy, vampire-like immunity to damage etc etc. 
> Normal looking swords that are nano-chainsaws and go trough everything- the limit imposed by physics is sky-high. 
