...
* URL: https://www.reddit.com/r/rational/comments/8y0cxu/d_wednesday_worldbuilding_thread/
* Score: 9

* Created: 2018-07-11T15:07:03
...
>> **u/jaspercb** [+3]  *Gravitas Free Zone* (3 hours later)
>> 
...
>> --------------
>> 
>> Even without that, though, mining minerals from seawater is [quite possible](https://en.wikipedia.org/wiki/Brine_mining) - including uranium, so using nuclear energy for power may be plausible. Mind you, it's not at all easy to do. The other option, given the possibility of submarines in the fleet, is of course [underwater mining](https://en.wikipedia.org/wiki/Deep_sea_mining) for minerals. And a bit of googling suggests that rubber made from kelp is not only plausible but has been done (or at least claimed) before, so the ocean can provide insulators.
>> 
...
>> 
>> For modern or better, seacrete is an infinte building material. 
...
> **u/Mandeltrot_Set** [+1]  (a day later)
> 
...
> 
> Let's say that we solve [this problem with centaurs](https://www.smbc-comics.com/comic/the-truth-about-centaurs) by saying that the centaur is kept alive by the horse organs while the human torso is filled with extra brains to make up for the larger body size compared to a human. What would be the practical upshot of this, particularly in terms of how one might play as a race in a tabletop game?
