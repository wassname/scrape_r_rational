...
* Author: u/scooterboo2  *Tinker 3: Embeded Systems**
* URL: http://www.mangareader.net/164/liar-game.html
* Score: 20

* Created: 2015-01-14T04:00:47
...
> **u/scooterboo2** [+9]  *Tinker 3: Embeded Systems**
> 
...
>> **u/Magodo** [+7]  *Ankh-Morpork City Watch**
>> 
...
> **u/The_Mad_Duke** [+4]  *House Tremontaine**
> 
...
>> **u/MadScientist14159** [+1]  *WIP: Sodium Hypochlorite (Rational Bleach) Eventually. Maybe.**
>> 
>> [spoilers ch17](#s "If they had, then 15 would have ensured he went last and the same thing would have happened.")
>> But yes, good call.
>> [spoilers ch17](#s "Also: the entire chapter it seemed really obvious what 15 and Shinichi's play was. I can't see how the other two didn't spot it.")
>> 

>>> **u/eaglejarl** [+1] *
>>> 
>>> > [...the ](#s "same thing would have happened")
>>> Really?  Let me check; assume the votes go:
>>> * 22 (Akiyama): No
>>> * [3: ](#s "Yes.  [Score is N:1 / Y:1]")
>>> * [11: ](#s "No. [Score is N:2 / Y:1]; Akiyama is in the majority and cannot win.")
>>> * [15: ](#s "Say he votes 'Yes' as his teammates expect.  The score is a draw, do the round over.  On the other hand, say he defects and votes 'No'; the score is now N:3, Y:1 and player 3 wins as the only 'Yes' vote.  If he votes last, 15 cannot force a win for either himself or Akiyama.")
>>> [Furthermore, ](#s "If 15 goes either first or second, he still cannot force a win for Akiyama or himself--the other two will adjust their votes to force the draw and will also know that 15 is a traitor.")
...
>>>>>>> **u/Rouninscholar** [+1] *
>>>>>>> 
>>>>>>> Yeah. The one thing that bugged me the whole time was that noone had mentioned it. I would be far happier of someone said "hey didn't you lie earlier"
>>>>>>> "Oh, that was before the game started for you"
