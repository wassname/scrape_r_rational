...
* URL: http://www.critical-hits.com/blog/2015/04/21/castles-in-the-sky-part-i-history-mechanics-and-trade/
* Score: 21

* Created: 2015-04-21T13:23:03
...
>>>> 
>>>> More likely [floating ships](http://dawnchapel.com/2015/03/skyfaring-vocabulary/).
...
>>>>>> **u/OffColorCommentary** [+5]  (12 hours later)
>>>>>> 
...
>> 
>> Boats [can sail upwind](http://www.discoverboating.com/resources/article.aspx?id=253). If the wind across the castle is perfectly homogeneous and the castle is already moving as fast as the wind, you are stuck, but if there's a difference you can use that difference to do work. I'm not sure if a flying castle could move against the wind using wind power only, but I wouldn't be surprised.
...
> **u/scooterboo2** [+1]  *Tinker 3: Embeded Systems* (4 hours later)
> 
